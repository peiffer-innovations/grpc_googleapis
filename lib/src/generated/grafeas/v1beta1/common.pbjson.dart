...
const NoteKind$json = const {
  ...
  '2': const [
    ...
    const {'1': 'INTOTO', '2': 8},
    const {'1': 'SBOM', '2': 9},
    const {'1': 'SPDX_PACKAGE', '2': 10},
    const {'1': 'SPDX_FILE', '2': 11},
    const {'1': 'SPDX_RELATIONSHIP', '2': 12},
  ],
};
...
final $typed_data.Uint8List noteKindDescriptor = $convert.base64Decode(
    '');
