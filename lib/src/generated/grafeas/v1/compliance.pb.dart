...
class ComplianceNote_CisBenchmark extends $pb.GeneratedMessage {
  factory ComplianceNote_CisBenchmark({
    ...
    final result = create();
    if (profileLevel != null) result.profileLevel = profileLevel;
  ...
  factory ComplianceNote_CisBenchmark.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ComplianceNote_CisBenchmark.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aI(1, _omitFieldNames ? '' : 'profileLevel')
    ..aE<$0.Severity>(2, _omitFieldNames ? '' : 'severity',
        enumValues: $0.Severity.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ComplianceNote_CisBenchmark clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set profileLevel($core.int value) => $_setSignedInt32(0, value);
  @$pb.TagNumber(1)
  $core.bool hasProfileLevel() => $_has(0);
  @$pb.TagNumber(1)
  void clearProfileLevel() => $_clearField(1);

  @$pb.TagNumber(2)
  $0.Severity get severity => $_getN(1);
  @$pb.TagNumber(2)
  set severity($0.Severity value) => $_setField(2, value);
  @$pb.TagNumber(2)
...
class ComplianceNote extends $pb.GeneratedMessage {
  factory ComplianceNote({
    ...
    if (cisBenchmark != null) result.cisBenchmark = cisBenchmark;
    if (scanInstructions != null) result.scanInstructions = scanInstructions;
  ...
  factory ComplianceNote.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ComplianceNote.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<ComplianceVersion>(3, _omitFieldNames ? '' : 'version',
  ...
  @$pb.TagNumber(6)
  void clearComplianceType() => $_clearField($_whichOneof(0));

  @$pb.TagNumber(8)
  ComplianceNote_PotentialImpact whichPotentialImpact() =>
      _ComplianceNote_PotentialImpactByTag[$_whichOneof(1)]!;
  @$pb.TagNumber(8)
  void clearPotentialImpact() => $_clearField($_whichOneof(1));
  ...
  @$pb.TagNumber(3)
  $pb.PbList<ComplianceVersion> get version => $_getList(2);
  ...
  @$pb.TagNumber(6)
  set cisBenchmark(ComplianceNote_CisBenchmark value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasCisBenchmark() => $_has(5);
  @$pb.TagNumber(6)
  void clearCisBenchmark() => $_clearField(6);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set scanInstructions($core.List<$core.int> value) => $_setBytes(6, value);
  @$pb.TagNumber(7)
  $core.bool hasScanInstructions() => $_has(6);
  @$pb.TagNumber(7)
  void clearScanInstructions() => $_clearField(7);
...
class ComplianceVersion extends $pb.GeneratedMessage {
  factory ComplianceVersion({
    ...
    if (benchmarkDocument != null) result.benchmarkDocument = benchmarkDocument;
    return result;
  }

  ComplianceVersion._();

  factory ComplianceVersion.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ComplianceVersion.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ComplianceVersion clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(3)
  set benchmarkDocument($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasBenchmarkDocument() => $_has(2);
  @$pb.TagNumber(3)
  void clearBenchmarkDocument() => $_clearField(3);
}
...
class ComplianceOccurrence extends $pb.GeneratedMessage {
  ...
  ComplianceOccurrence._();

  factory ComplianceOccurrence.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ComplianceOccurrence.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'),
      createEmptyInstance: create)
    ..pPM<NonCompliantFile>(2, _omitFieldNames ? '' : 'nonCompliantFiles',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ComplianceOccurrence clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  $pb.PbList<NonCompliantFile> get nonCompliantFiles => $_getList(0);

  @$pb.TagNumber(3)
  $core.String get nonComplianceReason => $_getSZ(1);
  @$pb.TagNumber(3)
  set nonComplianceReason($core.String value) => $_setString(1, value);
  @$pb.TagNumber(3)
  $core.bool hasNonComplianceReason() => $_has(1);
  @$pb.TagNumber(3)
  void clearNonComplianceReason() => $_clearField(3);

  /// The OS and config version the benchmark was run on.
  @$pb.TagNumber(4)
  ComplianceVersion get version => $_getN(2);
  @$pb.TagNumber(4)
  set version(ComplianceVersion value) => $_setField(4, value);
  @$pb.TagNumber(4)
...
class NonCompliantFile extends $pb.GeneratedMessage {
  factory NonCompliantFile({
    ...
    if (displayCommand != null) result.displayCommand = displayCommand;
  ...
  factory NonCompliantFile.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory NonCompliantFile.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  NonCompliantFile clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  set displayCommand($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasDisplayCommand() => $_has(1);
  @$pb.TagNumber(2)
  void clearDisplayCommand() => $_clearField(2);
