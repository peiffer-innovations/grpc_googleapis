...
class NodeConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'bootDiskKmsKey')
    ..aOM<EphemeralStorageConfig>(
        24,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'ephemeralStorageConfig',
        subBuilder: EphemeralStorageConfig.create)
    ..aOM<GcfsConfig>(
        25,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(24)
  set ephemeralStorageConfig(EphemeralStorageConfig v) {
    setField(24, v);
  }
  ...
  @$pb.TagNumber(36)
  FastSocket get fastSocket => $_getN(28);
  @$pb.TagNumber(36)
  ...
  @$pb.TagNumber(36)
  $core.bool hasFastSocket() => $_has(28);
  @$pb.TagNumber(36)
  void clearFastSocket() => clearField(36);
  @$pb.TagNumber(36)
  FastSocket ensureFastSocket() => $_ensure(28);

  @$pb.TagNumber(37)
  $core.Map<$core.String, $core.String> get resourceLabels => $_getMap(29);

  @$pb.TagNumber(38)
  NodePoolLoggingConfig get loggingConfig => $_getN(30);
  @$pb.TagNumber(38)
  ...
  @$pb.TagNumber(38)
  $core.bool hasLoggingConfig() => $_has(30);
  @$pb.TagNumber(38)
  void clearLoggingConfig() => clearField(38);
  @$pb.TagNumber(38)
  NodePoolLoggingConfig ensureLoggingConfig() => $_ensure(30);

  @$pb.TagNumber(39)
  WindowsNodeConfig get windowsNodeConfig => $_getN(31);
  @$pb.TagNumber(39)
  ...
  @$pb.TagNumber(39)
  $core.bool hasWindowsNodeConfig() => $_has(31);
  @$pb.TagNumber(39)
  void clearWindowsNodeConfig() => clearField(39);
  @$pb.TagNumber(39)
  WindowsNodeConfig ensureWindowsNodeConfig() => $_ensure(31);

  @$pb.TagNumber(40)
  LocalNvmeSsdBlockConfig get localNvmeSsdBlockConfig => $_getN(32);
  @$pb.TagNumber(40)
  ...
  @$pb.TagNumber(40)
  $core.bool hasLocalNvmeSsdBlockConfig() => $_has(32);
  @$pb.TagNumber(40)
  void clearLocalNvmeSsdBlockConfig() => clearField(40);
  @$pb.TagNumber(40)
  LocalNvmeSsdBlockConfig ensureLocalNvmeSsdBlockConfig() => $_ensure(32);
  ...
  @$pb.TagNumber(41)
  $core.bool hasEphemeralStorageLocalSsdConfig() => $_has(33);
  @$pb.TagNumber(41)
...
class SandboxConfig extends $pb.GeneratedMessage {
  ...
  factory SandboxConfig({
    @$core.Deprecated('This field is deprecated.') $core.String? sandboxType,
...
class EphemeralStorageConfig extends $pb.GeneratedMessage {
  ...
  factory EphemeralStorageConfig.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory EphemeralStorageConfig.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  EphemeralStorageConfig clone() =>
      EphemeralStorageConfig()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  EphemeralStorageConfig copyWith(
          void Function(EphemeralStorageConfig) updates) =>
      super.copyWith((message) => updates(message as EphemeralStorageConfig))
          as EphemeralStorageConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static EphemeralStorageConfig create() => EphemeralStorageConfig._();
  EphemeralStorageConfig createEmptyInstance() => create();
  static $pb.PbList<EphemeralStorageConfig> createRepeated() =>
      $pb.PbList<EphemeralStorageConfig>();
  @$core.pragma('dart2js:noInline')
  static EphemeralStorageConfig getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EphemeralStorageConfig>(create);
...
class AddonsConfig extends $pb.GeneratedMessage {
  ...
  factory AddonsConfig({
    ...
    @$core.Deprecated('This field is deprecated.') IstioConfig? istioConfig,
    CloudRunConfig? cloudRunConfig,
    DnsCacheConfig? dnsCacheConfig,
    ConfigConnectorConfig? configConnectorConfig,
    GcePersistentDiskCsiDriverConfig? gcePersistentDiskCsiDriverConfig,
    @$core.Deprecated('This field is deprecated.') KalmConfig? kalmConfig,
    ...
    if (gcsFuseCsiDriverConfig != null) {
      _result.gcsFuseCsiDriverConfig = gcsFuseCsiDriverConfig;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(17)
  GcsFuseCsiDriverConfig get gcsFuseCsiDriverConfig => $_getN(12);
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(17)
  $core.bool hasGcsFuseCsiDriverConfig() => $_has(12);
  @$pb.TagNumber(17)
  void clearGcsFuseCsiDriverConfig() => clearField(17);
  @$pb.TagNumber(17)
  GcsFuseCsiDriverConfig ensureGcsFuseCsiDriverConfig() => $_ensure(12);
}
...
class KalmConfig extends $pb.GeneratedMessage {
  ...
  factory KalmConfig.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory KalmConfig.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  KalmConfig copyWith(void Function(KalmConfig) updates) =>
      super.copyWith((message) => updates(message as KalmConfig))
          as KalmConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static KalmConfig getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<KalmConfig>(create);
...
class GcsFuseCsiDriverConfig extends $pb.GeneratedMessage {
  ...
  GcsFuseCsiDriverConfig copyWith(
      ...
      super.copyWith((message) => updates(message as GcsFuseCsiDriverConfig))
          as GcsFuseCsiDriverConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IstioConfig extends $pb.GeneratedMessage {
  ...
  IstioConfig._() : super();
  factory IstioConfig({
    @$core.Deprecated('This field is deprecated.') $core.bool? disabled,
    @$core.Deprecated('This field is deprecated.')
  ...
  IstioConfig copyWith(void Function(IstioConfig) updates) =>
      super.copyWith((message) => updates(message as IstioConfig))
          as IstioConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IPAllocationPolicy extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(21)
  PodCIDROverprovisionConfig get podCidrOverprovisionConfig => $_getN(16);
  @$pb.TagNumber(21)
  set podCidrOverprovisionConfig(PodCIDROverprovisionConfig v) {
    setField(21, v);
  }
  ...
  @$pb.TagNumber(21)
  $core.bool hasPodCidrOverprovisionConfig() => $_has(16);
  @$pb.TagNumber(21)
  void clearPodCidrOverprovisionConfig() => clearField(21);
  @$pb.TagNumber(21)
  PodCIDROverprovisionConfig ensurePodCidrOverprovisionConfig() => $_ensure(16);

  @$pb.TagNumber(22)
  $core.String get subnetIpv6CidrBlock => $_getSZ(17);
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(22)
  $core.bool hasSubnetIpv6CidrBlock() => $_has(17);
  @$pb.TagNumber(22)
  void clearSubnetIpv6CidrBlock() => clearField(22);

  @$pb.TagNumber(23)
  $core.String get servicesIpv6CidrBlock => $_getSZ(18);
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(23)
  $core.bool hasServicesIpv6CidrBlock() => $_has(18);
  @$pb.TagNumber(23)
  void clearServicesIpv6CidrBlock() => clearField(23);

  @$pb.TagNumber(24)
  AdditionalPodRangesConfig get additionalPodRangesConfig => $_getN(19);
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(24)
  $core.bool hasAdditionalPodRangesConfig() => $_has(19);
  @$pb.TagNumber(24)
  void clearAdditionalPodRangesConfig() => clearField(24);
  @$pb.TagNumber(24)
  AdditionalPodRangesConfig ensureAdditionalPodRangesConfig() => $_ensure(19);
}
...
class ClusterTelemetry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.container.v1beta1'),
      createEmptyInstance: create)
    ..e<ClusterTelemetry_Type>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'type',
        $pb.PbFieldType.OE,
        defaultOrMaker: ClusterTelemetry_Type.UNSPECIFIED,
        valueOf: ClusterTelemetry_Type.valueOf,
        enumValues: ClusterTelemetry_Type.values)
    ..hasRequiredFields = false;
  ...
  factory ClusterTelemetry.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ClusterTelemetry.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ClusterTelemetry copyWith(void Function(ClusterTelemetry) updates) =>
      super.copyWith((message) => updates(message as ClusterTelemetry))
          as ClusterTelemetry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ClusterTelemetry create() => ClusterTelemetry._();
  ClusterTelemetry createEmptyInstance() => create();
  static $pb.PbList<ClusterTelemetry> createRepeated() =>
      $pb.PbList<ClusterTelemetry>();
  @$core.pragma('dart2js:noInline')
  static ClusterTelemetry getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ClusterTelemetry>(create);
  static ClusterTelemetry? _defaultInstance;

  @$pb.TagNumber(1)
  ClusterTelemetry_Type get type => $_getN(0);
  @$pb.TagNumber(1)
  set type(ClusterTelemetry_Type v) {
    setField(1, v);
  }
...
class Cluster extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ClusterTelemetry>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'clusterTelemetry',
        subBuilder: ClusterTelemetry.create)
    ..aOM<TpuConfig>(
        47,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'tpuConfig',
        subBuilder: TpuConfig.create)
  ...
  factory Cluster({
    ...
    @$core.Deprecated('This field is deprecated.') $core.bool? privateCluster,
    @$core.Deprecated('This field is deprecated.')
    $core.String? masterIpv4CidrBlock,
  ...
  @$pb.TagNumber(139)
  $core.String get etag => $_getSZ(71);
  @$pb.TagNumber(139)
  ...
  @$pb.TagNumber(139)
  $core.bool hasEtag() => $_has(71);
  @$pb.TagNumber(139)
  void clearEtag() => clearField(139);

  @$pb.TagNumber(140)
  Fleet get fleet => $_getN(72);
  @$pb.TagNumber(140)
  set fleet(Fleet v) {
    setField(140, v);
  }
  ...
  @$pb.TagNumber(140)
  $core.bool hasFleet() => $_has(72);
  @$pb.TagNumber(140)
  void clearFleet() => clearField(140);
  @$pb.TagNumber(140)
  Fleet ensureFleet() => $_ensure(72);
}
...
class ProtectConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<ProtectConfig_WorkloadVulnerabilityMode>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'workloadVulnerabilityMode',
        $pb.PbFieldType.OE,
        defaultOrMaker: ProtectConfig_WorkloadVulnerabilityMode
            .WORKLOAD_VULNERABILITY_MODE_UNSPECIFIED,
        valueOf: ProtectConfig_WorkloadVulnerabilityMode.valueOf,
        enumValues: ProtectConfig_WorkloadVulnerabilityMode.values)
    ..hasRequiredFields = false;

  ProtectConfig._() : super();
  factory ProtectConfig({
    WorkloadConfig? workloadConfig,
    ProtectConfig_WorkloadVulnerabilityMode? workloadVulnerabilityMode,
  }) {
    final _result = create();
    ...
    if (workloadVulnerabilityMode != null) {
      _result.workloadVulnerabilityMode = workloadVulnerabilityMode;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  ProtectConfig_WorkloadVulnerabilityMode get workloadVulnerabilityMode =>
      $_getN(1);
  @$pb.TagNumber(2)
  set workloadVulnerabilityMode(ProtectConfig_WorkloadVulnerabilityMode v) {
    setField(2, v);
  }

  @$pb.TagNumber(2)
  $core.bool hasWorkloadVulnerabilityMode() => $_has(1);
  @$pb.TagNumber(2)
  void clearWorkloadVulnerabilityMode() => clearField(2);
}
...
class ClusterUpdate extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(30)
  set desiredClusterTelemetry(ClusterTelemetry v) {
    setField(30, v);
  }
  ...
  @$pb.TagNumber(38)
  set desiredTpuConfig(TpuConfig v) {
    setField(38, v);
  }
  ...
  @$pb.TagNumber(71)
  $core.bool get desiredEnablePrivateEndpoint => $_getBF(38);
  @$pb.TagNumber(71)
  ...
  @$pb.TagNumber(71)
  $core.bool hasDesiredEnablePrivateEndpoint() => $_has(38);
  @$pb.TagNumber(71)
  void clearDesiredEnablePrivateEndpoint() => clearField(71);

  @$pb.TagNumber(100)
  $core.String get desiredMasterVersion => $_getSZ(39);
  @$pb.TagNumber(100)
  ...
  @$pb.TagNumber(100)
  $core.bool hasDesiredMasterVersion() => $_has(39);
  @$pb.TagNumber(100)
  void clearDesiredMasterVersion() => clearField(100);

  @$pb.TagNumber(109)
  GcfsConfig get desiredGcfsConfig => $_getN(40);
  @$pb.TagNumber(109)
  ...
  @$pb.TagNumber(109)
  $core.bool hasDesiredGcfsConfig() => $_has(40);
  @$pb.TagNumber(109)
  void clearDesiredGcfsConfig() => clearField(109);
  @$pb.TagNumber(109)
  GcfsConfig ensureDesiredGcfsConfig() => $_ensure(40);

  @$pb.TagNumber(110)
  NetworkTags get desiredNodePoolAutoConfigNetworkTags => $_getN(41);
  @$pb.TagNumber(110)
  ...
  @$pb.TagNumber(110)
  $core.bool hasDesiredNodePoolAutoConfigNetworkTags() => $_has(41);
  @$pb.TagNumber(110)
  void clearDesiredNodePoolAutoConfigNetworkTags() => clearField(110);
  @$pb.TagNumber(110)
  NetworkTags ensureDesiredNodePoolAutoConfigNetworkTags() => $_ensure(41);

  @$pb.TagNumber(112)
  ProtectConfig get desiredProtectConfig => $_getN(42);
  @$pb.TagNumber(112)
  ...
  @$pb.TagNumber(112)
  $core.bool hasDesiredProtectConfig() => $_has(42);
  @$pb.TagNumber(112)
  void clearDesiredProtectConfig() => clearField(112);
  @$pb.TagNumber(112)
  ProtectConfig ensureDesiredProtectConfig() => $_ensure(42);

  @$pb.TagNumber(114)
  GatewayAPIConfig get desiredGatewayApiConfig => $_getN(43);
  @$pb.TagNumber(114)
  ...
  @$pb.TagNumber(114)
  $core.bool hasDesiredGatewayApiConfig() => $_has(43);
  @$pb.TagNumber(114)
  void clearDesiredGatewayApiConfig() => clearField(114);
  @$pb.TagNumber(114)
  GatewayAPIConfig ensureDesiredGatewayApiConfig() => $_ensure(43);

  @$pb.TagNumber(115)
  $core.String get etag => $_getSZ(44);
  @$pb.TagNumber(115)
  set etag($core.String v) {
    $_setString(44, v);
  }
  ...
  @$pb.TagNumber(115)
  $core.bool hasEtag() => $_has(44);
  @$pb.TagNumber(115)
  void clearEtag() => clearField(115);

  @$pb.TagNumber(116)
  NodePoolLoggingConfig get desiredNodePoolLoggingConfig => $_getN(45);
  @$pb.TagNumber(116)
  ...
  @$pb.TagNumber(116)
  $core.bool hasDesiredNodePoolLoggingConfig() => $_has(45);
  @$pb.TagNumber(116)
  void clearDesiredNodePoolLoggingConfig() => clearField(116);
  @$pb.TagNumber(116)
  NodePoolLoggingConfig ensureDesiredNodePoolLoggingConfig() => $_ensure(45);

  @$pb.TagNumber(117)
  Fleet get desiredFleet => $_getN(46);
  @$pb.TagNumber(117)
  ...
  @$pb.TagNumber(117)
  $core.bool hasDesiredFleet() => $_has(46);
  @$pb.TagNumber(117)
  void clearDesiredFleet() => clearField(117);
  @$pb.TagNumber(117)
  Fleet ensureDesiredFleet() => $_ensure(46);

  @$pb.TagNumber(119)
  StackType get desiredStackType => $_getN(47);
  @$pb.TagNumber(119)
  ...
  @$pb.TagNumber(119)
  $core.bool hasDesiredStackType() => $_has(47);
  @$pb.TagNumber(119)
  void clearDesiredStackType() => clearField(119);

  @$pb.TagNumber(120)
  AdditionalPodRangesConfig get additionalPodRangesConfig => $_getN(48);
  @$pb.TagNumber(120)
  set additionalPodRangesConfig(AdditionalPodRangesConfig v) {
    setField(120, v);
  }
  ...
  @$pb.TagNumber(120)
  $core.bool hasAdditionalPodRangesConfig() => $_has(48);
  @$pb.TagNumber(120)
  void clearAdditionalPodRangesConfig() => clearField(120);
  @$pb.TagNumber(120)
  AdditionalPodRangesConfig ensureAdditionalPodRangesConfig() => $_ensure(48);

  @$pb.TagNumber(121)
  AdditionalPodRangesConfig get removedAdditionalPodRangesConfig => $_getN(49);
  @$pb.TagNumber(121)
  ...
  @$pb.TagNumber(121)
  $core.bool hasRemovedAdditionalPodRangesConfig() => $_has(49);
  @$pb.TagNumber(121)
...
class ServerConfig_ReleaseChannelConfig_AvailableVersion
  ...
  factory ServerConfig_ReleaseChannelConfig_AvailableVersion.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ServerConfig_ReleaseChannelConfig_AvailableVersion.fromJson(
          $core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ServerConfig_ReleaseChannelConfig_AvailableVersion clone() =>
      ServerConfig_ReleaseChannelConfig_AvailableVersion()
        ..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ServerConfig_ReleaseChannelConfig_AvailableVersion copyWith(
          void Function(ServerConfig_ReleaseChannelConfig_AvailableVersion)
              updates) =>
      super.copyWith((message) => updates(
              message as ServerConfig_ReleaseChannelConfig_AvailableVersion))
          as ServerConfig_ReleaseChannelConfig_AvailableVersion; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ServerConfig_ReleaseChannelConfig_AvailableVersion create() =>
      ServerConfig_ReleaseChannelConfig_AvailableVersion._();
  ServerConfig_ReleaseChannelConfig_AvailableVersion createEmptyInstance() =>
      create();
  static $pb.PbList<ServerConfig_ReleaseChannelConfig_AvailableVersion>
      createRepeated() =>
          $pb.PbList<ServerConfig_ReleaseChannelConfig_AvailableVersion>();
  @$core.pragma('dart2js:noInline')
  static ServerConfig_ReleaseChannelConfig_AvailableVersion getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          ServerConfig_ReleaseChannelConfig_AvailableVersion>(create);
...
class ServerConfig_ReleaseChannelConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'defaultVersion')
    ..pc<ServerConfig_ReleaseChannelConfig_AvailableVersion>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'availableVersions',
        $pb.PbFieldType.PM,
        subBuilder: ServerConfig_ReleaseChannelConfig_AvailableVersion.create)
    ..pPS(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory ServerConfig_ReleaseChannelConfig({
    ...
    @$core.Deprecated('This field is deprecated.')
    $core.Iterable<ServerConfig_ReleaseChannelConfig_AvailableVersion>?
        availableVersions,
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(3)
  $core.List<ServerConfig_ReleaseChannelConfig_AvailableVersion>
      get availableVersions => $_getList(2);
...
class ServerConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, WindowsVersions>(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'windowsVersionMaps',
        entryClassName: 'ServerConfig.WindowsVersionMapsEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: WindowsVersions.create,
        packageName: const $pb.PackageName('google.container.v1beta1'))
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(10)
  $core.Map<$core.String, WindowsVersions> get windowsVersionMaps =>
      $_getMap(6);
}
...
class WindowsVersions_WindowsVersion extends $pb.GeneratedMessage {
  ...
  factory WindowsVersions_WindowsVersion.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory WindowsVersions_WindowsVersion.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  WindowsVersions_WindowsVersion clone() =>
      WindowsVersions_WindowsVersion()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  WindowsVersions_WindowsVersion copyWith(
          void Function(WindowsVersions_WindowsVersion) updates) =>
      super.copyWith(
              (message) => updates(message as WindowsVersions_WindowsVersion))
          as WindowsVersions_WindowsVersion; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static WindowsVersions_WindowsVersion create() =>
      WindowsVersions_WindowsVersion._();
  WindowsVersions_WindowsVersion createEmptyInstance() => create();
  static $pb.PbList<WindowsVersions_WindowsVersion> createRepeated() =>
      $pb.PbList<WindowsVersions_WindowsVersion>();
  @$core.pragma('dart2js:noInline')
  static WindowsVersions_WindowsVersion getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<WindowsVersions_WindowsVersion>(create);
...
class WindowsVersions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.container.v1beta1'),
      createEmptyInstance: create)
    ..pc<WindowsVersions_WindowsVersion>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'windowsVersions',
        $pb.PbFieldType.PM,
        subBuilder: WindowsVersions_WindowsVersion.create)
    ..hasRequiredFields = false;
  ...
  factory WindowsVersions.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory WindowsVersions.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  WindowsVersions copyWith(void Function(WindowsVersions) updates) =>
      super.copyWith((message) => updates(message as WindowsVersions))
          as WindowsVersions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static WindowsVersions create() => WindowsVersions._();
  WindowsVersions createEmptyInstance() => create();
  static $pb.PbList<WindowsVersions> createRepeated() =>
      $pb.PbList<WindowsVersions>();
  @$core.pragma('dart2js:noInline')
  static WindowsVersions getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<WindowsVersions>(create);
  static WindowsVersions? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<WindowsVersions_WindowsVersion> get windowsVersions =>
      $_getList(0);
}
...
class ListLocationsRequest extends $pb.GeneratedMessage {
  ...
  ListLocationsRequest copyWith(void Function(ListLocationsRequest) updates) =>
      super.copyWith((message) => updates(message as ListLocationsRequest))
          as ListLocationsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListLocationsResponse extends $pb.GeneratedMessage {
  ...
  ListLocationsResponse copyWith(
      ...
      super.copyWith((message) => updates(message as ListLocationsResponse))
          as ListLocationsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WorkloadIdentityConfig extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set identityNamespace($core.String v) {
    $_setString(0, v);
  }
...
class WorkloadCertificates extends $pb.GeneratedMessage {
  ...
  factory WorkloadCertificates.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory WorkloadCertificates.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  WorkloadCertificates clone() =>
      WorkloadCertificates()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  WorkloadCertificates copyWith(void Function(WorkloadCertificates) updates) =>
      super.copyWith((message) => updates(message as WorkloadCertificates))
          as WorkloadCertificates; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static WorkloadCertificates create() => WorkloadCertificates._();
  WorkloadCertificates createEmptyInstance() => create();
  static $pb.PbList<WorkloadCertificates> createRepeated() =>
      $pb.PbList<WorkloadCertificates>();
  @$core.pragma('dart2js:noInline')
  static WorkloadCertificates getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<WorkloadCertificates>(create);
...
class TpuConfig extends $pb.GeneratedMessage {
  ...
  factory TpuConfig.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TpuConfig.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TpuConfig copyWith(void Function(TpuConfig) updates) =>
      super.copyWith((message) => updates(message as TpuConfig))
          as TpuConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static TpuConfig getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TpuConfig>(create);
  ...
  @$pb.TagNumber(3)
  set ipv4CidrBlock($core.String v) {
    $_setString(2, v);
  }
...
class Master extends $pb.GeneratedMessage {
  ...
  factory Master.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Master.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Master copyWith(void Function(Master) updates) =>
      super.copyWith((message) => updates(message as Master))
          as Master; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Master getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Master>(create);
...
class UpgradeAvailableEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<WindowsVersions>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'windowsVersions',
        subBuilder: WindowsVersions.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(5)
  set windowsVersions(WindowsVersions v) {
    setField(5, v);
  }
