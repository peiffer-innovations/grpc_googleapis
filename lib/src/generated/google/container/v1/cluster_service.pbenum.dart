...
class IPv6AccessType extends $pb.ProtobufEnum {
  static const IPv6AccessType IPV6_ACCESS_TYPE_UNSPECIFIED =
      IPv6AccessType._(0, _omitEnumNames ? '' : 'IPV6_ACCESS_TYPE_UNSPECIFIED');
  static const IPv6AccessType INTERNAL =
      IPv6AccessType._(1, _omitEnumNames ? '' : 'INTERNAL');
  static const IPv6AccessType EXTERNAL =
      IPv6AccessType._(2, _omitEnumNames ? '' : 'EXTERNAL');
...
class NodeConfig_LocalSsdEncryptionMode extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, NodeConfig_LocalSsdEncryptionMode>
      _byValue = $pb.ProtobufEnum.initByValue(values);
  static NodeConfig_LocalSsdEncryptionMode? valueOf($core.int value) =>
      _byValue[value];

  const NodeConfig_LocalSsdEncryptionMode._($core.int v, $core.String n)
      : super(v, n);
}
...
class NodeConfig_EffectiveCgroupMode extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, NodeConfig_EffectiveCgroupMode> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static NodeConfig_EffectiveCgroupMode? valueOf($core.int value) =>
      _byValue[value];

  const NodeConfig_EffectiveCgroupMode._($core.int v, $core.String n)
      : super(v, n);
}
...
class UpgradeInfoEvent_State extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, UpgradeInfoEvent_State> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static UpgradeInfoEvent_State? valueOf($core.int value) => _byValue[value];

  const UpgradeInfoEvent_State._($core.int v, $core.String n) : super(v, n);
}
