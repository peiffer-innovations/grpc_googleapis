...
final $typed_data.Uint8List createApplicationRequestDescriptor =
    $convert.base64Decode(
        'ChhDcmVhdGVBcHBsaWNhdGlvblJlcXVlc3QSQgoLYXBwbGljYXRpb24YAiABKAsyIC5nb29nbGUuYXBwZW5naW5lLnYxLkFwcGxpY2F0aW9uUgthcHBsaWNhdGlvbg==');
...
final $typed_data.Uint8List updateApplicationRequestDescriptor =
    $convert.base64Decode(
        'ChhVcGRhdGVBcHBsaWNhdGlvblJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRJCCgthcHBsaWNhdGlvbhgCIAEoCzIgLmdvb2dsZS5hcHBlbmdpbmUudjEuQXBwbGljYXRpb25SC2FwcGxpY2F0aW9uEjsKC3VwZGF0ZV9tYXNrGAMgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
final $typed_data.Uint8List listServicesResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0U2VydmljZXNSZXNwb25zZRI4CghzZXJ2aWNlcxgBIAMoCzIcLmdvb2dsZS5hcHBlbmdpbmUudjEuU2VydmljZVIIc2VydmljZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List updateServiceRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listVersionsRequestDescriptor = $convert.base64Decode(
    'ChNMaXN0VmVyc2lvbnNSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50EjQKBHZpZXcYAiABKA4yIC5nb29nbGUuYXBwZW5naW5lLnYxLlZlcnNpb25WaWV3UgR2aWV3EhsKCXBhZ2Vfc2l6ZRgDIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgEIAEoCVIJcGFnZVRva2Vu');
...
final $typed_data.Uint8List listVersionsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0VmVyc2lvbnNSZXNwb25zZRI4Cgh2ZXJzaW9ucxgBIAMoCzIcLmdvb2dsZS5hcHBlbmdpbmUudjEuVmVyc2lvblIIdmVyc2lvbnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List getVersionRequestDescriptor = $convert.base64Decode(
    'ChFHZXRWZXJzaW9uUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEjQKBHZpZXcYAiABKA4yIC5nb29nbGUuYXBwZW5naW5lLnYxLlZlcnNpb25WaWV3UgR2aWV3');
...
final $typed_data.Uint8List createVersionRequestDescriptor = $convert.base64Decode(
    'ChRDcmVhdGVWZXJzaW9uUmVxdWVzdBIWCgZwYXJlbnQYASABKAlSBnBhcmVudBI2Cgd2ZXJzaW9uGAIgASgLMhwuZ29vZ2xlLmFwcGVuZ2luZS52MS5WZXJzaW9uUgd2ZXJzaW9u');
...
final $typed_data.Uint8List updateVersionRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVWZXJzaW9uUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEjYKB3ZlcnNpb24YAiABKAsyHC5nb29nbGUuYXBwZW5naW5lLnYxLlZlcnNpb25SB3ZlcnNpb24SOwoLdXBkYXRlX21hc2sYAyABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List listInstancesResponseDescriptor = $convert.base64Decode(
    'ChVMaXN0SW5zdGFuY2VzUmVzcG9uc2USOwoJaW5zdGFuY2VzGAEgAygLMh0uZ29vZ2xlLmFwcGVuZ2luZS52MS5JbnN0YW5jZVIJaW5zdGFuY2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List listIngressRulesResponseDescriptor =
    $convert.base64Decode(
        'ChhMaXN0SW5ncmVzc1J1bGVzUmVzcG9uc2USRgoNaW5ncmVzc19ydWxlcxgBIAMoCzIhLmdvb2dsZS5hcHBlbmdpbmUudjEuRmlyZXdhbGxSdWxlUgxpbmdyZXNzUnVsZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List batchUpdateIngressRulesRequestDescriptor =
    $convert.base64Decode(
        'Ch5CYXRjaFVwZGF0ZUluZ3Jlc3NSdWxlc1JlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRJGCg1pbmdyZXNzX3J1bGVzGAIgAygLMiEuZ29vZ2xlLmFwcGVuZ2luZS52MS5GaXJld2FsbFJ1bGVSDGluZ3Jlc3NSdWxlcw==');
...
final $typed_data.Uint8List batchUpdateIngressRulesResponseDescriptor =
    $convert.base64Decode(
        'Ch9CYXRjaFVwZGF0ZUluZ3Jlc3NSdWxlc1Jlc3BvbnNlEkYKDWluZ3Jlc3NfcnVsZXMYASADKAsyIS5nb29nbGUuYXBwZW5naW5lLnYxLkZpcmV3YWxsUnVsZVIMaW5ncmVzc1J1bGVz');
...
final $typed_data.Uint8List createIngressRuleRequestDescriptor =
    $convert.base64Decode(
        'ChhDcmVhdGVJbmdyZXNzUnVsZVJlcXVlc3QSFgoGcGFyZW50GAEgASgJUgZwYXJlbnQSNQoEcnVsZRgCIAEoCzIhLmdvb2dsZS5hcHBlbmdpbmUudjEuRmlyZXdhbGxSdWxlUgRydWxl');
...
final $typed_data.Uint8List updateIngressRuleRequestDescriptor =
    $convert.base64Decode(
        'ChhVcGRhdGVJbmdyZXNzUnVsZVJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRI1CgRydWxlGAIgASgLMiEuZ29vZ2xlLmFwcGVuZ2luZS52MS5GaXJld2FsbFJ1bGVSBHJ1bGUSOwoLdXBkYXRlX21hc2sYAyABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List listAuthorizedDomainsResponseDescriptor =
    $convert.base64Decode(
        'Ch1MaXN0QXV0aG9yaXplZERvbWFpbnNSZXNwb25zZRI/Cgdkb21haW5zGAEgAygLMiUuZ29vZ2xlLmFwcGVuZ2luZS52MS5BdXRob3JpemVkRG9tYWluUgdkb21haW5zEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List listAuthorizedCertificatesRequestDescriptor =
    $convert.base64Decode(
        'CiFMaXN0QXV0aG9yaXplZENlcnRpZmljYXRlc1JlcXVlc3QSFgoGcGFyZW50GAEgASgJUgZwYXJlbnQSQgoEdmlldxgEIAEoDjIuLmdvb2dsZS5hcHBlbmdpbmUudjEuQXV0aG9yaXplZENlcnRpZmljYXRlVmlld1IEdmlldxIbCglwYWdlX3NpemUYAiABKAVSCHBhZ2VTaXplEh0KCnBhZ2VfdG9rZW4YAyABKAlSCXBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List listAuthorizedCertificatesResponseDescriptor =
    $convert.base64Decode(
        'CiJMaXN0QXV0aG9yaXplZENlcnRpZmljYXRlc1Jlc3BvbnNlEk4KDGNlcnRpZmljYXRlcxgBIAMoCzIqLmdvb2dsZS5hcHBlbmdpbmUudjEuQXV0aG9yaXplZENlcnRpZmljYXRlUgxjZXJ0aWZpY2F0ZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List getAuthorizedCertificateRequestDescriptor =
    $convert.base64Decode(
        'Ch9HZXRBdXRob3JpemVkQ2VydGlmaWNhdGVSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSQgoEdmlldxgCIAEoDjIuLmdvb2dsZS5hcHBlbmdpbmUudjEuQXV0aG9yaXplZENlcnRpZmljYXRlVmlld1IEdmlldw==');
...
final $typed_data.Uint8List createAuthorizedCertificateRequestDescriptor =
    $convert.base64Decode(
        'CiJDcmVhdGVBdXRob3JpemVkQ2VydGlmaWNhdGVSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50EkwKC2NlcnRpZmljYXRlGAIgASgLMiouZ29vZ2xlLmFwcGVuZ2luZS52MS5BdXRob3JpemVkQ2VydGlmaWNhdGVSC2NlcnRpZmljYXRl');
...
final $typed_data.Uint8List updateAuthorizedCertificateRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listDomainMappingsResponseDescriptor =
    $convert.base64Decode(
        'ChpMaXN0RG9tYWluTWFwcGluZ3NSZXNwb25zZRJLCg9kb21haW5fbWFwcGluZ3MYASADKAsyIi5nb29nbGUuYXBwZW5naW5lLnYxLkRvbWFpbk1hcHBpbmdSDmRvbWFpbk1hcHBpbmdzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List createDomainMappingRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List updateDomainMappingRequestDescriptor =
    $convert.base64Decode(
        'ChpVcGRhdGVEb21haW5NYXBwaW5nUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEkkKDmRvbWFpbl9tYXBwaW5nGAIgASgLMiIuZ29vZ2xlLmFwcGVuZ2luZS52MS5Eb21haW5NYXBwaW5nUg1kb21haW5NYXBwaW5nEjsKC3VwZGF0ZV9tYXNrGAMgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
