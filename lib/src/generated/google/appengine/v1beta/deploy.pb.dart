...
//
// Generated from google/appengine/v1beta/deploy.proto.
...
class Deployment extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set build(BuildInfo value) => $_setField(5, value);
  @$pb.TagNumber(5)
...
class BuildInfo extends $pb.GeneratedMessage {
  ...
  factory BuildInfo.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory BuildInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
