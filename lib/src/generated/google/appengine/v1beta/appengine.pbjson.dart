...
final $typed_data.Uint8List authorizedCertificateViewDescriptor =
    $convert.base64Decode(
        'ChlBdXRob3JpemVkQ2VydGlmaWNhdGVWaWV3EhUKEUJBU0lDX0NFUlRJRklDQVRFEAASFAoQRlVMTF9DRVJUSUZJQ0FURRAB');
...
final $typed_data.Uint8List domainOverrideStrategyDescriptor =
    $convert.base64Decode(
        'ChZEb21haW5PdmVycmlkZVN0cmF0ZWd5EigKJFVOU1BFQ0lGSUVEX0RPTUFJTl9PVkVSUklERV9TVFJBVEVHWRAAEgoKBlNUUklDVBABEgwKCE9WRVJSSURFEAI=');
...
final $typed_data.Uint8List createApplicationRequestDescriptor =
    $convert.base64Decode(
        'ChhDcmVhdGVBcHBsaWNhdGlvblJlcXVlc3QSRgoLYXBwbGljYXRpb24YAiABKAsyJC5nb29nbGUuYXBwZW5naW5lLnYxYmV0YS5BcHBsaWNhdGlvblILYXBwbGljYXRpb24=');
...
final $typed_data.Uint8List updateApplicationRequestDescriptor =
    $convert.base64Decode(
        'ChhVcGRhdGVBcHBsaWNhdGlvblJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRJGCgthcHBsaWNhdGlvbhgCIAEoCzIkLmdvb2dsZS5hcHBlbmdpbmUudjFiZXRhLkFwcGxpY2F0aW9uUgthcHBsaWNhdGlvbhI7Cgt1cGRhdGVfbWFzaxgDIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCnVwZGF0ZU1hc2s=');
...
final $typed_data.Uint8List listServicesRequestDescriptor = $convert.base64Decode(
    'ChNMaXN0U2VydmljZXNSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50EhsKCXBhZ2Vfc2l6ZRgCIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgDIAEoCVIJcGFnZVRva2Vu');
...
final $typed_data.Uint8List listServicesResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0U2VydmljZXNSZXNwb25zZRI8CghzZXJ2aWNlcxgBIAMoCzIgLmdvb2dsZS5hcHBlbmdpbmUudjFiZXRhLlNlcnZpY2VSCHNlcnZpY2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List updateServiceRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listVersionsRequestDescriptor = $convert.base64Decode(
    'ChNMaXN0VmVyc2lvbnNSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50EjgKBHZpZXcYAiABKA4yJC5nb29nbGUuYXBwZW5naW5lLnYxYmV0YS5WZXJzaW9uVmlld1IEdmlldxIbCglwYWdlX3NpemUYAyABKAVSCHBhZ2VTaXplEh0KCnBhZ2VfdG9rZW4YBCABKAlSCXBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List listVersionsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0VmVyc2lvbnNSZXNwb25zZRI8Cgh2ZXJzaW9ucxgBIAMoCzIgLmdvb2dsZS5hcHBlbmdpbmUudjFiZXRhLlZlcnNpb25SCHZlcnNpb25zEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List getVersionRequestDescriptor = $convert.base64Decode(
    'ChFHZXRWZXJzaW9uUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEjgKBHZpZXcYAiABKA4yJC5nb29nbGUuYXBwZW5naW5lLnYxYmV0YS5WZXJzaW9uVmlld1IEdmlldw==');
...
final $typed_data.Uint8List createVersionRequestDescriptor = $convert.base64Decode(
    'ChRDcmVhdGVWZXJzaW9uUmVxdWVzdBIWCgZwYXJlbnQYASABKAlSBnBhcmVudBI6Cgd2ZXJzaW9uGAIgASgLMiAuZ29vZ2xlLmFwcGVuZ2luZS52MWJldGEuVmVyc2lvblIHdmVyc2lvbg==');
...
final $typed_data.Uint8List updateVersionRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVWZXJzaW9uUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEjoKB3ZlcnNpb24YAiABKAsyIC5nb29nbGUuYXBwZW5naW5lLnYxYmV0YS5WZXJzaW9uUgd2ZXJzaW9uEjsKC3VwZGF0ZV9tYXNrGAMgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
final $typed_data.Uint8List listInstancesRequestDescriptor = $convert.base64Decode(
    'ChRMaXN0SW5zdGFuY2VzUmVxdWVzdBIWCgZwYXJlbnQYASABKAlSBnBhcmVudBIbCglwYWdlX3NpemUYAiABKAVSCHBhZ2VTaXplEh0KCnBhZ2VfdG9rZW4YAyABKAlSCXBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List listInstancesResponseDescriptor = $convert.base64Decode(
    'ChVMaXN0SW5zdGFuY2VzUmVzcG9uc2USPwoJaW5zdGFuY2VzGAEgAygLMiEuZ29vZ2xlLmFwcGVuZ2luZS52MWJldGEuSW5zdGFuY2VSCWluc3RhbmNlcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List debugInstanceRequestDescriptor = $convert.base64Decode(
    'ChREZWJ1Z0luc3RhbmNlUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEhcKB3NzaF9rZXkYAiABKAlSBnNzaEtleQ==');
...
final $typed_data.Uint8List listIngressRulesRequestDescriptor =
    $convert.base64Decode(
        'ChdMaXN0SW5ncmVzc1J1bGVzUmVxdWVzdBIWCgZwYXJlbnQYASABKAlSBnBhcmVudBIbCglwYWdlX3NpemUYAiABKAVSCHBhZ2VTaXplEh0KCnBhZ2VfdG9rZW4YAyABKAlSCXBhZ2VUb2tlbhIpChBtYXRjaGluZ19hZGRyZXNzGAQgASgJUg9tYXRjaGluZ0FkZHJlc3M=');
...
final $typed_data.Uint8List listIngressRulesResponseDescriptor =
    $convert.base64Decode(
        'ChhMaXN0SW5ncmVzc1J1bGVzUmVzcG9uc2USSgoNaW5ncmVzc19ydWxlcxgBIAMoCzIlLmdvb2dsZS5hcHBlbmdpbmUudjFiZXRhLkZpcmV3YWxsUnVsZVIMaW5ncmVzc1J1bGVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List batchUpdateIngressRulesRequestDescriptor =
    $convert.base64Decode(
        'Ch5CYXRjaFVwZGF0ZUluZ3Jlc3NSdWxlc1JlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRJKCg1pbmdyZXNzX3J1bGVzGAIgAygLMiUuZ29vZ2xlLmFwcGVuZ2luZS52MWJldGEuRmlyZXdhbGxSdWxlUgxpbmdyZXNzUnVsZXM=');
...
final $typed_data.Uint8List batchUpdateIngressRulesResponseDescriptor =
    $convert.base64Decode(
        'Ch9CYXRjaFVwZGF0ZUluZ3Jlc3NSdWxlc1Jlc3BvbnNlEkoKDWluZ3Jlc3NfcnVsZXMYASADKAsyJS5nb29nbGUuYXBwZW5naW5lLnYxYmV0YS5GaXJld2FsbFJ1bGVSDGluZ3Jlc3NSdWxlcw==');
...
final $typed_data.Uint8List createIngressRuleRequestDescriptor =
    $convert.base64Decode(
        'ChhDcmVhdGVJbmdyZXNzUnVsZVJlcXVlc3QSFgoGcGFyZW50GAEgASgJUgZwYXJlbnQSOQoEcnVsZRgCIAEoCzIlLmdvb2dsZS5hcHBlbmdpbmUudjFiZXRhLkZpcmV3YWxsUnVsZVIEcnVsZQ==');
...
final $typed_data.Uint8List updateIngressRuleRequestDescriptor =
    $convert.base64Decode(
        'ChhVcGRhdGVJbmdyZXNzUnVsZVJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRI5CgRydWxlGAIgASgLMiUuZ29vZ2xlLmFwcGVuZ2luZS52MWJldGEuRmlyZXdhbGxSdWxlUgRydWxlEjsKC3VwZGF0ZV9tYXNrGAMgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
final $typed_data.Uint8List listAuthorizedDomainsRequestDescriptor =
    $convert.base64Decode(
        'ChxMaXN0QXV0aG9yaXplZERvbWFpbnNSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50EhsKCXBhZ2Vfc2l6ZRgCIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgDIAEoCVIJcGFnZVRva2Vu');
...
final $typed_data.Uint8List listAuthorizedDomainsResponseDescriptor =
    $convert.base64Decode(
        'Ch1MaXN0QXV0aG9yaXplZERvbWFpbnNSZXNwb25zZRJDCgdkb21haW5zGAEgAygLMikuZ29vZ2xlLmFwcGVuZ2luZS52MWJldGEuQXV0aG9yaXplZERvbWFpblIHZG9tYWlucxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List listAuthorizedCertificatesRequestDescriptor =
    $convert.base64Decode(
        'CiFMaXN0QXV0aG9yaXplZENlcnRpZmljYXRlc1JlcXVlc3QSFgoGcGFyZW50GAEgASgJUgZwYXJlbnQSRgoEdmlldxgEIAEoDjIyLmdvb2dsZS5hcHBlbmdpbmUudjFiZXRhLkF1dGhvcml6ZWRDZXJ0aWZpY2F0ZVZpZXdSBHZpZXcSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
...
final $typed_data.Uint8List listAuthorizedCertificatesResponseDescriptor =
    $convert.base64Decode(
        'CiJMaXN0QXV0aG9yaXplZENlcnRpZmljYXRlc1Jlc3BvbnNlElIKDGNlcnRpZmljYXRlcxgBIAMoCzIuLmdvb2dsZS5hcHBlbmdpbmUudjFiZXRhLkF1dGhvcml6ZWRDZXJ0aWZpY2F0ZVIMY2VydGlmaWNhdGVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List getAuthorizedCertificateRequestDescriptor =
    $convert.base64Decode(
        'Ch9HZXRBdXRob3JpemVkQ2VydGlmaWNhdGVSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSRgoEdmlldxgCIAEoDjIyLmdvb2dsZS5hcHBlbmdpbmUudjFiZXRhLkF1dGhvcml6ZWRDZXJ0aWZpY2F0ZVZpZXdSBHZpZXc=');
...
final $typed_data.Uint8List createAuthorizedCertificateRequestDescriptor =
    $convert.base64Decode(
        'CiJDcmVhdGVBdXRob3JpemVkQ2VydGlmaWNhdGVSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50ElAKC2NlcnRpZmljYXRlGAIgASgLMi4uZ29vZ2xlLmFwcGVuZ2luZS52MWJldGEuQXV0aG9yaXplZENlcnRpZmljYXRlUgtjZXJ0aWZpY2F0ZQ==');
...
final $typed_data.Uint8List updateAuthorizedCertificateRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List deleteAuthorizedCertificateRequestDescriptor =
    $convert.base64Decode(
        'CiJEZWxldGVBdXRob3JpemVkQ2VydGlmaWNhdGVSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List listDomainMappingsRequestDescriptor =
    $convert.base64Decode(
        'ChlMaXN0RG9tYWluTWFwcGluZ3NSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50EhsKCXBhZ2Vfc2l6ZRgCIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgDIAEoCVIJcGFnZVRva2Vu');
...
final $typed_data.Uint8List listDomainMappingsResponseDescriptor =
    $convert.base64Decode(
        'ChpMaXN0RG9tYWluTWFwcGluZ3NSZXNwb25zZRJPCg9kb21haW5fbWFwcGluZ3MYASADKAsyJi5nb29nbGUuYXBwZW5naW5lLnYxYmV0YS5Eb21haW5NYXBwaW5nUg5kb21haW5NYXBwaW5ncxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List createDomainMappingRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List updateDomainMappingRequestDescriptor =
    $convert.base64Decode(
        'ChpVcGRhdGVEb21haW5NYXBwaW5nUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEk0KDmRvbWFpbl9tYXBwaW5nGAIgASgLMiYuZ29vZ2xlLmFwcGVuZ2luZS52MWJldGEuRG9tYWluTWFwcGluZ1INZG9tYWluTWFwcGluZxI7Cgt1cGRhdGVfbWFzaxgDIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCnVwZGF0ZU1hc2s=');
