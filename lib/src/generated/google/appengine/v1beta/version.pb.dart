...
class AutomaticScaling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<CustomMetric>(21, _omitFieldNames ? '' : 'customMetrics',
  ...
  /// Only applicable in the App Engine flexible environment.
  @$pb.TagNumber(21)
  $pb.PbList<CustomMetric> get customMetrics => $_getList(13);
}
...
class CustomMetric extends $pb.GeneratedMessage {
  factory CustomMetric({
    ...
    if (singleInstanceAssignment != null)
      result.singleInstanceAssignment = singleInstanceAssignment;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aD(3, _omitFieldNames ? '' : 'targetUtilization')
    ..aD(4, _omitFieldNames ? '' : 'singleInstanceAssignment')
  ...
  @$pb.TagNumber(3)
  @$pb.TagNumber(4)
  void clearTargetSpec() => $_clearField($_whichOneof(0));
  ...
  @$pb.TagNumber(3)
  set targetUtilization($core.double value) => $_setDouble(2, value);
  @$pb.TagNumber(3)
  $core.bool hasTargetUtilization() => $_has(2);
  @$pb.TagNumber(3)
  void clearTargetUtilization() => $_clearField(3);
  ...
  @$pb.TagNumber(4)
  set singleInstanceAssignment($core.double value) => $_setDouble(3, value);
  @$pb.TagNumber(4)
  $core.bool hasSingleInstanceAssignment() => $_has(3);
  @$pb.TagNumber(4)
  void clearSingleInstanceAssignment() => $_clearField(4);
