...
class LookupRequest extends $pb.GeneratedMessage {
  factory LookupRequest({
    ...
    if (propertyMask != null) result.propertyMask = propertyMask;
  ...
  @$pb.TagNumber(5)
  set propertyMask(PropertyMask value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasPropertyMask() => $_has(2);
  @$pb.TagNumber(5)
  void clearPropertyMask() => $_clearField(5);
  @$pb.TagNumber(5)
...
class LookupResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set readTime($3.Timestamp value) => $_setField(7, value);
  @$pb.TagNumber(7)
...
class RunQueryRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set databaseId($core.String value) => $_setString(5, value);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set propertyMask(PropertyMask value) => $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasPropertyMask() => $_has(6);
  @$pb.TagNumber(10)
  void clearPropertyMask() => $_clearField(10);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set explainOptions($4.ExplainOptions value) => $_setField(12, value);
  @$pb.TagNumber(12)
  $core.bool hasExplainOptions() => $_has(7);
  @$pb.TagNumber(12)
  void clearExplainOptions() => $_clearField(12);
  @$pb.TagNumber(12)
...
class RunQueryResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set explainMetrics($4.ExplainMetrics value) => $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasExplainMetrics() => $_has(3);
  @$pb.TagNumber(9)
  void clearExplainMetrics() => $_clearField(9);
  @$pb.TagNumber(9)
...
class RunAggregationQueryRequest extends $pb.GeneratedMessage {
  factory RunAggregationQueryRequest({
    ...
    if (readOptions != null) result.readOptions = readOptions;
    if (partitionId != null) result.partitionId = partitionId;
    if (aggregationQuery != null) result.aggregationQuery = aggregationQuery;
    if (gqlQuery != null) result.gqlQuery = gqlQuery;
    if (projectId != null) result.projectId = projectId;
    if (databaseId != null) result.databaseId = databaseId;
    if (explainOptions != null) result.explainOptions = explainOptions;
  ...
  @$pb.TagNumber(3)
  set aggregationQuery($2.AggregationQuery value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasAggregationQuery() => $_has(2);
  @$pb.TagNumber(3)
  void clearAggregationQuery() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(11)
  set explainOptions($4.ExplainOptions value) => $_setField(11, value);
  @$pb.TagNumber(11)
  $core.bool hasExplainOptions() => $_has(6);
  @$pb.TagNumber(11)
  void clearExplainOptions() => $_clearField(11);
  @$pb.TagNumber(11)
...
class RunAggregationQueryResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set batch($5.AggregationResultBatch value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasBatch() => $_has(0);
  @$pb.TagNumber(1)
  void clearBatch() => $_clearField(1);
  ...
  @$pb.TagNumber(2)
  set query($2.AggregationQuery value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasQuery() => $_has(1);
  @$pb.TagNumber(2)
  void clearQuery() => $_clearField(2);
...
class CommitRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(10)
  set singleUseTransaction(TransactionOptions value) => $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasSingleUseTransaction() => $_has(5);
  @$pb.TagNumber(10)
  void clearSingleUseTransaction() => $_clearField(10);
  @$pb.TagNumber(10)
...
class CommitResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  set commitTime($3.Timestamp value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasCommitTime() => $_has(2);
  @$pb.TagNumber(8)
  void clearCommitTime() => $_clearField(8);
  @$pb.TagNumber(8)
...
class Mutation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<PropertyMask>(9, _omitFieldNames ? '' : 'propertyMask',
        subBuilder: PropertyMask.create)
    ..aE<Mutation_ConflictResolutionStrategy>(
        10, _omitFieldNames ? '' : 'conflictResolutionStrategy',
        enumValues: Mutation_ConflictResolutionStrategy.values)
    ..aOM<$3.Timestamp>(11, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $3.Timestamp.create)
    ..pPM<PropertyTransform>(12, _omitFieldNames ? '' : 'propertyTransforms',
  ...
  @$pb.TagNumber(9)
  set propertyMask(PropertyMask value) => $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasPropertyMask() => $_has(5);
  @$pb.TagNumber(9)
  void clearPropertyMask() => $_clearField(9);
  @$pb.TagNumber(9)
  ...
  Mutation_ConflictResolutionStrategy get conflictResolutionStrategy =>
      $_getN(6);
  @$pb.TagNumber(10)
  set conflictResolutionStrategy(Mutation_ConflictResolutionStrategy value) =>
      $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasConflictResolutionStrategy() => $_has(6);
  @$pb.TagNumber(10)
  void clearConflictResolutionStrategy() => $_clearField(10);
  ...
  @$pb.TagNumber(11)
  set updateTime($3.Timestamp value) => $_setField(11, value);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  $pb.PbList<PropertyTransform> get propertyTransforms => $_getList(8);
}
...
class PropertyTransform extends $pb.GeneratedMessage {
  factory PropertyTransform({
    ...
    if (setToServerValue != null) result.setToServerValue = setToServerValue;
  ...
  factory PropertyTransform.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory PropertyTransform.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<PropertyTransform_ServerValue>(
        2, _omitFieldNames ? '' : 'setToServerValue',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PropertyTransform clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(6)
  @$pb.TagNumber(7)
  void clearTransformType() => $_clearField($_whichOneof(0));
  ...
  @$pb.TagNumber(2)
  set setToServerValue(PropertyTransform_ServerValue value) =>
      $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasSetToServerValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearSetToServerValue() => $_clearField(2);
  ...
  @$pb.TagNumber(3)
  set increment($1.Value value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasIncrement() => $_has(2);
  @$pb.TagNumber(3)
  void clearIncrement() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set maximum($1.Value value) => $_setField(4, value);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set minimum($1.Value value) => $_setField(5, value);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set appendMissingElements($1.ArrayValue value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasAppendMissingElements() => $_has(5);
  @$pb.TagNumber(6)
  void clearAppendMissingElements() => $_clearField(6);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set removeAllFromArray($1.ArrayValue value) => $_setField(7, value);
  @$pb.TagNumber(7)
  $core.bool hasRemoveAllFromArray() => $_has(6);
  @$pb.TagNumber(7)
  void clearRemoveAllFromArray() => $_clearField(7);
  @$pb.TagNumber(7)
...
class MutationResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$3.Timestamp>(7, _omitFieldNames ? '' : 'createTime',
        subBuilder: $3.Timestamp.create)
    ..pPM<$1.Value>(8, _omitFieldNames ? '' : 'transformResults',
        subBuilder: $1.Value.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(7)
  set createTime($3.Timestamp value) => $_setField(7, value);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  $pb.PbList<$1.Value> get transformResults => $_getList(5);
}
...
class PropertyMask extends $pb.GeneratedMessage {
  ...
  factory PropertyMask.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory PropertyMask.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
...
class ReadOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set newTransaction(TransactionOptions value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasNewTransaction() => $_has(2);
  @$pb.TagNumber(3)
  void clearNewTransaction() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set readTime($3.Timestamp value) => $_setField(4, value);
  @$pb.TagNumber(4)
...
class TransactionOptions_ReadOnly extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set readTime($3.Timestamp value) => $_setField(1, value);
  @$pb.TagNumber(1)
