...
final $typed_data.Uint8List lookupRequestDescriptor = $convert.base64Decode(
    'Cg1Mb29rdXBSZXF1ZXN0Eh0KCnByb2plY3RfaWQYCCABKAlSCXByb2plY3RJZBJICgxyZWFkX29wdGlvbnMYASABKAsyJS5nb29nbGUuZGF0YXN0b3JlLnYxYmV0YTMuUmVhZE9wdGlvbnNSC3JlYWRPcHRpb25zEjEKBGtleXMYAyADKAsyHS5nb29nbGUuZGF0YXN0b3JlLnYxYmV0YTMuS2V5UgRrZXlz');
...
final $typed_data.Uint8List lookupResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List runQueryRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List runQueryResponseDescriptor = $convert.base64Decode(
    'ChBSdW5RdWVyeVJlc3BvbnNlEkAKBWJhdGNoGAEgASgLMiouZ29vZ2xlLmRhdGFzdG9yZS52MWJldGEzLlF1ZXJ5UmVzdWx0QmF0Y2hSBWJhdGNoEjUKBXF1ZXJ5GAIgASgLMh8uZ29vZ2xlLmRhdGFzdG9yZS52MWJldGEzLlF1ZXJ5UgVxdWVyeQ==');
...
final $typed_data.Uint8List beginTransactionRequestDescriptor =
    $convert.base64Decode(
        'ChdCZWdpblRyYW5zYWN0aW9uUmVxdWVzdBIdCgpwcm9qZWN0X2lkGAggASgJUglwcm9qZWN0SWQSXQoTdHJhbnNhY3Rpb25fb3B0aW9ucxgKIAEoCzIsLmdvb2dsZS5kYXRhc3RvcmUudjFiZXRhMy5UcmFuc2FjdGlvbk9wdGlvbnNSEnRyYW5zYWN0aW9uT3B0aW9ucw==');
...
final $typed_data.Uint8List rollbackRequestDescriptor = $convert.base64Decode(
    'Cg9Sb2xsYmFja1JlcXVlc3QSHQoKcHJvamVjdF9pZBgIIAEoCVIJcHJvamVjdElkEiAKC3RyYW5zYWN0aW9uGAEgASgMUgt0cmFuc2FjdGlvbg==');
...
final $typed_data.Uint8List commitRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List commitResponseDescriptor = $convert.base64Decode(
    'Cg5Db21taXRSZXNwb25zZRJTChBtdXRhdGlvbl9yZXN1bHRzGAMgAygLMiguZ29vZ2xlLmRhdGFzdG9yZS52MWJldGEzLk11dGF0aW9uUmVzdWx0Ug9tdXRhdGlvblJlc3VsdHMSIwoNaW5kZXhfdXBkYXRlcxgEIAEoBVIMaW5kZXhVcGRhdGVz');
...
final $typed_data.Uint8List allocateIdsRequestDescriptor = $convert.base64Decode(
    'ChJBbGxvY2F0ZUlkc1JlcXVlc3QSHQoKcHJvamVjdF9pZBgIIAEoCVIJcHJvamVjdElkEjEKBGtleXMYASADKAsyHS5nb29nbGUuZGF0YXN0b3JlLnYxYmV0YTMuS2V5UgRrZXlz');
...
final $typed_data.Uint8List allocateIdsResponseDescriptor = $convert.base64Decode(
    'ChNBbGxvY2F0ZUlkc1Jlc3BvbnNlEjEKBGtleXMYASADKAsyHS5nb29nbGUuZGF0YXN0b3JlLnYxYmV0YTMuS2V5UgRrZXlz');
...
final $typed_data.Uint8List reserveIdsRequestDescriptor = $convert.base64Decode(
    'ChFSZXNlcnZlSWRzUmVxdWVzdBIdCgpwcm9qZWN0X2lkGAggASgJUglwcm9qZWN0SWQSHwoLZGF0YWJhc2VfaWQYCSABKAlSCmRhdGFiYXNlSWQSMQoEa2V5cxgBIAMoCzIdLmdvb2dsZS5kYXRhc3RvcmUudjFiZXRhMy5LZXlSBGtleXM=');
...
final $typed_data.Uint8List mutationDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List mutationResultDescriptor = $convert.base64Decode(
    'Cg5NdXRhdGlvblJlc3VsdBIvCgNrZXkYAyABKAsyHS5nb29nbGUuZGF0YXN0b3JlLnYxYmV0YTMuS2V5UgNrZXkSGAoHdmVyc2lvbhgEIAEoA1IHdmVyc2lvbhIrChFjb25mbGljdF9kZXRlY3RlZBgFIAEoCFIQY29uZmxpY3REZXRlY3RlZA==');
...
final $typed_data.Uint8List readOptionsDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List transactionOptionsDescriptor = $convert.base64Decode(
    '');
