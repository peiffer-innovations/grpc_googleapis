...
//
// Generated from google/chat/v1/space_event.proto.
...
class SpaceEvent extends $pb.GeneratedMessage {
  ...
  factory SpaceEvent.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory SpaceEvent.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$pb.TagNumber(3)
  set eventTime($0.Timestamp value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasEventTime() => $_has(1);
  @$pb.TagNumber(3)
  void clearEventTime() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(12)
  set messageCreatedEventData($1.MessageCreatedEventData value) =>
      $_setField(12, value);
  @$pb.TagNumber(12)
  $core.bool hasMessageCreatedEventData() => $_has(3);
  @$pb.TagNumber(12)
  void clearMessageCreatedEventData() => $_clearField(12);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set messageUpdatedEventData($1.MessageUpdatedEventData value) =>
      $_setField(13, value);
  @$pb.TagNumber(13)
  $core.bool hasMessageUpdatedEventData() => $_has(4);
  @$pb.TagNumber(13)
  void clearMessageUpdatedEventData() => $_clearField(13);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set messageDeletedEventData($1.MessageDeletedEventData value) =>
      $_setField(14, value);
  @$pb.TagNumber(14)
  $core.bool hasMessageDeletedEventData() => $_has(5);
  @$pb.TagNumber(14)
  void clearMessageDeletedEventData() => $_clearField(14);
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set spaceUpdatedEventData($1.SpaceUpdatedEventData value) =>
      $_setField(15, value);
  @$pb.TagNumber(15)
  $core.bool hasSpaceUpdatedEventData() => $_has(6);
  @$pb.TagNumber(15)
  void clearSpaceUpdatedEventData() => $_clearField(15);
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(17)
  set membershipCreatedEventData($1.MembershipCreatedEventData value) =>
      $_setField(17, value);
  @$pb.TagNumber(17)
  $core.bool hasMembershipCreatedEventData() => $_has(7);
  @$pb.TagNumber(17)
  void clearMembershipCreatedEventData() => $_clearField(17);
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set membershipUpdatedEventData($1.MembershipUpdatedEventData value) =>
      $_setField(18, value);
  @$pb.TagNumber(18)
  $core.bool hasMembershipUpdatedEventData() => $_has(8);
  @$pb.TagNumber(18)
  void clearMembershipUpdatedEventData() => $_clearField(18);
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(21)
  set reactionCreatedEventData($1.ReactionCreatedEventData value) =>
      $_setField(21, value);
  @$pb.TagNumber(21)
  $core.bool hasReactionCreatedEventData() => $_has(9);
  @$pb.TagNumber(21)
  void clearReactionCreatedEventData() => $_clearField(21);
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(22)
  set reactionDeletedEventData($1.ReactionDeletedEventData value) =>
      $_setField(22, value);
  @$pb.TagNumber(22)
  $core.bool hasReactionDeletedEventData() => $_has(10);
  @$pb.TagNumber(22)
  void clearReactionDeletedEventData() => $_clearField(22);
  @$pb.TagNumber(22)
  ...
  $1.MessageBatchCreatedEventData get messageBatchCreatedEventData =>
      $_getN(11);
  @$pb.TagNumber(26)
  set messageBatchCreatedEventData($1.MessageBatchCreatedEventData value) =>
      $_setField(26, value);
  @$pb.TagNumber(26)
  $core.bool hasMessageBatchCreatedEventData() => $_has(11);
  @$pb.TagNumber(26)
  void clearMessageBatchCreatedEventData() => $_clearField(26);
  @$pb.TagNumber(26)
  ...
  $1.MessageBatchUpdatedEventData get messageBatchUpdatedEventData =>
      $_getN(12);
  @$pb.TagNumber(27)
  set messageBatchUpdatedEventData($1.MessageBatchUpdatedEventData value) =>
      $_setField(27, value);
  @$pb.TagNumber(27)
  $core.bool hasMessageBatchUpdatedEventData() => $_has(12);
  @$pb.TagNumber(27)
  void clearMessageBatchUpdatedEventData() => $_clearField(27);
  @$pb.TagNumber(27)
  ...
  $1.MessageBatchDeletedEventData get messageBatchDeletedEventData =>
      $_getN(13);
  @$pb.TagNumber(28)
  set messageBatchDeletedEventData($1.MessageBatchDeletedEventData value) =>
      $_setField(28, value);
  @$pb.TagNumber(28)
  $core.bool hasMessageBatchDeletedEventData() => $_has(13);
  @$pb.TagNumber(28)
  void clearMessageBatchDeletedEventData() => $_clearField(28);
  @$pb.TagNumber(28)
  ...
  @$pb.TagNumber(29)
  set spaceBatchUpdatedEventData($1.SpaceBatchUpdatedEventData value) =>
      $_setField(29, value);
  @$pb.TagNumber(29)
  $core.bool hasSpaceBatchUpdatedEventData() => $_has(14);
  @$pb.TagNumber(29)
  void clearSpaceBatchUpdatedEventData() => $_clearField(29);
  @$pb.TagNumber(29)
  ...
  $1.MembershipBatchCreatedEventData get membershipBatchCreatedEventData =>
      $_getN(15);
  @$pb.TagNumber(31)
  set membershipBatchCreatedEventData(
          $1.MembershipBatchCreatedEventData value) =>
      $_setField(31, value);
  @$pb.TagNumber(31)
  $core.bool hasMembershipBatchCreatedEventData() => $_has(15);
  @$pb.TagNumber(31)
  void clearMembershipBatchCreatedEventData() => $_clearField(31);
  @$pb.TagNumber(31)
  ...
  $1.MembershipBatchUpdatedEventData get membershipBatchUpdatedEventData =>
      $_getN(16);
  @$pb.TagNumber(32)
  set membershipBatchUpdatedEventData(
          $1.MembershipBatchUpdatedEventData value) =>
      $_setField(32, value);
  @$pb.TagNumber(32)
  $core.bool hasMembershipBatchUpdatedEventData() => $_has(16);
  @$pb.TagNumber(32)
  void clearMembershipBatchUpdatedEventData() => $_clearField(32);
  @$pb.TagNumber(32)
  ...
  $1.MembershipBatchDeletedEventData get membershipBatchDeletedEventData =>
      $_getN(17);
  @$pb.TagNumber(33)
  set membershipBatchDeletedEventData(
          $1.MembershipBatchDeletedEventData value) =>
      $_setField(33, value);
  @$pb.TagNumber(33)
  $core.bool hasMembershipBatchDeletedEventData() => $_has(17);
  @$pb.TagNumber(33)
  void clearMembershipBatchDeletedEventData() => $_clearField(33);
  @$pb.TagNumber(33)
  ...
  $1.ReactionBatchCreatedEventData get reactionBatchCreatedEventData =>
      $_getN(18);
  @$pb.TagNumber(34)
  set reactionBatchCreatedEventData($1.ReactionBatchCreatedEventData value) =>
      $_setField(34, value);
  @$pb.TagNumber(34)
  $core.bool hasReactionBatchCreatedEventData() => $_has(18);
  @$pb.TagNumber(34)
  void clearReactionBatchCreatedEventData() => $_clearField(34);
  @$pb.TagNumber(34)
  ...
  $1.ReactionBatchDeletedEventData get reactionBatchDeletedEventData =>
      $_getN(19);
  @$pb.TagNumber(35)
  set reactionBatchDeletedEventData($1.ReactionBatchDeletedEventData value) =>
      $_setField(35, value);
  @$pb.TagNumber(35)
  $core.bool hasReactionBatchDeletedEventData() => $_has(19);
  @$pb.TagNumber(35)
  void clearReactionBatchDeletedEventData() => $_clearField(35);
  @$pb.TagNumber(35)
  ...
  @$pb.TagNumber(219)
  set membershipDeletedEventData($1.MembershipDeletedEventData value) =>
      $_setField(219, value);
  @$pb.TagNumber(219)
  $core.bool hasMembershipDeletedEventData() => $_has(20);
  @$pb.TagNumber(219)
  void clearMembershipDeletedEventData() => $_clearField(219);
  @$pb.TagNumber(219)
...
class GetSpaceEventRequest extends $pb.GeneratedMessage {
  ...
  GetSpaceEventRequest._();

  factory GetSpaceEventRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetSpaceEventRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetSpaceEventRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListSpaceEventsRequest extends $pb.GeneratedMessage {
  ...
  ListSpaceEventsRequest._();

  factory ListSpaceEventsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListSpaceEventsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListSpaceEventsRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListSpaceEventsResponse extends $pb.GeneratedMessage {
  factory ListSpaceEventsResponse({
    ...
    final result = create();
    if (spaceEvents != null) result.spaceEvents.addAll(spaceEvents);
    if (nextPageToken != null) result.nextPageToken = nextPageToken;
    return result;
  }

  ListSpaceEventsResponse._();

  factory ListSpaceEventsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListSpaceEventsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'),
      createEmptyInstance: create)
    ..pPM<SpaceEvent>(1, _omitFieldNames ? '' : 'spaceEvents',
        subBuilder: SpaceEvent.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListSpaceEventsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<SpaceEvent> get spaceEvents => $_getList(0);
