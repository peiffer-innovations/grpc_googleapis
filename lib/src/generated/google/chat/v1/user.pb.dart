...
class User extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<User_Type>(5, _omitFieldNames ? '' : 'type',
  ...
  @$pb.TagNumber(5)
  set type(User_Type value) => $_setField(5, value);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set domainId($core.String value) => $_setString(3, value);
  @$pb.TagNumber(6)
  $core.bool hasDomainId() => $_has(3);
  @$pb.TagNumber(6)
  void clearDomainId() => $_clearField(6);
