...
class Space_SpaceDetails extends $pb.GeneratedMessage {
  factory Space_SpaceDetails({
    ...
    if (guidelines != null) result.guidelines = guidelines;
    return result;
  }

  Space_SpaceDetails._();

  factory Space_SpaceDetails.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Space_SpaceDetails.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  Space_SpaceDetails clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  set guidelines($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasGuidelines() => $_has(1);
  @$pb.TagNumber(2)
  void clearGuidelines() => $_clearField(2);
}
...
class Space_MembershipCount extends $pb.GeneratedMessage {
  factory Space_MembershipCount({
    ...
    if (joinedGroupCount != null) result.joinedGroupCount = joinedGroupCount;
    return result;
  }

  Space_MembershipCount._();

  factory Space_MembershipCount.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Space_MembershipCount.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'),
      createEmptyInstance: create)
    ..aI(4, _omitFieldNames ? '' : 'joinedDirectHumanUserCount')
    ..aI(5, _omitFieldNames ? '' : 'joinedGroupCount')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Space_MembershipCount clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(4)
  set joinedDirectHumanUserCount($core.int value) => $_setSignedInt32(0, value);
  @$pb.TagNumber(4)
  $core.bool hasJoinedDirectHumanUserCount() => $_has(0);
  @$pb.TagNumber(4)
  void clearJoinedDirectHumanUserCount() => $_clearField(4);

  /// Output only. Count of all groups that have directly joined the space.
  @$pb.TagNumber(5)
  $core.int get joinedGroupCount => $_getIZ(1);
  @$pb.TagNumber(5)
  set joinedGroupCount($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(5)
  $core.bool hasJoinedGroupCount() => $_has(1);
  @$pb.TagNumber(5)
  void clearJoinedGroupCount() => $_clearField(5);
}
...
class Space_AccessSettings extends $pb.GeneratedMessage {
  ...
  Space_AccessSettings._();

  factory Space_AccessSettings.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Space_AccessSettings.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'),
      createEmptyInstance: create)
    ..aE<Space_AccessSettings_AccessState>(
        1, _omitFieldNames ? '' : 'accessState',
        enumValues: Space_AccessSettings_AccessState.values)
    ..aOS(3, _omitFieldNames ? '' : 'audience')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Space_AccessSettings clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set accessState(Space_AccessSettings_AccessState value) =>
      $_setField(1, value);
  @$pb.TagNumber(1)
...
class Space_PermissionSettings extends $pb.GeneratedMessage {
  factory Space_PermissionSettings({
    ...
    if (toggleHistory != null) result.toggleHistory = toggleHistory;
    if (useAtMentionAll != null) result.useAtMentionAll = useAtMentionAll;
    if (manageApps != null) result.manageApps = manageApps;
    if (manageWebhooks != null) result.manageWebhooks = manageWebhooks;
    if (postMessages != null) result.postMessages = postMessages;
    if (replyMessages != null) result.replyMessages = replyMessages;
    return result;
  }

  Space_PermissionSettings._();

  factory Space_PermissionSettings.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Space_PermissionSettings.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Space_PermissionSettings clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set manageMembersAndGroups(Space_PermissionSetting value) =>
      $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasManageMembersAndGroups() => $_has(0);
  @$pb.TagNumber(1)
  void clearManageMembersAndGroups() => $_clearField(1);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set modifySpaceDetails(Space_PermissionSetting value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasModifySpaceDetails() => $_has(1);
  @$pb.TagNumber(2)
  void clearModifySpaceDetails() => $_clearField(2);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set toggleHistory(Space_PermissionSetting value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasToggleHistory() => $_has(2);
  @$pb.TagNumber(3)
  void clearToggleHistory() => $_clearField(3);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set useAtMentionAll(Space_PermissionSetting value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasUseAtMentionAll() => $_has(3);
  @$pb.TagNumber(4)
  void clearUseAtMentionAll() => $_clearField(4);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set manageApps(Space_PermissionSetting value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasManageApps() => $_has(4);
  @$pb.TagNumber(5)
  void clearManageApps() => $_clearField(5);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set manageWebhooks(Space_PermissionSetting value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasManageWebhooks() => $_has(5);
  @$pb.TagNumber(6)
  void clearManageWebhooks() => $_clearField(6);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set postMessages(Space_PermissionSetting value) => $_setField(7, value);
  @$pb.TagNumber(7)
  $core.bool hasPostMessages() => $_has(6);
  @$pb.TagNumber(7)
  void clearPostMessages() => $_clearField(7);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set replyMessages(Space_PermissionSetting value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasReplyMessages() => $_has(7);
  @$pb.TagNumber(8)
  void clearReplyMessages() => $_clearField(8);
  @$pb.TagNumber(8)
...
class Space_PermissionSetting extends $pb.GeneratedMessage {
  factory Space_PermissionSetting({
    ...
    final result = create();
    if (managersAllowed != null) result.managersAllowed = managersAllowed;
    if (membersAllowed != null) result.membersAllowed = membersAllowed;
    if (assistantManagersAllowed != null)
      result.assistantManagersAllowed = assistantManagersAllowed;
    return result;
  }

  Space_PermissionSetting._();

  factory Space_PermissionSetting.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Space_PermissionSetting.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(3, _omitFieldNames ? '' : 'assistantManagersAllowed')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Space_PermissionSetting clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set managersAllowed($core.bool value) => $_setBool(0, value);
  @$pb.TagNumber(1)
  $core.bool hasManagersAllowed() => $_has(0);
  @$pb.TagNumber(1)
  void clearManagersAllowed() => $_clearField(1);
  ...
  @$pb.TagNumber(2)
  set membersAllowed($core.bool value) => $_setBool(1, value);
  @$pb.TagNumber(2)
  $core.bool hasMembersAllowed() => $_has(1);
  @$pb.TagNumber(2)
  void clearMembersAllowed() => $_clearField(2);

  /// Optional. Whether space managers
  /// [`ROLE_ASSISTANT_MANAGER`][google.chat.v1.Membership.MembershipRole.ROLE_ASSISTANT_MANAGER])
  /// have this permission.
  @$pb.TagNumber(3)
  $core.bool get assistantManagersAllowed => $_getBF(2);
  @$pb.TagNumber(3)
  set assistantManagersAllowed($core.bool value) => $_setBool(2, value);
  @$pb.TagNumber(3)
  $core.bool hasAssistantManagersAllowed() => $_has(2);
  @$pb.TagNumber(3)
  void clearAssistantManagersAllowed() => $_clearField(3);
}
...
class Space extends $pb.GeneratedMessage {
  factory Space({
    ...
    if (singleUserBotDm != null) result.singleUserBotDm = singleUserBotDm;
    if (threaded != null) result.threaded = threaded;
    ...
    if (spaceDetails != null) result.spaceDetails = spaceDetails;
    if (spaceHistoryState != null) result.spaceHistoryState = spaceHistoryState;
    if (importMode != null) result.importMode = importMode;
    if (createTime != null) result.createTime = createTime;
    if (lastActiveTime != null) result.lastActiveTime = lastActiveTime;
    if (adminInstalled != null) result.adminInstalled = adminInstalled;
    if (membershipCount != null) result.membershipCount = membershipCount;
    if (accessSettings != null) result.accessSettings = accessSettings;
    if (customer != null) result.customer = customer;
    if (spaceUri != null) result.spaceUri = spaceUri;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<Space_Type>(2, _omitFieldNames ? '' : 'type',
    ...
    ..aE<Space_SpaceThreadingState>(
        9, _omitFieldNames ? '' : 'spaceThreadingState',
        enumValues: Space_SpaceThreadingState.values)
    ..aE<Space_SpaceType>(10, _omitFieldNames ? '' : 'spaceType',
    ...
    ..aE<$2.HistoryState>(13, _omitFieldNames ? '' : 'spaceHistoryState',
    ...
    ..aOS(24, _omitFieldNames ? '' : 'customer')
    ..aOS(25, _omitFieldNames ? '' : 'spaceUri')
    ..aE<Space_PredefinedPermissionSettings>(
        26, _omitFieldNames ? '' : 'predefinedPermissionSettings',
  ...
  @$pb.TagNumber(26)
  @$pb.TagNumber(27)
  void clearSpacePermissionSettings() => $_clearField($_whichOneof(0));
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  set type(Space_Type value) => $_setField(2, value);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set singleUserBotDm($core.bool value) => $_setBool(3, value);
  @$pb.TagNumber(4)
  $core.bool hasSingleUserBotDm() => $_has(3);
  @$pb.TagNumber(4)
  void clearSingleUserBotDm() => $_clearField(4);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  set threaded($core.bool value) => $_setBool(4, value);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $core.bool hasThreaded() => $_has(4);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  void clearThreaded() => $_clearField(5);
  ...
  @$pb.TagNumber(8)
  set externalUserAllowed($core.bool value) => $_setBool(5, value);
  @$pb.TagNumber(8)
  $core.bool hasExternalUserAllowed() => $_has(5);
  @$pb.TagNumber(8)
  void clearExternalUserAllowed() => $_clearField(8);

  /// Output only. The threading state in the Chat space.
  @$pb.TagNumber(9)
  Space_SpaceThreadingState get spaceThreadingState => $_getN(6);
  @$pb.TagNumber(9)
  set spaceThreadingState(Space_SpaceThreadingState value) =>
      $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasSpaceThreadingState() => $_has(6);
  @$pb.TagNumber(9)
  void clearSpaceThreadingState() => $_clearField(9);
  ...
  @$pb.TagNumber(10)
  set spaceType(Space_SpaceType value) => $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasSpaceType() => $_has(7);
  @$pb.TagNumber(10)
  void clearSpaceType() => $_clearField(10);

  /// Optional. Details about the space including description and rules.
  @$pb.TagNumber(11)
  Space_SpaceDetails get spaceDetails => $_getN(8);
  @$pb.TagNumber(11)
  set spaceDetails(Space_SpaceDetails value) => $_setField(11, value);
  @$pb.TagNumber(11)
  $core.bool hasSpaceDetails() => $_has(8);
  @$pb.TagNumber(11)
  void clearSpaceDetails() => $_clearField(11);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(13)
  set spaceHistoryState($2.HistoryState value) => $_setField(13, value);
  @$pb.TagNumber(13)
  $core.bool hasSpaceHistoryState() => $_has(9);
  @$pb.TagNumber(13)
  void clearSpaceHistoryState() => $_clearField(13);
  ...
  @$pb.TagNumber(16)
  set importMode($core.bool value) => $_setBool(10, value);
  @$pb.TagNumber(16)
  $core.bool hasImportMode() => $_has(10);
  @$pb.TagNumber(16)
  void clearImportMode() => $_clearField(16);
  ...
  @$pb.TagNumber(18)
  set lastActiveTime($0.Timestamp value) => $_setField(18, value);
  @$pb.TagNumber(18)
  $core.bool hasLastActiveTime() => $_has(12);
  @$pb.TagNumber(18)
  void clearLastActiveTime() => $_clearField(18);
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(19)
  set adminInstalled($core.bool value) => $_setBool(13, value);
  @$pb.TagNumber(19)
  $core.bool hasAdminInstalled() => $_has(13);
  @$pb.TagNumber(19)
  void clearAdminInstalled() => $_clearField(19);
  ...
  @$pb.TagNumber(20)
  set membershipCount(Space_MembershipCount value) => $_setField(20, value);
  @$pb.TagNumber(20)
  $core.bool hasMembershipCount() => $_has(14);
  @$pb.TagNumber(20)
  void clearMembershipCount() => $_clearField(20);
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(23)
  set accessSettings(Space_AccessSettings value) => $_setField(23, value);
  @$pb.TagNumber(23)
  $core.bool hasAccessSettings() => $_has(15);
  @$pb.TagNumber(23)
  void clearAccessSettings() => $_clearField(23);
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(24)
  $core.String get customer => $_getSZ(16);
  @$pb.TagNumber(24)
  set customer($core.String value) => $_setString(16, value);
  @$pb.TagNumber(24)
  $core.bool hasCustomer() => $_has(16);
  @$pb.TagNumber(24)
  void clearCustomer() => $_clearField(24);

  /// Output only. The URI for a user to access the space.
  @$pb.TagNumber(25)
  $core.String get spaceUri => $_getSZ(17);
  @$pb.TagNumber(25)
  set spaceUri($core.String value) => $_setString(17, value);
  @$pb.TagNumber(25)
  $core.bool hasSpaceUri() => $_has(17);
  @$pb.TagNumber(25)
  void clearSpaceUri() => $_clearField(25);
  ...
  Space_PredefinedPermissionSettings get predefinedPermissionSettings =>
      $_getN(18);
  @$pb.TagNumber(26)
  set predefinedPermissionSettings(Space_PredefinedPermissionSettings value) =>
      $_setField(26, value);
  @$pb.TagNumber(26)
  $core.bool hasPredefinedPermissionSettings() => $_has(18);
  @$pb.TagNumber(26)
  void clearPredefinedPermissionSettings() => $_clearField(26);
  ...
  /// authentication](https://developers.google.com/workspace/chat/authenticate-authorize-chat-user)
  @$pb.TagNumber(27)
  Space_PermissionSettings get permissionSettings => $_getN(19);
  @$pb.TagNumber(27)
  set permissionSettings(Space_PermissionSettings value) =>
      $_setField(27, value);
  @$pb.TagNumber(27)
  $core.bool hasPermissionSettings() => $_has(19);
  @$pb.TagNumber(27)
  void clearPermissionSettings() => $_clearField(27);
  @$pb.TagNumber(27)
  Space_PermissionSettings ensurePermissionSettings() => $_ensure(19);
  ...
  @$pb.TagNumber(28)
  $0.Timestamp get importModeExpireTime => $_getN(20);
  @$pb.TagNumber(28)
  set importModeExpireTime($0.Timestamp value) => $_setField(28, value);
  @$pb.TagNumber(28)
  $core.bool hasImportModeExpireTime() => $_has(20);
  @$pb.TagNumber(28)
  void clearImportModeExpireTime() => $_clearField(28);
  @$pb.TagNumber(28)
  $0.Timestamp ensureImportModeExpireTime() => $_ensure(20);
}
...
class FindDirectMessageRequest extends $pb.GeneratedMessage {
  ...
  FindDirectMessageRequest._();

  factory FindDirectMessageRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory FindDirectMessageRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FindDirectMessageRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class SearchSpacesRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set useAdminAccess($core.bool value) => $_setBool(0, value);
  @$pb.TagNumber(1)
  $core.bool hasUseAdminAccess() => $_has(0);
  @$pb.TagNumber(1)
  void clearUseAdminAccess() => $_clearField(1);
...
class CompleteImportSpaceRequest extends $pb.GeneratedMessage {
  ...
  CompleteImportSpaceRequest._();

  factory CompleteImportSpaceRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CompleteImportSpaceRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CompleteImportSpaceRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class CompleteImportSpaceResponse extends $pb.GeneratedMessage {
  ...
  factory CompleteImportSpaceResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CompleteImportSpaceResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CompleteImportSpaceResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
