...
class LogMetric extends $pb.GeneratedMessage {
  ...
  factory LogMetric.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory LogMetric.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<LogMetric_ApiVersion>(4, _omitFieldNames ? '' : 'version',
        enumValues: LogMetric_ApiVersion.values)
    ..aOM<$2.MetricDescriptor>(5, _omitFieldNames ? '' : 'metricDescriptor',
    ...
    ..aOM<$3.Distribution_BucketOptions>(
        8, _omitFieldNames ? '' : 'bucketOptions',
        subBuilder: $3.Distribution_BucketOptions.create)
    ..aOM<$4.Timestamp>(9, _omitFieldNames ? '' : 'createTime',
        subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(10, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $4.Timestamp.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  set version(LogMetric_ApiVersion value) => $_setField(4, value);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set metricDescriptor($2.MetricDescriptor value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasMetricDescriptor() => $_has(4);
  @$pb.TagNumber(5)
  void clearMetricDescriptor() => $_clearField(5);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set valueExtractor($core.String value) => $_setString(5, value);
  @$pb.TagNumber(6)
  $core.bool hasValueExtractor() => $_has(5);
  @$pb.TagNumber(6)
  void clearValueExtractor() => $_clearField(6);
  ...
  @$pb.TagNumber(7)
  $pb.PbMap<$core.String, $core.String> get labelExtractors => $_getMap(6);
  ...
  @$pb.TagNumber(8)
  void clearBucketOptions() => $_clearField(8);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(12)
  set disabled($core.bool value) => $_setBool(10, value);
  @$pb.TagNumber(12)
  $core.bool hasDisabled() => $_has(10);
  @$pb.TagNumber(12)
  void clearDisabled() => $_clearField(12);
  ...
  @$pb.TagNumber(13)
  set bucketName($core.String value) => $_setString(11, value);
  @$pb.TagNumber(13)
  $core.bool hasBucketName() => $_has(11);
  @$pb.TagNumber(13)
  void clearBucketName() => $_clearField(13);
}
...
class ListLogMetricsRequest extends $pb.GeneratedMessage {
  ...
  ListLogMetricsRequest._();

  factory ListLogMetricsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListLogMetricsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListLogMetricsRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListLogMetricsResponse extends $pb.GeneratedMessage {
  ...
  ListLogMetricsResponse._();

  factory ListLogMetricsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListLogMetricsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.logging.v2'),
      createEmptyInstance: create)
    ..pPM<LogMetric>(1, _omitFieldNames ? '' : 'metrics',
        subBuilder: LogMetric.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListLogMetricsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<LogMetric> get metrics => $_getList(0);
...
class GetLogMetricRequest extends $pb.GeneratedMessage {
  ...
  GetLogMetricRequest._();

  factory GetLogMetricRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetLogMetricRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetLogMetricRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class CreateLogMetricRequest extends $pb.GeneratedMessage {
  ...
  CreateLogMetricRequest._();

  factory CreateLogMetricRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CreateLogMetricRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CreateLogMetricRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  set metric(LogMetric value) => $_setField(2, value);
  @$pb.TagNumber(2)
...
class UpdateLogMetricRequest extends $pb.GeneratedMessage {
  ...
  UpdateLogMetricRequest._();

  factory UpdateLogMetricRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory UpdateLogMetricRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UpdateLogMetricRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class DeleteLogMetricRequest extends $pb.GeneratedMessage {
  ...
  DeleteLogMetricRequest._();

  factory DeleteLogMetricRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory DeleteLogMetricRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DeleteLogMetricRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
