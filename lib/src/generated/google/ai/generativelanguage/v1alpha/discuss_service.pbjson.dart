...
//
// Generated from google/ai/generativelanguage/v1alpha/discuss_service.proto.
...
const GenerateMessageRequest$json = {
  ...
  '2': [
    {'1': 'model', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'model'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ai.generativelanguage.v1alpha.MessagePrompt',
      '8': {},
      '10': 'prompt'
    },
    {
...
final $typed_data.Uint8List generateMessageRequestDescriptor = $convert.base64Decode(
    ...
    'MjMuZ29vZ2xlLmFpLmdlbmVyYXRpdmVsYW5ndWFnZS52MWFscGhhLk1lc3NhZ2VQcm9tcHRCA+'
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ai.generativelanguage.v1alpha.Message',
      '10': 'candidates'
    },
    {
      '1': 'messages',
...
final $typed_data.Uint8List generateMessageResponseDescriptor = $convert.base64Decode(
    ...
    'FpLmdlbmVyYXRpdmVsYW5ndWFnZS52MWFscGhhLk1lc3NhZ2VSCmNhbmRpZGF0ZXMSSQoIbWVz'
    'c2FnZXMYAiADKAsyLS5nb29nbGUuYWkuZ2VuZXJhdGl2ZWxhbmd1YWdlLnYxYWxwaGEuTWVzc2'
    'FnZVIIbWVzc2FnZXMSTQoHZmlsdGVycxgDIAMoCzIzLmdvb2dsZS5haS5nZW5lcmF0aXZlbGFu'
    'Z3VhZ2UudjFhbHBoYS5Db250ZW50RmlsdGVyUgdmaWx0ZXJz');
...
final $typed_data.Uint8List messageDescriptor = $convert.base64Decode(
    ...
    'bmVyYXRpdmVsYW5ndWFnZS52MWFscGhhLkNpdGF0aW9uTWV0YWRhdGFCA+BBA0gAUhBjaXRhdG'
...
const MessagePrompt$json = {
  ...
  '2': [
    {'1': 'context', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'context'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ai.generativelanguage.v1alpha.Example',
      '8': {},
      '10': 'examples'
    },
    {
...
final $typed_data.Uint8List messagePromptDescriptor = $convert.base64Decode(
    ...
    'xlcxgCIAMoCzItLmdvb2dsZS5haS5nZW5lcmF0aXZlbGFuZ3VhZ2UudjFhbHBoYS5FeGFtcGxl'
    'QgPgQQFSCGV4YW1wbGVzEk4KCG1lc3NhZ2VzGAMgAygLMi0uZ29vZ2xlLmFpLmdlbmVyYXRpdm'
    'VsYW5ndWFnZS52MWFscGhhLk1lc3NhZ2VCA+BBAlIIbWVzc2FnZXM=');
...
final $typed_data.Uint8List exampleDescriptor = $convert.base64Decode(
    ...
    '52MWFscGhhLk1lc3NhZ2VCA+BBAlIFaW5wdXQSSgoGb3V0cHV0GAIgASgLMi0uZ29vZ2xlLmFp'
    'LmdlbmVyYXRpdmVsYW5ndWFnZS52MWFscGhhLk1lc3NhZ2VCA+BBAlIGb3V0cHV0');
...
final $typed_data.Uint8List countMessageTokensRequestDescriptor = $convert.base64Decode(
    ...
    'ASgLMjMuZ29vZ2xlLmFpLmdlbmVyYXRpdmVsYW5ndWFnZS52MWFscGhhLk1lc3NhZ2VQcm9tcH'
    'RCA+BBAlIGcHJvbXB0');
