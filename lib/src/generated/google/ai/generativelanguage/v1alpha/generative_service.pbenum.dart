...
class GenerateAnswerRequest_AnswerStyle extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, GenerateAnswerRequest_AnswerStyle>
      _byValue = $pb.ProtobufEnum.initByValue(values);
  static GenerateAnswerRequest_AnswerStyle? valueOf($core.int value) =>
      _byValue[value];

  const GenerateAnswerRequest_AnswerStyle._($core.int v, $core.String n)
      : super(v, n);
}
...
class GenerateAnswerResponse_InputFeedback_BlockReason
  ...
  static final $core
      .Map<$core.int, GenerateAnswerResponse_InputFeedback_BlockReason>
      _byValue = $pb.ProtobufEnum.initByValue(values);
