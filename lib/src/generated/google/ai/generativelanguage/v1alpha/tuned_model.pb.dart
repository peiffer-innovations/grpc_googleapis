...
class TuningExamples extends $pb.GeneratedMessage {
  factory TuningExamples({
    ...
    $core.Iterable<TuningMultiturnExample>? multiturnExamples,
  }) {
    final $result = create();
    if (examples != null) {
      $result.examples.addAll(examples);
    }
    if (multiturnExamples != null) {
      $result.multiturnExamples.addAll(multiturnExamples);
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<TuningMultiturnExample>(
        2, _omitFieldNames ? '' : 'multiturnExamples', $pb.PbFieldType.PM,
        subBuilder: TuningMultiturnExample.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $core.List<TuningMultiturnExample> get multiturnExamples => $_getList(1);
}

enum TuningPart_Data { text, notSet }
...
class TuningPart extends $pb.GeneratedMessage {
  factory TuningPart({
    $core.String? text,
  }) {
    final $result = create();
  ...
  TuningPart._() : super();
  factory TuningPart.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TuningPart.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, TuningPart_Data> _TuningPart_DataByTag = {
    2: TuningPart_Data.text,
    0: TuningPart_Data.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TuningPart',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.ai.generativelanguage.v1alpha'),
      createEmptyInstance: create)
    ..oo(0, [2])
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TuningPart clone() => TuningPart()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TuningPart copyWith(void Function(TuningPart) updates) =>
      super.copyWith((message) => updates(message as TuningPart)) as TuningPart;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TuningPart create() => TuningPart._();
  TuningPart createEmptyInstance() => create();
  static $pb.PbList<TuningPart> createRepeated() => $pb.PbList<TuningPart>();
  @$core.pragma('dart2js:noInline')
  static TuningPart getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TuningPart>(create);
  static TuningPart? _defaultInstance;

  TuningPart_Data whichData() => _TuningPart_DataByTag[$_whichOneof(0)]!;
...
class TuningContent extends $pb.GeneratedMessage {
  factory TuningContent({
    $core.Iterable<TuningPart>? parts,
    $core.String? role,
  }) {
    final $result = create();
    if (parts != null) {
  ...
  TuningContent._() : super();
  factory TuningContent.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TuningContent.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TuningContent',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.ai.generativelanguage.v1alpha'),
      createEmptyInstance: create)
    ..pc<TuningPart>(1, _omitFieldNames ? '' : 'parts', $pb.PbFieldType.PM,
        subBuilder: TuningPart.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TuningContent clone() => TuningContent()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TuningContent copyWith(void Function(TuningContent) updates) =>
      super.copyWith((message) => updates(message as TuningContent))
          as TuningContent;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TuningContent create() => TuningContent._();
  TuningContent createEmptyInstance() => create();
  static $pb.PbList<TuningContent> createRepeated() =>
      $pb.PbList<TuningContent>();
  @$core.pragma('dart2js:noInline')
  static TuningContent getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TuningContent>(create);
  static TuningContent? _defaultInstance;

  /// Ordered `Parts` that constitute a single message. Parts may have different
  /// MIME types.
  @$pb.TagNumber(1)
  $core.List<TuningPart> get parts => $_getList(0);
...
class TuningMultiturnExample extends $pb.GeneratedMessage {
  factory TuningMultiturnExample({
    $core.Iterable<TuningContent>? contents,
    TuningContent? systemInstruction,
  }) {
    final $result = create();
    if (contents != null) {
  ...
  TuningMultiturnExample._() : super();
  factory TuningMultiturnExample.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TuningMultiturnExample.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TuningMultiturnExample',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.ai.generativelanguage.v1alpha'),
      createEmptyInstance: create)
    ..pc<TuningContent>(
        1, _omitFieldNames ? '' : 'contents', $pb.PbFieldType.PM,
        subBuilder: TuningContent.create)
    ..aOM<TuningContent>(8, _omitFieldNames ? '' : 'systemInstruction',
        subBuilder: TuningContent.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TuningMultiturnExample clone() =>
      TuningMultiturnExample()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TuningMultiturnExample copyWith(
          void Function(TuningMultiturnExample) updates) =>
      super.copyWith((message) => updates(message as TuningMultiturnExample))
          as TuningMultiturnExample;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TuningMultiturnExample create() => TuningMultiturnExample._();
  TuningMultiturnExample createEmptyInstance() => create();
  static $pb.PbList<TuningMultiturnExample> createRepeated() =>
      $pb.PbList<TuningMultiturnExample>();
  @$core.pragma('dart2js:noInline')
  static TuningMultiturnExample getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TuningMultiturnExample>(create);
  static TuningMultiturnExample? _defaultInstance;

  /// Each Content represents a turn in the conversation.
  @$pb.TagNumber(1)
  $core.List<TuningContent> get contents => $_getList(0);

  /// Optional. Developer set system instructions.
  /// Currently, text only.
  @$pb.TagNumber(8)
  TuningContent get systemInstruction => $_getN(1);
  @$pb.TagNumber(8)
  set systemInstruction(TuningContent v) {
    setField(8, v);
  }

  @$pb.TagNumber(8)
  $core.bool hasSystemInstruction() => $_has(1);
  @$pb.TagNumber(8)
  void clearSystemInstruction() => clearField(8);
  @$pb.TagNumber(8)
  TuningContent ensureSystemInstruction() => $_ensure(1);
}
