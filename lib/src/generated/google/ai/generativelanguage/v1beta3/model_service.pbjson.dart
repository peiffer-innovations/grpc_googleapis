  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ai.generativelanguage.v1beta3.Model',
      '10': 'models'
    },
...
final $typed_data.Uint8List listModelsResponseDescriptor = $convert.base64Decode(
    ...
    'RpdmVsYW5ndWFnZS52MWJldGEzLk1vZGVsUgZtb2RlbHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIg'
...
final $typed_data.Uint8List listTunedModelsRequestDescriptor =
    $convert.base64Decode(
        'ChZMaXN0VHVuZWRNb2RlbHNSZXF1ZXN0EiAKCXBhZ2Vfc2l6ZRgBIAEoBUID4EEBUghwYWdlU2'
        'l6ZRIiCgpwYWdlX3Rva2VuGAIgASgJQgPgQQFSCXBhZ2VUb2tlbg==');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ai.generativelanguage.v1beta3.TunedModel',
      '10': 'tunedModels'
    },
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
...
final $typed_data.Uint8List listTunedModelsResponseDescriptor = $convert.base64Decode(
    ...
    'UuYWkuZ2VuZXJhdGl2ZWxhbmd1YWdlLnYxYmV0YTMuVHVuZWRNb2RlbFILdHVuZWRNb2RlbHMS'
...
final $typed_data.Uint8List createTunedModelRequestDescriptor = $convert.base64Decode(
    ...
    'cmF0aXZlbGFuZ3VhZ2UudjFiZXRhMy5UdW5lZE1vZGVsQgPgQQJSCnR1bmVkTW9kZWxCEQoPX3'
    'R1bmVkX21vZGVsX2lk');
...
final $typed_data.Uint8List createTunedModelMetadataDescriptor = $convert.base64Decode(
    ...
    'dlLnYxYmV0YTMuVHVuaW5nU25hcHNob3RSCXNuYXBzaG90cw==');
...
final $typed_data.Uint8List updateTunedModelRequestDescriptor = $convert.base64Decode(
    ...
    '5haS5nZW5lcmF0aXZlbGFuZ3VhZ2UudjFiZXRhMy5UdW5lZE1vZGVsQgPgQQJSCnR1bmVkTW9k'
