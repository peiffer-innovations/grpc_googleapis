...
//
// Generated from google/ai/generativelanguage/v1beta3/permission_service.proto.
...
const CreatePermissionRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ai.generativelanguage.v1beta3.Permission',
      '8': {},
      '10': 'permission'
    },
  ],
...
final $typed_data.Uint8List createPermissionRequestDescriptor = $convert.base64Decode(
    ...
    'aXNzaW9uGAIgASgLMjAuZ29vZ2xlLmFpLmdlbmVyYXRpdmVsYW5ndWFnZS52MWJldGEzLlBlcm'
...
final $typed_data.Uint8List listPermissionsResponseDescriptor = $convert.base64Decode(
    ...
    '5haS5nZW5lcmF0aXZlbGFuZ3VhZ2UudjFiZXRhMy5QZXJtaXNzaW9uUgtwZXJtaXNzaW9ucxIm'
...
final $typed_data.Uint8List updatePermissionRequestDescriptor = $convert.base64Decode(
    ...
    'FpLmdlbmVyYXRpdmVsYW5ndWFnZS52MWJldGEzLlBlcm1pc3Npb25CA+BBAlIKcGVybWlzc2lv'
...
final $typed_data.Uint8List transferOwnershipRequestDescriptor = $convert.base64Decode(
    'ChhUcmFuc2Zlck93bmVyc2hpcFJlcXVlc3QSSAoEbmFtZRgBIAEoCUI04EEC+kEuCixnZW5lcm'
    'F0aXZlbGFuZ3VhZ2UuZ29vZ2xlYXBpcy5jb20vVHVuZWRNb2RlbFIEbmFtZRIoCg1lbWFpbF9h'
