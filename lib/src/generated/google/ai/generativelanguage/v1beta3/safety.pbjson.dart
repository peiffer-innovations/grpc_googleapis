...
//
// Generated from google/ai/generativelanguage/v1beta3/safety.proto.
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.ai.generativelanguage.v1beta3.ContentFilter.BlockedReason',
      '10': 'reason'
    },
    {
      '1': 'message',
...
final $typed_data.Uint8List contentFilterDescriptor = $convert.base64Decode(
    ...
    'FuZ3VhZ2UudjFiZXRhMy5Db250ZW50RmlsdGVyLkJsb2NrZWRSZWFzb25SBnJlYXNvbhIdCgdt'
...
final $typed_data.Uint8List safetyFeedbackDescriptor = $convert.base64Decode(
    ...
    'xhbmd1YWdlLnYxYmV0YTMuU2FmZXR5UmF0aW5nUgZyYXRpbmcSTQoHc2V0dGluZxgCIAEoCzIz'
    'Lmdvb2dsZS5haS5nZW5lcmF0aXZlbGFuZ3VhZ2UudjFiZXRhMy5TYWZldHlTZXR0aW5nUgdzZX'
    'R0aW5n');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.ai.generativelanguage.v1beta3.HarmCategory',
      '8': {},
      '10': 'category'
    },
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.ai.generativelanguage.v1beta3.SafetyRating.HarmProbability',
      '8': {},
      '10': 'probability'
    },
  ],
...
final $typed_data.Uint8List safetyRatingDescriptor = $convert.base64Decode(
    ...
    'xhbmd1YWdlLnYxYmV0YTMuSGFybUNhdGVnb3J5QgPgQQJSCGNhdGVnb3J5EmkKC3Byb2JhYmls'
    'aXR5GAQgASgOMkIuZ29vZ2xlLmFpLmdlbmVyYXRpdmVsYW5ndWFnZS52MWJldGEzLlNhZmV0eV'
...
const SafetySetting$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '5': 14,
      '6':
          '.google.ai.generativelanguage.v1beta3.SafetySetting.HarmBlockThreshold',
      '8': {},
      '10': 'threshold'
    },
  ],
...
final $typed_data.Uint8List safetySettingDescriptor = $convert.base64Decode(
    ...
    'VsYW5ndWFnZS52MWJldGEzLkhhcm1DYXRlZ29yeUID4EECUghjYXRlZ29yeRJpCgl0aHJlc2hv'
    'bGQYBCABKA4yRi5nb29nbGUuYWkuZ2VuZXJhdGl2ZWxhbmd1YWdlLnYxYmV0YTMuU2FmZXR5U2'
    'V0dGluZy5IYXJtQmxvY2tUaHJlc2hvbGRCA+BBAlIJdGhyZXNob2xkIpQBChJIYXJtQmxvY2tU'
    ...
    'TFlfSElHSBADEg4KCkJMT0NLX05PTkUQBA==');
