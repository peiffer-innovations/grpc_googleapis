...
class RetrieverServiceClient extends $grpc.Client {
  static final _$createCorpus =
      $grpc.ClientMethod<$0.CreateCorpusRequest, $1.Corpus>(
          ...
          ($core.List<$core.int> value) => $1.Corpus.fromBuffer(value));
  ...
  static final _$listCorpora =
      $grpc.ClientMethod<$0.ListCorporaRequest, $0.ListCorporaResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.ListCorporaResponse.fromBuffer(value));
  static final _$queryCorpus =
      $grpc.ClientMethod<$0.QueryCorpusRequest, $0.QueryCorpusResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.QueryCorpusResponse.fromBuffer(value));
  ...
  static final _$batchCreateChunks = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.BatchCreateChunksResponse.fromBuffer(value));
  ...
  static final _$batchUpdateChunks = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.BatchUpdateChunksResponse.fromBuffer(value));
  ...
  static final _$listChunks =
      $grpc.ClientMethod<$0.ListChunksRequest, $0.ListChunksResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.ListChunksResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.Corpus> createCorpus($0.CreateCorpusRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createCorpus, request, options: options);
  }

  $grpc.ResponseFuture<$1.Corpus> getCorpus($0.GetCorpusRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getCorpus, request, options: options);
  }

  $grpc.ResponseFuture<$1.Corpus> updateCorpus($0.UpdateCorpusRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateCorpus, request, options: options);
  }

  $grpc.ResponseFuture<$2.Empty> deleteCorpus($0.DeleteCorpusRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.Chunk> createChunk($0.CreateChunkRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.Chunk> getChunk($0.GetChunkRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getChunk, request, options: options);
  }

  $grpc.ResponseFuture<$1.Chunk> updateChunk($0.UpdateChunkRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$2.Empty> deleteChunk($0.DeleteChunkRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class RetrieverServiceBase extends $grpc.Service {
  ...
  $async.Future<$1.Chunk> getChunk_Pre(
      $grpc.ServiceCall call, $async.Future<$0.GetChunkRequest> request) async {
