...
class FileServiceClient extends $grpc.Client {
  ...
  /// Download the `File`.
  $grpc.ResponseFuture<$0.DownloadFileResponse> downloadFile(
...
abstract class FileServiceBase extends $grpc.Service {
  ...
  FileServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.DownloadFileRequest, $0.DownloadFileResponse>(
            'DownloadFile',
            downloadFile_Pre,
            false,
            false,
  ...
  $async.Future<$0.DownloadFileResponse> downloadFile_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.DownloadFileRequest> $request) async {
    return downloadFile($call, await $request);
  }

  $async.Future<$0.DownloadFileResponse> downloadFile(
