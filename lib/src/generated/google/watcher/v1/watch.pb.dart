...
class Request extends $pb.GeneratedMessage {
  factory Request({
    ...
    if (resumeMarker != null) result.resumeMarker = resumeMarker;
    return result;
  }
  ...
  @$pb.TagNumber(2)
  set resumeMarker($core.List<$core.int> value) => $_setBytes(1, value);
  @$pb.TagNumber(2)
  $core.bool hasResumeMarker() => $_has(1);
  @$pb.TagNumber(2)
  void clearResumeMarker() => $_clearField(2);
}
...
class ChangeBatch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.watcher.v1'),
      createEmptyInstance: create)
    ..pPM<Change>(1, _omitFieldNames ? '' : 'changes',
  ...
  @$pb.TagNumber(1)
  $pb.PbList<Change> get changes => $_getList(0);
}
...
class Change extends $pb.GeneratedMessage {
  factory Change({
    ...
    if (resumeMarker != null) result.resumeMarker = resumeMarker;
    if (continued != null) result.continued = continued;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<Change_State>(2, _omitFieldNames ? '' : 'state',
  ...
  @$pb.TagNumber(2)
  set state(Change_State value) => $_setField(2, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set resumeMarker($core.List<$core.int> value) => $_setBytes(2, value);
  @$pb.TagNumber(4)
  $core.bool hasResumeMarker() => $_has(2);
  @$pb.TagNumber(4)
  void clearResumeMarker() => $_clearField(4);
  ...
  @$pb.TagNumber(5)
  set continued($core.bool value) => $_setBool(3, value);
  @$pb.TagNumber(5)
  $core.bool hasContinued() => $_has(3);
  @$pb.TagNumber(5)
  void clearContinued() => $_clearField(5);
  ...
  @$pb.TagNumber(6)
  set data($1.Any value) => $_setField(6, value);
  @$pb.TagNumber(6)
