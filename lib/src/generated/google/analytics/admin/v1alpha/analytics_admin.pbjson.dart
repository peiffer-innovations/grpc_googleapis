...
@$core.Deprecated('Use getWebDataStreamRequestDescriptor instead')
const GetWebDataStreamRequest$json = const {
  '1': 'GetWebDataStreamRequest',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
  ],
};

/// Descriptor for `GetWebDataStreamRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getWebDataStreamRequestDescriptor =
    $convert.base64Decode(
        'ChdHZXRXZWJEYXRhU3RyZWFtUmVxdWVzdBJHCgRuYW1lGAEgASgJQjPgQQL6QS0KK2FuYWx5dGljc2FkbWluLmdvb2dsZWFwaXMuY29tL1dlYkRhdGFTdHJlYW1SBG5hbWU=');
@$core.Deprecated('Use deleteWebDataStreamRequestDescriptor instead')
const DeleteWebDataStreamRequest$json = const {
  '1': 'DeleteWebDataStreamRequest',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
  ],
};

/// Descriptor for `DeleteWebDataStreamRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteWebDataStreamRequestDescriptor =
    $convert.base64Decode(
        'ChpEZWxldGVXZWJEYXRhU3RyZWFtUmVxdWVzdBJHCgRuYW1lGAEgASgJQjPgQQL6QS0KK2FuYWx5dGljc2FkbWluLmdvb2dsZWFwaXMuY29tL1dlYkRhdGFTdHJlYW1SBG5hbWU=');
@$core.Deprecated('Use updateWebDataStreamRequestDescriptor instead')
const UpdateWebDataStreamRequest$json = const {
  '1': 'UpdateWebDataStreamRequest',
  '2': const [
    const {
      '1': 'web_data_stream',
      '3': 1,
...
/// Descriptor for `UpdateWebDataStreamRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateWebDataStreamRequestDescriptor =
    $convert.base64Decode(
        'ChpVcGRhdGVXZWJEYXRhU3RyZWFtUmVxdWVzdBJaCg93ZWJfZGF0YV9zdHJlYW0YASABKAsyLS5nb29nbGUuYW5hbHl0aWNzLmFkbWluLnYxYWxwaGEuV2ViRGF0YVN0cmVhbUID4EECUg13ZWJEYXRhU3RyZWFtEkAKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza0ID4EECUgp1cGRhdGVNYXNr');
@$core.Deprecated('Use createWebDataStreamRequestDescriptor instead')
const CreateWebDataStreamRequest$json = const {
  '1': 'CreateWebDataStreamRequest',
  '2': const [
    const {
      '1': 'web_data_stream',
      '3': 1,
...
/// Descriptor for `CreateWebDataStreamRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createWebDataStreamRequestDescriptor =
    $convert.base64Decode(
        '');
@$core.Deprecated('Use listWebDataStreamsRequestDescriptor instead')
const ListWebDataStreamsRequest$json = const {
  '1': 'ListWebDataStreamsRequest',
  '2': const [
    const {
      '1': 'parent',
      '3': 1,
...
/// Descriptor for `ListWebDataStreamsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listWebDataStreamsRequestDescriptor =
    $convert.base64Decode(
        'ChlMaXN0V2ViRGF0YVN0cmVhbXNSZXF1ZXN0EksKBnBhcmVudBgBIAEoCUIz4EEC+kEtEithbmFseXRpY3NhZG1pbi5nb29nbGVhcGlzLmNvbS9XZWJEYXRhU3RyZWFtUgZwYXJlbnQSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
@$core.Deprecated('Use listWebDataStreamsResponseDescriptor instead')
const ListWebDataStreamsResponse$json = const {
  '1': 'ListWebDataStreamsResponse',
  '2': const [
    const {
      '1': 'web_data_streams',
      '3': 1,
...
/// Descriptor for `ListWebDataStreamsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listWebDataStreamsResponseDescriptor =
    $convert.base64Decode(
        'ChpMaXN0V2ViRGF0YVN0cmVhbXNSZXNwb25zZRJXChB3ZWJfZGF0YV9zdHJlYW1zGAEgAygLMi0uZ29vZ2xlLmFuYWx5dGljcy5hZG1pbi52MWFscGhhLldlYkRhdGFTdHJlYW1SDndlYkRhdGFTdHJlYW1zEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
@$core.Deprecated('Use getIosAppDataStreamRequestDescriptor instead')
const GetIosAppDataStreamRequest$json = const {
  '1': 'GetIosAppDataStreamRequest',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
  ],
};

/// Descriptor for `GetIosAppDataStreamRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getIosAppDataStreamRequestDescriptor =
    $convert.base64Decode(
        'ChpHZXRJb3NBcHBEYXRhU3RyZWFtUmVxdWVzdBJKCgRuYW1lGAEgASgJQjbgQQL6QTAKLmFuYWx5dGljc2FkbWluLmdvb2dsZWFwaXMuY29tL0lvc0FwcERhdGFTdHJlYW1SBG5hbWU=');
@$core.Deprecated('Use deleteIosAppDataStreamRequestDescriptor instead')
const DeleteIosAppDataStreamRequest$json = const {
  '1': 'DeleteIosAppDataStreamRequest',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
  ],
};

/// Descriptor for `DeleteIosAppDataStreamRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteIosAppDataStreamRequestDescriptor =
    $convert.base64Decode(
        'Ch1EZWxldGVJb3NBcHBEYXRhU3RyZWFtUmVxdWVzdBJKCgRuYW1lGAEgASgJQjbgQQL6QTAKLmFuYWx5dGljc2FkbWluLmdvb2dsZWFwaXMuY29tL0lvc0FwcERhdGFTdHJlYW1SBG5hbWU=');
@$core.Deprecated('Use updateIosAppDataStreamRequestDescriptor instead')
const UpdateIosAppDataStreamRequest$json = const {
  '1': 'UpdateIosAppDataStreamRequest',
  '2': const [
    const {
...
/// Descriptor for `UpdateIosAppDataStreamRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateIosAppDataStreamRequestDescriptor =
    $convert.base64Decode(
        '');
@$core.Deprecated('Use listIosAppDataStreamsRequestDescriptor instead')
const ListIosAppDataStreamsRequest$json = const {
  '1': 'ListIosAppDataStreamsRequest',
  '2': const [
    const {
      '1': 'parent',
      '3': 1,
...
/// Descriptor for `ListIosAppDataStreamsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listIosAppDataStreamsRequestDescriptor =
    $convert.base64Decode(
        'ChxMaXN0SW9zQXBwRGF0YVN0cmVhbXNSZXF1ZXN0Ek4KBnBhcmVudBgBIAEoCUI24EEC+kEwEi5hbmFseXRpY3NhZG1pbi5nb29nbGVhcGlzLmNvbS9Jb3NBcHBEYXRhU3RyZWFtUgZwYXJlbnQSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
@$core.Deprecated('Use listIosAppDataStreamsResponseDescriptor instead')
const ListIosAppDataStreamsResponse$json = const {
  '1': 'ListIosAppDataStreamsResponse',
  '2': const [
    const {
      '1': 'ios_app_data_streams',
      '3': 1,
      '4': 3,
      '5': 11,
      '6': '.google.analytics.admin.v1alpha.IosAppDataStream',
      '10': 'iosAppDataStreams'
    },
    const {
      '1': 'next_page_token',
      '3': 2,
...
/// Descriptor for `ListIosAppDataStreamsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listIosAppDataStreamsResponseDescriptor =
    $convert.base64Decode(
        'Ch1MaXN0SW9zQXBwRGF0YVN0cmVhbXNSZXNwb25zZRJhChRpb3NfYXBwX2RhdGFfc3RyZWFtcxgBIAMoCzIwLmdvb2dsZS5hbmFseXRpY3MuYWRtaW4udjFhbHBoYS5Jb3NBcHBEYXRhU3RyZWFtUhFpb3NBcHBEYXRhU3RyZWFtcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
@$core.Deprecated('Use getAndroidAppDataStreamRequestDescriptor instead')
const GetAndroidAppDataStreamRequest$json = const {
  '1': 'GetAndroidAppDataStreamRequest',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
  ],
};

/// Descriptor for `GetAndroidAppDataStreamRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getAndroidAppDataStreamRequestDescriptor =
    $convert.base64Decode(
        'Ch5HZXRBbmRyb2lkQXBwRGF0YVN0cmVhbVJlcXVlc3QSTgoEbmFtZRgBIAEoCUI64EEC+kE0CjJhbmFseXRpY3NhZG1pbi5nb29nbGVhcGlzLmNvbS9BbmRyb2lkQXBwRGF0YVN0cmVhbVIEbmFtZQ==');
@$core.Deprecated('Use deleteAndroidAppDataStreamRequestDescriptor instead')
const DeleteAndroidAppDataStreamRequest$json = const {
  '1': 'DeleteAndroidAppDataStreamRequest',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
  ],
};

/// Descriptor for `DeleteAndroidAppDataStreamRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteAndroidAppDataStreamRequestDescriptor =
    $convert.base64Decode(
        'CiFEZWxldGVBbmRyb2lkQXBwRGF0YVN0cmVhbVJlcXVlc3QSTgoEbmFtZRgBIAEoCUI64EEC+kE0CjJhbmFseXRpY3NhZG1pbi5nb29nbGVhcGlzLmNvbS9BbmRyb2lkQXBwRGF0YVN0cmVhbVIEbmFtZQ==');
@$core.Deprecated('Use updateAndroidAppDataStreamRequestDescriptor instead')
const UpdateAndroidAppDataStreamRequest$json = const {
  '1': 'UpdateAndroidAppDataStreamRequest',
  '2': const [
    const {
...
/// Descriptor for `UpdateAndroidAppDataStreamRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateAndroidAppDataStreamRequestDescriptor =
    $convert.base64Decode(
        '');
@$core.Deprecated('Use listAndroidAppDataStreamsRequestDescriptor instead')
const ListAndroidAppDataStreamsRequest$json = const {
  '1': 'ListAndroidAppDataStreamsRequest',
  '2': const [
    const {
      '1': 'parent',
      '3': 1,
...
/// Descriptor for `ListAndroidAppDataStreamsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listAndroidAppDataStreamsRequestDescriptor =
    $convert.base64Decode(
        'CiBMaXN0QW5kcm9pZEFwcERhdGFTdHJlYW1zUmVxdWVzdBJSCgZwYXJlbnQYASABKAlCOuBBAvpBNBIyYW5hbHl0aWNzYWRtaW4uZ29vZ2xlYXBpcy5jb20vQW5kcm9pZEFwcERhdGFTdHJlYW1SBnBhcmVudBIbCglwYWdlX3NpemUYAiABKAVSCHBhZ2VTaXplEh0KCnBhZ2VfdG9rZW4YAyABKAlSCXBhZ2VUb2tlbg==');
@$core.Deprecated('Use listAndroidAppDataStreamsResponseDescriptor instead')
const ListAndroidAppDataStreamsResponse$json = const {
  '1': 'ListAndroidAppDataStreamsResponse',
  '2': const [
    const {
      '1': 'android_app_data_streams',
      '3': 1,
      '4': 3,
      '5': 11,
      '6': '.google.analytics.admin.v1alpha.AndroidAppDataStream',
      '10': 'androidAppDataStreams'
    },
    const {
      '1': 'next_page_token',
      '3': 2,
...
/// Descriptor for `ListAndroidAppDataStreamsResponse`. Decode as a `google.protobuf.DescriptorProto`.
