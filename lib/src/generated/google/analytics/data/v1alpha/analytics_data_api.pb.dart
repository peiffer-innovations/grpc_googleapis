...
class CreateRecurringAudienceListRequest extends $pb.GeneratedMessage {
  ...
  factory CreateRecurringAudienceListRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CreateRecurringAudienceListRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  CreateRecurringAudienceListRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  set recurringAudienceList(RecurringAudienceList value) =>
      $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasRecurringAudienceList() => $_has(1);
  @$pb.TagNumber(2)
  void clearRecurringAudienceList() => $_clearField(2);
  @$pb.TagNumber(2)
...
class RecurringAudienceList extends $pb.GeneratedMessage {
  factory RecurringAudienceList({
    ...
    if (audienceLists != null) result.audienceLists.addAll(audienceLists);
    if (webhookNotification != null)
      result.webhookNotification = webhookNotification;
    return result;
  }

  RecurringAudienceList._();

  factory RecurringAudienceList.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RecurringAudienceList.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<AudienceDimension>(4, _omitFieldNames ? '' : 'dimensions',
        subBuilder: AudienceDimension.create)
    ..aI(5, _omitFieldNames ? '' : 'activeDaysRemaining')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RecurringAudienceList clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(3)
  set audienceDisplayName($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasAudienceDisplayName() => $_has(2);
  @$pb.TagNumber(3)
  void clearAudienceDisplayName() => $_clearField(3);

  /// Required. The dimensions requested and displayed in the audience list
  /// response.
  @$pb.TagNumber(4)
  $pb.PbList<AudienceDimension> get dimensions => $_getList(3);
  ...
  @$pb.TagNumber(5)
  set activeDaysRemaining($core.int value) => $_setSignedInt32(4, value);
  @$pb.TagNumber(5)
  $core.bool hasActiveDaysRemaining() => $_has(4);
  @$pb.TagNumber(5)
  void clearActiveDaysRemaining() => $_clearField(5);
  ...
  @$pb.TagNumber(6)
  $pb.PbList<$core.String> get audienceLists => $_getList(5);
  ...
  @$pb.TagNumber(8)
  set webhookNotification(WebhookNotification value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasWebhookNotification() => $_has(6);
  @$pb.TagNumber(8)
  void clearWebhookNotification() => $_clearField(8);
  @$pb.TagNumber(8)
...
class WebhookNotification extends $pb.GeneratedMessage {
  factory WebhookNotification({
    ...
    if (channelToken != null) result.channelToken = channelToken;
    return result;
  }

  WebhookNotification._();

  factory WebhookNotification.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory WebhookNotification.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  WebhookNotification clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  set channelToken($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasChannelToken() => $_has(1);
  @$pb.TagNumber(2)
  void clearChannelToken() => $_clearField(2);
}
...
class GetRecurringAudienceListRequest extends $pb.GeneratedMessage {
  ...
  factory GetRecurringAudienceListRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetRecurringAudienceListRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetRecurringAudienceListRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListRecurringAudienceListsRequest extends $pb.GeneratedMessage {
  ...
  factory ListRecurringAudienceListsRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListRecurringAudienceListsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListRecurringAudienceListsRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListRecurringAudienceListsResponse extends $pb.GeneratedMessage {
  ...
  factory ListRecurringAudienceListsResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListRecurringAudienceListsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1alpha'),
      createEmptyInstance: create)
    ..pPM<RecurringAudienceList>(
        1, _omitFieldNames ? '' : 'recurringAudienceLists',
        subBuilder: RecurringAudienceList.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListRecurringAudienceListsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<RecurringAudienceList> get recurringAudienceLists => $_getList(0);
...
class GetPropertyQuotasSnapshotRequest extends $pb.GeneratedMessage {
  ...
  factory GetPropertyQuotasSnapshotRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetPropertyQuotasSnapshotRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetPropertyQuotasSnapshotRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class PropertyQuotasSnapshot extends $pb.GeneratedMessage {
  factory PropertyQuotasSnapshot({
    $2.PropertyQuota? corePropertyQuota,
    $2.PropertyQuota? realtimePropertyQuota,
    $2.PropertyQuota? funnelPropertyQuota,
    $core.String? name,
  }) {
    final result = create();
    if (corePropertyQuota != null) result.corePropertyQuota = corePropertyQuota;
  ...
  PropertyQuotasSnapshot._();

  factory PropertyQuotasSnapshot.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory PropertyQuotasSnapshot.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1alpha'),
      createEmptyInstance: create)
    ..aOM<$2.PropertyQuota>(1, _omitFieldNames ? '' : 'corePropertyQuota',
        subBuilder: $2.PropertyQuota.create)
    ..aOM<$2.PropertyQuota>(2, _omitFieldNames ? '' : 'realtimePropertyQuota',
        subBuilder: $2.PropertyQuota.create)
    ..aOM<$2.PropertyQuota>(3, _omitFieldNames ? '' : 'funnelPropertyQuota',
        subBuilder: $2.PropertyQuota.create)
    ..aOS(4, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PropertyQuotasSnapshot clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $2.PropertyQuota get corePropertyQuota => $_getN(0);
  @$pb.TagNumber(1)
  set corePropertyQuota($2.PropertyQuota value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasCorePropertyQuota() => $_has(0);
  @$pb.TagNumber(1)
  void clearCorePropertyQuota() => $_clearField(1);
  @$pb.TagNumber(1)
  $2.PropertyQuota ensureCorePropertyQuota() => $_ensure(0);

  /// Property Quota for realtime property tokens
  @$pb.TagNumber(2)
  $2.PropertyQuota get realtimePropertyQuota => $_getN(1);
  @$pb.TagNumber(2)
  set realtimePropertyQuota($2.PropertyQuota value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasRealtimePropertyQuota() => $_has(1);
  @$pb.TagNumber(2)
  void clearRealtimePropertyQuota() => $_clearField(2);
  @$pb.TagNumber(2)
  $2.PropertyQuota ensureRealtimePropertyQuota() => $_ensure(1);

  /// Property Quota for funnel property tokens
  @$pb.TagNumber(3)
  $2.PropertyQuota get funnelPropertyQuota => $_getN(2);
  @$pb.TagNumber(3)
  set funnelPropertyQuota($2.PropertyQuota value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasFunnelPropertyQuota() => $_has(2);
  @$pb.TagNumber(3)
  void clearFunnelPropertyQuota() => $_clearField(3);
  @$pb.TagNumber(3)
  $2.PropertyQuota ensureFunnelPropertyQuota() => $_ensure(2);
...
class GetAudienceListRequest extends $pb.GeneratedMessage {
  ...
  GetAudienceListRequest._();

  factory GetAudienceListRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetAudienceListRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetAudienceListRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListAudienceListsRequest extends $pb.GeneratedMessage {
  ...
  ListAudienceListsRequest._();

  factory ListAudienceListsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListAudienceListsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListAudienceListsRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListAudienceListsResponse extends $pb.GeneratedMessage {
  ...
  ListAudienceListsResponse._();

  factory ListAudienceListsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListAudienceListsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1alpha'),
      createEmptyInstance: create)
    ..pPM<AudienceList>(1, _omitFieldNames ? '' : 'audienceLists',
        subBuilder: AudienceList.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListAudienceListsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<AudienceList> get audienceLists => $_getList(0);
...
class CreateAudienceListRequest extends $pb.GeneratedMessage {
  factory CreateAudienceListRequest({
    ...
    final result = create();
    if (parent != null) result.parent = parent;
    if (audienceList != null) result.audienceList = audienceList;
    return result;
  }

  CreateAudienceListRequest._();

  factory CreateAudienceListRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CreateAudienceListRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CreateAudienceListRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  set audienceList(AudienceList value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasAudienceList() => $_has(1);
  @$pb.TagNumber(2)
  void clearAudienceList() => $_clearField(2);
  @$pb.TagNumber(2)
...
class AudienceList extends $pb.GeneratedMessage {
  factory AudienceList({
    ...
    if (beginCreatingTime != null) result.beginCreatingTime = beginCreatingTime;
  ...
  factory AudienceList.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AudienceList.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<AudienceDimension>(4, _omitFieldNames ? '' : 'dimensions',
        subBuilder: AudienceDimension.create)
    ..aE<AudienceList_State>(5, _omitFieldNames ? '' : 'state',
        enumValues: AudienceList_State.values)
    ..aOM<$3.Timestamp>(6, _omitFieldNames ? '' : 'beginCreatingTime',
        subBuilder: $3.Timestamp.create)
    ..aI(7, _omitFieldNames ? '' : 'creationQuotaTokensCharged')
    ..aI(8, _omitFieldNames ? '' : 'rowCount')
    ..aOS(9, _omitFieldNames ? '' : 'errorMessage')
    ..aD(11, _omitFieldNames ? '' : 'percentageCompleted')
  ...
  @$pb.TagNumber(5)
  set state(AudienceList_State value) => $_setField(5, value);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $3.Timestamp get beginCreatingTime => $_getN(5);
  @$pb.TagNumber(6)
  set beginCreatingTime($3.Timestamp value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasBeginCreatingTime() => $_has(5);
  @$pb.TagNumber(6)
  void clearBeginCreatingTime() => $_clearField(6);
  @$pb.TagNumber(6)
  $3.Timestamp ensureBeginCreatingTime() => $_ensure(5);
  ...
  @$pb.TagNumber(7)
  set creationQuotaTokensCharged($core.int value) => $_setSignedInt32(6, value);
  @$pb.TagNumber(7)
  $core.bool hasCreationQuotaTokensCharged() => $_has(6);
  @$pb.TagNumber(7)
  void clearCreationQuotaTokensCharged() => $_clearField(7);

  /// Output only. The total number of rows in the AudienceList result.
  @$pb.TagNumber(8)
  $core.int get rowCount => $_getIZ(7);
  @$pb.TagNumber(8)
  set rowCount($core.int value) => $_setSignedInt32(7, value);
  @$pb.TagNumber(8)
  $core.bool hasRowCount() => $_has(7);
  @$pb.TagNumber(8)
  void clearRowCount() => $_clearField(8);
  ...
  @$pb.TagNumber(11)
  set percentageCompleted($core.double value) => $_setDouble(9, value);
  @$pb.TagNumber(11)
  $core.bool hasPercentageCompleted() => $_has(9);
  @$pb.TagNumber(11)
  void clearPercentageCompleted() => $_clearField(11);
  ...
  @$pb.TagNumber(12)
  set recurringAudienceList($core.String value) => $_setString(10, value);
  @$pb.TagNumber(12)
  $core.bool hasRecurringAudienceList() => $_has(10);
  @$pb.TagNumber(12)
  void clearRecurringAudienceList() => $_clearField(12);
  ...
  @$pb.TagNumber(13)
  set webhookNotification(WebhookNotification value) => $_setField(13, value);
  @$pb.TagNumber(13)
  $core.bool hasWebhookNotification() => $_has(11);
  @$pb.TagNumber(13)
  void clearWebhookNotification() => $_clearField(13);
  @$pb.TagNumber(13)
...
class AudienceListMetadata extends $pb.GeneratedMessage {
  ...
  AudienceListMetadata._();

  factory AudienceListMetadata.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AudienceListMetadata.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AudienceListMetadata clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class QueryAudienceListRequest extends $pb.GeneratedMessage {
  ...
  QueryAudienceListRequest._();

  factory QueryAudienceListRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QueryAudienceListRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  QueryAudienceListRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class QueryAudienceListResponse extends $pb.GeneratedMessage {
  factory QueryAudienceListResponse({
    ...
    final result = create();
    if (audienceList != null) result.audienceList = audienceList;
    if (audienceRows != null) result.audienceRows.addAll(audienceRows);
    if (rowCount != null) result.rowCount = rowCount;
    return result;
  }

  QueryAudienceListResponse._();

  factory QueryAudienceListResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QueryAudienceListResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<AudienceList>(1, _omitFieldNames ? '' : 'audienceList',
        subBuilder: AudienceList.create)
    ..pPM<AudienceRow>(2, _omitFieldNames ? '' : 'audienceRows',
        subBuilder: AudienceRow.create)
    ..aI(3, _omitFieldNames ? '' : 'rowCount')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  QueryAudienceListResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set audienceList(AudienceList value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasAudienceList() => $_has(0);
  @$pb.TagNumber(1)
  void clearAudienceList() => $_clearField(1);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $pb.PbList<AudienceRow> get audienceRows => $_getList(1);
...
class SheetExportAudienceListRequest extends $pb.GeneratedMessage {
  ...
  factory SheetExportAudienceListRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory SheetExportAudienceListRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SheetExportAudienceListRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class SheetExportAudienceListResponse extends $pb.GeneratedMessage {
  factory SheetExportAudienceListResponse({
    ...
    final result = create();
    if (spreadsheetUri != null) result.spreadsheetUri = spreadsheetUri;
    if (spreadsheetId != null) result.spreadsheetId = spreadsheetId;
    if (rowCount != null) result.rowCount = rowCount;
    if (audienceList != null) result.audienceList = audienceList;
    return result;
  }
  ...
  factory SheetExportAudienceListResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory SheetExportAudienceListResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SheetExportAudienceListResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set spreadsheetUri($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
  $core.bool hasSpreadsheetUri() => $_has(0);
  @$pb.TagNumber(1)
  void clearSpreadsheetUri() => $_clearField(1);

  /// An ID that identifies the created Google Sheet resource.
  @$pb.TagNumber(2)
  $core.String get spreadsheetId => $_getSZ(1);
  @$pb.TagNumber(2)
  set spreadsheetId($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasSpreadsheetId() => $_has(1);
  @$pb.TagNumber(2)
  void clearSpreadsheetId() => $_clearField(2);
  ...
  @$pb.TagNumber(4)
  set audienceList(AudienceList value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasAudienceList() => $_has(3);
  @$pb.TagNumber(4)
  void clearAudienceList() => $_clearField(4);
  @$pb.TagNumber(4)
...
class AudienceRow extends $pb.GeneratedMessage {
  ...
  factory AudienceRow.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AudienceRow.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1alpha'),
      createEmptyInstance: create)
    ..pPM<AudienceDimensionValue>(1, _omitFieldNames ? '' : 'dimensionValues',
        subBuilder: AudienceDimensionValue.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AudienceRow clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<AudienceDimensionValue> get dimensionValues => $_getList(0);
}
...
class AudienceDimension extends $pb.GeneratedMessage {
  ...
  factory AudienceDimension.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AudienceDimension.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AudienceDimension clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class AudienceDimensionValue extends $pb.GeneratedMessage {
  ...
  AudienceDimensionValue._();

  factory AudienceDimensionValue.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AudienceDimensionValue.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AudienceDimensionValue clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class RunFunnelReportRequest extends $pb.GeneratedMessage {
  factory RunFunnelReportRequest({
    ...
    $core.Iterable<$2.DateRange>? dateRanges,
    $2.Funnel? funnel,
    $2.FunnelBreakdown? funnelBreakdown,
    $2.FunnelNextAction? funnelNextAction,
    RunFunnelReportRequest_FunnelVisualizationType? funnelVisualizationType,
    $core.Iterable<$2.Segment>? segments,
    $fixnum.Int64? limit,
    $2.FilterExpression? dimensionFilter,
    ...
    if (funnelBreakdown != null) result.funnelBreakdown = funnelBreakdown;
    if (funnelNextAction != null) result.funnelNextAction = funnelNextAction;
  ...
  RunFunnelReportRequest._();

  factory RunFunnelReportRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RunFunnelReportRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<$2.DateRange>(2, _omitFieldNames ? '' : 'dateRanges',
        subBuilder: $2.DateRange.create)
    ..aOM<$2.Funnel>(3, _omitFieldNames ? '' : 'funnel',
        subBuilder: $2.Funnel.create)
    ..aOM<$2.FunnelBreakdown>(4, _omitFieldNames ? '' : 'funnelBreakdown',
        subBuilder: $2.FunnelBreakdown.create)
    ..aOM<$2.FunnelNextAction>(5, _omitFieldNames ? '' : 'funnelNextAction',
        subBuilder: $2.FunnelNextAction.create)
    ..aE<RunFunnelReportRequest_FunnelVisualizationType>(
        6, _omitFieldNames ? '' : 'funnelVisualizationType',
        enumValues: RunFunnelReportRequest_FunnelVisualizationType.values)
    ..pPM<$2.Segment>(7, _omitFieldNames ? '' : 'segments',
        subBuilder: $2.Segment.create)
    ..aInt64(9, _omitFieldNames ? '' : 'limit')
    ..aOM<$2.FilterExpression>(10, _omitFieldNames ? '' : 'dimensionFilter',
        subBuilder: $2.FilterExpression.create)
    ..aOB(12, _omitFieldNames ? '' : 'returnPropertyQuota')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RunFunnelReportRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  $pb.PbList<$2.DateRange> get dateRanges => $_getList(1);

  /// Optional. The configuration of this request's funnel. This funnel
  /// configuration is required.
  @$pb.TagNumber(3)
  $2.Funnel get funnel => $_getN(2);
  @$pb.TagNumber(3)
  set funnel($2.Funnel value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasFunnel() => $_has(2);
  @$pb.TagNumber(3)
  void clearFunnel() => $_clearField(3);
  @$pb.TagNumber(3)
  $2.Funnel ensureFunnel() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $2.FunnelBreakdown get funnelBreakdown => $_getN(3);
  @$pb.TagNumber(4)
  set funnelBreakdown($2.FunnelBreakdown value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasFunnelBreakdown() => $_has(3);
  @$pb.TagNumber(4)
  void clearFunnelBreakdown() => $_clearField(4);
  @$pb.TagNumber(4)
  $2.FunnelBreakdown ensureFunnelBreakdown() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $2.FunnelNextAction get funnelNextAction => $_getN(4);
  @$pb.TagNumber(5)
  set funnelNextAction($2.FunnelNextAction value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasFunnelNextAction() => $_has(4);
  @$pb.TagNumber(5)
  void clearFunnelNextAction() => $_clearField(5);
  @$pb.TagNumber(5)
  $2.FunnelNextAction ensureFunnelNextAction() => $_ensure(4);
  ...
  set funnelVisualizationType(
          RunFunnelReportRequest_FunnelVisualizationType value) =>
      $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasFunnelVisualizationType() => $_has(5);
  @$pb.TagNumber(6)
  void clearFunnelVisualizationType() => $_clearField(6);
  ...
  @$pb.TagNumber(7)
  $pb.PbList<$2.Segment> get segments => $_getList(6);
  ...
  @$pb.TagNumber(10)
  $2.FilterExpression get dimensionFilter => $_getN(8);
  @$pb.TagNumber(10)
  set dimensionFilter($2.FilterExpression value) => $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasDimensionFilter() => $_has(8);
  @$pb.TagNumber(10)
  void clearDimensionFilter() => $_clearField(10);
  @$pb.TagNumber(10)
  $2.FilterExpression ensureDimensionFilter() => $_ensure(8);
  ...
  @$pb.TagNumber(12)
  set returnPropertyQuota($core.bool value) => $_setBool(9, value);
  @$pb.TagNumber(12)
  $core.bool hasReturnPropertyQuota() => $_has(9);
  @$pb.TagNumber(12)
  void clearReturnPropertyQuota() => $_clearField(12);
}
...
class RunFunnelReportResponse extends $pb.GeneratedMessage {
  factory RunFunnelReportResponse({
    $2.FunnelSubReport? funnelTable,
    $2.FunnelSubReport? funnelVisualization,
    $2.PropertyQuota? propertyQuota,
    $core.String? kind,
  }) {
    final result = create();
    if (funnelTable != null) result.funnelTable = funnelTable;
    if (funnelVisualization != null)
      result.funnelVisualization = funnelVisualization;
    if (propertyQuota != null) result.propertyQuota = propertyQuota;
    if (kind != null) result.kind = kind;
    return result;
  }

  RunFunnelReportResponse._();

  factory RunFunnelReportResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RunFunnelReportResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1alpha'),
      createEmptyInstance: create)
    ..aOM<$2.FunnelSubReport>(1, _omitFieldNames ? '' : 'funnelTable',
        subBuilder: $2.FunnelSubReport.create)
    ..aOM<$2.FunnelSubReport>(2, _omitFieldNames ? '' : 'funnelVisualization',
        subBuilder: $2.FunnelSubReport.create)
    ..aOM<$2.PropertyQuota>(3, _omitFieldNames ? '' : 'propertyQuota',
        subBuilder: $2.PropertyQuota.create)
    ..aOS(4, _omitFieldNames ? '' : 'kind')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RunFunnelReportResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  /// was requested.
  @$pb.TagNumber(1)
  $2.FunnelSubReport get funnelTable => $_getN(0);
  @$pb.TagNumber(1)
  set funnelTable($2.FunnelSubReport value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasFunnelTable() => $_has(0);
  @$pb.TagNumber(1)
  void clearFunnelTable() => $_clearField(1);
  @$pb.TagNumber(1)
  $2.FunnelSubReport ensureFunnelTable() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $2.FunnelSubReport get funnelVisualization => $_getN(1);
  @$pb.TagNumber(2)
  set funnelVisualization($2.FunnelSubReport value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasFunnelVisualization() => $_has(1);
  @$pb.TagNumber(2)
  void clearFunnelVisualization() => $_clearField(2);
  @$pb.TagNumber(2)
  $2.FunnelSubReport ensureFunnelVisualization() => $_ensure(1);

  /// This Analytics Property's quota state including this request.
  @$pb.TagNumber(3)
  $2.PropertyQuota get propertyQuota => $_getN(2);
  @$pb.TagNumber(3)
  set propertyQuota($2.PropertyQuota value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasPropertyQuota() => $_has(2);
  @$pb.TagNumber(3)
  void clearPropertyQuota() => $_clearField(3);
  @$pb.TagNumber(3)
  $2.PropertyQuota ensurePropertyQuota() => $_ensure(2);
...
class ReportTask_ReportDefinition extends $pb.GeneratedMessage {
  factory ReportTask_ReportDefinition({
    $core.Iterable<$2.Dimension>? dimensions,
    $core.Iterable<$2.Metric>? metrics,
    $core.Iterable<$2.DateRange>? dateRanges,
    $2.FilterExpression? dimensionFilter,
    $2.FilterExpression? metricFilter,
    $fixnum.Int64? offset,
    $fixnum.Int64? limit,
    $core.Iterable<$2.MetricAggregation>? metricAggregations,
    $core.Iterable<$2.OrderBy>? orderBys,
    $core.String? currencyCode,
    $2.CohortSpec? cohortSpec,
    $core.bool? keepEmptyRows,
    $2.SamplingLevel? samplingLevel,
  }) {
    final result = create();
    if (dimensions != null) result.dimensions.addAll(dimensions);
    ...
    if (cohortSpec != null) result.cohortSpec = cohortSpec;
    if (keepEmptyRows != null) result.keepEmptyRows = keepEmptyRows;
    if (samplingLevel != null) result.samplingLevel = samplingLevel;
    return result;
  }

  ReportTask_ReportDefinition._();

  factory ReportTask_ReportDefinition.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ReportTask_ReportDefinition.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1alpha'),
      createEmptyInstance: create)
    ..pPM<$2.Dimension>(2, _omitFieldNames ? '' : 'dimensions',
        subBuilder: $2.Dimension.create)
    ..pPM<$2.Metric>(3, _omitFieldNames ? '' : 'metrics',
        subBuilder: $2.Metric.create)
    ..pPM<$2.DateRange>(4, _omitFieldNames ? '' : 'dateRanges',
        subBuilder: $2.DateRange.create)
    ..aOM<$2.FilterExpression>(5, _omitFieldNames ? '' : 'dimensionFilter',
        subBuilder: $2.FilterExpression.create)
    ..aOM<$2.FilterExpression>(6, _omitFieldNames ? '' : 'metricFilter',
        subBuilder: $2.FilterExpression.create)
    ..aInt64(7, _omitFieldNames ? '' : 'offset')
    ..aInt64(8, _omitFieldNames ? '' : 'limit')
    ..pc<$2.MetricAggregation>(
        9, _omitFieldNames ? '' : 'metricAggregations', $pb.PbFieldType.KE,
        valueOf: $2.MetricAggregation.valueOf,
        enumValues: $2.MetricAggregation.values,
        defaultEnumValue: $2.MetricAggregation.METRIC_AGGREGATION_UNSPECIFIED)
    ..pPM<$2.OrderBy>(10, _omitFieldNames ? '' : 'orderBys',
        subBuilder: $2.OrderBy.create)
    ..aOS(11, _omitFieldNames ? '' : 'currencyCode')
    ..aOM<$2.CohortSpec>(12, _omitFieldNames ? '' : 'cohortSpec',
        subBuilder: $2.CohortSpec.create)
    ..aOB(13, _omitFieldNames ? '' : 'keepEmptyRows')
    ..aE<$2.SamplingLevel>(14, _omitFieldNames ? '' : 'samplingLevel',
        enumValues: $2.SamplingLevel.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReportTask_ReportDefinition clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  $pb.PbList<$2.Dimension> get dimensions => $_getList(0);

  /// Optional. The metrics requested and displayed.
  @$pb.TagNumber(3)
  $pb.PbList<$2.Metric> get metrics => $_getList(1);
  ...
  @$pb.TagNumber(4)
  $pb.PbList<$2.DateRange> get dateRanges => $_getList(2);
  ...
  /// for examples. Metrics cannot be used in this filter.
  @$pb.TagNumber(5)
  $2.FilterExpression get dimensionFilter => $_getN(3);
  @$pb.TagNumber(5)
  set dimensionFilter($2.FilterExpression value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasDimensionFilter() => $_has(3);
  @$pb.TagNumber(5)
  void clearDimensionFilter() => $_clearField(5);
  @$pb.TagNumber(5)
  $2.FilterExpression ensureDimensionFilter() => $_ensure(3);
  ...
  /// this filter.
  @$pb.TagNumber(6)
  $2.FilterExpression get metricFilter => $_getN(4);
  @$pb.TagNumber(6)
  set metricFilter($2.FilterExpression value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasMetricFilter() => $_has(4);
  @$pb.TagNumber(6)
  void clearMetricFilter() => $_clearField(6);
  @$pb.TagNumber(6)
  $2.FilterExpression ensureMetricFilter() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  $pb.PbList<$2.MetricAggregation> get metricAggregations => $_getList(7);

  /// Optional. Specifies how rows are ordered in the response.
  @$pb.TagNumber(10)
  $pb.PbList<$2.OrderBy> get orderBys => $_getList(8);
  ...
  @$pb.TagNumber(11)
  set currencyCode($core.String value) => $_setString(9, value);
  @$pb.TagNumber(11)
  $core.bool hasCurrencyCode() => $_has(9);
  @$pb.TagNumber(11)
  void clearCurrencyCode() => $_clearField(11);
  ...
  @$pb.TagNumber(12)
  $2.CohortSpec get cohortSpec => $_getN(10);
  @$pb.TagNumber(12)
  set cohortSpec($2.CohortSpec value) => $_setField(12, value);
  @$pb.TagNumber(12)
  $core.bool hasCohortSpec() => $_has(10);
  @$pb.TagNumber(12)
  void clearCohortSpec() => $_clearField(12);
  @$pb.TagNumber(12)
  $2.CohortSpec ensureCohortSpec() => $_ensure(10);
  ...
  @$pb.TagNumber(13)
  set keepEmptyRows($core.bool value) => $_setBool(11, value);
  @$pb.TagNumber(13)
  $core.bool hasKeepEmptyRows() => $_has(11);
  @$pb.TagNumber(13)
  void clearKeepEmptyRows() => $_clearField(13);

  /// Optional. The report's sampling level.
  @$pb.TagNumber(14)
  $2.SamplingLevel get samplingLevel => $_getN(12);
  @$pb.TagNumber(14)
  set samplingLevel($2.SamplingLevel value) => $_setField(14, value);
  @$pb.TagNumber(14)
  $core.bool hasSamplingLevel() => $_has(12);
  @$pb.TagNumber(14)
  void clearSamplingLevel() => $_clearField(14);
}
...
class ReportTask_ReportMetadata extends $pb.GeneratedMessage {
  factory ReportTask_ReportMetadata({
    ...
    if (creationQuotaTokensCharged != null)
      result.creationQuotaTokensCharged = creationQuotaTokensCharged;
    if (taskRowCount != null) result.taskRowCount = taskRowCount;
    if (errorMessage != null) result.errorMessage = errorMessage;
    if (totalRowCount != null) result.totalRowCount = totalRowCount;
    return result;
  }

  ReportTask_ReportMetadata._();

  factory ReportTask_ReportMetadata.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ReportTask_ReportMetadata.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1alpha'),
      createEmptyInstance: create)
    ..aE<ReportTask_ReportMetadata_State>(1, _omitFieldNames ? '' : 'state',
        enumValues: ReportTask_ReportMetadata_State.values)
    ..aOM<$3.Timestamp>(2, _omitFieldNames ? '' : 'beginCreatingTime',
        subBuilder: $3.Timestamp.create)
    ..aI(3, _omitFieldNames ? '' : 'creationQuotaTokensCharged')
    ..aI(4, _omitFieldNames ? '' : 'taskRowCount')
    ..aOS(5, _omitFieldNames ? '' : 'errorMessage')
    ..aI(6, _omitFieldNames ? '' : 'totalRowCount')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReportTask_ReportMetadata clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set state(ReportTask_ReportMetadata_State value) => $_setField(1, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $3.Timestamp get beginCreatingTime => $_getN(1);
  @$pb.TagNumber(2)
  set beginCreatingTime($3.Timestamp value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasBeginCreatingTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearBeginCreatingTime() => $_clearField(2);
  @$pb.TagNumber(2)
  $3.Timestamp ensureBeginCreatingTime() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  set creationQuotaTokensCharged($core.int value) => $_setSignedInt32(2, value);
  @$pb.TagNumber(3)
  $core.bool hasCreationQuotaTokensCharged() => $_has(2);
  @$pb.TagNumber(3)
  void clearCreationQuotaTokensCharged() => $_clearField(3);
  ...
  @$pb.TagNumber(4)
  set taskRowCount($core.int value) => $_setSignedInt32(3, value);
  @$pb.TagNumber(4)
  $core.bool hasTaskRowCount() => $_has(3);
  @$pb.TagNumber(4)
  void clearTaskRowCount() => $_clearField(4);
  ...
  @$pb.TagNumber(6)
  set totalRowCount($core.int value) => $_setSignedInt32(5, value);
  @$pb.TagNumber(6)
  $core.bool hasTotalRowCount() => $_has(5);
  @$pb.TagNumber(6)
  void clearTotalRowCount() => $_clearField(6);
}
...
class ReportTask extends $pb.GeneratedMessage {
  factory ReportTask({
    ...
    final result = create();
    if (name != null) result.name = name;
    if (reportDefinition != null) result.reportDefinition = reportDefinition;
    if (reportMetadata != null) result.reportMetadata = reportMetadata;
    return result;
  }

  ReportTask._();

  factory ReportTask.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ReportTask.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(2)
  set reportDefinition(ReportTask_ReportDefinition value) =>
      $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasReportDefinition() => $_has(1);
  @$pb.TagNumber(2)
  void clearReportDefinition() => $_clearField(2);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set reportMetadata(ReportTask_ReportMetadata value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasReportMetadata() => $_has(2);
  @$pb.TagNumber(3)
  void clearReportMetadata() => $_clearField(3);
  @$pb.TagNumber(3)
...
class CreateReportTaskRequest extends $pb.GeneratedMessage {
  factory CreateReportTaskRequest({
    ...
    final result = create();
    if (parent != null) result.parent = parent;
    if (reportTask != null) result.reportTask = reportTask;
    return result;
  }

  CreateReportTaskRequest._();

  factory CreateReportTaskRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CreateReportTaskRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CreateReportTaskRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  set reportTask(ReportTask value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasReportTask() => $_has(1);
  @$pb.TagNumber(2)
  void clearReportTask() => $_clearField(2);
  @$pb.TagNumber(2)
...
class ReportTaskMetadata extends $pb.GeneratedMessage {
  ...
  ReportTaskMetadata._();

  factory ReportTaskMetadata.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ReportTaskMetadata.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReportTaskMetadata clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class QueryReportTaskRequest extends $pb.GeneratedMessage {
  ...
  QueryReportTaskRequest._();

  factory QueryReportTaskRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QueryReportTaskRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  QueryReportTaskRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class QueryReportTaskResponse extends $pb.GeneratedMessage {
  factory QueryReportTaskResponse({
    $core.Iterable<$2.DimensionHeader>? dimensionHeaders,
    $core.Iterable<$2.MetricHeader>? metricHeaders,
    $core.Iterable<$2.Row>? rows,
    $core.Iterable<$2.Row>? totals,
    $core.Iterable<$2.Row>? maximums,
    $core.Iterable<$2.Row>? minimums,
    $core.int? rowCount,
    $2.ResponseMetaData? metadata,
  }) {
    final result = create();
    ...
    if (maximums != null) result.maximums.addAll(maximums);
    if (minimums != null) result.minimums.addAll(minimums);
    if (rowCount != null) result.rowCount = rowCount;
    if (metadata != null) result.metadata = metadata;
    return result;
  }

  QueryReportTaskResponse._();

  factory QueryReportTaskResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QueryReportTaskResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1alpha'),
      createEmptyInstance: create)
    ..pPM<$2.DimensionHeader>(1, _omitFieldNames ? '' : 'dimensionHeaders',
        subBuilder: $2.DimensionHeader.create)
    ..pPM<$2.MetricHeader>(2, _omitFieldNames ? '' : 'metricHeaders',
        subBuilder: $2.MetricHeader.create)
    ..pPM<$2.Row>(3, _omitFieldNames ? '' : 'rows', subBuilder: $2.Row.create)
    ..pPM<$2.Row>(4, _omitFieldNames ? '' : 'totals', subBuilder: $2.Row.create)
    ..pPM<$2.Row>(5, _omitFieldNames ? '' : 'maximums',
        subBuilder: $2.Row.create)
    ..pPM<$2.Row>(6, _omitFieldNames ? '' : 'minimums',
        subBuilder: $2.Row.create)
    ..aI(7, _omitFieldNames ? '' : 'rowCount')
    ..aOM<$2.ResponseMetaData>(8, _omitFieldNames ? '' : 'metadata',
        subBuilder: $2.ResponseMetaData.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  QueryReportTaskResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<$2.DimensionHeader> get dimensionHeaders => $_getList(0);

  /// Describes metric columns. The number of MetricHeaders and ordering of
  /// MetricHeaders matches the metrics present in rows.
  @$pb.TagNumber(2)
  $pb.PbList<$2.MetricHeader> get metricHeaders => $_getList(1);

  /// Rows of dimension value combinations and metric values in the report.
  @$pb.TagNumber(3)
  $pb.PbList<$2.Row> get rows => $_getList(2);

  /// If requested, the totaled values of metrics.
  @$pb.TagNumber(4)
  $pb.PbList<$2.Row> get totals => $_getList(3);

  /// If requested, the maximum values of metrics.
  @$pb.TagNumber(5)
  $pb.PbList<$2.Row> get maximums => $_getList(4);

  /// If requested, the minimum values of metrics.
  @$pb.TagNumber(6)
  $pb.PbList<$2.Row> get minimums => $_getList(5);
  ...
  @$pb.TagNumber(8)
  $2.ResponseMetaData get metadata => $_getN(7);
  @$pb.TagNumber(8)
  set metadata($2.ResponseMetaData value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasMetadata() => $_has(7);
  @$pb.TagNumber(8)
  void clearMetadata() => $_clearField(8);
  @$pb.TagNumber(8)
  $2.ResponseMetaData ensureMetadata() => $_ensure(7);
}
...
class GetReportTaskRequest extends $pb.GeneratedMessage {
  ...
  GetReportTaskRequest._();

  factory GetReportTaskRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetReportTaskRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetReportTaskRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListReportTasksRequest extends $pb.GeneratedMessage {
  ...
  ListReportTasksRequest._();

  factory ListReportTasksRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListReportTasksRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListReportTasksRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListReportTasksResponse extends $pb.GeneratedMessage {
  factory ListReportTasksResponse({
    ...
    final result = create();
    if (reportTasks != null) result.reportTasks.addAll(reportTasks);
    if (nextPageToken != null) result.nextPageToken = nextPageToken;
    return result;
  }

  ListReportTasksResponse._();

  factory ListReportTasksResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListReportTasksResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1alpha'),
      createEmptyInstance: create)
    ..pPM<ReportTask>(1, _omitFieldNames ? '' : 'reportTasks',
        subBuilder: ReportTask.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListReportTasksResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<ReportTask> get reportTasks => $_getList(0);
