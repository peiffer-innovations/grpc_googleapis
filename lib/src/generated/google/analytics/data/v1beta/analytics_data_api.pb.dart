...
class CheckCompatibilityRequest extends $pb.GeneratedMessage {
  factory CheckCompatibilityRequest({
    ...
    $2.Compatibility? compatibilityFilter,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.FilterExpression>(4, _omitFieldNames ? '' : 'dimensionFilter',
        subBuilder: $2.FilterExpression.create)
    ..aOM<$2.FilterExpression>(5, _omitFieldNames ? '' : 'metricFilter',
        subBuilder: $2.FilterExpression.create)
    ..aE<$2.Compatibility>(6, _omitFieldNames ? '' : 'compatibilityFilter',
        enumValues: $2.Compatibility.values)
  ...
  @$pb.TagNumber(2)
  $pb.PbList<$2.Dimension> get dimensions => $_getList(1);

  /// The metrics in this report. `metrics` should be the same value as in your
  /// `runReport` request.
  @$pb.TagNumber(3)
  $pb.PbList<$2.Metric> get metrics => $_getList(2);
  ...
  @$pb.TagNumber(4)
  set dimensionFilter($2.FilterExpression value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasDimensionFilter() => $_has(3);
  @$pb.TagNumber(4)
  void clearDimensionFilter() => $_clearField(4);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set metricFilter($2.FilterExpression value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasMetricFilter() => $_has(4);
  @$pb.TagNumber(5)
  void clearMetricFilter() => $_clearField(5);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $2.Compatibility get compatibilityFilter => $_getN(5);
  @$pb.TagNumber(6)
  set compatibilityFilter($2.Compatibility value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasCompatibilityFilter() => $_has(5);
  @$pb.TagNumber(6)
  void clearCompatibilityFilter() => $_clearField(6);
}

/// The compatibility response with the compatibility of each dimension & metric.
class CheckCompatibilityResponse extends $pb.GeneratedMessage {
  factory CheckCompatibilityResponse({
    $core.Iterable<$2.DimensionCompatibility>? dimensionCompatibilities,
    $core.Iterable<$2.MetricCompatibility>? metricCompatibilities,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1beta'),
      createEmptyInstance: create)
    ..pPM<$2.DimensionCompatibility>(
        1, _omitFieldNames ? '' : 'dimensionCompatibilities',
        subBuilder: $2.DimensionCompatibility.create)
    ..pPM<$2.MetricCompatibility>(
        2, _omitFieldNames ? '' : 'metricCompatibilities',
        subBuilder: $2.MetricCompatibility.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $pb.PbList<$2.DimensionCompatibility> get dimensionCompatibilities =>
      $_getList(0);

  /// The compatibility of each metric.
  @$pb.TagNumber(2)
  $pb.PbList<$2.MetricCompatibility> get metricCompatibilities => $_getList(1);
}
...
class Metadata extends $pb.GeneratedMessage {
  factory Metadata({
    $core.Iterable<$2.DimensionMetadata>? dimensions,
    $core.Iterable<$2.MetricMetadata>? metrics,
    $core.String? name,
    $core.Iterable<$2.ComparisonMetadata>? comparisons,
  }) {
    final result = create();
    if (dimensions != null) result.dimensions.addAll(dimensions);
    if (metrics != null) result.metrics.addAll(metrics);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1beta'),
      createEmptyInstance: create)
    ..pPM<$2.DimensionMetadata>(1, _omitFieldNames ? '' : 'dimensions',
        subBuilder: $2.DimensionMetadata.create)
    ..pPM<$2.MetricMetadata>(2, _omitFieldNames ? '' : 'metrics',
        subBuilder: $2.MetricMetadata.create)
    ..aOS(3, _omitFieldNames ? '' : 'name')
    ..pPM<$2.ComparisonMetadata>(4, _omitFieldNames ? '' : 'comparisons',
        subBuilder: $2.ComparisonMetadata.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $pb.PbList<$2.DimensionMetadata> get dimensions => $_getList(0);

  /// The metric descriptions.
  @$pb.TagNumber(2)
  $pb.PbList<$2.MetricMetadata> get metrics => $_getList(1);
  ...
  @$pb.TagNumber(4)
  $pb.PbList<$2.ComparisonMetadata> get comparisons => $_getList(3);
}
...
class RunReportRequest extends $pb.GeneratedMessage {
  factory RunReportRequest({
    ...
    $core.Iterable<$2.Comparison>? comparisons,
  }) {
    final result = create();
    if (property != null) result.property = property;
    if (dimensions != null) result.dimensions.addAll(dimensions);
  ...
  factory RunReportRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RunReportRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<$2.Comparison>(15, _omitFieldNames ? '' : 'comparisons',
        subBuilder: $2.Comparison.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RunReportRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  /// must be unspecified.
  @$pb.TagNumber(4)
  $pb.PbList<$2.DateRange> get dateRanges => $_getList(3);
  ...
  @$pb.TagNumber(5)
  $2.FilterExpression get dimensionFilter => $_getN(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $2.FilterExpression ensureDimensionFilter() => $_ensure(4);
  ...
  @$pb.TagNumber(6)
  $2.FilterExpression get metricFilter => $_getN(5);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $2.FilterExpression ensureMetricFilter() => $_ensure(5);
  ...
  @$pb.TagNumber(11)
  set currencyCode($core.String value) => $_setString(10, value);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  $2.CohortSpec get cohortSpec => $_getN(11);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(12)
  $2.CohortSpec ensureCohortSpec() => $_ensure(11);
  ...
  @$pb.TagNumber(13)
  set keepEmptyRows($core.bool value) => $_setBool(12, value);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set returnPropertyQuota($core.bool value) => $_setBool(13, value);
  @$pb.TagNumber(14)
  $core.bool hasReturnPropertyQuota() => $_has(13);
  @$pb.TagNumber(14)
  void clearReturnPropertyQuota() => $_clearField(14);

  /// Optional. The configuration of comparisons requested and displayed. The
  /// request only requires a comparisons field in order to receive a comparison
  /// column in the response.
  @$pb.TagNumber(15)
  $pb.PbList<$2.Comparison> get comparisons => $_getList(14);
}
...
class RunReportResponse extends $pb.GeneratedMessage {
  ...
  factory RunReportResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RunReportResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.PropertyQuota>(9, _omitFieldNames ? '' : 'propertyQuota',
        subBuilder: $2.PropertyQuota.create)
    ..aOS(10, _omitFieldNames ? '' : 'kind')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RunReportResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(9)
  $2.PropertyQuota get propertyQuota => $_getN(8);
  @$pb.TagNumber(9)
  set propertyQuota($2.PropertyQuota value) => $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasPropertyQuota() => $_has(8);
  @$pb.TagNumber(9)
  void clearPropertyQuota() => $_clearField(9);
  @$pb.TagNumber(9)
  $2.PropertyQuota ensurePropertyQuota() => $_ensure(8);
...
class RunPivotReportRequest extends $pb.GeneratedMessage {
  factory RunPivotReportRequest({
    ...
    if (metrics != null) result.metrics.addAll(metrics);
    if (dateRanges != null) result.dateRanges.addAll(dateRanges);
    if (pivots != null) result.pivots.addAll(pivots);
    if (dimensionFilter != null) result.dimensionFilter = dimensionFilter;
    if (metricFilter != null) result.metricFilter = metricFilter;
    if (currencyCode != null) result.currencyCode = currencyCode;
    if (cohortSpec != null) result.cohortSpec = cohortSpec;
  ...
  RunPivotReportRequest._();

  factory RunPivotReportRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RunPivotReportRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<$2.DateRange>(4, _omitFieldNames ? '' : 'dateRanges',
        subBuilder: $2.DateRange.create)
    ..pPM<$2.Pivot>(5, _omitFieldNames ? '' : 'pivots',
        subBuilder: $2.Pivot.create)
    ..aOM<$2.FilterExpression>(6, _omitFieldNames ? '' : 'dimensionFilter',
        subBuilder: $2.FilterExpression.create)
    ..aOM<$2.FilterExpression>(7, _omitFieldNames ? '' : 'metricFilter',
        subBuilder: $2.FilterExpression.create)
    ..aOS(8, _omitFieldNames ? '' : 'currencyCode')
    ..aOM<$2.CohortSpec>(9, _omitFieldNames ? '' : 'cohortSpec',
        subBuilder: $2.CohortSpec.create)
    ..aOB(10, _omitFieldNames ? '' : 'keepEmptyRows')
    ..aOB(11, _omitFieldNames ? '' : 'returnPropertyQuota')
    ..pPM<$2.Comparison>(12, _omitFieldNames ? '' : 'comparisons',
        subBuilder: $2.Comparison.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RunPivotReportRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(5)
  $pb.PbList<$2.Pivot> get pivots => $_getList(4);

  /// The filter clause of dimensions. Dimensions must be requested to be used in
  /// this filter. Metrics cannot be used in this filter.
  @$pb.TagNumber(6)
  $2.FilterExpression get dimensionFilter => $_getN(5);
  @$pb.TagNumber(6)
  set dimensionFilter($2.FilterExpression value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasDimensionFilter() => $_has(5);
  @$pb.TagNumber(6)
  void clearDimensionFilter() => $_clearField(6);
  @$pb.TagNumber(6)
  $2.FilterExpression ensureDimensionFilter() => $_ensure(5);

  /// The filter clause of metrics. Applied at post aggregation phase, similar to
  /// SQL having-clause. Metrics must be requested to be used in this filter.
  /// Dimensions cannot be used in this filter.
  @$pb.TagNumber(7)
  $2.FilterExpression get metricFilter => $_getN(6);
  @$pb.TagNumber(7)
  set metricFilter($2.FilterExpression value) => $_setField(7, value);
  @$pb.TagNumber(7)
  $core.bool hasMetricFilter() => $_has(6);
  @$pb.TagNumber(7)
  void clearMetricFilter() => $_clearField(7);
  @$pb.TagNumber(7)
  $2.FilterExpression ensureMetricFilter() => $_ensure(6);
  ...
  /// in the request the 'cohort' dimension must be present.
  @$pb.TagNumber(9)
  $2.CohortSpec get cohortSpec => $_getN(8);
  @$pb.TagNumber(9)
  set cohortSpec($2.CohortSpec value) => $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasCohortSpec() => $_has(8);
  @$pb.TagNumber(9)
  void clearCohortSpec() => $_clearField(9);
  @$pb.TagNumber(9)
  $2.CohortSpec ensureCohortSpec() => $_ensure(8);
  ...
  @$pb.TagNumber(10)
  set keepEmptyRows($core.bool value) => $_setBool(9, value);
  @$pb.TagNumber(10)
  $core.bool hasKeepEmptyRows() => $_has(9);
  @$pb.TagNumber(10)
  void clearKeepEmptyRows() => $_clearField(10);
  ...
  @$pb.TagNumber(11)
  set returnPropertyQuota($core.bool value) => $_setBool(10, value);
  @$pb.TagNumber(11)
  $core.bool hasReturnPropertyQuota() => $_has(10);
  @$pb.TagNumber(11)
  void clearReturnPropertyQuota() => $_clearField(11);

  /// Optional. The configuration of comparisons requested and displayed. The
  /// request requires both a comparisons field and a comparisons dimension to
  /// receive a comparison column in the response.
  @$pb.TagNumber(12)
  $pb.PbList<$2.Comparison> get comparisons => $_getList(11);
}

/// The response pivot report table corresponding to a pivot request.
class RunPivotReportResponse extends $pb.GeneratedMessage {
  factory RunPivotReportResponse({
    $core.Iterable<$2.PivotHeader>? pivotHeaders,
    $core.Iterable<$2.DimensionHeader>? dimensionHeaders,
    $core.Iterable<$2.MetricHeader>? metricHeaders,
    $core.Iterable<$2.Row>? rows,
    $core.Iterable<$2.Row>? aggregates,
    $2.ResponseMetaData? metadata,
    $2.PropertyQuota? propertyQuota,
    $core.String? kind,
  }) {
    final result = create();
    if (pivotHeaders != null) result.pivotHeaders.addAll(pivotHeaders);
    if (dimensionHeaders != null)
      result.dimensionHeaders.addAll(dimensionHeaders);
    if (metricHeaders != null) result.metricHeaders.addAll(metricHeaders);
    if (rows != null) result.rows.addAll(rows);
  ...
  RunPivotReportResponse._();

  factory RunPivotReportResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RunPivotReportResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1beta'),
      createEmptyInstance: create)
    ..pPM<$2.PivotHeader>(1, _omitFieldNames ? '' : 'pivotHeaders',
        subBuilder: $2.PivotHeader.create)
    ..pPM<$2.DimensionHeader>(2, _omitFieldNames ? '' : 'dimensionHeaders',
        subBuilder: $2.DimensionHeader.create)
    ..pPM<$2.MetricHeader>(3, _omitFieldNames ? '' : 'metricHeaders',
        subBuilder: $2.MetricHeader.create)
    ..pPM<$2.Row>(4, _omitFieldNames ? '' : 'rows', subBuilder: $2.Row.create)
    ..pPM<$2.Row>(5, _omitFieldNames ? '' : 'aggregates',
        subBuilder: $2.Row.create)
    ..aOM<$2.ResponseMetaData>(6, _omitFieldNames ? '' : 'metadata',
        subBuilder: $2.ResponseMetaData.create)
    ..aOM<$2.PropertyQuota>(7, _omitFieldNames ? '' : 'propertyQuota',
        subBuilder: $2.PropertyQuota.create)
    ..aOS(8, _omitFieldNames ? '' : 'kind')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RunPivotReportResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  ///     }]
  @$pb.TagNumber(1)
  $pb.PbList<$2.PivotHeader> get pivotHeaders => $_getList(0);

  /// Describes dimension columns. The number of DimensionHeaders and ordering of
  /// DimensionHeaders matches the dimensions present in rows.
  @$pb.TagNumber(2)
  $pb.PbList<$2.DimensionHeader> get dimensionHeaders => $_getList(1);

  /// Describes metric columns. The number of MetricHeaders and ordering of
  /// MetricHeaders matches the metrics present in rows.
  @$pb.TagNumber(3)
  $pb.PbList<$2.MetricHeader> get metricHeaders => $_getList(2);

  /// Rows of dimension value combinations and metric values in the report.
  @$pb.TagNumber(4)
  $pb.PbList<$2.Row> get rows => $_getList(3);
  ...
  @$pb.TagNumber(5)
  $pb.PbList<$2.Row> get aggregates => $_getList(4);

  /// Metadata for the report.
  @$pb.TagNumber(6)
  $2.ResponseMetaData get metadata => $_getN(5);
  @$pb.TagNumber(6)
  set metadata($2.ResponseMetaData value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasMetadata() => $_has(5);
  @$pb.TagNumber(6)
  void clearMetadata() => $_clearField(6);
  @$pb.TagNumber(6)
  $2.ResponseMetaData ensureMetadata() => $_ensure(5);

  /// This Google Analytics property's quota state including this request.
  @$pb.TagNumber(7)
  $2.PropertyQuota get propertyQuota => $_getN(6);
  @$pb.TagNumber(7)
  set propertyQuota($2.PropertyQuota value) => $_setField(7, value);
  @$pb.TagNumber(7)
  $core.bool hasPropertyQuota() => $_has(6);
  @$pb.TagNumber(7)
  void clearPropertyQuota() => $_clearField(7);
  @$pb.TagNumber(7)
  $2.PropertyQuota ensurePropertyQuota() => $_ensure(6);
...
class BatchRunReportsRequest extends $pb.GeneratedMessage {
  ...
  BatchRunReportsRequest._();

  factory BatchRunReportsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory BatchRunReportsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'property')
    ..pPM<RunReportRequest>(2, _omitFieldNames ? '' : 'requests',
        subBuilder: RunReportRequest.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BatchRunReportsRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  $pb.PbList<RunReportRequest> get requests => $_getList(1);
}
...
class BatchRunReportsResponse extends $pb.GeneratedMessage {
  ...
  BatchRunReportsResponse._();

  factory BatchRunReportsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory BatchRunReportsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1beta'),
      createEmptyInstance: create)
    ..pPM<RunReportResponse>(1, _omitFieldNames ? '' : 'reports',
        subBuilder: RunReportResponse.create)
    ..aOS(2, _omitFieldNames ? '' : 'kind')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BatchRunReportsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<RunReportResponse> get reports => $_getList(0);
...
class BatchRunPivotReportsRequest extends $pb.GeneratedMessage {
  ...
  factory BatchRunPivotReportsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory BatchRunPivotReportsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'property')
    ..pPM<RunPivotReportRequest>(2, _omitFieldNames ? '' : 'requests',
        subBuilder: RunPivotReportRequest.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BatchRunPivotReportsRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  $pb.PbList<RunPivotReportRequest> get requests => $_getList(1);
}
...
class BatchRunPivotReportsResponse extends $pb.GeneratedMessage {
  factory BatchRunPivotReportsResponse({
    ...
    final result = create();
    if (pivotReports != null) result.pivotReports.addAll(pivotReports);
    if (kind != null) result.kind = kind;
    return result;
  }
  ...
  factory BatchRunPivotReportsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory BatchRunPivotReportsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1beta'),
      createEmptyInstance: create)
    ..pPM<RunPivotReportResponse>(1, _omitFieldNames ? '' : 'pivotReports',
        subBuilder: RunPivotReportResponse.create)
    ..aOS(2, _omitFieldNames ? '' : 'kind')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  BatchRunPivotReportsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<RunPivotReportResponse> get pivotReports => $_getList(0);
...
class GetMetadataRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetMetadataRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class RunRealtimeReportRequest extends $pb.GeneratedMessage {
  factory RunRealtimeReportRequest({
    ...
    $core.Iterable<$2.OrderBy>? orderBys,
    $core.bool? returnPropertyQuota,
    $core.Iterable<$2.MinuteRange>? minuteRanges,
  }) {
    final result = create();
    if (property != null) result.property = property;
    if (dimensions != null) result.dimensions.addAll(dimensions);
    ...
    if (returnPropertyQuota != null)
      result.returnPropertyQuota = returnPropertyQuota;
    if (minuteRanges != null) result.minuteRanges.addAll(minuteRanges);
    return result;
  }

  RunRealtimeReportRequest._();

  factory RunRealtimeReportRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RunRealtimeReportRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$2.MetricAggregation>(
        ...
        enumValues: $2.MetricAggregation.values,
        defaultEnumValue: $2.MetricAggregation.METRIC_AGGREGATION_UNSPECIFIED)
    ..pPM<$2.OrderBy>(8, _omitFieldNames ? '' : 'orderBys',
        subBuilder: $2.OrderBy.create)
    ..aOB(9, _omitFieldNames ? '' : 'returnPropertyQuota')
    ..pPM<$2.MinuteRange>(10, _omitFieldNames ? '' : 'minuteRanges',
        subBuilder: $2.MinuteRange.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RunRealtimeReportRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  /// where the dimension_values are set to "RESERVED_(MetricAggregation)".
  @$pb.TagNumber(7)
  $pb.PbList<$2.MetricAggregation> get metricAggregations => $_getList(6);

  /// Specifies how rows are ordered in the response.
  @$pb.TagNumber(8)
  $pb.PbList<$2.OrderBy> get orderBys => $_getList(7);
  ...
  @$pb.TagNumber(9)
  set returnPropertyQuota($core.bool value) => $_setBool(8, value);
  @$pb.TagNumber(9)
  $core.bool hasReturnPropertyQuota() => $_has(8);
  @$pb.TagNumber(9)
  void clearReturnPropertyQuota() => $_clearField(9);
  ...
  @$pb.TagNumber(10)
  $pb.PbList<$2.MinuteRange> get minuteRanges => $_getList(9);
}
...
class RunRealtimeReportResponse extends $pb.GeneratedMessage {
  ...
  RunRealtimeReportResponse._();

  factory RunRealtimeReportResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RunRealtimeReportResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<$2.Row>(6, _omitFieldNames ? '' : 'minimums',
        subBuilder: $2.Row.create)
    ..aI(7, _omitFieldNames ? '' : 'rowCount')
    ..aOM<$2.PropertyQuota>(8, _omitFieldNames ? '' : 'propertyQuota',
        subBuilder: $2.PropertyQuota.create)
    ..aOS(9, _omitFieldNames ? '' : 'kind')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RunRealtimeReportResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  /// request.
  @$pb.TagNumber(8)
  $2.PropertyQuota get propertyQuota => $_getN(7);
  @$pb.TagNumber(8)
  set propertyQuota($2.PropertyQuota value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasPropertyQuota() => $_has(7);
  @$pb.TagNumber(8)
  void clearPropertyQuota() => $_clearField(8);
  @$pb.TagNumber(8)
  $2.PropertyQuota ensurePropertyQuota() => $_ensure(7);
  ...
  @$pb.TagNumber(9)
  set kind($core.String value) => $_setString(8, value);
  @$pb.TagNumber(9)
...
class GetAudienceExportRequest extends $pb.GeneratedMessage {
  ...
  GetAudienceExportRequest._();

  factory GetAudienceExportRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetAudienceExportRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetAudienceExportRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListAudienceExportsRequest extends $pb.GeneratedMessage {
  ...
  ListAudienceExportsRequest._();

  factory ListAudienceExportsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListAudienceExportsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListAudienceExportsRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListAudienceExportsResponse extends $pb.GeneratedMessage {
  factory ListAudienceExportsResponse({
    ...
    final result = create();
    if (audienceExports != null) result.audienceExports.addAll(audienceExports);
  ...
  factory ListAudienceExportsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListAudienceExportsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.analytics.data.v1beta'),
      createEmptyInstance: create)
    ..pPM<AudienceExport>(1, _omitFieldNames ? '' : 'audienceExports',
        subBuilder: AudienceExport.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListAudienceExportsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<AudienceExport> get audienceExports => $_getList(0);
...
class CreateAudienceExportRequest extends $pb.GeneratedMessage {
  factory CreateAudienceExportRequest({
    ...
    final result = create();
    if (parent != null) result.parent = parent;
    if (audienceExport != null) result.audienceExport = audienceExport;
    return result;
  }

  CreateAudienceExportRequest._();

  factory CreateAudienceExportRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CreateAudienceExportRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CreateAudienceExportRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  set audienceExport(AudienceExport value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasAudienceExport() => $_has(1);
  @$pb.TagNumber(2)
  void clearAudienceExport() => $_clearField(2);
  @$pb.TagNumber(2)
...
class AudienceExport extends $pb.GeneratedMessage {
  ...
  factory AudienceExport.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AudienceExport.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<AudienceExport_State>(5, _omitFieldNames ? '' : 'state',
    ...
    ..aD(10, _omitFieldNames ? '' : 'percentageCompleted')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AudienceExport clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(5)
  set state(AudienceExport_State value) => $_setField(5, value);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(10)
  void clearPercentageCompleted() => $_clearField(10);
}
...
class AudienceExportMetadata extends $pb.GeneratedMessage {
  ...
  AudienceExportMetadata._();

  factory AudienceExportMetadata.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AudienceExportMetadata.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AudienceExportMetadata clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class QueryAudienceExportRequest extends $pb.GeneratedMessage {
  ...
  QueryAudienceExportRequest._();

  factory QueryAudienceExportRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QueryAudienceExportRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  QueryAudienceExportRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class QueryAudienceExportResponse extends $pb.GeneratedMessage {
  ...
  factory QueryAudienceExportResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QueryAudienceExportResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  QueryAudienceExportResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set audienceExport(AudienceExport value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasAudienceExport() => $_has(0);
  @$pb.TagNumber(1)
  void clearAudienceExport() => $_clearField(1);
  @$pb.TagNumber(1)
