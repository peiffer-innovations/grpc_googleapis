...
class SpacesServiceClient extends $grpc.Client {
  ...
  static final _$connectActiveConference = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.ConnectActiveConferenceResponse.fromBuffer(value));
  ...
  static final _$listMembers =
      $grpc.ClientMethod<$0.ListMembersRequest, $0.ListMembersResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.ListMembersResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.ConnectActiveConferenceResponse>
      connectActiveConference($0.ConnectActiveConferenceRequest request,
          {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.Member> createMember($0.CreateMemberRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createMember, request, options: options);
  }

  $grpc.ResponseFuture<$1.Member> getMember($0.GetMemberRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$2.Empty> deleteMember($0.DeleteMemberRequest request,
      {$grpc.CallOptions? options}) {
...
class ConferenceRecordsServiceClient extends $grpc.Client {
  static final _$getConferenceRecord = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) => $1.ConferenceRecord.fromBuffer(value));
  ...
  static final _$getTranscriptEntry = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) => $1.TranscriptEntry.fromBuffer(value));
