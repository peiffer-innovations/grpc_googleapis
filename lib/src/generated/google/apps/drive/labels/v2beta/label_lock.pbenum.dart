...
class LabelLock_State extends $pb.ProtobufEnum {
  static const LabelLock_State STATE_UNSPECIFIED = LabelLock_State._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'STATE_UNSPECIFIED');
  static const LabelLock_State ACTIVE = LabelLock_State._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ACTIVE');
  static const LabelLock_State DELETING = LabelLock_State._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DELETING');
