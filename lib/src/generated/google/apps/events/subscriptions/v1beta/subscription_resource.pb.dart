...
class Subscription_DriveOptions extends $pb.GeneratedMessage {
  factory Subscription_DriveOptions({
  ...
  Subscription_DriveOptions._();

  factory Subscription_DriveOptions.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Subscription_DriveOptions.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Subscription.DriveOptions',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.apps.events.subscriptions.v1beta'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'includeDescendants')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Subscription_DriveOptions clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Subscription_DriveOptions copyWith(
          void Function(Subscription_DriveOptions) updates) =>
      super.copyWith((message) => updates(message as Subscription_DriveOptions))
          as Subscription_DriveOptions;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Subscription_DriveOptions create() => Subscription_DriveOptions._();
  @$core.override
  Subscription_DriveOptions createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static Subscription_DriveOptions getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Subscription_DriveOptions>(create);
  static Subscription_DriveOptions? _defaultInstance;
  ...
  @$pb.TagNumber(1)
  $core.bool get includeDescendants => $_getBF(0);
  @$pb.TagNumber(1)
  set includeDescendants($core.bool value) => $_setBool(0, value);
  @$pb.TagNumber(1)
  $core.bool hasIncludeDescendants() => $_has(0);
  @$pb.TagNumber(1)
  void clearIncludeDescendants() => $_clearField(1);
}

enum Subscription_SubscriptionOptions { driveOptions, notSet }
...
class Subscription extends $pb.GeneratedMessage {
  factory Subscription({
    ...
    Subscription_DriveOptions? driveOptions,
  }) {
    final result = create();
    ...
    if (driveOptions != null) result.driveOptions = driveOptions;
    return result;
  }
  ...
  static const $core.Map<$core.int, Subscription_SubscriptionOptions>
      _Subscription_SubscriptionOptionsByTag = {
    20: Subscription_SubscriptionOptions.driveOptions,
    0: Subscription_SubscriptionOptions.notSet
  };
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Subscription_DriveOptions>(20, _omitFieldNames ? '' : 'driveOptions',
        subBuilder: Subscription_DriveOptions.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(20)
  Subscription_SubscriptionOptions whichSubscriptionOptions() =>
      _Subscription_SubscriptionOptionsByTag[$_whichOneof(0)]!;
  @$pb.TagNumber(20)
  void clearSubscriptionOptions() => $_clearField($_whichOneof(0));

  @$pb.TagNumber(13)
  @$pb.TagNumber(14)
  Subscription_Expiration whichExpiration() =>
      _Subscription_ExpirationByTag[$_whichOneof(1)]!;
  @$pb.TagNumber(13)
  @$pb.TagNumber(14)
  void clearExpiration() => $_clearField($_whichOneof(1));
  ...
  /// resources.
  @$pb.TagNumber(20)
  Subscription_DriveOptions get driveOptions => $_getN(15);
  @$pb.TagNumber(20)
  set driveOptions(Subscription_DriveOptions value) => $_setField(20, value);
  @$pb.TagNumber(20)
  $core.bool hasDriveOptions() => $_has(15);
  @$pb.TagNumber(20)
  void clearDriveOptions() => $_clearField(20);
  @$pb.TagNumber(20)
  Subscription_DriveOptions ensureDriveOptions() => $_ensure(15);
}
