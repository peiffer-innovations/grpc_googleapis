...
const Session$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.example.showcase.v1beta2.Session.Version',
      '10': 'version'
    },
  ],
...
final $typed_data.Uint8List sessionDescriptor = $convert.base64Decode(
    '');
...
const CreateSessionRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1beta2.Session',
      '10': 'session'
    },
  ],
};
...
final $typed_data.Uint8List createSessionRequestDescriptor = $convert.base64Decode(
    'ChRDcmVhdGVTZXNzaW9uUmVxdWVzdBJCCgdzZXNzaW9uGAEgASgLMiguZ29vZ2xlLmV4YW1wbGUuc2hvd2Nhc2UudjFiZXRhMi5TZXNzaW9uUgdzZXNzaW9u');
...
final $typed_data.Uint8List listSessionsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0U2Vzc2lvbnNSZXNwb25zZRJECghzZXNzaW9ucxgBIAMoCzIoLmdvb2dsZS5leGFtcGxlLnNob3djYXNlLnYxYmV0YTIuU2Vzc2lvblIIc2Vzc2lvbnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
const ReportSessionResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.example.showcase.v1beta2.ReportSessionResponse.Result',
      '10': 'result'
    },
    const {
      '1': 'test_runs',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.example.showcase.v1beta2.TestRun',
      '10': 'testRuns'
    },
  ],
...
final $typed_data.Uint8List reportSessionResponseDescriptor = $convert.base64Decode(
    '');
...
const Test$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.example.showcase.v1beta2.Test.ExpectationLevel',
      '10': 'expectationLevel'
    },
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.example.showcase.v1beta2.Test.Blueprint',
      '10': 'blueprints'
    },
  ],
...
const Test_Blueprint$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1beta2.Test.Blueprint.Invocation',
      '10': 'request'
    },
    const {
...
final $typed_data.Uint8List testDescriptor = $convert.base64Decode(
    '');
...
const Issue$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.example.showcase.v1beta2.Issue.Type',
      '10': 'type'
    },
    const {
      '1': 'severity',
      ...
      '4': 1,
      '5': 14,
      '6': '.google.example.showcase.v1beta2.Issue.Severity',
      '10': 'severity'
    },
    const {'1': 'description', '3': 3, '4': 1, '5': 9, '10': 'description'},
  ],
...
final $typed_data.Uint8List issueDescriptor = $convert.base64Decode(
    '');
...
const ListTestsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.example.showcase.v1beta2.Test',
      '10': 'tests'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listTestsResponseDescriptor = $convert.base64Decode(
    'ChFMaXN0VGVzdHNSZXNwb25zZRI7CgV0ZXN0cxgBIAMoCzIlLmdvb2dsZS5leGFtcGxlLnNob3djYXNlLnYxYmV0YTIuVGVzdFIFdGVzdHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
const TestRun$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1beta2.Issue',
      '10': 'issue'
    },
  ],
};
...
final $typed_data.Uint8List testRunDescriptor = $convert.base64Decode(
    'CgdUZXN0UnVuEjUKBHRlc3QYASABKAlCIfpBHgocc2hvd2Nhc2UuZ29vZ2xlYXBpcy5jb20vVGVzdFIEdGVzdBI8CgVpc3N1ZRgCIAEoCzImLmdvb2dsZS5leGFtcGxlLnNob3djYXNlLnYxYmV0YTIuSXNzdWVSBWlzc3Vl');
...
final $typed_data.Uint8List verifyTestResponseDescriptor = $convert.base64Decode(
    'ChJWZXJpZnlUZXN0UmVzcG9uc2USPAoFaXNzdWUYASABKAsyJi5nb29nbGUuZXhhbXBsZS5zaG93Y2FzZS52MWJldGEyLklzc3VlUgVpc3N1ZQ==');
