...
const Sequence$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.example.showcase.v1beta2.Sequence.Response',
      '10': 'responses'
    },
  ],
...
final $typed_data.Uint8List sequenceDescriptor = $convert.base64Decode(
    '');
...
const SequenceReport$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.example.showcase.v1beta2.SequenceReport.Attempt',
      '10': 'attempts'
    },
  ],
...
final $typed_data.Uint8List sequenceReportDescriptor = $convert.base64Decode(
    '');
...
const CreateSequenceRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1beta2.Sequence',
      '10': 'sequence'
    },
  ],
};
...
final $typed_data.Uint8List createSequenceRequestDescriptor = $convert.base64Decode(
    'ChVDcmVhdGVTZXF1ZW5jZVJlcXVlc3QSRQoIc2VxdWVuY2UYASABKAsyKS5nb29nbGUuZXhhbXBsZS5zaG93Y2FzZS52MWJldGEyLlNlcXVlbmNlUghzZXF1ZW5jZQ==');
