...
const EchoRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.example.showcase.v1beta1.Severity',
      '10': 'severity'
    },
  ],
  '8': const [
...
final $typed_data.Uint8List echoRequestDescriptor = $convert.base64Decode(
    'CgtFY2hvUmVxdWVzdBIaCgdjb250ZW50GAEgASgJSABSB2NvbnRlbnQSKgoFZXJyb3IYAiABKAsyEi5nb29nbGUucnBjLlN0YXR1c0gAUgVlcnJvchJFCghzZXZlcml0eRgDIAEoDjIpLmdvb2dsZS5leGFtcGxlLnNob3djYXNlLnYxYmV0YTEuU2V2ZXJpdHlSCHNldmVyaXR5QgoKCHJlc3BvbnNl');
...
final $typed_data.Uint8List echoResponseDescriptor = $convert.base64Decode(
    'CgxFY2hvUmVzcG9uc2USGAoHY29udGVudBgBIAEoCVIHY29udGVudBJFCghzZXZlcml0eRgCIAEoDjIpLmdvb2dsZS5leGFtcGxlLnNob3djYXNlLnYxYmV0YTEuU2V2ZXJpdHlSCHNldmVyaXR5');
...
const PagedExpandResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.example.showcase.v1beta1.EchoResponse',
      '10': 'responses'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List pagedExpandResponseDescriptor = $convert.base64Decode(
    'ChNQYWdlZEV4cGFuZFJlc3BvbnNlEksKCXJlc3BvbnNlcxgBIAMoCzItLmdvb2dsZS5leGFtcGxlLnNob3djYXNlLnYxYmV0YTEuRWNob1Jlc3BvbnNlUglyZXNwb25zZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
const WaitRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1beta1.WaitResponse',
      '9': 1,
      '10': 'success'
    },
  ],
...
final $typed_data.Uint8List waitRequestDescriptor = $convert.base64Decode(
    '');
...
const BlockRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1beta1.BlockResponse',
      '9': 0,
      '10': 'success'
    },
  ],
...
final $typed_data.Uint8List blockRequestDescriptor = $convert.base64Decode(
    '');
