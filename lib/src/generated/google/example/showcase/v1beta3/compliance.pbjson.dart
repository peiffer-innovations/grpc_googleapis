...
const RepeatRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1beta3.ComplianceData',
      '10': 'info'
    },
  ],
};
...
final $typed_data.Uint8List repeatRequestDescriptor = $convert.base64Decode(
    'Cg1SZXBlYXRSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSQwoEaW5mbxgCIAEoCzIvLmdvb2dsZS5leGFtcGxlLnNob3djYXNlLnYxYmV0YTMuQ29tcGxpYW5jZURhdGFSBGluZm8=');
...
final $typed_data.Uint8List repeatResponseDescriptor = $convert.base64Decode(
    'Cg5SZXBlYXRSZXNwb25zZRJDCgRpbmZvGAEgASgLMi8uZ29vZ2xlLmV4YW1wbGUuc2hvd2Nhc2UudjFiZXRhMy5Db21wbGlhbmNlRGF0YVIEaW5mbw==');
...
const ComplianceData$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1beta3.ComplianceDataChild',
      '10': 'fChild'
    },
    const {
      '1': 'p_string',
...
final $typed_data.Uint8List complianceDataDescriptor = $convert.base64Decode(
    '');
...
const ComplianceDataChild$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1beta3.ComplianceDataGrandchild',
      '10': 'fChild'
    },
    const {
      '1': 'p_string',
...
final $typed_data.Uint8List complianceDataChildDescriptor = $convert.base64Decode(
    '');
