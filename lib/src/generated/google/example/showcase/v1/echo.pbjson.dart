...
const EchoRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.example.showcase.v1.Severity',
      '10': 'severity'
    },
  ],
  '8': const [
...
final $typed_data.Uint8List echoRequestDescriptor = $convert.base64Decode(
    'CgtFY2hvUmVxdWVzdBIaCgdjb250ZW50GAEgASgJSABSB2NvbnRlbnQSKgoFZXJyb3IYAiABKAsyEi5nb29nbGUucnBjLlN0YXR1c0gAUgVlcnJvchJACghzZXZlcml0eRgDIAEoDjIkLmdvb2dsZS5leGFtcGxlLnNob3djYXNlLnYxLlNldmVyaXR5UghzZXZlcml0eUIKCghyZXNwb25zZQ==');
...
final $typed_data.Uint8List echoResponseDescriptor = $convert.base64Decode(
    'CgxFY2hvUmVzcG9uc2USGAoHY29udGVudBgBIAEoCVIHY29udGVudBJACghzZXZlcml0eRgCIAEoDjIkLmdvb2dsZS5leGFtcGxlLnNob3djYXNlLnYxLlNldmVyaXR5UghzZXZlcml0eQ==');
...
const PagedExpandResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.example.showcase.v1.EchoResponse',
      '10': 'responses'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List pagedExpandResponseDescriptor = $convert.base64Decode(
    'ChNQYWdlZEV4cGFuZFJlc3BvbnNlEkYKCXJlc3BvbnNlcxgBIAMoCzIoLmdvb2dsZS5leGFtcGxlLnNob3djYXNlLnYxLkVjaG9SZXNwb25zZVIJcmVzcG9uc2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const WaitRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1.WaitResponse',
      '9': 1,
      '10': 'success'
    },
  ],
...
final $typed_data.Uint8List waitRequestDescriptor = $convert.base64Decode(
    '');
...
const BlockRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.example.showcase.v1.BlockResponse',
      '9': 0,
      '10': 'success'
    },
    const {
...
final $typed_data.Uint8List blockRequestDescriptor = $convert.base64Decode(
    '');
