...
final $typed_data.Uint8List readRequestDescriptor = $convert.base64Decode(
    'CgtSZWFkUmVxdWVzdBIjCg1yZXNvdXJjZV9uYW1lGAEgASgJUgxyZXNvdXJjZU5hbWUSHwoLcmVhZF9vZmZzZXQYAiABKANSCnJlYWRPZmZzZXQSHQoKcmVhZF9saW1pdBgDIAEoA1IJcmVhZExpbWl0');
...
final $typed_data.Uint8List writeRequestDescriptor = $convert.base64Decode(
    'CgxXcml0ZVJlcXVlc3QSIwoNcmVzb3VyY2VfbmFtZRgBIAEoCVIMcmVzb3VyY2VOYW1lEiEKDHdyaXRlX29mZnNldBgCIAEoA1ILd3JpdGVPZmZzZXQSIQoMZmluaXNoX3dyaXRlGAMgASgIUgtmaW5pc2hXcml0ZRISCgRkYXRhGAogASgMUgRkYXRh');
...
final $typed_data.Uint8List queryWriteStatusRequestDescriptor =
    $convert.base64Decode(
        'ChdRdWVyeVdyaXRlU3RhdHVzUmVxdWVzdBIjCg1yZXNvdXJjZV9uYW1lGAEgASgJUgxyZXNvdXJjZU5hbWU=');
