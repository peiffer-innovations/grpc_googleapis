...
class DayOfWeek extends $pb.ProtobufEnum {
  ...
  static const DayOfWeek MONDAY = DayOfWeek._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MONDAY');
  static const DayOfWeek TUESDAY = DayOfWeek._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TUESDAY');
  static const DayOfWeek WEDNESDAY = DayOfWeek._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WEDNESDAY');
  static const DayOfWeek THURSDAY = DayOfWeek._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'THURSDAY');
  static const DayOfWeek FRIDAY = DayOfWeek._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FRIDAY');
  static const DayOfWeek SATURDAY = DayOfWeek._(
      6,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SATURDAY');
  static const DayOfWeek SUNDAY = DayOfWeek._(
      7,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SUNDAY');
