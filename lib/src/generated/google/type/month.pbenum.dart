...
class Month extends $pb.ProtobufEnum {
  static const Month MONTH_UNSPECIFIED = Month._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MONTH_UNSPECIFIED');
  static const Month JANUARY = Month._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'JANUARY');
  static const Month FEBRUARY = Month._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FEBRUARY');
  ...
  static const Month JULY = Month._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'JULY');
  static const Month AUGUST = Month._(
      8,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'AUGUST');
  static const Month SEPTEMBER = Month._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SEPTEMBER');
  static const Month OCTOBER = Month._(
      10,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'OCTOBER');
  static const Month NOVEMBER = Month._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NOVEMBER');
  static const Month DECEMBER = Month._(
      12,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DECEMBER');
