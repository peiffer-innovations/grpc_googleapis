...
class UspsAddress extends $pb.GeneratedMessage {
  factory UspsAddress({
    ...
    final result = create();
    if (firstAddressLine != null) result.firstAddressLine = firstAddressLine;
    if (firm != null) result.firm = firm;
    if (secondAddressLine != null) result.secondAddressLine = secondAddressLine;
    if (urbanization != null) result.urbanization = urbanization;
    ...
    if (zipCodeExtension != null) result.zipCodeExtension = zipCodeExtension;
    return result;
  }

  UspsAddress._();

  factory UspsAddress.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory UspsAddress.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$pb.TagNumber(1)
  set firstAddressLine($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
  $core.bool hasFirstAddressLine() => $_has(0);
  @$pb.TagNumber(1)
  void clearFirstAddressLine() => $_clearField(1);

  /// Firm name.
  @$pb.TagNumber(2)
  $core.String get firm => $_getSZ(1);
  @$pb.TagNumber(2)
  set firm($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set secondAddressLine($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasSecondAddressLine() => $_has(2);
  @$pb.TagNumber(3)
  void clearSecondAddressLine() => $_clearField(3);

  /// Puerto Rican urbanization name.
  @$pb.TagNumber(4)
  $core.String get urbanization => $_getSZ(3);
  @$pb.TagNumber(4)
  set urbanization($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasUrbanization() => $_has(3);
  @$pb.TagNumber(4)
  void clearUrbanization() => $_clearField(4);

  /// City + state + postal code.
  @$pb.TagNumber(5)
  $core.String get cityStateZipAddressLine => $_getSZ(4);
  @$pb.TagNumber(5)
  set cityStateZipAddressLine($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  $core.bool hasCityStateZipAddressLine() => $_has(4);
  @$pb.TagNumber(5)
  void clearCityStateZipAddressLine() => $_clearField(5);
  ...
  @$pb.TagNumber(8)
  set zipCode($core.String value) => $_setString(7, value);
  @$pb.TagNumber(8)
  $core.bool hasZipCode() => $_has(7);
  @$pb.TagNumber(8)
  void clearZipCode() => $_clearField(8);

  /// 4-digit postal code extension e.g. 5023.
  @$pb.TagNumber(9)
  $core.String get zipCodeExtension => $_getSZ(8);
  @$pb.TagNumber(9)
  set zipCodeExtension($core.String value) => $_setString(8, value);
  @$pb.TagNumber(9)
  $core.bool hasZipCodeExtension() => $_has(8);
  @$pb.TagNumber(9)
  void clearZipCodeExtension() => $_clearField(9);
}
...
class UspsData extends $pb.GeneratedMessage {
  factory UspsData({
    ...
    if (deliveryPointCode != null) result.deliveryPointCode = deliveryPointCode;
    if (deliveryPointCheckDigit != null)
      result.deliveryPointCheckDigit = deliveryPointCheckDigit;
    if (dpvConfirmation != null) result.dpvConfirmation = dpvConfirmation;
    if (dpvFootnote != null) result.dpvFootnote = dpvFootnote;
    if (dpvCmra != null) result.dpvCmra = dpvCmra;
    if (dpvVacant != null) result.dpvVacant = dpvVacant;
    if (dpvNoStat != null) result.dpvNoStat = dpvNoStat;
    if (carrierRoute != null) result.carrierRoute = carrierRoute;
    if (carrierRouteIndicator != null)
      result.carrierRouteIndicator = carrierRouteIndicator;
    if (ewsNoMatch != null) result.ewsNoMatch = ewsNoMatch;
    if (postOfficeCity != null) result.postOfficeCity = postOfficeCity;
    if (postOfficeState != null) result.postOfficeState = postOfficeState;
    if (abbreviatedCity != null) result.abbreviatedCity = abbreviatedCity;
    if (fipsCountyCode != null) result.fipsCountyCode = fipsCountyCode;
    if (county != null) result.county = county;
    if (elotNumber != null) result.elotNumber = elotNumber;
    if (elotFlag != null) result.elotFlag = elotFlag;
    if (lacsLinkReturnCode != null)
      result.lacsLinkReturnCode = lacsLinkReturnCode;
    if (lacsLinkIndicator != null) result.lacsLinkIndicator = lacsLinkIndicator;
    if (poBoxOnlyPostalCode != null)
      result.poBoxOnlyPostalCode = poBoxOnlyPostalCode;
    if (suitelinkFootnote != null) result.suitelinkFootnote = suitelinkFootnote;
    if (pmbDesignator != null) result.pmbDesignator = pmbDesignator;
    if (pmbNumber != null) result.pmbNumber = pmbNumber;
    if (addressRecordType != null) result.addressRecordType = addressRecordType;
    if (defaultAddress != null) result.defaultAddress = defaultAddress;
    if (errorMessage != null) result.errorMessage = errorMessage;
    if (cassProcessed != null) result.cassProcessed = cassProcessed;
    if (dpvNoStatReasonCode != null)
      result.dpvNoStatReasonCode = dpvNoStatReasonCode;
    if (dpvDrop != null) result.dpvDrop = dpvDrop;
    if (dpvThrowback != null) result.dpvThrowback = dpvThrowback;
    ...
    if (dpvPbsa != null) result.dpvPbsa = dpvPbsa;
  ...
  factory UspsData.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory UspsData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(1)
  set standardizedAddress(UspsAddress value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasStandardizedAddress() => $_has(0);
  @$pb.TagNumber(1)
  void clearStandardizedAddress() => $_clearField(1);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set deliveryPointCode($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasDeliveryPointCode() => $_has(1);
  @$pb.TagNumber(2)
  void clearDeliveryPointCode() => $_clearField(2);
  ...
  @$pb.TagNumber(3)
  set deliveryPointCheckDigit($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasDeliveryPointCheckDigit() => $_has(2);
  @$pb.TagNumber(3)
  void clearDeliveryPointCheckDigit() => $_clearField(3);
  ...
  @$pb.TagNumber(4)
  set dpvConfirmation($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasDpvConfirmation() => $_has(3);
  @$pb.TagNumber(4)
  void clearDpvConfirmation() => $_clearField(4);
  ...
  @$pb.TagNumber(5)
  set dpvFootnote($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  $core.bool hasDpvFootnote() => $_has(4);
  @$pb.TagNumber(5)
  void clearDpvFootnote() => $_clearField(5);
  ...
  @$pb.TagNumber(6)
  set dpvCmra($core.String value) => $_setString(5, value);
  @$pb.TagNumber(6)
  $core.bool hasDpvCmra() => $_has(5);
  @$pb.TagNumber(6)
  void clearDpvCmra() => $_clearField(6);
  ...
  @$pb.TagNumber(7)
  set dpvVacant($core.String value) => $_setString(6, value);
  @$pb.TagNumber(7)
  $core.bool hasDpvVacant() => $_has(6);
  @$pb.TagNumber(7)
  void clearDpvVacant() => $_clearField(7);
  ...
  @$pb.TagNumber(8)
  set dpvNoStat($core.String value) => $_setString(7, value);
  @$pb.TagNumber(8)
  $core.bool hasDpvNoStat() => $_has(7);
  @$pb.TagNumber(8)
  void clearDpvNoStat() => $_clearField(8);
  ...
  @$pb.TagNumber(9)
  set carrierRoute($core.String value) => $_setString(8, value);
  @$pb.TagNumber(9)
  $core.bool hasCarrierRoute() => $_has(8);
  @$pb.TagNumber(9)
  void clearCarrierRoute() => $_clearField(9);

  /// Carrier route rate sort indicator.
  @$pb.TagNumber(10)
  $core.String get carrierRouteIndicator => $_getSZ(9);
  @$pb.TagNumber(10)
  set carrierRouteIndicator($core.String value) => $_setString(9, value);
  @$pb.TagNumber(10)
  $core.bool hasCarrierRouteIndicator() => $_has(9);
  @$pb.TagNumber(10)
  void clearCarrierRouteIndicator() => $_clearField(10);
  ...
  @$pb.TagNumber(11)
  set ewsNoMatch($core.bool value) => $_setBool(10, value);
  @$pb.TagNumber(11)
  $core.bool hasEwsNoMatch() => $_has(10);
  @$pb.TagNumber(11)
  void clearEwsNoMatch() => $_clearField(11);

  /// Main post office city.
  @$pb.TagNumber(12)
  $core.String get postOfficeCity => $_getSZ(11);
  @$pb.TagNumber(12)
  set postOfficeCity($core.String value) => $_setString(11, value);
  @$pb.TagNumber(12)
  $core.bool hasPostOfficeCity() => $_has(11);
  @$pb.TagNumber(12)
  void clearPostOfficeCity() => $_clearField(12);

  /// Main post office state.
  @$pb.TagNumber(13)
  $core.String get postOfficeState => $_getSZ(12);
  @$pb.TagNumber(13)
  set postOfficeState($core.String value) => $_setString(12, value);
  @$pb.TagNumber(13)
  $core.bool hasPostOfficeState() => $_has(12);
  @$pb.TagNumber(13)
  void clearPostOfficeState() => $_clearField(13);

  /// Abbreviated city.
  @$pb.TagNumber(14)
  $core.String get abbreviatedCity => $_getSZ(13);
  @$pb.TagNumber(14)
  set abbreviatedCity($core.String value) => $_setString(13, value);
  @$pb.TagNumber(14)
  $core.bool hasAbbreviatedCity() => $_has(13);
  @$pb.TagNumber(14)
  void clearAbbreviatedCity() => $_clearField(14);

  /// FIPS county code.
  @$pb.TagNumber(15)
  $core.String get fipsCountyCode => $_getSZ(14);
  @$pb.TagNumber(15)
  set fipsCountyCode($core.String value) => $_setString(14, value);
  @$pb.TagNumber(15)
  $core.bool hasFipsCountyCode() => $_has(14);
  @$pb.TagNumber(15)
  void clearFipsCountyCode() => $_clearField(15);

  /// County name.
  @$pb.TagNumber(16)
  $core.String get county => $_getSZ(15);
  @$pb.TagNumber(16)
  set county($core.String value) => $_setString(15, value);
  @$pb.TagNumber(16)
  $core.bool hasCounty() => $_has(15);
  @$pb.TagNumber(16)
  void clearCounty() => $_clearField(16);

  /// Enhanced Line of Travel (eLOT) number.
  @$pb.TagNumber(17)
  $core.String get elotNumber => $_getSZ(16);
  @$pb.TagNumber(17)
  set elotNumber($core.String value) => $_setString(16, value);
  @$pb.TagNumber(17)
  $core.bool hasElotNumber() => $_has(16);
  @$pb.TagNumber(17)
  void clearElotNumber() => $_clearField(17);

  /// eLOT Ascending/Descending Flag (A/D).
  @$pb.TagNumber(18)
  $core.String get elotFlag => $_getSZ(17);
  @$pb.TagNumber(18)
  set elotFlag($core.String value) => $_setString(17, value);
  @$pb.TagNumber(18)
  $core.bool hasElotFlag() => $_has(17);
  @$pb.TagNumber(18)
  void clearElotFlag() => $_clearField(18);

  /// LACSLink return code.
  @$pb.TagNumber(19)
  $core.String get lacsLinkReturnCode => $_getSZ(18);
  @$pb.TagNumber(19)
  set lacsLinkReturnCode($core.String value) => $_setString(18, value);
  @$pb.TagNumber(19)
  $core.bool hasLacsLinkReturnCode() => $_has(18);
  @$pb.TagNumber(19)
  void clearLacsLinkReturnCode() => $_clearField(19);

  /// LACSLink indicator.
  @$pb.TagNumber(20)
  $core.String get lacsLinkIndicator => $_getSZ(19);
  @$pb.TagNumber(20)
  set lacsLinkIndicator($core.String value) => $_setString(19, value);
  @$pb.TagNumber(20)
  $core.bool hasLacsLinkIndicator() => $_has(19);
  @$pb.TagNumber(20)
  void clearLacsLinkIndicator() => $_clearField(20);

  /// PO Box only postal code.
  @$pb.TagNumber(21)
  $core.bool get poBoxOnlyPostalCode => $_getBF(20);
  @$pb.TagNumber(21)
  set poBoxOnlyPostalCode($core.bool value) => $_setBool(20, value);
  @$pb.TagNumber(21)
  $core.bool hasPoBoxOnlyPostalCode() => $_has(20);
  @$pb.TagNumber(21)
  void clearPoBoxOnlyPostalCode() => $_clearField(21);
  ...
  @$pb.TagNumber(22)
  set suitelinkFootnote($core.String value) => $_setString(21, value);
  @$pb.TagNumber(22)
  $core.bool hasSuitelinkFootnote() => $_has(21);
  @$pb.TagNumber(22)
  void clearSuitelinkFootnote() => $_clearField(22);

  /// PMB (Private Mail Box) unit designator.
  @$pb.TagNumber(23)
  $core.String get pmbDesignator => $_getSZ(22);
  @$pb.TagNumber(23)
  set pmbDesignator($core.String value) => $_setString(22, value);
  @$pb.TagNumber(23)
  $core.bool hasPmbDesignator() => $_has(22);
  @$pb.TagNumber(23)
  void clearPmbDesignator() => $_clearField(23);

  /// PMB (Private Mail Box) number;
  @$pb.TagNumber(24)
  $core.String get pmbNumber => $_getSZ(23);
  @$pb.TagNumber(24)
  set pmbNumber($core.String value) => $_setString(23, value);
  @$pb.TagNumber(24)
  $core.bool hasPmbNumber() => $_has(23);
  @$pb.TagNumber(24)
  void clearPmbNumber() => $_clearField(24);
  ...
  @$pb.TagNumber(25)
  set addressRecordType($core.String value) => $_setString(24, value);
  @$pb.TagNumber(25)
  $core.bool hasAddressRecordType() => $_has(24);
  @$pb.TagNumber(25)
  void clearAddressRecordType() => $_clearField(25);
  ...
  @$pb.TagNumber(26)
  set defaultAddress($core.bool value) => $_setBool(25, value);
  @$pb.TagNumber(26)
  $core.bool hasDefaultAddress() => $_has(25);
  @$pb.TagNumber(26)
  void clearDefaultAddress() => $_clearField(26);
  ...
  @$pb.TagNumber(27)
  set errorMessage($core.String value) => $_setString(26, value);
  @$pb.TagNumber(27)
  $core.bool hasErrorMessage() => $_has(26);
  @$pb.TagNumber(27)
  void clearErrorMessage() => $_clearField(27);

  /// Indicator that the request has been CASS processed.
  @$pb.TagNumber(28)
  $core.bool get cassProcessed => $_getBF(27);
  @$pb.TagNumber(28)
  set cassProcessed($core.bool value) => $_setBool(27, value);
  @$pb.TagNumber(28)
  $core.bool hasCassProcessed() => $_has(27);
  @$pb.TagNumber(28)
  void clearCassProcessed() => $_clearField(28);
  ...
  @$pb.TagNumber(29)
  set dpvNoStatReasonCode($core.int value) => $_setSignedInt32(28, value);
  @$pb.TagNumber(29)
  $core.bool hasDpvNoStatReasonCode() => $_has(28);
  @$pb.TagNumber(29)
  void clearDpvNoStatReasonCode() => $_clearField(29);
  ...
  @$pb.TagNumber(30)
  set dpvDrop($core.String value) => $_setString(29, value);
  @$pb.TagNumber(30)
  $core.bool hasDpvDrop() => $_has(29);
  @$pb.TagNumber(30)
  void clearDpvDrop() => $_clearField(30);
  ...
  @$pb.TagNumber(31)
  set dpvThrowback($core.String value) => $_setString(30, value);
  @$pb.TagNumber(31)
  $core.bool hasDpvThrowback() => $_has(30);
  @$pb.TagNumber(31)
  void clearDpvThrowback() => $_clearField(31);
  ...
  @$pb.TagNumber(32)
  set dpvNonDeliveryDays($core.String value) => $_setString(31, value);
  @$pb.TagNumber(32)
  $core.bool hasDpvNonDeliveryDays() => $_has(31);
  @$pb.TagNumber(32)
  void clearDpvNonDeliveryDays() => $_clearField(32);
  ...
  @$pb.TagNumber(33)
  set dpvNonDeliveryDaysValues($core.int value) => $_setSignedInt32(32, value);
  @$pb.TagNumber(33)
  $core.bool hasDpvNonDeliveryDaysValues() => $_has(32);
  @$pb.TagNumber(33)
  void clearDpvNonDeliveryDaysValues() => $_clearField(33);
  ...
  @$pb.TagNumber(34)
  set dpvNoSecureLocation($core.String value) => $_setString(33, value);
  @$pb.TagNumber(34)
  $core.bool hasDpvNoSecureLocation() => $_has(33);
  @$pb.TagNumber(34)
  void clearDpvNoSecureLocation() => $_clearField(34);
  ...
  @$pb.TagNumber(35)
  set dpvPbsa($core.String value) => $_setString(34, value);
  @$pb.TagNumber(35)
  $core.bool hasDpvPbsa() => $_has(34);
  @$pb.TagNumber(35)
  void clearDpvPbsa() => $_clearField(35);
  ...
  @$pb.TagNumber(36)
  set dpvDoorNotAccessible($core.String value) => $_setString(35, value);
  @$pb.TagNumber(36)
  $core.bool hasDpvDoorNotAccessible() => $_has(35);
  @$pb.TagNumber(36)
  void clearDpvDoorNotAccessible() => $_clearField(36);
  ...
  @$pb.TagNumber(37)
  set dpvEnhancedDeliveryCode($core.String value) => $_setString(36, value);
  @$pb.TagNumber(37)
  $core.bool hasDpvEnhancedDeliveryCode() => $_has(36);
  @$pb.TagNumber(37)
  void clearDpvEnhancedDeliveryCode() => $_clearField(37);
}
