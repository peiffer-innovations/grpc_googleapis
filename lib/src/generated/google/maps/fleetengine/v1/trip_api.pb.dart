...
class CreateTripRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set trip($1.Trip value) => $_setField(4, value);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  void clearTripId() => $_clearField(5);
}
...
class GetTripRequest extends $pb.GeneratedMessage {
  factory GetTripRequest({
    ...
    if (routeFormatType != null) result.routeFormatType = routeFormatType;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.Timestamp>(7, _omitFieldNames ? '' : 'remainingWaypointsVersion',
        subBuilder: $4.Timestamp.create)
    ..aE<$7.PolylineFormatType>(8, _omitFieldNames ? '' : 'routeFormatType',
    ...
    ..aOM<$4.Timestamp>(
        ...
        subBuilder: $4.Timestamp.create)
    ..aE<$1.TripView>(11, _omitFieldNames ? '' : 'view',
  ...
  @$pb.TagNumber(6)
  set currentRouteSegmentVersion($4.Timestamp value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasCurrentRouteSegmentVersion() => $_has(2);
  @$pb.TagNumber(6)
  void clearCurrentRouteSegmentVersion() => $_clearField(6);
  @$pb.TagNumber(6)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(7)
  set remainingWaypointsVersion($4.Timestamp value) => $_setField(7, value);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(7)
  $core.bool hasRemainingWaypointsVersion() => $_has(3);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(7)
  void clearRemainingWaypointsVersion() => $_clearField(7);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set routeFormatType($7.PolylineFormatType value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasRouteFormatType() => $_has(4);
  @$pb.TagNumber(8)
  void clearRouteFormatType() => $_clearField(8);
  ...
  @$pb.TagNumber(9)
  set currentRouteSegmentTrafficVersion($4.Timestamp value) =>
      $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasCurrentRouteSegmentTrafficVersion() => $_has(5);
  @$pb.TagNumber(9)
  void clearCurrentRouteSegmentTrafficVersion() => $_clearField(9);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set remainingWaypointsRouteVersion($4.Timestamp value) =>
      $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasRemainingWaypointsRouteVersion() => $_has(6);
  @$pb.TagNumber(10)
  void clearRemainingWaypointsRouteVersion() => $_clearField(10);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set view($1.TripView value) => $_setField(11, value);
  @$pb.TagNumber(11)
  $core.bool hasView() => $_has(7);
  @$pb.TagNumber(11)
  void clearView() => $_clearField(11);
}
...
class ReportBillableTripRequest extends $pb.GeneratedMessage {
  ...
  ReportBillableTripRequest._();

  factory ReportBillableTripRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ReportBillableTripRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<$1.BillingPlatformIdentifier>(5, _omitFieldNames ? '' : 'platform',
        enumValues: $1.BillingPlatformIdentifier.values)
    ..pPS(6, _omitFieldNames ? '' : 'relatedIds')
    ..aE<ReportBillableTripRequest_SolutionType>(
        7, _omitFieldNames ? '' : 'solutionType',
        enumValues: ReportBillableTripRequest_SolutionType.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReportBillableTripRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(5)
  set platform($1.BillingPlatformIdentifier value) => $_setField(5, value);
  @$pb.TagNumber(5)
  ...
  /// limited to 50.
  @$pb.TagNumber(6)
  $pb.PbList<$core.String> get relatedIds => $_getList(3);
  ...
  @$pb.TagNumber(7)
  set solutionType(ReportBillableTripRequest_SolutionType value) =>
      $_setField(7, value);
  @$pb.TagNumber(7)
  $core.bool hasSolutionType() => $_has(4);
  @$pb.TagNumber(7)
  void clearSolutionType() => $_clearField(7);
}
...
class SearchTripsRequest extends $pb.GeneratedMessage {
  factory SearchTripsRequest({
    ...
    if (activeTripsOnly != null) result.activeTripsOnly = activeTripsOnly;
    if (pageSize != null) result.pageSize = pageSize;
    if (pageToken != null) result.pageToken = pageToken;
    if (minimumStaleness != null) result.minimumStaleness = minimumStaleness;
    return result;
  }

  SearchTripsRequest._();

  factory SearchTripsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory SearchTripsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SearchTripsRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(5)
  set activeTripsOnly($core.bool value) => $_setBool(3, value);
  @$pb.TagNumber(5)
  $core.bool hasActiveTripsOnly() => $_has(3);
  @$pb.TagNumber(5)
  void clearActiveTripsOnly() => $_clearField(5);
  ...
  @$pb.TagNumber(8)
  set minimumStaleness($6.Duration value) => $_setField(8, value);
  @$pb.TagNumber(8)
  $core.bool hasMinimumStaleness() => $_has(6);
  @$pb.TagNumber(8)
  void clearMinimumStaleness() => $_clearField(8);
  @$pb.TagNumber(8)
...
class SearchTripsResponse extends $pb.GeneratedMessage {
  ...
  SearchTripsResponse._();

  factory SearchTripsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory SearchTripsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'maps.fleetengine.v1'),
      createEmptyInstance: create)
    ..pPM<$1.Trip>(1, _omitFieldNames ? '' : 'trips',
        subBuilder: $1.Trip.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SearchTripsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<$1.Trip> get trips => $_getList(0);
