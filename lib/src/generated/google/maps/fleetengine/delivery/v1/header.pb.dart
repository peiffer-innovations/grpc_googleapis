...
class DeliveryRequestHeader extends $pb.GeneratedMessage {
  ...
  DeliveryRequestHeader._();

  factory DeliveryRequestHeader.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory DeliveryRequestHeader.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DeliveryRequestHeader',
    ...
    ..aE<DeliveryRequestHeader_SdkType>(6, _omitFieldNames ? '' : 'sdkType',
        enumValues: DeliveryRequestHeader_SdkType.values)
    ..aOS(7, _omitFieldNames ? '' : 'mapsSdkVersion')
    ..aOS(8, _omitFieldNames ? '' : 'navSdkVersion')
    ..aE<DeliveryRequestHeader_Platform>(9, _omitFieldNames ? '' : 'platform',
  ...
  DeliveryRequestHeader clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(6)
  set sdkType(DeliveryRequestHeader_SdkType value) => $_setField(6, value);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(9)
  set platform(DeliveryRequestHeader_Platform value) => $_setField(9, value);
  @$pb.TagNumber(9)
