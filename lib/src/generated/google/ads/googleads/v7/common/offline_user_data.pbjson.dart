...
final $typed_data.Uint8List offlineUserAddressInfoDescriptor =
    $convert.base64Decode(
        '');
...
const UserIdentifier$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v7.enums.UserIdentifierSourceEnum.UserIdentifierSource',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.OfflineUserAddressInfo',
      '9': 0,
      '10': 'addressInfo'
    },
  ],
...
final $typed_data.Uint8List userIdentifierDescriptor = $convert.base64Decode(
    '');
...
const TransactionAttribute$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.StoreAttribute',
      '10': 'storeAttribute'
    },
    const {
      '1': 'custom_value',
...
const UserData$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.UserIdentifier',
      '10': 'userIdentifiers'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.TransactionAttribute',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.UserAttribute',
      '10': 'userAttribute'
    },
  ],
};
...
final $typed_data.Uint8List userDataDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List userAttributeDescriptor = $convert.base64Decode(
    'Cg1Vc2VyQXR0cmlidXRlEjcKFWxpZmV0aW1lX3ZhbHVlX21pY3JvcxgBIAEoA0gAUhNsaWZldGltZVZhbHVlTWljcm9ziAEBEjcKFWxpZmV0aW1lX3ZhbHVlX2J1Y2tldBgCIAEoBUgBUhNsaWZldGltZVZhbHVlQnVja2V0iAEBQhgKFl9saWZldGltZV92YWx1ZV9taWNyb3NCGAoWX2xpZmV0aW1lX3ZhbHVlX2J1Y2tldA==');
...
const StoreSalesMetadata$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.StoreSalesThirdPartyMetadata',
...
final $typed_data.Uint8List storeSalesMetadataDescriptor = $convert.base64Decode(
    '');
