...
const CrmBasedUserListInfo$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v7.enums.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType',
      '10': 'uploadKeyType'
    },
    const {
      '1': 'data_source_type',
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v7.enums.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType',
      '10': 'dataSourceType'
    },
  ],
  '8': const [
...
final $typed_data.Uint8List crmBasedUserListInfoDescriptor = $convert.base64Decode(
    '');
...
const UserListRuleInfo$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v7.enums.UserListRuleTypeEnum.UserListRuleType',
      '10': 'ruleType'
    },
    const {
      '1': 'rule_item_groups',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.UserListRuleItemGroupInfo',
      '10': 'ruleItemGroups'
    },
  ],
};
...
final $typed_data.Uint8List userListRuleInfoDescriptor = $convert.base64Decode(
    '');
...
const UserListRuleItemGroupInfo$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.UserListRuleItemInfo',
      '10': 'ruleItems'
    },
  ],
};
...
final $typed_data.Uint8List userListRuleItemGroupInfoDescriptor =
    $convert.base64Decode(
        'ChlVc2VyTGlzdFJ1bGVJdGVtR3JvdXBJbmZvElMKCnJ1bGVfaXRlbXMYASADKAsyNC5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5jb21tb24uVXNlckxpc3RSdWxlSXRlbUluZm9SCXJ1bGVJdGVtcw==');
...
const UserListRuleItemInfo$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.UserListNumberRuleItemInfo',
      '9': 0,
      '10': 'numberRuleItem'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.UserListStringRuleItemInfo',
      '9': 0,
      '10': 'stringRuleItem'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.UserListDateRuleItemInfo',
      '9': 0,
      '10': 'dateRuleItem'
    },
  ],
...
final $typed_data.Uint8List userListRuleItemInfoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List userListDateRuleItemInfoDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List userListNumberRuleItemInfoDescriptor =
    $convert.base64Decode(
        'ChpVc2VyTGlzdE51bWJlclJ1bGVJdGVtSW5mbxJ8CghvcGVyYXRvchgBIAEoDjJgLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LmVudW1zLlVzZXJMaXN0TnVtYmVyUnVsZUl0ZW1PcGVyYXRvckVudW0uVXNlckxpc3ROdW1iZXJSdWxlSXRlbU9wZXJhdG9yUghvcGVyYXRvchIZCgV2YWx1ZRgDIAEoAUgAUgV2YWx1ZYgBAUIICgZfdmFsdWU=');
...
final $typed_data.Uint8List userListStringRuleItemInfoDescriptor =
    $convert.base64Decode(
        'ChpVc2VyTGlzdFN0cmluZ1J1bGVJdGVtSW5mbxJ8CghvcGVyYXRvchgBIAEoDjJgLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LmVudW1zLlVzZXJMaXN0U3RyaW5nUnVsZUl0ZW1PcGVyYXRvckVudW0uVXNlckxpc3RTdHJpbmdSdWxlSXRlbU9wZXJhdG9yUghvcGVyYXRvchIZCgV2YWx1ZRgDIAEoCUgAUgV2YWx1ZYgBAUIICgZfdmFsdWU=');
...
const CombinedRuleUserListInfo$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.UserListRuleInfo',
      '10': 'leftOperand'
    },
    const {
      '1': 'right_operand',
...
final $typed_data.Uint8List combinedRuleUserListInfoDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List dateSpecificRuleUserListInfoDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List expressionRuleUserListInfoDescriptor =
    $convert.base64Decode(
        'ChpFeHByZXNzaW9uUnVsZVVzZXJMaXN0SW5mbxJECgRydWxlGAEgASgLMjAuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjcuY29tbW9uLlVzZXJMaXN0UnVsZUluZm9SBHJ1bGU=');
...
const RuleBasedUserListInfo$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.CombinedRuleUserListInfo',
      '9': 0,
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.DateSpecificRuleUserListInfo',
      '9': 0,
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.ExpressionRuleUserListInfo',
      '9': 0,
...
final $typed_data.Uint8List ruleBasedUserListInfoDescriptor = $convert.base64Decode(
    '');
...
const LogicalUserListInfo$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.UserListLogicalRuleInfo',
      '10': 'rules'
    },
  ],
};
...
final $typed_data.Uint8List logicalUserListInfoDescriptor = $convert.base64Decode(
    'ChNMb2dpY2FsVXNlckxpc3RJbmZvEk0KBXJ1bGVzGAEgAygLMjcuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjcuY29tbW9uLlVzZXJMaXN0TG9naWNhbFJ1bGVJbmZvUgVydWxlcw==');
...
const UserListLogicalRuleInfo$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.LogicalUserListOperandInfo',
      '10': 'ruleOperands'
    },
  ],
};
...
final $typed_data.Uint8List userListLogicalRuleInfoDescriptor =
    $convert.base64Decode(
        '');
...
const BasicUserListInfo$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.UserListActionInfo',
      '10': 'actions'
    },
  ],
};
...
final $typed_data.Uint8List basicUserListInfoDescriptor = $convert.base64Decode(
    'ChFCYXNpY1VzZXJMaXN0SW5mbxJMCgdhY3Rpb25zGAEgAygLMjIuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjcuY29tbW9uLlVzZXJMaXN0QWN0aW9uSW5mb1IHYWN0aW9ucw==');
