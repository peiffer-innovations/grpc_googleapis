...
const YearMonthRange$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.YearMonth',
      '10': 'start'
    },
    const {
      '1': 'end',
...
final $typed_data.Uint8List yearMonthRangeDescriptor = $convert.base64Decode(
    'Cg5ZZWFyTW9udGhSYW5nZRI/CgVzdGFydBgBIAEoCzIpLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LmNvbW1vbi5ZZWFyTW9udGhSBXN0YXJ0EjsKA2VuZBgCIAEoCzIpLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LmNvbW1vbi5ZZWFyTW9udGhSA2VuZA==');
...
final $typed_data.Uint8List yearMonthDescriptor = $convert.base64Decode(
    'CglZZWFyTW9udGgSEgoEeWVhchgBIAEoA1IEeWVhchJQCgVtb250aBgCIAEoDjI6Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LmVudW1zLk1vbnRoT2ZZZWFyRW51bS5Nb250aE9mWWVhclIFbW9udGg=');
