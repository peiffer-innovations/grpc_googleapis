...
const KeywordPlanHistoricalMetrics$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.MonthlySearchVolume',
...
final $typed_data.Uint8List keywordPlanHistoricalMetricsDescriptor =
    $convert.base64Decode(
        '');
...
const HistoricalMetricsOptions$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.YearMonthRange',
      '9': 0,
      '10': 'yearMonthRange',
      '17': true
    },
...
final $typed_data.Uint8List historicalMetricsOptionsDescriptor =
    $convert.base64Decode(
        'ChhIaXN0b3JpY2FsTWV0cmljc09wdGlvbnMSXQoQeWVhcl9tb250aF9yYW5nZRgBIAEoCzIuLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LmNvbW1vbi5ZZWFyTW9udGhSYW5nZUgAUg55ZWFyTW9udGhSYW5nZYgBAUITChFfeWVhcl9tb250aF9yYW5nZQ==');
...
final $typed_data.Uint8List monthlySearchVolumeDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List keywordPlanAggregateMetricsDescriptor =
    $convert.base64Decode(
        'ChtLZXl3b3JkUGxhbkFnZ3JlZ2F0ZU1ldHJpY3MSlgEKFmFnZ3JlZ2F0ZV9tZXRyaWNfdHlwZXMYASADKA4yYC5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5lbnVtcy5LZXl3b3JkUGxhbkFnZ3JlZ2F0ZU1ldHJpY1R5cGVFbnVtLktleXdvcmRQbGFuQWdncmVnYXRlTWV0cmljVHlwZVIUYWdncmVnYXRlTWV0cmljVHlwZXM=');
...
const KeywordPlanAggregateMetricResults$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.KeywordPlanDeviceSearches',
      '10': 'deviceSearches'
    },
  ],
};
...
final $typed_data.Uint8List keywordPlanAggregateMetricResultsDescriptor =
    $convert.base64Decode(
        'CiFLZXl3b3JkUGxhbkFnZ3JlZ2F0ZU1ldHJpY1Jlc3VsdHMSYgoPZGV2aWNlX3NlYXJjaGVzGAEgAygLMjkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjcuY29tbW9uLktleXdvcmRQbGFuRGV2aWNlU2VhcmNoZXNSDmRldmljZVNlYXJjaGVz');
...
final $typed_data.Uint8List keywordPlanDeviceSearchesDescriptor =
    $convert.base64Decode(
        'ChlLZXl3b3JkUGxhbkRldmljZVNlYXJjaGVzEkgKBmRldmljZRgBIAEoDjIwLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LmVudW1zLkRldmljZUVudW0uRGV2aWNlUgZkZXZpY2USJgoMc2VhcmNoX2NvdW50GAIgASgDSABSC3NlYXJjaENvdW50iAEBQg8KDV9zZWFyY2hfY291bnQ=');
...
const KeywordAnnotations$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.KeywordConcept',
      '10': 'concepts'
    },
  ],
};
...
final $typed_data.Uint8List keywordAnnotationsDescriptor = $convert.base64Decode(
    'ChJLZXl3b3JkQW5ub3RhdGlvbnMSSgoIY29uY2VwdHMYASADKAsyLi5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5jb21tb24uS2V5d29yZENvbmNlcHRSCGNvbmNlcHRz');
...
const KeywordConcept$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.common.ConceptGroup',
      '10': 'conceptGroup'
    },
  ],
};
...
final $typed_data.Uint8List keywordConceptDescriptor = $convert.base64Decode(
    'Cg5LZXl3b3JkQ29uY2VwdBISCgRuYW1lGAEgASgJUgRuYW1lElEKDWNvbmNlcHRfZ3JvdXAYAiABKAsyLC5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5jb21tb24uQ29uY2VwdEdyb3VwUgxjb25jZXB0R3JvdXA=');
...
final $typed_data.Uint8List conceptGroupDescriptor = $convert.base64Decode(
    'CgxDb25jZXB0R3JvdXASEgoEbmFtZRgBIAEoCVIEbmFtZRJuCgR0eXBlGAIgASgOMlouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjcuZW51bXMuS2V5d29yZFBsYW5Db25jZXB0R3JvdXBUeXBlRW51bS5LZXl3b3JkUGxhbkNvbmNlcHRHcm91cFR5cGVSBHR5cGU=');
