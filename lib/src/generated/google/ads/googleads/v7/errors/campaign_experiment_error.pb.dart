...
class CampaignExperimentErrorEnum extends $pb.GeneratedMessage {
  ...
  CampaignExperimentErrorEnum copyWith(
      ...
      super.copyWith(
          ...
          as CampaignExperimentErrorEnum; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static CampaignExperimentErrorEnum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CampaignExperimentErrorEnum>(create);
