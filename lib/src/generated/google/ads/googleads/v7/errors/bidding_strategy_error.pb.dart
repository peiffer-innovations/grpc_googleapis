...
class BiddingStrategyErrorEnum extends $pb.GeneratedMessage {
  ...
  BiddingStrategyErrorEnum copyWith(
      ...
      super.copyWith((message) => updates(message as BiddingStrategyErrorEnum))
          as BiddingStrategyErrorEnum; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static BiddingStrategyErrorEnum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BiddingStrategyErrorEnum>(create);
