...
class WebpageView extends $pb.GeneratedMessage {
  ...
  factory WebpageView.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory WebpageView.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  WebpageView copyWith(void Function(WebpageView) updates) =>
      super.copyWith((message) => updates(message as WebpageView))
          as WebpageView; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static WebpageView getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<WebpageView>(create);
