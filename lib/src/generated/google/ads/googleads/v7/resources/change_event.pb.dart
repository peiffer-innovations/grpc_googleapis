...
class ChangeEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$13.ChangeEventResourceTypeEnum_ChangeEventResourceType>(
        ...
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $13.ChangeEventResourceTypeEnum_ChangeEventResourceType.UNSPECIFIED,
        valueOf:
            $13.ChangeEventResourceTypeEnum_ChangeEventResourceType.valueOf,
        enumValues:
            $13.ChangeEventResourceTypeEnum_ChangeEventResourceType.values)
    ..aOS(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'changeResourceName')
    ..e<$14.ChangeClientTypeEnum_ChangeClientType>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'clientType',
        $pb.PbFieldType.OE,
        defaultOrMaker: $14.ChangeClientTypeEnum_ChangeClientType.UNSPECIFIED,
        valueOf: $14.ChangeClientTypeEnum_ChangeClientType.valueOf,
        enumValues: $14.ChangeClientTypeEnum_ChangeClientType.values)
    ..aOS(
        6,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..e<$15.ResourceChangeOperationEnum_ResourceChangeOperation>(
        ...
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $15.ResourceChangeOperationEnum_ResourceChangeOperation.UNSPECIFIED,
        valueOf:
            $15.ResourceChangeOperationEnum_ResourceChangeOperation.valueOf,
        enumValues:
            $15.ResourceChangeOperationEnum_ResourceChangeOperation.values)
    ..aOM<$0.FieldMask>(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory ChangeEvent({
    ...
    $15.ResourceChangeOperationEnum_ResourceChangeOperation?
        resourceChangeOperation,
  ...
  @$pb.TagNumber(3)
  $13.ChangeEventResourceTypeEnum_ChangeEventResourceType
      get changeResourceType => $_getN(2);
  @$pb.TagNumber(3)
  set changeResourceType(
      $13.ChangeEventResourceTypeEnum_ChangeEventResourceType v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(5)
  set clientType($14.ChangeClientTypeEnum_ChangeClientType v) {
    setField(5, v);
  }
  ...
  set resourceChangeOperation(
      $15.ResourceChangeOperationEnum_ResourceChangeOperation v) {
    setField(9, v);
  }
