...
class ChangeStatusResourceTypeEnum extends $pb.GeneratedMessage {
  ...
  ChangeStatusResourceTypeEnum copyWith(
      ...
      super.copyWith(
          ...
          as ChangeStatusResourceTypeEnum; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static ChangeStatusResourceTypeEnum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ChangeStatusResourceTypeEnum>(create);
