...
class TimeTypeEnum_TimeType extends $pb.ProtobufEnum {
  static const TimeTypeEnum_TimeType UNSPECIFIED = TimeTypeEnum_TimeType._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNSPECIFIED');
  static const TimeTypeEnum_TimeType UNKNOWN = TimeTypeEnum_TimeType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  static const TimeTypeEnum_TimeType NOW = TimeTypeEnum_TimeType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NOW');
  static const TimeTypeEnum_TimeType FOREVER = TimeTypeEnum_TimeType._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FOREVER');
