...
class ExtensionSettingDeviceEnum extends $pb.GeneratedMessage {
  ...
  ExtensionSettingDeviceEnum copyWith(
      ...
      super.copyWith(
          ...
          as ExtensionSettingDeviceEnum; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static ExtensionSettingDeviceEnum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ExtensionSettingDeviceEnum>(create);
