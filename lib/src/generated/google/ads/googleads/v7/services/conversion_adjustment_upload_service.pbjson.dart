...
const UploadConversionAdjustmentsRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.ConversionAdjustment',
      '8': const {},
...
final $typed_data.Uint8List uploadConversionAdjustmentsRequestDescriptor =
    $convert.base64Decode(
        '');
...
const UploadConversionAdjustmentsResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.ConversionAdjustmentResult',
      '10': 'results'
    },
  ],
};
...
final $typed_data.Uint8List uploadConversionAdjustmentsResponseDescriptor =
    $convert.base64Decode(
        '');
...
const ConversionAdjustment$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v7.enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentType',
      '10': 'adjustmentType'
    },
    const {
      '1': 'restatement_value',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.RestatementValue',
      '10': 'restatementValue'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.GclidDateTimePair',
      '9': 0,
...
final $typed_data.Uint8List conversionAdjustmentDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List conversionAdjustmentResultDescriptor =
    $convert.base64Decode(
        '');
