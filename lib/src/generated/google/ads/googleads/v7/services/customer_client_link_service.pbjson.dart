...
const MutateCustomerClientLinkRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.CustomerClientLinkOperation',
      '8': const {},
      '10': 'operation'
    },
...
final $typed_data.Uint8List mutateCustomerClientLinkRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List customerClientLinkOperationDescriptor =
    $convert.base64Decode(
        '');
...
const MutateCustomerClientLinkResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.MutateCustomerClientLinkResult',
      '10': 'result'
    },
  ],
};
...
final $typed_data.Uint8List mutateCustomerClientLinkResponseDescriptor =
    $convert.base64Decode(
        'CiBNdXRhdGVDdXN0b21lckNsaWVudExpbmtSZXNwb25zZRJYCgZyZXN1bHQYASABKAsyQC5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5zZXJ2aWNlcy5NdXRhdGVDdXN0b21lckNsaWVudExpbmtSZXN1bHRSBnJlc3VsdA==');
