...
final $typed_data.Uint8List mutateCampaignLabelsRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List campaignLabelOperationDescriptor =
    $convert.base64Decode(
        'ChZDYW1wYWlnbkxhYmVsT3BlcmF0aW9uEkoKBmNyZWF0ZRgBIAEoCzIwLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LnJlc291cmNlcy5DYW1wYWlnbkxhYmVsSABSBmNyZWF0ZRIYCgZyZW1vdmUYAiABKAlIAFIGcmVtb3ZlQgsKCW9wZXJhdGlvbg==');
...
final $typed_data.Uint8List mutateCampaignLabelsResponseDescriptor =
    $convert.base64Decode(
        'ChxNdXRhdGVDYW1wYWlnbkxhYmVsc1Jlc3BvbnNlEkYKFXBhcnRpYWxfZmFpbHVyZV9lcnJvchgDIAEoCzISLmdvb2dsZS5ycGMuU3RhdHVzUhNwYXJ0aWFsRmFpbHVyZUVycm9yElUKB3Jlc3VsdHMYAiADKAsyOy5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5zZXJ2aWNlcy5NdXRhdGVDYW1wYWlnbkxhYmVsUmVzdWx0UgdyZXN1bHRz');
