...
final $typed_data.Uint8List mutateCustomerRequestDescriptor = $convert.base64Decode(
    '');
...
const CreateCustomerClientRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.ads.googleads.v7.enums.AccessRoleEnum.AccessRole',
      '10': 'accessRole'
    },
...
final $typed_data.Uint8List customerOperationDescriptor = $convert.base64Decode(
    'ChFDdXN0b21lck9wZXJhdGlvbhJDCgZ1cGRhdGUYASABKAsyKy5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5yZXNvdXJjZXMuQ3VzdG9tZXJSBnVwZGF0ZRI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCnVwZGF0ZU1hc2s=');
...
final $typed_data.Uint8List mutateCustomerResponseDescriptor =
    $convert.base64Decode(
        'ChZNdXRhdGVDdXN0b21lclJlc3BvbnNlEk4KBnJlc3VsdBgCIAEoCzI2Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LnNlcnZpY2VzLk11dGF0ZUN1c3RvbWVyUmVzdWx0UgZyZXN1bHQ=');
...
final $typed_data.Uint8List mutateCustomerResultDescriptor = $convert.base64Decode(
    'ChRNdXRhdGVDdXN0b21lclJlc3VsdBIjCg1yZXNvdXJjZV9uYW1lGAEgASgJUgxyZXNvdXJjZU5hbWUSRwoIY3VzdG9tZXIYAiABKAsyKy5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5yZXNvdXJjZXMuQ3VzdG9tZXJSCGN1c3RvbWVy');
