  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$106.BatchJob>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'create',
        subBuilder: $106.BatchJob.create)
    ..hasRequiredFields = false;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'sequenceToken')
    ..pc<$104.MutateOperation>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mutateOperations',
        $pb.PbFieldType.PM,
        subBuilder: $104.MutateOperation.create)
    ..hasRequiredFields = false;
...
class ListBatchJobResultsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$108.ResponseContentTypeEnum_ResponseContentType>(
        ...
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $108.ResponseContentTypeEnum_ResponseContentType.UNSPECIFIED,
        valueOf: $108.ResponseContentTypeEnum_ResponseContentType.valueOf,
        enumValues: $108.ResponseContentTypeEnum_ResponseContentType.values)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $108.ResponseContentTypeEnum_ResponseContentType get responseContentType =>
      $_getN(3);
  @$pb.TagNumber(4)
  set responseContentType($108.ResponseContentTypeEnum_ResponseContentType v) {
    setField(4, v);
  }
...
class BatchJobResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'operationIndex')
    ..aOM<$104.MutateOperationResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mutateOperationResponse',
        subBuilder: $104.MutateOperationResponse.create)
    ..aOM<$107.Status>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'status',
        subBuilder: $107.Status.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set mutateOperationResponse($104.MutateOperationResponse v) {
    setField(2, v);
  }
