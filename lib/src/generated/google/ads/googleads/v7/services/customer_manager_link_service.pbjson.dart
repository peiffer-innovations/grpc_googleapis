...
const MutateCustomerManagerLinkRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.CustomerManagerLinkOperation',
      '8': const {},
      '10': 'operations'
    },
...
final $typed_data.Uint8List mutateCustomerManagerLinkRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List customerManagerLinkOperationDescriptor =
    $convert.base64Decode(
        'ChxDdXN0b21lck1hbmFnZXJMaW5rT3BlcmF0aW9uEjsKC3VwZGF0ZV9tYXNrGAQgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaxJQCgZ1cGRhdGUYAiABKAsyNi5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5yZXNvdXJjZXMuQ3VzdG9tZXJNYW5hZ2VyTGlua0gAUgZ1cGRhdGVCCwoJb3BlcmF0aW9u');
...
const MutateCustomerManagerLinkResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.MutateCustomerManagerLinkResult',
      '10': 'results'
    },
  ],
};
...
final $typed_data.Uint8List mutateCustomerManagerLinkResponseDescriptor =
    $convert.base64Decode(
        'CiFNdXRhdGVDdXN0b21lck1hbmFnZXJMaW5rUmVzcG9uc2USWwoHcmVzdWx0cxgBIAMoCzJBLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LnNlcnZpY2VzLk11dGF0ZUN1c3RvbWVyTWFuYWdlckxpbmtSZXN1bHRSB3Jlc3VsdHM=');
