...
final $typed_data.Uint8List createAccountLinkRequestDescriptor =
    $convert.base64Decode(
        'ChhDcmVhdGVBY2NvdW50TGlua1JlcXVlc3QSJAoLY3VzdG9tZXJfaWQYASABKAlCA+BBAlIKY3VzdG9tZXJJZBJWCgxhY2NvdW50X2xpbmsYAiABKAsyLi5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5yZXNvdXJjZXMuQWNjb3VudExpbmtCA+BBAlILYWNjb3VudExpbms=');
...
const MutateAccountLinkRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.AccountLinkOperation',
      '8': const {},
      '10': 'operation'
    },
    const {
...
final $typed_data.Uint8List mutateAccountLinkRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List accountLinkOperationDescriptor = $convert.base64Decode(
    '');
...
const MutateAccountLinkResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.MutateAccountLinkResult',
      '10': 'result'
    },
  ],
};
...
final $typed_data.Uint8List mutateAccountLinkResponseDescriptor =
    $convert.base64Decode(
        'ChlNdXRhdGVBY2NvdW50TGlua1Jlc3BvbnNlElEKBnJlc3VsdBgBIAEoCzI5Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LnNlcnZpY2VzLk11dGF0ZUFjY291bnRMaW5rUmVzdWx0UgZyZXN1bHQ=');
