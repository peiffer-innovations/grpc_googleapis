...
const MutateCustomerUserAccessRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.CustomerUserAccessOperation',
      '8': const {},
      '10': 'operation'
    },
  ],
...
final $typed_data.Uint8List mutateCustomerUserAccessRequestDescriptor =
    $convert.base64Decode(
        'Ch9NdXRhdGVDdXN0b21lclVzZXJBY2Nlc3NSZXF1ZXN0EiQKC2N1c3RvbWVyX2lkGAEgASgJQgPgQQJSCmN1c3RvbWVySWQSYAoJb3BlcmF0aW9uGAIgASgLMj0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjcuc2VydmljZXMuQ3VzdG9tZXJVc2VyQWNjZXNzT3BlcmF0aW9uQgPgQQJSCW9wZXJhdGlvbg==');
...
final $typed_data.Uint8List customerUserAccessOperationDescriptor =
    $convert.base64Decode(
        '');
...
const MutateCustomerUserAccessResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v7.services.MutateCustomerUserAccessResult',
      '10': 'result'
    },
  ],
};
...
final $typed_data.Uint8List mutateCustomerUserAccessResponseDescriptor =
    $convert.base64Decode(
        'CiBNdXRhdGVDdXN0b21lclVzZXJBY2Nlc3NSZXNwb25zZRJYCgZyZXN1bHQYASABKAsyQC5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5zZXJ2aWNlcy5NdXRhdGVDdXN0b21lclVzZXJBY2Nlc3NSZXN1bHRSBnJlc3VsdA==');
