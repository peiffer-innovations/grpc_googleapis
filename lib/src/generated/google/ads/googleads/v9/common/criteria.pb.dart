...
class KeywordThemeInfo extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, KeywordThemeInfo_KeywordTheme>
      _KeywordThemeInfo_KeywordThemeByTag = {
  ...
  factory KeywordThemeInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory KeywordThemeInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  KeywordThemeInfo copyWith(void Function(KeywordThemeInfo) updates) =>
      super.copyWith((message) => updates(message as KeywordThemeInfo))
          as KeywordThemeInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static KeywordThemeInfo create() => KeywordThemeInfo._();
  KeywordThemeInfo createEmptyInstance() => create();
  static $pb.PbList<KeywordThemeInfo> createRepeated() =>
      $pb.PbList<KeywordThemeInfo>();
  @$core.pragma('dart2js:noInline')
  static KeywordThemeInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<KeywordThemeInfo>(create);
  static KeywordThemeInfo? _defaultInstance;

  KeywordThemeInfo_KeywordTheme whichKeywordTheme() =>
      _KeywordThemeInfo_KeywordThemeByTag[$_whichOneof(0)]!;
  void clearKeywordTheme() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  $core.String get keywordThemeConstant => $_getSZ(0);
  @$pb.TagNumber(1)
  set keywordThemeConstant($core.String v) {
    $_setString(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set freeFormKeywordTheme($core.String v) {
    $_setString(1, v);
  }
