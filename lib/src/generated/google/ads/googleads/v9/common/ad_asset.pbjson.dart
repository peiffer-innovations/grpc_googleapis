...
const AdTextAsset$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v9.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType',
      '10': 'pinnedField'
    },
    const {
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.AdAssetPolicySummary',
...
final $typed_data.Uint8List adTextAssetDescriptor = $convert.base64Decode(
    '');
