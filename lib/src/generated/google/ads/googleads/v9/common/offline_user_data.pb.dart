...
class UserAttribute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ShoppingLoyalty>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'shoppingLoyalty',
        subBuilder: ShoppingLoyalty.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(7)
  set shoppingLoyalty(ShoppingLoyalty v) {
    setField(7, v);
  }
...
class ShoppingLoyalty extends $pb.GeneratedMessage {
  ...
  factory ShoppingLoyalty.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ShoppingLoyalty.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ShoppingLoyalty copyWith(void Function(ShoppingLoyalty) updates) =>
      super.copyWith((message) => updates(message as ShoppingLoyalty))
          as ShoppingLoyalty; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ShoppingLoyalty create() => ShoppingLoyalty._();
  ShoppingLoyalty createEmptyInstance() => create();
  static $pb.PbList<ShoppingLoyalty> createRepeated() =>
      $pb.PbList<ShoppingLoyalty>();
  @$core.pragma('dart2js:noInline')
  static ShoppingLoyalty getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ShoppingLoyalty>(create);
  static ShoppingLoyalty? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get loyaltyTier => $_getSZ(0);
  @$pb.TagNumber(1)
  set loyaltyTier($core.String v) {
    $_setString(0, v);
  }
