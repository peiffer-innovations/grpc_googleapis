...
class VideoBumperInStreamAdInfo extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set companionBanner($0.AdImageAsset v) {
    setField(3, v);
  }
...
class VideoTrueViewDiscoveryAdInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'description2')
    ..e<$2.VideoThumbnailEnum_VideoThumbnail>(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'thumbnail',
        $pb.PbFieldType.OE,
        defaultOrMaker: $2.VideoThumbnailEnum_VideoThumbnail.UNSPECIFIED,
        valueOf: $2.VideoThumbnailEnum_VideoThumbnail.valueOf,
        enumValues: $2.VideoThumbnailEnum_VideoThumbnail.values)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(7)
  set thumbnail($2.VideoThumbnailEnum_VideoThumbnail v) {
    setField(7, v);
  }
...
class AppPreRegistrationAdInfo extends $pb.GeneratedMessage {
  ...
  factory AppPreRegistrationAdInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AppPreRegistrationAdInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  AppPreRegistrationAdInfo clone() =>
      AppPreRegistrationAdInfo()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AppPreRegistrationAdInfo copyWith(
          void Function(AppPreRegistrationAdInfo) updates) =>
      super.copyWith((message) => updates(message as AppPreRegistrationAdInfo))
          as AppPreRegistrationAdInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AppPreRegistrationAdInfo create() => AppPreRegistrationAdInfo._();
  AppPreRegistrationAdInfo createEmptyInstance() => create();
  static $pb.PbList<AppPreRegistrationAdInfo> createRepeated() =>
      $pb.PbList<AppPreRegistrationAdInfo>();
  @$core.pragma('dart2js:noInline')
  static AppPreRegistrationAdInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AppPreRegistrationAdInfo>(create);
...
class CallAdInfo extends $pb.GeneratedMessage {
  ...
  factory CallAdInfo({
    ...
    $6.CallConversionReportingStateEnum_CallConversionReportingState?
        conversionReportingState,
  ...
  set conversionReportingState(
      $6.CallConversionReportingStateEnum_CallConversionReportingState v) {
    setField(10, v);
  }
