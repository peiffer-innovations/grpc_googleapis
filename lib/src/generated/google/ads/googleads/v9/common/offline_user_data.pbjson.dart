...
const UserIdentifier$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v9.enums.UserIdentifierSourceEnum.UserIdentifierSource',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.OfflineUserAddressInfo',
      '9': 0,
      '10': 'addressInfo'
    },
  ],
...
final $typed_data.Uint8List userIdentifierDescriptor = $convert.base64Decode(
    '');
...
const TransactionAttribute$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.StoreAttribute',
      '10': 'storeAttribute'
    },
    const {
      '1': 'custom_value',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.ItemAttribute',
      '10': 'itemAttribute'
    },
  ],
  '8': const [
...
const UserData$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.TransactionAttribute',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.UserAttribute',
      '10': 'userAttribute'
    },
  ],
};
...
final $typed_data.Uint8List userDataDescriptor = $convert.base64Decode(
    '');
...
const UserAttribute$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.ShoppingLoyalty',
      '9': 2,
      '10': 'shoppingLoyalty',
      '17': true
    },
...
final $typed_data.Uint8List userAttributeDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List shoppingLoyaltyDescriptor = $convert.base64Decode(
    'Cg9TaG9wcGluZ0xveWFsdHkSJgoMbG95YWx0eV90aWVyGAEgASgJSABSC2xveWFsdHlUaWVyiAEBQg8KDV9sb3lhbHR5X3RpZXI=');
...
const StoreSalesMetadata$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.StoreSalesThirdPartyMetadata',
...
final $typed_data.Uint8List storeSalesMetadataDescriptor = $convert.base64Decode(
    '');
