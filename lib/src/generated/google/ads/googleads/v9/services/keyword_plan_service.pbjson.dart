...
final $typed_data.Uint8List mutateKeywordPlansRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List keywordPlanOperationDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List mutateKeywordPlansResponseDescriptor =
    $convert.base64Decode(
        'ChpNdXRhdGVLZXl3b3JkUGxhbnNSZXNwb25zZRJGChVwYXJ0aWFsX2ZhaWx1cmVfZXJyb3IYAyABKAsyEi5nb29nbGUucnBjLlN0YXR1c1ITcGFydGlhbEZhaWx1cmVFcnJvchJUCgdyZXN1bHRzGAIgAygLMjouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjkuc2VydmljZXMuTXV0YXRlS2V5d29yZFBsYW5zUmVzdWx0UgdyZXN1bHRz');
...
const GenerateForecastCurveResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.KeywordPlanCampaignForecastCurve',
...
final $typed_data.Uint8List generateForecastCurveResponseDescriptor =
    $convert.base64Decode(
        'Ch1HZW5lcmF0ZUZvcmVjYXN0Q3VydmVSZXNwb25zZRJ8ChhjYW1wYWlnbl9mb3JlY2FzdF9jdXJ2ZXMYASADKAsyQi5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5zZXJ2aWNlcy5LZXl3b3JkUGxhbkNhbXBhaWduRm9yZWNhc3RDdXJ2ZVIWY2FtcGFpZ25Gb3JlY2FzdEN1cnZlcw==');
...
const GenerateForecastTimeSeriesResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 11,
      '6':
          '.google.ads.googleads.v9.services.KeywordPlanWeeklyTimeSeriesForecast',
...
final $typed_data.Uint8List generateForecastTimeSeriesResponseDescriptor =
    $convert.base64Decode(
        'CiJHZW5lcmF0ZUZvcmVjYXN0VGltZVNlcmllc1Jlc3BvbnNlEoYBChx3ZWVrbHlfdGltZV9zZXJpZXNfZm9yZWNhc3RzGAEgAygLMkUuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjkuc2VydmljZXMuS2V5d29yZFBsYW5XZWVrbHlUaW1lU2VyaWVzRm9yZWNhc3RSGXdlZWtseVRpbWVTZXJpZXNGb3JlY2FzdHM=');
...
const GenerateForecastMetricsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.KeywordPlanCampaignForecast',
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.KeywordPlanAdGroupForecast',
      '10': 'adGroupForecasts'
    },
    const {
      '1': 'keyword_forecasts',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.KeywordPlanKeywordForecast',
      '10': 'keywordForecasts'
    },
  ],
};
...
final $typed_data.Uint8List generateForecastMetricsResponseDescriptor =
    $convert.base64Decode(
        '');
...
const KeywordPlanCampaignForecast$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.ForecastMetrics',
      '10': 'campaignForecast'
    },
  ],
  '8': const [
...
final $typed_data.Uint8List keywordPlanCampaignForecastDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List keywordPlanAdGroupForecastDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List keywordPlanKeywordForecastDescriptor =
    $convert.base64Decode(
        '');
...
const KeywordPlanCampaignForecastCurve$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 11,
      '6':
          '.google.ads.googleads.v9.services.KeywordPlanMaxCpcBidForecastCurve',
...
const KeywordPlanMaxCpcBidForecastCurve$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.KeywordPlanMaxCpcBidForecast',
...
final $typed_data.Uint8List keywordPlanMaxCpcBidForecastCurveDescriptor =
    $convert.base64Decode(
        'CiFLZXl3b3JkUGxhbk1heENwY0JpZEZvcmVjYXN0Q3VydmUScQoVbWF4X2NwY19iaWRfZm9yZWNhc3RzGAEgAygLMj4uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjkuc2VydmljZXMuS2V5d29yZFBsYW5NYXhDcGNCaWRGb3JlY2FzdFISbWF4Q3BjQmlkRm9yZWNhc3Rz');
...
final $typed_data.Uint8List keywordPlanMaxCpcBidForecastDescriptor =
    $convert.base64Decode(
        '');
...
const KeywordPlanWeeklyTimeSeriesForecast$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.KeywordPlanWeeklyForecast',
      '10': 'weeklyForecasts'
    },
  ],
  '8': const [
...
final $typed_data.Uint8List keywordPlanWeeklyTimeSeriesForecastDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List keywordPlanWeeklyForecastDescriptor =
    $convert.base64Decode(
        'ChlLZXl3b3JkUGxhbldlZWtseUZvcmVjYXN0EiIKCnN0YXJ0X2RhdGUYASABKAlIAFIJc3RhcnREYXRliAEBEk0KCGZvcmVjYXN0GAIgASgLMjEuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjkuc2VydmljZXMuRm9yZWNhc3RNZXRyaWNzUghmb3JlY2FzdEINCgtfc3RhcnRfZGF0ZQ==');
...
const GenerateHistoricalMetricsRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.KeywordPlanAggregateMetrics',
      '10': 'aggregateMetrics'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.HistoricalMetricsOptions',
...
final $typed_data.Uint8List generateHistoricalMetricsRequestDescriptor =
    $convert.base64Decode(
        '');
...
const GenerateHistoricalMetricsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 11,
      '6':
          '.google.ads.googleads.v9.services.KeywordPlanKeywordHistoricalMetrics',
      '10': 'metrics'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.KeywordPlanAggregateMetricResults',
...
final $typed_data.Uint8List generateHistoricalMetricsResponseDescriptor =
    $convert.base64Decode(
        '');
...
const KeywordPlanKeywordHistoricalMetrics$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.KeywordPlanHistoricalMetrics',
      '10': 'keywordMetrics'
    },
  ],
  '8': const [
...
final $typed_data.Uint8List keywordPlanKeywordHistoricalMetricsDescriptor =
    $convert.base64Decode(
        '');
