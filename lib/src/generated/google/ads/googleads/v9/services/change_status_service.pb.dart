...
class GetChangeStatusRequest extends $pb.GeneratedMessage {
  ...
  GetChangeStatusRequest copyWith(
      ...
      super.copyWith((message) => updates(message as GetChangeStatusRequest))
          as GetChangeStatusRequest; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static GetChangeStatusRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetChangeStatusRequest>(create);
