...
class SuggestKeywordThemesRequest extends $pb.GeneratedMessage {
  ...
  factory SuggestKeywordThemesRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SuggestKeywordThemesRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SuggestKeywordThemesRequest clone() =>
      SuggestKeywordThemesRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SuggestKeywordThemesRequest copyWith(
          void Function(SuggestKeywordThemesRequest) updates) =>
      super.copyWith(
              (message) => updates(message as SuggestKeywordThemesRequest))
          as SuggestKeywordThemesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SuggestKeywordThemesRequest create() =>
      SuggestKeywordThemesRequest._();
  SuggestKeywordThemesRequest createEmptyInstance() => create();
  static $pb.PbList<SuggestKeywordThemesRequest> createRepeated() =>
      $pb.PbList<SuggestKeywordThemesRequest>();
  @$core.pragma('dart2js:noInline')
  static SuggestKeywordThemesRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SuggestKeywordThemesRequest>(create);
...
class SuggestKeywordThemesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.ads.googleads.v9.services'),
      createEmptyInstance: create)
    ..pc<$3.KeywordThemeConstant>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'keywordThemes',
        $pb.PbFieldType.PM,
        subBuilder: $3.KeywordThemeConstant.create)
    ..hasRequiredFields = false;
  ...
  factory SuggestKeywordThemesResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SuggestKeywordThemesResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SuggestKeywordThemesResponse clone() =>
      SuggestKeywordThemesResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SuggestKeywordThemesResponse copyWith(
          void Function(SuggestKeywordThemesResponse) updates) =>
      super.copyWith(
              (message) => updates(message as SuggestKeywordThemesResponse))
          as SuggestKeywordThemesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SuggestKeywordThemesResponse create() =>
      SuggestKeywordThemesResponse._();
  SuggestKeywordThemesResponse createEmptyInstance() => create();
  static $pb.PbList<SuggestKeywordThemesResponse> createRepeated() =>
      $pb.PbList<SuggestKeywordThemesResponse>();
  @$core.pragma('dart2js:noInline')
  static SuggestKeywordThemesResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SuggestKeywordThemesResponse>(create);
