...
const GenerateKeywordIdeasRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.KeywordAndUrlSeed',
      '9': 0,
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.KeywordSeed',
      '9': 0,
      '10': 'keywordSeed'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.UrlSeed',
      '9': 0,
      '10': 'urlSeed'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.SiteSeed',
      '9': 0,
      '10': 'siteSeed'
    },
  ],
...
final $typed_data.Uint8List generateKeywordIdeasRequestDescriptor =
    $convert.base64Decode(
        '');
...
const GenerateKeywordIdeaResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.GenerateKeywordIdeaResult',
      '10': 'results'
    },
    const {
...
final $typed_data.Uint8List generateKeywordIdeaResponseDescriptor =
    $convert.base64Decode(
        '');
...
const GenerateKeywordIdeaResult$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.KeywordAnnotations',
...
final $typed_data.Uint8List generateKeywordIdeaResultDescriptor =
    $convert.base64Decode(
        '');
