...
const ListPlannableLocationsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.PlannableLocation',
...
final $typed_data.Uint8List listPlannableLocationsResponseDescriptor =
    $convert.base64Decode(
        'Ch5MaXN0UGxhbm5hYmxlTG9jYXRpb25zUmVzcG9uc2USZAoTcGxhbm5hYmxlX2xvY2F0aW9ucxgBIAMoCzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnNlcnZpY2VzLlBsYW5uYWJsZUxvY2F0aW9uUhJwbGFubmFibGVMb2NhdGlvbnM=');
...
final $typed_data.Uint8List plannableLocationDescriptor = $convert.base64Decode(
    '');
...
const ListPlannableProductsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.ProductMetadata',
      '10': 'productMetadata'
    },
  ],
};
...
final $typed_data.Uint8List listPlannableProductsResponseDescriptor =
    $convert.base64Decode(
        'Ch1MaXN0UGxhbm5hYmxlUHJvZHVjdHNSZXNwb25zZRJcChBwcm9kdWN0X21ldGFkYXRhGAEgAygLMjEuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjkuc2VydmljZXMuUHJvZHVjdE1ldGFkYXRhUg9wcm9kdWN0TWV0YWRhdGE=');
...
const ProductMetadata$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.PlannableTargeting',
...
final $typed_data.Uint8List productMetadataDescriptor = $convert.base64Decode(
    '');
...
const PlannableTargeting$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v9.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange',
      '10': 'ageRanges'
    },
    const {
      '1': 'genders',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.common.GenderInfo',
      '10': 'genders'
    },
    const {
      '1': 'devices',
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v9.enums.ReachPlanNetworkEnum.ReachPlanNetwork',
      '10': 'networks'
    },
  ],
};
...
final $typed_data.Uint8List plannableTargetingDescriptor = $convert.base64Decode(
    '');
...
const GenerateProductMixIdeasRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.Preferences',
      '10': 'preferences'
    },
  ],
};
...
const Preferences$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v9.enums.ReachPlanAdLengthEnum.ReachPlanAdLength',
      '10': 'adLength'
    },
    const {
      '1': 'top_content_only',
...
final $typed_data.Uint8List preferencesDescriptor = $convert.base64Decode(
    '');
...
const GenerateProductMixIdeasResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.ProductAllocation',
...
final $typed_data.Uint8List generateProductMixIdeasResponseDescriptor =
    $convert.base64Decode(
        'Ch9HZW5lcmF0ZVByb2R1Y3RNaXhJZGVhc1Jlc3BvbnNlEmIKEnByb2R1Y3RfYWxsb2NhdGlvbhgBIAMoCzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnNlcnZpY2VzLlByb2R1Y3RBbGxvY2F0aW9uUhFwcm9kdWN0QWxsb2NhdGlvbg==');
...
const GenerateReachForecastRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.CampaignDuration',
      '8': const {},
      '10': 'campaignDuration'
    },
    const {
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.FrequencyCap',
    ...
    const {
      '1': 'effective_frequency_limit',
      '3': 12,
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.EffectiveFrequencyLimit',
      '9': 3,
      '10': 'effectiveFrequencyLimit',
      '17': true
    },
    const {
      '1': 'targeting',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.Targeting',
      '10': 'targeting'
    },
    const {
      '1': 'planned_products',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.PlannedProduct',
      '8': const {},
      '10': 'plannedProducts'
    },
  ],
...
final $typed_data.Uint8List generateReachForecastRequestDescriptor =
    $convert.base64Decode(
        '');
...
const EffectiveFrequencyLimit$json = const {
  ...
  '2': const [
    const {
      '1': 'effective_frequency_breakdown_limit',
      '3': 1,
      '4': 1,
      '5': 5,
      '10': 'effectiveFrequencyBreakdownLimit'
    },
  ],
};

/// Descriptor for `EffectiveFrequencyLimit`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List effectiveFrequencyLimitDescriptor =
    $convert.base64Decode(
        'ChdFZmZlY3RpdmVGcmVxdWVuY3lMaW1pdBJNCiNlZmZlY3RpdmVfZnJlcXVlbmN5X2JyZWFrZG93bl9saW1pdBgBIAEoBVIgZWZmZWN0aXZlRnJlcXVlbmN5QnJlYWtkb3duTGltaXQ=');
...
const FrequencyCap$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v9.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit',
      '8': const {},
      '10': 'timeUnit'
    },
  ],
...
final $typed_data.Uint8List frequencyCapDescriptor = $convert.base64Decode(
    'CgxGcmVxdWVuY3lDYXASJQoLaW1wcmVzc2lvbnMYAyABKAVCA+BBAlILaW1wcmVzc2lvbnMSbgoJdGltZV91bml0GAIgASgOMkwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjkuZW51bXMuRnJlcXVlbmN5Q2FwVGltZVVuaXRFbnVtLkZyZXF1ZW5jeUNhcFRpbWVVbml0QgPgQQJSCHRpbWVVbml0');
...
final $typed_data.Uint8List targetingDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List campaignDurationDescriptor = $convert.base64Decode(
    'ChBDYW1wYWlnbkR1cmF0aW9uEi0KEGR1cmF0aW9uX2luX2RheXMYAiABKAVIAFIOZHVyYXRpb25JbkRheXOIAQESSAoKZGF0ZV9yYW5nZRgDIAEoCzIpLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LmNvbW1vbi5EYXRlUmFuZ2VSCWRhdGVSYW5nZUITChFfZHVyYXRpb25faW5fZGF5cw==');
...
const GenerateReachForecastResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.OnTargetAudienceMetrics',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.ReachCurve',
      '10': 'reachCurve'
    },
  ],
};
...
final $typed_data.Uint8List generateReachForecastResponseDescriptor =
    $convert.base64Decode(
        '');
...
const ReachCurve$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.ReachForecast',
      '10': 'reachForecasts'
    },
  ],
};
...
final $typed_data.Uint8List reachCurveDescriptor = $convert.base64Decode(
    'CgpSZWFjaEN1cnZlElgKD3JlYWNoX2ZvcmVjYXN0cxgBIAMoCzIvLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnNlcnZpY2VzLlJlYWNoRm9yZWNhc3RSDnJlYWNoRm9yZWNhc3Rz');
...
const ReachForecast$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.Forecast',
      '10': 'forecast'
    },
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.PlannedProductReachForecast',
...
final $typed_data.Uint8List reachForecastDescriptor = $convert.base64Decode(
    '');
...
const Forecast$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'effective_frequency_breakdowns',
      '3': 10,
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.EffectiveFrequencyBreakdown',
      '10': 'effectiveFrequencyBreakdowns'
    },
  ],
  '8': const [
...
final $typed_data.Uint8List forecastDescriptor = $convert.base64Decode(
    '');
...
const PlannedProductReachForecast$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.PlannedProductForecast',
...
final $typed_data.Uint8List plannedProductReachForecastDescriptor =
    $convert.base64Decode(
        '');
...
const EffectiveFrequencyBreakdown$json = const {
  ...
  '2': const [
    const {
      '1': 'effective_frequency',
      '3': 1,
      '4': 1,
      '5': 5,
      '10': 'effectiveFrequency'
    },
    const {
      '1': 'on_target_reach',
      '3': 2,
...
final $typed_data.Uint8List effectiveFrequencyBreakdownDescriptor =
    $convert.base64Decode(
        'ChtFZmZlY3RpdmVGcmVxdWVuY3lCcmVha2Rvd24SLwoTZWZmZWN0aXZlX2ZyZXF1ZW5jeRgBIAEoBVISZWZmZWN0aXZlRnJlcXVlbmN5EiYKD29uX3RhcmdldF9yZWFjaBgCIAEoA1INb25UYXJnZXRSZWFjaBIfCgt0b3RhbF9yZWFjaBgDIAEoA1IKdG90YWxSZWFjaA==');
