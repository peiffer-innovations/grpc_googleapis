...
const MutateCustomerUserAccessInvitationRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 11,
      '6':
          '.google.ads.googleads.v9.services.CustomerUserAccessInvitationOperation',
      '8': const {},
      '10': 'operation'
    },
  ],
...
final $typed_data.Uint8List
    mutateCustomerUserAccessInvitationRequestDescriptor = $convert.base64Decode(
        'CilNdXRhdGVDdXN0b21lclVzZXJBY2Nlc3NJbnZpdGF0aW9uUmVxdWVzdBIkCgtjdXN0b21lcl9pZBgBIAEoCUID4EECUgpjdXN0b21lcklkEmoKCW9wZXJhdGlvbhgCIAEoCzJHLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnNlcnZpY2VzLkN1c3RvbWVyVXNlckFjY2Vzc0ludml0YXRpb25PcGVyYXRpb25CA+BBAlIJb3BlcmF0aW9u');
...
final $typed_data.Uint8List customerUserAccessInvitationOperationDescriptor =
    $convert.base64Decode(
        'CiVDdXN0b21lclVzZXJBY2Nlc3NJbnZpdGF0aW9uT3BlcmF0aW9uElkKBmNyZWF0ZRgBIAEoCzI/Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnJlc291cmNlcy5DdXN0b21lclVzZXJBY2Nlc3NJbnZpdGF0aW9uSABSBmNyZWF0ZRIYCgZyZW1vdmUYAiABKAlIAFIGcmVtb3ZlQgsKCW9wZXJhdGlvbg==');
@$core.Deprecated(
...
const MutateCustomerUserAccessInvitationResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 11,
      '6':
          '.google.ads.googleads.v9.services.MutateCustomerUserAccessInvitationResult',
      '10': 'result'
    },
  ],
};
...
final $typed_data.Uint8List
    ...
    $convert.base64Decode(
        'CipNdXRhdGVDdXN0b21lclVzZXJBY2Nlc3NJbnZpdGF0aW9uUmVzcG9uc2USYgoGcmVzdWx0GAEgASgLMkouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjkuc2VydmljZXMuTXV0YXRlQ3VzdG9tZXJVc2VyQWNjZXNzSW52aXRhdGlvblJlc3VsdFIGcmVzdWx0');
@$core.Deprecated(
