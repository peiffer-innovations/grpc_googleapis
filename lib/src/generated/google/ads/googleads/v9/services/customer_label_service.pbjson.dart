...
final $typed_data.Uint8List mutateCustomerLabelsRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List customerLabelOperationDescriptor =
    $convert.base64Decode(
        'ChZDdXN0b21lckxhYmVsT3BlcmF0aW9uEkoKBmNyZWF0ZRgBIAEoCzIwLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnJlc291cmNlcy5DdXN0b21lckxhYmVsSABSBmNyZWF0ZRIYCgZyZW1vdmUYAiABKAlIAFIGcmVtb3ZlQgsKCW9wZXJhdGlvbg==');
...
final $typed_data.Uint8List mutateCustomerLabelsResponseDescriptor =
    $convert.base64Decode(
        'ChxNdXRhdGVDdXN0b21lckxhYmVsc1Jlc3BvbnNlEkYKFXBhcnRpYWxfZmFpbHVyZV9lcnJvchgDIAEoCzISLmdvb2dsZS5ycGMuU3RhdHVzUhNwYXJ0aWFsRmFpbHVyZUVycm9yElUKB3Jlc3VsdHMYAiADKAsyOy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5zZXJ2aWNlcy5NdXRhdGVDdXN0b21lckxhYmVsUmVzdWx0UgdyZXN1bHRz');
