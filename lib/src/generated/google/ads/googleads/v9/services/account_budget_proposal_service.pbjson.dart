...
const MutateAccountBudgetProposalRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.AccountBudgetProposalOperation',
      '8': const {},
      '10': 'operation'
    },
...
final $typed_data.Uint8List mutateAccountBudgetProposalRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List accountBudgetProposalOperationDescriptor =
    $convert.base64Decode(
        '');
...
const MutateAccountBudgetProposalResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 11,
      '6':
          '.google.ads.googleads.v9.services.MutateAccountBudgetProposalResult',
      '10': 'result'
    },
  ],
};
...
final $typed_data.Uint8List mutateAccountBudgetProposalResponseDescriptor =
    $convert.base64Decode(
        'CiNNdXRhdGVBY2NvdW50QnVkZ2V0UHJvcG9zYWxSZXNwb25zZRJbCgZyZXN1bHQYAiABKAsyQy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5zZXJ2aWNlcy5NdXRhdGVBY2NvdW50QnVkZ2V0UHJvcG9zYWxSZXN1bHRSBnJlc3VsdA==');
