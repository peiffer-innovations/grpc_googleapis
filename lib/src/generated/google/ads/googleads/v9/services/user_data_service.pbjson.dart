...
const UploadUserDataRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.UserDataOperation',
      '8': const {},
      '10': 'operations'
    },
    const {
...
final $typed_data.Uint8List userDataOperationDescriptor = $convert.base64Decode(
    'ChFVc2VyRGF0YU9wZXJhdGlvbhJCCgZjcmVhdGUYASABKAsyKC5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5jb21tb24uVXNlckRhdGFIAFIGY3JlYXRlEkIKBnJlbW92ZRgCIAEoCzIoLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LmNvbW1vbi5Vc2VyRGF0YUgAUgZyZW1vdmVCCwoJb3BlcmF0aW9u');
