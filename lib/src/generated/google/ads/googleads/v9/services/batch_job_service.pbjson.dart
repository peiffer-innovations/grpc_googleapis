...
const MutateBatchJobRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.BatchJobOperation',
      '8': const {},
      '10': 'operation'
    },
  ],
...
final $typed_data.Uint8List mutateBatchJobRequestDescriptor = $convert.base64Decode(
    'ChVNdXRhdGVCYXRjaEpvYlJlcXVlc3QSJAoLY3VzdG9tZXJfaWQYASABKAlCA+BBAlIKY3VzdG9tZXJJZBJWCglvcGVyYXRpb24YAiABKAsyMy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5zZXJ2aWNlcy5CYXRjaEpvYk9wZXJhdGlvbkID4EECUglvcGVyYXRpb24=');
...
final $typed_data.Uint8List batchJobOperationDescriptor = $convert.base64Decode(
    'ChFCYXRjaEpvYk9wZXJhdGlvbhJFCgZjcmVhdGUYASABKAsyKy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5yZXNvdXJjZXMuQmF0Y2hKb2JIAFIGY3JlYXRlQgsKCW9wZXJhdGlvbg==');
...
const MutateBatchJobResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.MutateBatchJobResult',
      '10': 'result'
    },
  ],
};
...
final $typed_data.Uint8List mutateBatchJobResponseDescriptor =
    $convert.base64Decode(
        'ChZNdXRhdGVCYXRjaEpvYlJlc3BvbnNlEk4KBnJlc3VsdBgBIAEoCzI2Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnNlcnZpY2VzLk11dGF0ZUJhdGNoSm9iUmVzdWx0UgZyZXN1bHQ=');
...
final $typed_data.Uint8List addBatchJobOperationsRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listBatchJobResultsRequestDescriptor =
    $convert.base64Decode(
        '');
...
const ListBatchJobResultsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.BatchJobResult',
      '10': 'results'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listBatchJobResultsResponseDescriptor =
    $convert.base64Decode(
        'ChtMaXN0QmF0Y2hKb2JSZXN1bHRzUmVzcG9uc2USSgoHcmVzdWx0cxgBIAMoCzIwLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnNlcnZpY2VzLkJhdGNoSm9iUmVzdWx0UgdyZXN1bHRzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List batchJobResultDescriptor = $convert.base64Decode(
    '');
