...
const UploadClickConversionsRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.ClickConversion',
      '8': const {},
      '10': 'conversions'
    },
    const {
...
final $typed_data.Uint8List uploadClickConversionsRequestDescriptor =
    $convert.base64Decode(
        '');
...
const UploadClickConversionsResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.ClickConversionResult',
      '10': 'results'
    },
  ],
};
...
final $typed_data.Uint8List uploadClickConversionsResponseDescriptor =
    $convert.base64Decode(
        'Ch5VcGxvYWRDbGlja0NvbnZlcnNpb25zUmVzcG9uc2USRgoVcGFydGlhbF9mYWlsdXJlX2Vycm9yGAEgASgLMhIuZ29vZ2xlLnJwYy5TdGF0dXNSE3BhcnRpYWxGYWlsdXJlRXJyb3ISUQoHcmVzdWx0cxgCIAMoCzI3Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnNlcnZpY2VzLkNsaWNrQ29udmVyc2lvblJlc3VsdFIHcmVzdWx0cw==');
...
const UploadCallConversionsRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.CallConversion',
      '8': const {},
      '10': 'conversions'
    },
    const {
...
final $typed_data.Uint8List uploadCallConversionsRequestDescriptor =
    $convert.base64Decode(
        '');
...
const UploadCallConversionsResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.CallConversionResult',
      '10': 'results'
    },
  ],
};
...
final $typed_data.Uint8List uploadCallConversionsResponseDescriptor =
    $convert.base64Decode(
        'Ch1VcGxvYWRDYWxsQ29udmVyc2lvbnNSZXNwb25zZRJGChVwYXJ0aWFsX2ZhaWx1cmVfZXJyb3IYASABKAsyEi5nb29nbGUucnBjLlN0YXR1c1ITcGFydGlhbEZhaWx1cmVFcnJvchJQCgdyZXN1bHRzGAIgAygLMjYuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjkuc2VydmljZXMuQ2FsbENvbnZlcnNpb25SZXN1bHRSB3Jlc3VsdHM=');
...
const ClickConversion$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.ExternalAttributionData',
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.CustomVariable',
      '10': 'customVariables'
    },
    const {
      '1': 'cart_data',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.CartData',
      '10': 'cartData'
    },
    const {
      '1': 'user_identifiers',
...
final $typed_data.Uint8List clickConversionDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List callConversionDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List clickConversionResultDescriptor = $convert.base64Decode(
    '');
...
const CartData$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v9.services.CartData.Item',
      '10': 'items'
    },
  ],
...
final $typed_data.Uint8List cartDataDescriptor = $convert.base64Decode(
    '');
