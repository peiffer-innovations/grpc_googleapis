...
class InvoiceErrorEnum_InvoiceError extends $pb.ProtobufEnum {
  ...
  static const InvoiceErrorEnum_InvoiceError
      BILLING_SETUP_NOT_ON_MONTHLY_INVOICING = InvoiceErrorEnum_InvoiceError._(
          5,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'BILLING_SETUP_NOT_ON_MONTHLY_INVOICING');
  static const InvoiceErrorEnum_InvoiceError NON_SERVING_CUSTOMER =
      InvoiceErrorEnum_InvoiceError._(
          6,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
