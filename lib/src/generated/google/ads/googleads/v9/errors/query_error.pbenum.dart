...
class QueryErrorEnum_QueryError extends $pb.ProtobufEnum {
  static const QueryErrorEnum_QueryError UNSPECIFIED =
      QueryErrorEnum_QueryError._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'UNSPECIFIED');
  static const QueryErrorEnum_QueryError UNKNOWN = QueryErrorEnum_QueryError._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  ...
  static const QueryErrorEnum_QueryError INVALID_DATE_FORMAT =
      QueryErrorEnum_QueryError._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'INVALID_DATE_FORMAT');
  static const QueryErrorEnum_QueryError MISALIGNED_DATE_FOR_FILTER =
      QueryErrorEnum_QueryError._(
          64,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
  ...
  static const QueryErrorEnum_QueryError FILTER_HAS_TOO_MANY_VALUES =
      QueryErrorEnum_QueryError._(
          63,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
