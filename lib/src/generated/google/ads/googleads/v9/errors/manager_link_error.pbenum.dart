  ...
  static const ManagerLinkErrorEnum_ManagerLinkError
      ...
      ManagerLinkErrorEnum_ManagerLinkError._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'SUSPENDED_ACCOUNT_CANNOT_ADD_CLIENTS');
  static const ManagerLinkErrorEnum_ManagerLinkError CLIENT_OUTSIDE_TREE =
      ManagerLinkErrorEnum_ManagerLinkError._(
          16,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'CLIENT_OUTSIDE_TREE');
  static const ManagerLinkErrorEnum_ManagerLinkError INVALID_STATUS_CHANGE =
      ManagerLinkErrorEnum_ManagerLinkError._(
          17,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'INVALID_STATUS_CHANGE');
  static const ManagerLinkErrorEnum_ManagerLinkError INVALID_CHANGE =
      ManagerLinkErrorEnum_ManagerLinkError._(
          18,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'INVALID_CHANGE');
  static const ManagerLinkErrorEnum_ManagerLinkError
      CUSTOMER_CANNOT_MANAGE_SELF = ManagerLinkErrorEnum_ManagerLinkError._(
          19,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
