...
class CampaignCustomizer extends $pb.GeneratedMessage {
  ...
  factory CampaignCustomizer.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CampaignCustomizer.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  CampaignCustomizer copyWith(void Function(CampaignCustomizer) updates) =>
      super.copyWith((message) => updates(message as CampaignCustomizer))
          as CampaignCustomizer; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CampaignCustomizer create() => CampaignCustomizer._();
  CampaignCustomizer createEmptyInstance() => create();
  static $pb.PbList<CampaignCustomizer> createRepeated() =>
      $pb.PbList<CampaignCustomizer>();
  @$core.pragma('dart2js:noInline')
  static CampaignCustomizer getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CampaignCustomizer>(create);
