...
class ConversionAction_AttributionModelSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$7.AttributionModelEnum_AttributionModel>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'attributionModel',
        $pb.PbFieldType.OE,
        defaultOrMaker: $7.AttributionModelEnum_AttributionModel.UNSPECIFIED,
        valueOf: $7.AttributionModelEnum_AttributionModel.valueOf,
        enumValues: $7.AttributionModelEnum_AttributionModel.values)
    ..e<$8.DataDrivenModelStatusEnum_DataDrivenModelStatus>(
        ...
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $8.DataDrivenModelStatusEnum_DataDrivenModelStatus.UNSPECIFIED,
        valueOf: $8.DataDrivenModelStatusEnum_DataDrivenModelStatus.valueOf,
        enumValues: $8.DataDrivenModelStatusEnum_DataDrivenModelStatus.values)
  ...
  @$pb.TagNumber(1)
  set attributionModel($7.AttributionModelEnum_AttributionModel v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  $8.DataDrivenModelStatusEnum_DataDrivenModelStatus
      get dataDrivenModelStatus => $_getN(1);
  @$pb.TagNumber(2)
  set dataDrivenModelStatus(
      $8.DataDrivenModelStatusEnum_DataDrivenModelStatus v) {
    setField(2, v);
  }
...
class ConversionAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'appId')
    ..e<$6.ConversionOriginEnum_ConversionOrigin>(
        30,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'origin',
        $pb.PbFieldType.OE,
        defaultOrMaker: $6.ConversionOriginEnum_ConversionOrigin.UNSPECIFIED,
        valueOf: $6.ConversionOriginEnum_ConversionOrigin.valueOf,
        enumValues: $6.ConversionOriginEnum_ConversionOrigin.values)
    ..aOB(
        31,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(30)
  set origin($6.ConversionOriginEnum_ConversionOrigin v) {
    setField(30, v);
  }
  ...
  @$pb.TagNumber(31)
  set primaryForGoal($core.bool v) {
    $_setBool(20, v);
  }
