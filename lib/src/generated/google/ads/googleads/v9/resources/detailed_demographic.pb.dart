...
class DetailedDemographic extends $pb.GeneratedMessage {
  ...
  factory DetailedDemographic.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DetailedDemographic.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  DetailedDemographic copyWith(void Function(DetailedDemographic) updates) =>
      super.copyWith((message) => updates(message as DetailedDemographic))
          as DetailedDemographic; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DetailedDemographic create() => DetailedDemographic._();
  DetailedDemographic createEmptyInstance() => create();
  static $pb.PbList<DetailedDemographic> createRepeated() =>
      $pb.PbList<DetailedDemographic>();
  @$core.pragma('dart2js:noInline')
  static DetailedDemographic getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DetailedDemographic>(create);
