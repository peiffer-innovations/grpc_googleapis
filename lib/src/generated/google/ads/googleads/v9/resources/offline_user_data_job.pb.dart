...
class OfflineUserDataJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'externalId')
    ..aOM<OfflineUserDataJobMetadata>(
        11,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'operationMetadata',
        subBuilder: OfflineUserDataJobMetadata.create)
  ...
  @$pb.TagNumber(11)
  set operationMetadata(OfflineUserDataJobMetadata v) {
    setField(11, v);
  }
...
class OfflineUserDataJobMetadata extends $pb.GeneratedMessage {
  ...
  factory OfflineUserDataJobMetadata({
    $4.OfflineUserDataJobMatchRateRangeEnum_OfflineUserDataJobMatchRateRange?
        matchRateRange,
  }) {
    final _result = create();
  ...
  factory OfflineUserDataJobMetadata.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory OfflineUserDataJobMetadata.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  OfflineUserDataJobMetadata clone() =>
      OfflineUserDataJobMetadata()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  OfflineUserDataJobMetadata copyWith(
          void Function(OfflineUserDataJobMetadata) updates) =>
      super.copyWith(
              (message) => updates(message as OfflineUserDataJobMetadata))
          as OfflineUserDataJobMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static $pb.PbList<OfflineUserDataJobMetadata> createRepeated() =>
      $pb.PbList<OfflineUserDataJobMetadata>();
  @$core.pragma('dart2js:noInline')
  static OfflineUserDataJobMetadata getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OfflineUserDataJobMetadata>(create);
  static OfflineUserDataJobMetadata? _defaultInstance;

  @$pb.TagNumber(1)
  $4.OfflineUserDataJobMatchRateRangeEnum_OfflineUserDataJobMatchRateRange
      get matchRateRange => $_getN(0);
  @$pb.TagNumber(1)
  set matchRateRange(
      $4.OfflineUserDataJobMatchRateRangeEnum_OfflineUserDataJobMatchRateRange
          v) {
