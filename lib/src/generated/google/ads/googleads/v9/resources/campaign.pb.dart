...
class Campaign_AppCampaignSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.ads.googleads.v9.resources'),
      createEmptyInstance: create)
    ..e<$19.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
        ...
        enumValues: $19
            .AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType
            .values)
    ..e<$20.AppCampaignAppStoreEnum_AppCampaignAppStore>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'appStore',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $20.AppCampaignAppStoreEnum_AppCampaignAppStore.UNSPECIFIED,
        valueOf: $20.AppCampaignAppStoreEnum_AppCampaignAppStore.valueOf,
        enumValues: $20.AppCampaignAppStoreEnum_AppCampaignAppStore.values)
    ..aOS(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory Campaign_AppCampaignSetting({
    $19.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType?
        biddingStrategyGoalType,
  ...
  @$pb.TagNumber(3)
  set appStore($20.AppCampaignAppStoreEnum_AppCampaignAppStore v) {
    setField(3, v);
  }
...
class Campaign_VanityPharma extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.ads.googleads.v9.resources'),
      createEmptyInstance: create)
    ..e<$21.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..e<$22.VanityPharmaTextEnum_VanityPharmaText>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'vanityPharmaText',
        $pb.PbFieldType.OE,
        defaultOrMaker: $22.VanityPharmaTextEnum_VanityPharmaText.UNSPECIFIED,
        valueOf: $22.VanityPharmaTextEnum_VanityPharmaText.valueOf,
        enumValues: $22.VanityPharmaTextEnum_VanityPharmaText.values)
    ..hasRequiredFields = false;

  Campaign_VanityPharma._() : super();
  factory Campaign_VanityPharma({
    $21.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode?
        vanityPharmaDisplayUrlMode,
  ...
  set vanityPharmaDisplayUrlMode(
      $21.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set vanityPharmaText($22.VanityPharmaTextEnum_VanityPharmaText v) {
    setField(2, v);
  }
...
class Campaign extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(72)
  set urlExpansionOptOut($core.bool v) {
    $_setBool(50, v);
  }
