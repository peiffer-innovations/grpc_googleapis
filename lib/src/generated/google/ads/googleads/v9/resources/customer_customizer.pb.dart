...
class CustomerCustomizer extends $pb.GeneratedMessage {
  ...
  factory CustomerCustomizer.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CustomerCustomizer.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  CustomerCustomizer copyWith(void Function(CustomerCustomizer) updates) =>
      super.copyWith((message) => updates(message as CustomerCustomizer))
          as CustomerCustomizer; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CustomerCustomizer create() => CustomerCustomizer._();
  CustomerCustomizer createEmptyInstance() => create();
  static $pb.PbList<CustomerCustomizer> createRepeated() =>
      $pb.PbList<CustomerCustomizer>();
  @$core.pragma('dart2js:noInline')
  static CustomerCustomizer getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CustomerCustomizer>(create);
