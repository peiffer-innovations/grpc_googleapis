...
class BiddingStrategySimulation extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, BiddingStrategySimulation_PointList>
      _BiddingStrategySimulation_PointListByTag = {
  ...
  factory BiddingStrategySimulation.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory BiddingStrategySimulation.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  BiddingStrategySimulation clone() =>
      BiddingStrategySimulation()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  BiddingStrategySimulation copyWith(
          void Function(BiddingStrategySimulation) updates) =>
      super.copyWith((message) => updates(message as BiddingStrategySimulation))
          as BiddingStrategySimulation; // ignore: deprecated_member_use
  ...
  static $pb.PbList<BiddingStrategySimulation> createRepeated() =>
      $pb.PbList<BiddingStrategySimulation>();
  @$core.pragma('dart2js:noInline')
  static BiddingStrategySimulation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BiddingStrategySimulation>(create);
  static BiddingStrategySimulation? _defaultInstance;

  BiddingStrategySimulation_PointList whichPointList() =>
      _BiddingStrategySimulation_PointListByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(2)
  set biddingStrategyId($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
