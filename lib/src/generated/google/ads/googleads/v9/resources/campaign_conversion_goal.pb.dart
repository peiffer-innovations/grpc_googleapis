...
class CampaignConversionGoal extends $pb.GeneratedMessage {
  ...
  factory CampaignConversionGoal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CampaignConversionGoal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  CampaignConversionGoal clone() =>
      CampaignConversionGoal()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CampaignConversionGoal copyWith(
          void Function(CampaignConversionGoal) updates) =>
      super.copyWith((message) => updates(message as CampaignConversionGoal))
          as CampaignConversionGoal; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CampaignConversionGoal create() => CampaignConversionGoal._();
  CampaignConversionGoal createEmptyInstance() => create();
  static $pb.PbList<CampaignConversionGoal> createRepeated() =>
      $pb.PbList<CampaignConversionGoal>();
  @$core.pragma('dart2js:noInline')
  static CampaignConversionGoal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CampaignConversionGoal>(create);
