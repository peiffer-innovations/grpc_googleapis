...
class FrequencyCapLevelEnum extends $pb.GeneratedMessage {
  ...
  FrequencyCapLevelEnum copyWith(
      ...
      super.copyWith((message) => updates(message as FrequencyCapLevelEnum))
          as FrequencyCapLevelEnum; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static FrequencyCapLevelEnum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FrequencyCapLevelEnum>(create);
