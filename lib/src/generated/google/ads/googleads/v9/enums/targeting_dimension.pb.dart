...
class TargetingDimensionEnum extends $pb.GeneratedMessage {
  ...
  TargetingDimensionEnum copyWith(
      ...
      super.copyWith((message) => updates(message as TargetingDimensionEnum))
          as TargetingDimensionEnum; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static TargetingDimensionEnum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TargetingDimensionEnum>(create);
