...
class EnumErrorEnum_EnumError extends $pb.ProtobufEnum {
  static const EnumErrorEnum_EnumError UNSPECIFIED = EnumErrorEnum_EnumError._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNSPECIFIED');
  static const EnumErrorEnum_EnumError UNKNOWN = EnumErrorEnum_EnumError._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  static const EnumErrorEnum_EnumError ENUM_VALUE_NOT_PERMITTED =
      EnumErrorEnum_EnumError._(
          3,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
