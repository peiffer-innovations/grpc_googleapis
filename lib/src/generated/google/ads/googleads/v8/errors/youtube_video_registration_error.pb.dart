...
class YoutubeVideoRegistrationErrorEnum extends $pb.GeneratedMessage {
  ...
  YoutubeVideoRegistrationErrorEnum copyWith(
      ...
      super.copyWith((message) =>
              updates(message as YoutubeVideoRegistrationErrorEnum))
          as YoutubeVideoRegistrationErrorEnum; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static YoutubeVideoRegistrationErrorEnum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<YoutubeVideoRegistrationErrorEnum>(
          create);
