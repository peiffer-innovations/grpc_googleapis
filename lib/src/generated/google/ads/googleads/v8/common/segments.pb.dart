...
class Segments extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$22.ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension>(
        138,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
        ...
        enumValues: $22
            .ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension
            .values)
    ..aOM<AssetInteractionTarget>(
        139,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'assetInteractionTarget',
        subBuilder: AssetInteractionTarget.create)
    ..e<$23.RecommendationTypeEnum_RecommendationType>(
        140,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'recommendationType',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $23.RecommendationTypeEnum_RecommendationType.UNSPECIFIED,
        valueOf: $23.RecommendationTypeEnum_RecommendationType.valueOf,
        enumValues: $23.RecommendationTypeEnum_RecommendationType.values)
  ...
  factory Segments({
    ...
    $22.ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension?
        conversionValueRulePrimaryDimension,
    ...
    if (conversionValueRulePrimaryDimension != null) {
      _result.conversionValueRulePrimaryDimension =
          conversionValueRulePrimaryDimension;
    }
  ...
  @$pb.TagNumber(138)
  $22.ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension
      get conversionValueRulePrimaryDimension => $_getN(81);
  @$pb.TagNumber(138)
  set conversionValueRulePrimaryDimension(
      $22.ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension
          v) {
    setField(138, v);
  }
  ...
  @$pb.TagNumber(139)
  set assetInteractionTarget(AssetInteractionTarget v) {
    setField(139, v);
  }
  ...
  @$pb.TagNumber(140)
  $23.RecommendationTypeEnum_RecommendationType get recommendationType =>
      $_getN(83);
  @$pb.TagNumber(140)
  set recommendationType($23.RecommendationTypeEnum_RecommendationType v) {
    setField(140, v);
  }
...
class BudgetCampaignAssociationStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'campaign')
    ..e<$24.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'status',
  ...
  factory BudgetCampaignAssociationStatus({
    ...
    $24.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus?
        status,
  }) {
    final _result = create();
    if (campaign != null) {
...
class AssetInteractionTarget extends $pb.GeneratedMessage {
  ...
  factory AssetInteractionTarget.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AssetInteractionTarget.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  AssetInteractionTarget clone() =>
      AssetInteractionTarget()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AssetInteractionTarget copyWith(
          void Function(AssetInteractionTarget) updates) =>
      super.copyWith((message) => updates(message as AssetInteractionTarget))
          as AssetInteractionTarget; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AssetInteractionTarget create() => AssetInteractionTarget._();
  AssetInteractionTarget createEmptyInstance() => create();
  static $pb.PbList<AssetInteractionTarget> createRepeated() =>
      $pb.PbList<AssetInteractionTarget>();
  @$core.pragma('dart2js:noInline')
  static AssetInteractionTarget getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AssetInteractionTarget>(create);
  ...
  @$pb.TagNumber(2)
  set interactionOnThisAsset($core.bool v) {
    $_setBool(1, v);
  }
