...
const TargetingSetting$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.common.TargetRestriction',
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.common.TargetRestrictionOperation',
...
final $typed_data.Uint8List targetRestrictionDescriptor = $convert.base64Decode(
    'ChFUYXJnZXRSZXN0cmljdGlvbhJ5ChN0YXJnZXRpbmdfZGltZW5zaW9uGAEgASgOMkguZ29vZ2xlLmFkcy5nb29nbGVhZHMudjguZW51bXMuVGFyZ2V0aW5nRGltZW5zaW9uRW51bS5UYXJnZXRpbmdEaW1lbnNpb25SEnRhcmdldGluZ0RpbWVuc2lvbhIeCghiaWRfb25seRgDIAEoCEgAUgdiaWRPbmx5iAEBQgsKCV9iaWRfb25seQ==');
...
const TargetRestrictionOperation$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v8.common.TargetRestrictionOperation.Operator',
      '10': 'operator'
    },
    const {
      '1': 'value',
...
final $typed_data.Uint8List targetRestrictionOperationDescriptor =
    $convert.base64Decode(
        '');
