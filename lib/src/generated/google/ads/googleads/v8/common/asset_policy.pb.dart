...
class AdAssetPolicySummary extends $pb.GeneratedMessage {
  ...
  factory AdAssetPolicySummary.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AdAssetPolicySummary.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  AdAssetPolicySummary clone() =>
      AdAssetPolicySummary()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AdAssetPolicySummary copyWith(void Function(AdAssetPolicySummary) updates) =>
      super.copyWith((message) => updates(message as AdAssetPolicySummary))
          as AdAssetPolicySummary; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AdAssetPolicySummary create() => AdAssetPolicySummary._();
  AdAssetPolicySummary createEmptyInstance() => create();
  static $pb.PbList<AdAssetPolicySummary> createRepeated() =>
      $pb.PbList<AdAssetPolicySummary>();
  @$core.pragma('dart2js:noInline')
  static AdAssetPolicySummary getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdAssetPolicySummary>(create);
