...
const AppFeedItem$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.ads.googleads.v8.enums.AppStoreEnum.AppStore',
      '10': 'appStore'
    },
...
final $typed_data.Uint8List appFeedItemDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List callFeedItemDescriptor = $convert.base64Decode(
    '');
...
const PriceFeedItem$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v8.enums.PriceExtensionTypeEnum.PriceExtensionType',
      '10': 'type'
    },
    const {
      '1': 'price_qualifier',
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.common.PriceOffer',
      '10': 'priceOfferings'
    },
    const {
      '1': 'final_url_suffix',
...
final $typed_data.Uint8List priceFeedItemDescriptor = $convert.base64Decode(
    '');
...
const PriceOffer$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v8.common.Money',
      '10': 'price'
    },
    const {
      '1': 'unit',
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v8.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit',
      '10': 'unit'
    },
...
final $typed_data.Uint8List priceOfferDescriptor = $convert.base64Decode(
    '');
...
const PromotionFeedItem$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v8.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion',
      '10': 'occasion'
    },
...
final $typed_data.Uint8List promotionFeedItemDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List sitelinkFeedItemDescriptor = $convert.base64Decode(
    '');
