...
class LegacyResponsiveDisplayAdInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.ads.googleads.v8.common'),
      createEmptyInstance: create)
    ..e<$2.DisplayAdFormatSettingEnum_DisplayAdFormatSetting>(
        13,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'formatSetting',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $2.DisplayAdFormatSettingEnum_DisplayAdFormatSetting.UNSPECIFIED,
        valueOf: $2.DisplayAdFormatSettingEnum_DisplayAdFormatSetting.valueOf,
        enumValues: $2.DisplayAdFormatSettingEnum_DisplayAdFormatSetting.values)
    ..aOS(
        16,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(13)
  $2.DisplayAdFormatSettingEnum_DisplayAdFormatSetting get formatSetting =>
      $_getN(0);
  @$pb.TagNumber(13)
  set formatSetting($2.DisplayAdFormatSettingEnum_DisplayAdFormatSetting v) {
    setField(13, v);
  }
...
class LegacyAppInstallAdInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.ads.googleads.v8.common'),
      createEmptyInstance: create)
    ..e<$3.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'appStore',
        ...
        enumValues:
            $3.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore.values)
    ..aOS(
        6,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(2)
  $3.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore get appStore =>
      $_getN(0);
  @$pb.TagNumber(2)
  set appStore($3.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore v) {
    setField(2, v);
  }
...
class DisplayUploadAdInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [2])
    ..e<$4.DisplayUploadProductTypeEnum_DisplayUploadProductType>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
        ...
        valueOf:
            $4.DisplayUploadProductTypeEnum_DisplayUploadProductType.valueOf,
        enumValues:
            $4.DisplayUploadProductTypeEnum_DisplayUploadProductType.values)
  ...
  factory DisplayUploadAdInfo({
    $4.DisplayUploadProductTypeEnum_DisplayUploadProductType?
        displayUploadProductType,
  ...
  set displayUploadProductType(
      $4.DisplayUploadProductTypeEnum_DisplayUploadProductType v) {
    setField(1, v);
  }
...
class SmartCampaignAdInfo extends $pb.GeneratedMessage {
  ...
  factory SmartCampaignAdInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SmartCampaignAdInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SmartCampaignAdInfo copyWith(void Function(SmartCampaignAdInfo) updates) =>
      super.copyWith((message) => updates(message as SmartCampaignAdInfo))
          as SmartCampaignAdInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SmartCampaignAdInfo create() => SmartCampaignAdInfo._();
  SmartCampaignAdInfo createEmptyInstance() => create();
  static $pb.PbList<SmartCampaignAdInfo> createRepeated() =>
      $pb.PbList<SmartCampaignAdInfo>();
  @$core.pragma('dart2js:noInline')
  static SmartCampaignAdInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SmartCampaignAdInfo>(create);
...
class CallAdInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'conversionAction')
    ..e<$5.CallConversionReportingStateEnum_CallConversionReportingState>(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory CallAdInfo({
    ...
    $5.CallConversionReportingStateEnum_CallConversionReportingState?
        conversionReportingState,
  ...
  factory CallAdInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CallAdInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CallAdInfo copyWith(void Function(CallAdInfo) updates) =>
      super.copyWith((message) => updates(message as CallAdInfo))
          as CallAdInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CallAdInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CallAdInfo>(create);
  ...
  set conversionReportingState(
      $5.CallConversionReportingStateEnum_CallConversionReportingState v) {
    setField(10, v);
  }
