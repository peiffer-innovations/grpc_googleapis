...
const ImageAsset$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v8.common.ImageDimension',
      '10': 'fullSize'
    },
  ],
  '8': const [
...
final $typed_data.Uint8List imageAssetDescriptor = $convert.base64Decode(
    '');
...
const LeadFormAsset$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v8.enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType',
      '8': const {},
      '10': 'callToActionType'
    },
    const {
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.common.LeadFormField',
      '10': 'fields'
    },
    const {
      '1': 'delivery_methods',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.common.LeadFormDeliveryMethod',
      '10': 'deliveryMethods'
    },
    const {
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v8.enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent',
      '10': 'desiredIntent'
    },
    const {
      '1': 'custom_disclosure',
...
const LeadFormField$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 14,
      '6':
          '.google.ads.googleads.v8.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType',
      '10': 'inputType'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v8.common.LeadFormSingleChoiceAnswers',
      '9': 0,
...
final $typed_data.Uint8List leadFormFieldDescriptor = $convert.base64Decode(
    '');
...
const LeadFormDeliveryMethod$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v8.common.WebhookDelivery',
      '9': 0,
      '10': 'webhook'
    },
  ],
...
final $typed_data.Uint8List leadFormDeliveryMethodDescriptor =
    $convert.base64Decode(
        'ChZMZWFkRm9ybURlbGl2ZXJ5TWV0aG9kEksKB3dlYmhvb2sYASABKAsyLy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5jb21tb24uV2ViaG9va0RlbGl2ZXJ5SABSB3dlYmhvb2tCEgoQZGVsaXZlcnlfZGV0YWlscw==');
...
final $typed_data.Uint8List promotionAssetDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List calloutAssetDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List sitelinkAssetDescriptor = $convert.base64Decode(
    '');
