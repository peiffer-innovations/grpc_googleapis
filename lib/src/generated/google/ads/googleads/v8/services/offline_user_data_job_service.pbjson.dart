...
final $typed_data.Uint8List createOfflineUserDataJobRequestDescriptor =
    $convert.base64Decode(
        'Ch9DcmVhdGVPZmZsaW5lVXNlckRhdGFKb2JSZXF1ZXN0EiQKC2N1c3RvbWVyX2lkGAEgASgJQgPgQQJSCmN1c3RvbWVySWQSTAoDam9iGAIgASgLMjUuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjgucmVzb3VyY2VzLk9mZmxpbmVVc2VyRGF0YUpvYkID4EECUgNqb2ISIwoNdmFsaWRhdGVfb25seRgDIAEoCFIMdmFsaWRhdGVPbmx5');
...
const AddOfflineUserDataJobOperationsRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.services.OfflineUserDataJobOperation',
      '8': const {},
      '10': 'operations'
    },
...
final $typed_data.Uint8List addOfflineUserDataJobOperationsRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List offlineUserDataJobOperationDescriptor =
    $convert.base64Decode(
        '');
@$core
