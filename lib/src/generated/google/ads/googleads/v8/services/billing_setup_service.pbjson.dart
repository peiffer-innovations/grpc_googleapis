...
const MutateBillingSetupRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v8.services.BillingSetupOperation',
      '8': const {},
      '10': 'operation'
    },
  ],
...
final $typed_data.Uint8List mutateBillingSetupRequestDescriptor =
    $convert.base64Decode(
        'ChlNdXRhdGVCaWxsaW5nU2V0dXBSZXF1ZXN0EiQKC2N1c3RvbWVyX2lkGAEgASgJQgPgQQJSCmN1c3RvbWVySWQSWgoJb3BlcmF0aW9uGAIgASgLMjcuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjguc2VydmljZXMuQmlsbGluZ1NldHVwT3BlcmF0aW9uQgPgQQJSCW9wZXJhdGlvbg==');
...
final $typed_data.Uint8List billingSetupOperationDescriptor = $convert.base64Decode(
    'ChVCaWxsaW5nU2V0dXBPcGVyYXRpb24SSQoGY3JlYXRlGAIgASgLMi8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjgucmVzb3VyY2VzLkJpbGxpbmdTZXR1cEgAUgZjcmVhdGUSGAoGcmVtb3ZlGAEgASgJSABSBnJlbW92ZUILCglvcGVyYXRpb24=');
...
const MutateBillingSetupResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v8.services.MutateBillingSetupResult',
      '10': 'result'
    },
  ],
};
...
final $typed_data.Uint8List mutateBillingSetupResponseDescriptor =
    $convert.base64Decode(
        'ChpNdXRhdGVCaWxsaW5nU2V0dXBSZXNwb25zZRJSCgZyZXN1bHQYASABKAsyOi5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5zZXJ2aWNlcy5NdXRhdGVCaWxsaW5nU2V0dXBSZXN1bHRSBnJlc3VsdA==');
