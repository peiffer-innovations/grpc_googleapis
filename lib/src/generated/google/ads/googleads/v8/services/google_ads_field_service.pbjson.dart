...
const SearchGoogleAdsFieldsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.resources.GoogleAdsField',
      '10': 'results'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List searchGoogleAdsFieldsResponseDescriptor =
    $convert.base64Decode(
        '');
