  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$116.BatchJob>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'create',
        subBuilder: $116.BatchJob.create)
    ..hasRequiredFields = false;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'sequenceToken')
    ..pc<$114.MutateOperation>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mutateOperations',
        $pb.PbFieldType.PM,
        subBuilder: $114.MutateOperation.create)
    ..hasRequiredFields = false;
...
class ListBatchJobResultsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'pageSize',
        $pb.PbFieldType.O3)
    ..e<$118.ResponseContentTypeEnum_ResponseContentType>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'responseContentType',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $118.ResponseContentTypeEnum_ResponseContentType.UNSPECIFIED,
        valueOf: $118.ResponseContentTypeEnum_ResponseContentType.valueOf,
        enumValues: $118.ResponseContentTypeEnum_ResponseContentType.values)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $118.ResponseContentTypeEnum_ResponseContentType get responseContentType =>
      $_getN(3);
  @$pb.TagNumber(4)
  set responseContentType($118.ResponseContentTypeEnum_ResponseContentType v) {
    setField(4, v);
  }
...
class BatchJobResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'operationIndex')
    ..aOM<$114.MutateOperationResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'mutateOperationResponse',
        subBuilder: $114.MutateOperationResponse.create)
    ..aOM<$117.Status>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'status',
        subBuilder: $117.Status.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set mutateOperationResponse($114.MutateOperationResponse v) {
    setField(2, v);
  }
