...
const ListMerchantCenterLinksResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.resources.MerchantCenterLink',
...
final $typed_data.Uint8List listMerchantCenterLinksResponseDescriptor =
    $convert.base64Decode(
        'Ch9MaXN0TWVyY2hhbnRDZW50ZXJMaW5rc1Jlc3BvbnNlEmkKFW1lcmNoYW50X2NlbnRlcl9saW5rcxgBIAMoCzI1Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LnJlc291cmNlcy5NZXJjaGFudENlbnRlckxpbmtSE21lcmNoYW50Q2VudGVyTGlua3M=');
...
const MutateMerchantCenterLinkRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v8.services.MerchantCenterLinkOperation',
      '8': const {},
      '10': 'operation'
    },
...
final $typed_data.Uint8List mutateMerchantCenterLinkRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List merchantCenterLinkOperationDescriptor =
    $convert.base64Decode(
        '');
...
const MutateMerchantCenterLinkResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.ads.googleads.v8.services.MutateMerchantCenterLinkResult',
      '10': 'result'
    },
  ],
};
...
final $typed_data.Uint8List mutateMerchantCenterLinkResponseDescriptor =
    $convert.base64Decode(
        'CiBNdXRhdGVNZXJjaGFudENlbnRlckxpbmtSZXNwb25zZRJYCgZyZXN1bHQYAiABKAsyQC5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5zZXJ2aWNlcy5NdXRhdGVNZXJjaGFudENlbnRlckxpbmtSZXN1bHRSBnJlc3VsdA==');
