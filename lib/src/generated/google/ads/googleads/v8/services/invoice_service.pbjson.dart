...
final $typed_data.Uint8List listInvoicesRequestDescriptor = $convert.base64Decode(
    '');
...
const ListInvoicesResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.resources.Invoice',
      '10': 'invoices'
    },
  ],
};
...
final $typed_data.Uint8List listInvoicesResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0SW52b2ljZXNSZXNwb25zZRJGCghpbnZvaWNlcxgBIAMoCzIqLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LnJlc291cmNlcy5JbnZvaWNlUghpbnZvaWNlcw==');
