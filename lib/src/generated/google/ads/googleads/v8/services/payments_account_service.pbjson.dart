...
const ListPaymentsAccountsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.resources.PaymentsAccount',
      '10': 'paymentsAccounts'
    },
  ],
};
...
final $typed_data.Uint8List listPaymentsAccountsResponseDescriptor =
    $convert.base64Decode(
        'ChxMaXN0UGF5bWVudHNBY2NvdW50c1Jlc3BvbnNlEl8KEXBheW1lbnRzX2FjY291bnRzGAEgAygLMjIuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjgucmVzb3VyY2VzLlBheW1lbnRzQWNjb3VudFIQcGF5bWVudHNBY2NvdW50cw==');
