...
const MutateCustomInterestsRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.services.CustomInterestOperation',
      '8': const {},
      '10': 'operations'
    },
...
final $typed_data.Uint8List mutateCustomInterestsRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List customInterestOperationDescriptor =
    $convert.base64Decode(
        '');
...
const MutateCustomInterestsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.ads.googleads.v8.services.MutateCustomInterestResult',
      '10': 'results'
    },
  ],
};
...
final $typed_data.Uint8List mutateCustomInterestsResponseDescriptor =
    $convert.base64Decode(
        'Ch1NdXRhdGVDdXN0b21JbnRlcmVzdHNSZXNwb25zZRJWCgdyZXN1bHRzGAIgAygLMjwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjguc2VydmljZXMuTXV0YXRlQ3VzdG9tSW50ZXJlc3RSZXN1bHRSB3Jlc3VsdHM=');
