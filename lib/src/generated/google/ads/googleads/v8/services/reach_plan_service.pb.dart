...
class PlannableTargeting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.ads.googleads.v8.services'),
      createEmptyInstance: create)
    ..pc<$2.ReachPlanAgeRangeEnum_ReachPlanAgeRange>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'ageRanges',
        $pb.PbFieldType.PE,
        valueOf: $2.ReachPlanAgeRangeEnum_ReachPlanAgeRange.valueOf,
        enumValues: $2.ReachPlanAgeRangeEnum_ReachPlanAgeRange.values)
    ..pc<$1.GenderInfo>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..pc<$3.ReachPlanNetworkEnum_ReachPlanNetwork>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'networks',
        $pb.PbFieldType.PE,
        valueOf: $3.ReachPlanNetworkEnum_ReachPlanNetwork.valueOf,
        enumValues: $3.ReachPlanNetworkEnum_ReachPlanNetwork.values)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$2.ReachPlanAgeRangeEnum_ReachPlanAgeRange> get ageRanges =>
      $_getList(0);
  ...
  @$pb.TagNumber(4)
  $core.List<$3.ReachPlanNetworkEnum_ReachPlanNetwork> get networks =>
      $_getList(3);
}
...
class FrequencyCap extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.ads.googleads.v8.services'),
      createEmptyInstance: create)
    ..e<$5.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'timeUnit',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $5.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit.UNSPECIFIED,
        valueOf: $5.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit.valueOf,
        enumValues: $5.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit.values)
    ..a<$core.int>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(2)
  set timeUnit($5.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit v) {
    setField(2, v);
  }
...
class Targeting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.ads.googleads.v8.services'),
      createEmptyInstance: create)
    ..e<$2.ReachPlanAgeRangeEnum_ReachPlanAgeRange>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'ageRange',
        $pb.PbFieldType.OE,
        defaultOrMaker: $2.ReachPlanAgeRangeEnum_ReachPlanAgeRange.UNSPECIFIED,
        valueOf: $2.ReachPlanAgeRangeEnum_ReachPlanAgeRange.valueOf,
        enumValues: $2.ReachPlanAgeRangeEnum_ReachPlanAgeRange.values)
    ..pc<$1.GenderInfo>(
        3,
    ...
    ..pc<$1.DeviceInfo>(
        ...
        $pb.PbFieldType.PM,
        subBuilder: $1.DeviceInfo.create)
    ..e<$3.ReachPlanNetworkEnum_ReachPlanNetwork>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'network',
        $pb.PbFieldType.OE,
        defaultOrMaker: $3.ReachPlanNetworkEnum_ReachPlanNetwork.UNSPECIFIED,
        valueOf: $3.ReachPlanNetworkEnum_ReachPlanNetwork.valueOf,
        enumValues: $3.ReachPlanNetworkEnum_ReachPlanNetwork.values)
    ..aOS(
        6,
  ...
  @$pb.TagNumber(2)
  set ageRange($2.ReachPlanAgeRangeEnum_ReachPlanAgeRange v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(5)
  set network($3.ReachPlanNetworkEnum_ReachPlanNetwork v) {
    setField(5, v);
  }
