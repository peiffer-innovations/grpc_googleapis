...
class RecommendationTypeEnum_RecommendationType extends $pb.ProtobufEnum {
  static const RecommendationTypeEnum_RecommendationType UNSPECIFIED =
      RecommendationTypeEnum_RecommendationType._(
          0,
  ...
  static const RecommendationTypeEnum_RecommendationType ENHANCED_CPC_OPT_IN =
      RecommendationTypeEnum_RecommendationType._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ...
              : 'ENHANCED_CPC_OPT_IN');
  static const RecommendationTypeEnum_RecommendationType
      SEARCH_PARTNERS_OPT_IN = RecommendationTypeEnum_RecommendationType._(
          8,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'SEARCH_PARTNERS_OPT_IN');
  static const RecommendationTypeEnum_RecommendationType
      MAXIMIZE_CLICKS_OPT_IN = RecommendationTypeEnum_RecommendationType._(
          9,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
  ...
  static const RecommendationTypeEnum_RecommendationType MOVE_UNUSED_BUDGET =
      RecommendationTypeEnum_RecommendationType._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ...
              : 'MOVE_UNUSED_BUDGET');
  static const RecommendationTypeEnum_RecommendationType
      FORECASTING_CAMPAIGN_BUDGET = RecommendationTypeEnum_RecommendationType._(
          16,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'FORECASTING_CAMPAIGN_BUDGET');
  static const RecommendationTypeEnum_RecommendationType TARGET_ROAS_OPT_IN =
      RecommendationTypeEnum_RecommendationType._(
          17,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'TARGET_ROAS_OPT_IN');
  static const RecommendationTypeEnum_RecommendationType RESPONSIVE_SEARCH_AD =
      RecommendationTypeEnum_RecommendationType._(
          18,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
