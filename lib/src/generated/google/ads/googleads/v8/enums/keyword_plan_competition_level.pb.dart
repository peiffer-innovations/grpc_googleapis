...
class KeywordPlanCompetitionLevelEnum extends $pb.GeneratedMessage {
  ...
  KeywordPlanCompetitionLevelEnum copyWith(
      ...
      super.copyWith(
          ...
          as KeywordPlanCompetitionLevelEnum; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static KeywordPlanCompetitionLevelEnum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<KeywordPlanCompetitionLevelEnum>(
          create);
