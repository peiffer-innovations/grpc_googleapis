...
class AssetFieldTypeEnum_AssetFieldType extends $pb.ProtobufEnum {
  static const AssetFieldTypeEnum_AssetFieldType UNSPECIFIED =
      AssetFieldTypeEnum_AssetFieldType._(
          0,
  ...
  static const AssetFieldTypeEnum_AssetFieldType YOUTUBE_VIDEO =
      AssetFieldTypeEnum_AssetFieldType._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'YOUTUBE_VIDEO');
  static const AssetFieldTypeEnum_AssetFieldType BOOK_ON_GOOGLE =
      AssetFieldTypeEnum_AssetFieldType._(
          8,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'BOOK_ON_GOOGLE');
  static const AssetFieldTypeEnum_AssetFieldType LEAD_FORM =
      AssetFieldTypeEnum_AssetFieldType._(
          9,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'LEAD_FORM');
  static const AssetFieldTypeEnum_AssetFieldType PROMOTION =
      AssetFieldTypeEnum_AssetFieldType._(
          10,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'PROMOTION');
  static const AssetFieldTypeEnum_AssetFieldType CALLOUT =
      AssetFieldTypeEnum_AssetFieldType._(
          11,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'CALLOUT');
  static const AssetFieldTypeEnum_AssetFieldType STRUCTURED_SNIPPET =
      AssetFieldTypeEnum_AssetFieldType._(
          12,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'STRUCTURED_SNIPPET');
  static const AssetFieldTypeEnum_AssetFieldType SITELINK =
      AssetFieldTypeEnum_AssetFieldType._(
          13,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
