...
class BudgetDeliveryMethodEnum extends $pb.GeneratedMessage {
  ...
  BudgetDeliveryMethodEnum copyWith(
      ...
      super.copyWith((message) => updates(message as BudgetDeliveryMethodEnum))
          as BudgetDeliveryMethodEnum; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static BudgetDeliveryMethodEnum getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<BudgetDeliveryMethodEnum>(create);
