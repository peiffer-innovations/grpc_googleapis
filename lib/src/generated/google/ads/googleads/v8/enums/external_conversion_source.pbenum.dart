...
class ExternalConversionSourceEnum_ExternalConversionSource
  ...
  static const ExternalConversionSourceEnum_ExternalConversionSource
      UNSPECIFIED = ExternalConversionSourceEnum_ExternalConversionSource._(
          0,
  ...
  static const ExternalConversionSourceEnum_ExternalConversionSource
      ANDROID_IN_APP = ExternalConversionSourceEnum_ExternalConversionSource._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ...
              : 'ANDROID_IN_APP');
  static const ExternalConversionSourceEnum_ExternalConversionSource
      IOS_IN_APP = ExternalConversionSourceEnum_ExternalConversionSource._(
          9,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'IOS_IN_APP');
  ...
  static const ExternalConversionSourceEnum_ExternalConversionSource
      CLICK_TO_CALL = ExternalConversionSourceEnum_ExternalConversionSource._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ...
              : 'CLICK_TO_CALL');
  static const ExternalConversionSourceEnum_ExternalConversionSource
      SALESFORCE = ExternalConversionSourceEnum_ExternalConversionSource._(
          16,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'SALESFORCE');
  ...
  static const ExternalConversionSourceEnum_ExternalConversionSource
      ...
      ExternalConversionSourceEnum_ExternalConversionSource._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ...
              : 'STORE_SALES_DIRECT_UPLOAD');
  static const ExternalConversionSourceEnum_ExternalConversionSource
      STORE_SALES = ExternalConversionSourceEnum_ExternalConversionSource._(
          24,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'STORE_SALES');
  static const ExternalConversionSourceEnum_ExternalConversionSource
      SEARCH_ADS_360 = ExternalConversionSourceEnum_ExternalConversionSource._(
          25,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'SEARCH_ADS_360');
  static const ExternalConversionSourceEnum_ExternalConversionSource
      GOOGLE_HOSTED = ExternalConversionSourceEnum_ExternalConversionSource._(
          27,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'GOOGLE_HOSTED');
  static const ExternalConversionSourceEnum_ExternalConversionSource
      FLOODLIGHT = ExternalConversionSourceEnum_ExternalConversionSource._(
          29,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'FLOODLIGHT');
