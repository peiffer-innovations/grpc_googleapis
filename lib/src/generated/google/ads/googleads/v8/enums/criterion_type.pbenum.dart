...
class CriterionTypeEnum_CriterionType extends $pb.ProtobufEnum {
  static const CriterionTypeEnum_CriterionType UNSPECIFIED =
      CriterionTypeEnum_CriterionType._(
          0,
  ...
  static const CriterionTypeEnum_CriterionType LOCATION_GROUP =
      CriterionTypeEnum_CriterionType._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'LOCATION_GROUP');
  static const CriterionTypeEnum_CriterionType CUSTOM_AUDIENCE =
      CriterionTypeEnum_CriterionType._(
          32,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'CUSTOM_AUDIENCE');
  static const CriterionTypeEnum_CriterionType COMBINED_AUDIENCE =
      CriterionTypeEnum_CriterionType._(
          33,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'COMBINED_AUDIENCE');
  static const CriterionTypeEnum_CriterionType KEYWORD_THEME =
      CriterionTypeEnum_CriterionType._(
          34,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
