...
class GenderTypeEnum_GenderType extends $pb.ProtobufEnum {
  static const GenderTypeEnum_GenderType UNSPECIFIED =
      GenderTypeEnum_GenderType._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'UNSPECIFIED');
  static const GenderTypeEnum_GenderType UNKNOWN = GenderTypeEnum_GenderType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  static const GenderTypeEnum_GenderType MALE = GenderTypeEnum_GenderType._(
      10,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MALE');
  static const GenderTypeEnum_GenderType FEMALE = GenderTypeEnum_GenderType._(
      11,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FEMALE');
