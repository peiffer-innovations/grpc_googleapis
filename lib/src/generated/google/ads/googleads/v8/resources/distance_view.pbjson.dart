...
const DistanceView$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.ads.googleads.v8.enums.DistanceBucketEnum.DistanceBucket',
      '8': const {},
      '10': 'distanceBucket'
    },
    const {
...
final $typed_data.Uint8List distanceViewDescriptor = $convert.base64Decode(
    '');
