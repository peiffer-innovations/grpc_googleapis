...
import '../enums/vanity_pharma_display_url_mode.pbenum.dart' as $15;
import '../enums/vanity_pharma_text.pbenum.dart' as $16;
...
import '../enums/app_campaign_bidding_strategy_goal_type.pbenum.dart' as $20;
import '../enums/app_campaign_app_store.pbenum.dart' as $21;
...
class Campaign_VanityPharma extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.ads.googleads.v8.resources'),
      createEmptyInstance: create)
    ..e<$15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..e<$16.VanityPharmaTextEnum_VanityPharmaText>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'vanityPharmaText',
        $pb.PbFieldType.OE,
        defaultOrMaker: $16.VanityPharmaTextEnum_VanityPharmaText.UNSPECIFIED,
        valueOf: $16.VanityPharmaTextEnum_VanityPharmaText.valueOf,
        enumValues: $16.VanityPharmaTextEnum_VanityPharmaText.values)
    ..hasRequiredFields = false;

  Campaign_VanityPharma._() : super();
  factory Campaign_VanityPharma({
    $15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode?
        vanityPharmaDisplayUrlMode,
    $16.VanityPharmaTextEnum_VanityPharmaText? vanityPharmaText,
  }) {
    final _result = create();
  ...
  set vanityPharmaDisplayUrlMode(
      $15.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  $16.VanityPharmaTextEnum_VanityPharmaText get vanityPharmaText => $_getN(1);
  @$pb.TagNumber(2)
  set vanityPharmaText($16.VanityPharmaTextEnum_VanityPharmaText v) {
    setField(2, v);
  }
...
class Campaign_GeoTargetTypeSetting extends $pb.GeneratedMessage {
  ...
  factory Campaign_GeoTargetTypeSetting({
    $17.PositiveGeoTargetTypeEnum_PositiveGeoTargetType? positiveGeoTargetType,
    $18.NegativeGeoTargetTypeEnum_NegativeGeoTargetType? negativeGeoTargetType,
  }) {
    final _result = create();
...
class Campaign_AppCampaignSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.ads.googleads.v8.resources'),
      createEmptyInstance: create)
    ..e<$20.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
        ...
        enumValues: $20
            .AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType
            .values)
    ..e<$21.AppCampaignAppStoreEnum_AppCampaignAppStore>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'appStore',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            $21.AppCampaignAppStoreEnum_AppCampaignAppStore.UNSPECIFIED,
        valueOf: $21.AppCampaignAppStoreEnum_AppCampaignAppStore.valueOf,
        enumValues: $21.AppCampaignAppStoreEnum_AppCampaignAppStore.values)
    ..aOS(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory Campaign_AppCampaignSetting({
    $20.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType?
        biddingStrategyGoalType,
    $21.AppCampaignAppStoreEnum_AppCampaignAppStore? appStore,
    $core.String? appId,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(3)
  $21.AppCampaignAppStoreEnum_AppCampaignAppStore get appStore => $_getN(1);
  @$pb.TagNumber(3)
  set appStore($21.AppCampaignAppStoreEnum_AppCampaignAppStore v) {
    setField(3, v);
  }
...
class Campaign extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(71)
  set accessibleBiddingStrategy($core.String v) {
    $_setString(49, v);
  }
