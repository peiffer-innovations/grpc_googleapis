...
class AudioInConfig_Encoding extends $pb.ProtobufEnum {
  static const AudioInConfig_Encoding ENCODING_UNSPECIFIED =
      AudioInConfig_Encoding._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'ENCODING_UNSPECIFIED');
  static const AudioInConfig_Encoding LINEAR16 = AudioInConfig_Encoding._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'LINEAR16');
  static const AudioInConfig_Encoding FLAC = AudioInConfig_Encoding._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FLAC');
  ...
  static const AudioOutConfig_Encoding ENCODING_UNSPECIFIED =
      AudioOutConfig_Encoding._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'ENCODING_UNSPECIFIED');
  static const AudioOutConfig_Encoding LINEAR16 = AudioOutConfig_Encoding._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'LINEAR16');
  static const AudioOutConfig_Encoding MP3 = AudioOutConfig_Encoding._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MP3');
  static const AudioOutConfig_Encoding OPUS_IN_OGG = AudioOutConfig_Encoding._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'OPUS_IN_OGG');
...
class ScreenOutConfig_ScreenMode extends $pb.ProtobufEnum {
  ...
  static const ScreenOutConfig_ScreenMode OFF = ScreenOutConfig_ScreenMode._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'OFF');
...
class ScreenOut_Format extends $pb.ProtobufEnum {
  static const ScreenOut_Format FORMAT_UNSPECIFIED = ScreenOut_Format._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FORMAT_UNSPECIFIED');
  static const ScreenOut_Format HTML = ScreenOut_Format._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'HTML');
