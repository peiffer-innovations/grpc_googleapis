...
class PickTimeSeriesFilter_Method extends $pb.ProtobufEnum {
  ...
  static final $core.List<PickTimeSeriesFilter_Method?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 5);
  static PickTimeSeriesFilter_Method? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const PickTimeSeriesFilter_Method._(super.value, super.name);
}
...
class PickTimeSeriesFilter_Direction extends $pb.ProtobufEnum {
  ...
  static final $core.List<PickTimeSeriesFilter_Direction?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static PickTimeSeriesFilter_Direction? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const PickTimeSeriesFilter_Direction._(super.value, super.name);
}
...
class StatisticalTimeSeriesFilter_Method extends $pb.ProtobufEnum {
  ...
  static final $core.List<StatisticalTimeSeriesFilter_Method?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 1);
  static StatisticalTimeSeriesFilter_Method? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const StatisticalTimeSeriesFilter_Method._(super.value, super.name);
}
