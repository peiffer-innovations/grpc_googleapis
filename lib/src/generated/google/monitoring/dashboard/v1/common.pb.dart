...
class Aggregation extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set alignmentPeriod($0.Duration value) => $_setField(1, value);
  @$pb.TagNumber(1)
...
class PickTimeSeriesFilter extends $pb.GeneratedMessage {
  factory PickTimeSeriesFilter({
    ...
    final result = create();
    if (rankingMethod != null) result.rankingMethod = rankingMethod;
    if (numTimeSeries != null) result.numTimeSeries = numTimeSeries;
    if (direction != null) result.direction = direction;
    if (interval != null) result.interval = interval;
    return result;
  }

  PickTimeSeriesFilter._();

  factory PickTimeSeriesFilter.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory PickTimeSeriesFilter.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.monitoring.dashboard.v1'),
      createEmptyInstance: create)
    ..aE<PickTimeSeriesFilter_Method>(1, _omitFieldNames ? '' : 'rankingMethod',
        enumValues: PickTimeSeriesFilter_Method.values)
    ..aI(2, _omitFieldNames ? '' : 'numTimeSeries')
    ..aE<PickTimeSeriesFilter_Direction>(3, _omitFieldNames ? '' : 'direction',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PickTimeSeriesFilter clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set rankingMethod(PickTimeSeriesFilter_Method value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasRankingMethod() => $_has(0);
  @$pb.TagNumber(1)
  void clearRankingMethod() => $_clearField(1);

  /// How many time series to allow to pass through the filter.
  @$pb.TagNumber(2)
  $core.int get numTimeSeries => $_getIZ(1);
  @$pb.TagNumber(2)
  set numTimeSeries($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(2)
  $core.bool hasNumTimeSeries() => $_has(1);
  @$pb.TagNumber(2)
  void clearNumTimeSeries() => $_clearField(2);

  /// How to use the ranking to select time series that pass through the filter.
  @$pb.TagNumber(3)
  PickTimeSeriesFilter_Direction get direction => $_getN(2);
  @$pb.TagNumber(3)
  set direction(PickTimeSeriesFilter_Direction value) => $_setField(3, value);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set interval($1.Interval value) => $_setField(4, value);
  @$pb.TagNumber(4)
...
class StatisticalTimeSeriesFilter extends $pb.GeneratedMessage {
  ...
  factory StatisticalTimeSeriesFilter.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory StatisticalTimeSeriesFilter.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.monitoring.dashboard.v1'),
      createEmptyInstance: create)
    ..aE<StatisticalTimeSeriesFilter_Method>(
        1, _omitFieldNames ? '' : 'rankingMethod',
        enumValues: StatisticalTimeSeriesFilter_Method.values)
    ..aI(2, _omitFieldNames ? '' : 'numTimeSeries')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  StatisticalTimeSeriesFilter clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set rankingMethod(StatisticalTimeSeriesFilter_Method value) =>
      $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasRankingMethod() => $_has(0);
  @$pb.TagNumber(1)
