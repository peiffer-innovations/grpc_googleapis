...
class ServiceMonitoringServiceClient extends $grpc.Client {
  ...
  ServiceMonitoringServiceClient(super.channel,
  ...
  $grpc.ResponseFuture<$1.Service> getService(
  ...
  $grpc.ResponseFuture<$2.Empty> deleteService(
  ...
  $grpc.ResponseFuture<$0.ListServiceLevelObjectivesResponse>
    ...
    $0.ListServiceLevelObjectivesRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$createServiceLevelObjective = $grpc.ClientMethod<
      ...
      $1.ServiceLevelObjective.fromBuffer);
  ...
  static final _$listServiceLevelObjectives = $grpc.ClientMethod<
      ...
      $0.ListServiceLevelObjectivesResponse.fromBuffer);
