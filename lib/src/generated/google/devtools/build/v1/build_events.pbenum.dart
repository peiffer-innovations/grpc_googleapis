...
class ConsoleOutputStream extends $pb.ProtobufEnum {
  static const ConsoleOutputStream UNKNOWN = ConsoleOutputStream._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  static const ConsoleOutputStream STDOUT = ConsoleOutputStream._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'STDOUT');
  static const ConsoleOutputStream STDERR = ConsoleOutputStream._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'STDERR');
...
class StreamId_BuildComponent extends $pb.ProtobufEnum {
  static const StreamId_BuildComponent UNKNOWN_COMPONENT =
      StreamId_BuildComponent._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'UNKNOWN_COMPONENT');
  static const StreamId_BuildComponent CONTROLLER = StreamId_BuildComponent._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'CONTROLLER');
  static const StreamId_BuildComponent WORKER = StreamId_BuildComponent._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WORKER');
  static const StreamId_BuildComponent TOOL = StreamId_BuildComponent._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TOOL');
