...
const BatchProcessDocumentsRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.ProcessDocumentRequest',
      '8': const {},
      '10': 'requests'
    },
...
final $typed_data.Uint8List batchProcessDocumentsRequestDescriptor =
    $convert.base64Decode(
        'ChxCYXRjaFByb2Nlc3NEb2N1bWVudHNSZXF1ZXN0ElgKCHJlcXVlc3RzGAEgAygLMjcuZ29vZ2xlLmNsb3VkLmRvY3VtZW50YWkudjFiZXRhMS5Qcm9jZXNzRG9jdW1lbnRSZXF1ZXN0QgPgQQJSCHJlcXVlc3RzEhYKBnBhcmVudBgCIAEoCVIGcGFyZW50');
...
const ProcessDocumentRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.InputConfig',
      '8': const {},
      '10': 'inputConfig'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.OutputConfig',
      '8': const {},
      '10': 'outputConfig'
    },
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.TableExtractionParams',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.FormExtractionParams',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.EntityExtractionParams',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.OcrParams',
      '10': 'ocrParams'
    },
  ],
};
...
const BatchProcessDocumentsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.ProcessDocumentResponse',
      '10': 'responses'
    },
  ],
};
...
final $typed_data.Uint8List batchProcessDocumentsResponseDescriptor =
    $convert.base64Decode(
        'Ch1CYXRjaFByb2Nlc3NEb2N1bWVudHNSZXNwb25zZRJWCglyZXNwb25zZXMYASADKAsyOC5nb29nbGUuY2xvdWQuZG9jdW1lbnRhaS52MWJldGExLlByb2Nlc3NEb2N1bWVudFJlc3BvbnNlUglyZXNwb25zZXM=');
...
final $typed_data.Uint8List processDocumentResponseDescriptor =
    $convert.base64Decode(
        'ChdQcm9jZXNzRG9jdW1lbnRSZXNwb25zZRJPCgxpbnB1dF9jb25maWcYASABKAsyLC5nb29nbGUuY2xvdWQuZG9jdW1lbnRhaS52MWJldGExLklucHV0Q29uZmlnUgtpbnB1dENvbmZpZxJSCg1vdXRwdXRfY29uZmlnGAIgASgLMi0uZ29vZ2xlLmNsb3VkLmRvY3VtZW50YWkudjFiZXRhMS5PdXRwdXRDb25maWdSDG91dHB1dENvbmZpZw==');
...
const TableExtractionParams$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.TableBoundHint',
      '8': const {},
      '10': 'tableBoundHints'
    },
    const {
...
final $typed_data.Uint8List tableExtractionParamsDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List tableBoundHintDescriptor = $convert.base64Decode(
    'Cg5UYWJsZUJvdW5kSGludBIkCgtwYWdlX251bWJlchgBIAEoBUID4EEBUgpwYWdlTnVtYmVyElAKDGJvdW5kaW5nX2JveBgCIAEoCzItLmdvb2dsZS5jbG91ZC5kb2N1bWVudGFpLnYxYmV0YTEuQm91bmRpbmdQb2x5Ugtib3VuZGluZ0JveA==');
...
const FormExtractionParams$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.KeyValuePairHint',
...
final $typed_data.Uint8List formExtractionParamsDescriptor = $convert.base64Decode(
    'ChRGb3JtRXh0cmFjdGlvblBhcmFtcxIYCgdlbmFibGVkGAEgASgIUgdlbmFibGVkEmIKFGtleV92YWx1ZV9wYWlyX2hpbnRzGAIgAygLMjEuZ29vZ2xlLmNsb3VkLmRvY3VtZW50YWkudjFiZXRhMS5LZXlWYWx1ZVBhaXJIaW50UhFrZXlWYWx1ZVBhaXJIaW50cxIjCg1tb2RlbF92ZXJzaW9uGAMgASgJUgxtb2RlbFZlcnNpb24=');
...
const InputConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.GcsSource',
      '9': 0,
      '10': 'gcsSource'
    },
    const {
...
final $typed_data.Uint8List inputConfigDescriptor = $convert.base64Decode(
    'CgtJbnB1dENvbmZpZxJLCgpnY3Nfc291cmNlGAEgASgLMiouZ29vZ2xlLmNsb3VkLmRvY3VtZW50YWkudjFiZXRhMS5HY3NTb3VyY2VIAFIJZ2NzU291cmNlEiAKCW1pbWVfdHlwZRgCIAEoCUID4EECUghtaW1lVHlwZUIICgZzb3VyY2U=');
...
const OutputConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.GcsDestination',
      '9': 0,
      '10': 'gcsDestination'
    },
    const {
...
final $typed_data.Uint8List outputConfigDescriptor = $convert.base64Decode(
    'CgxPdXRwdXRDb25maWcSWgoPZ2NzX2Rlc3RpbmF0aW9uGAEgASgLMi8uZ29vZ2xlLmNsb3VkLmRvY3VtZW50YWkudjFiZXRhMS5HY3NEZXN0aW5hdGlvbkgAUg5nY3NEZXN0aW5hdGlvbhImCg9wYWdlc19wZXJfc2hhcmQYAiABKAVSDXBhZ2VzUGVyU2hhcmRCDQoLZGVzdGluYXRpb24=');
...
const OperationMetadata$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.documentai.v1beta1.OperationMetadata.State',
      '10': 'state'
    },
...
final $typed_data.Uint8List operationMetadataDescriptor = $convert.base64Decode(
    '');
