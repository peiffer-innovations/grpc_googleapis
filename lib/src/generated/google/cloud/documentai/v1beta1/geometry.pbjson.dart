...
const BoundingPoly$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.Vertex',
      '10': 'vertices'
    },
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.documentai.v1beta1.NormalizedVertex',
...
final $typed_data.Uint8List boundingPolyDescriptor = $convert.base64Decode(
    'CgxCb3VuZGluZ1BvbHkSQwoIdmVydGljZXMYASADKAsyJy5nb29nbGUuY2xvdWQuZG9jdW1lbnRhaS52MWJldGExLlZlcnRleFIIdmVydGljZXMSYgoTbm9ybWFsaXplZF92ZXJ0aWNlcxgCIAMoCzIxLmdvb2dsZS5jbG91ZC5kb2N1bWVudGFpLnYxYmV0YTEuTm9ybWFsaXplZFZlcnRleFISbm9ybWFsaXplZFZlcnRpY2Vz');
