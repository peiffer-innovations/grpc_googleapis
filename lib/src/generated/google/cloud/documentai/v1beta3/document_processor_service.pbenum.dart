...
class ReviewDocumentOperationMetadata_State extends $pb.ProtobufEnum {
  static const ReviewDocumentOperationMetadata_State STATE_UNSPECIFIED =
      ReviewDocumentOperationMetadata_State._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'STATE_UNSPECIFIED');
  static const ReviewDocumentOperationMetadata_State RUNNING =
      ReviewDocumentOperationMetadata_State._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'RUNNING');
  static const ReviewDocumentOperationMetadata_State CANCELLING =
      ReviewDocumentOperationMetadata_State._(
          2,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'CANCELLING');
  static const ReviewDocumentOperationMetadata_State SUCCEEDED =
      ReviewDocumentOperationMetadata_State._(
          3,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'SUCCEEDED');
  static const ReviewDocumentOperationMetadata_State FAILED =
      ReviewDocumentOperationMetadata_State._(
          4,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'FAILED');
  static const ReviewDocumentOperationMetadata_State CANCELLED =
      ReviewDocumentOperationMetadata_State._(
          5,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
  ...
  static const $core.List<ReviewDocumentOperationMetadata_State> values =
      <ReviewDocumentOperationMetadata_State>[
    STATE_UNSPECIFIED,
    RUNNING,
    CANCELLING,
    SUCCEEDED,
  ...
  static final $core.Map<$core.int, ReviewDocumentOperationMetadata_State>
      _byValue = $pb.ProtobufEnum.initByValue(values);
  static ReviewDocumentOperationMetadata_State? valueOf($core.int value) =>
      _byValue[value];

  const ReviewDocumentOperationMetadata_State._($core.int v, $core.String n)
      : super(v, n);
}
