...
class ProcessDocumentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<AutoMlParams>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'automlParams',
        subBuilder: AutoMlParams.create)
    ..aOS(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(8)
  set automlParams(AutoMlParams v) {
    setField(8, v);
  }
...
class TableBoundHint extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set boundingBox($4.BoundingPoly v) {
    setField(2, v);
  }
...
class AutoMlParams extends $pb.GeneratedMessage {
  ...
  factory AutoMlParams.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AutoMlParams.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AutoMlParams copyWith(void Function(AutoMlParams) updates) =>
      super.copyWith((message) => updates(message as AutoMlParams))
          as AutoMlParams; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AutoMlParams create() => AutoMlParams._();
  AutoMlParams createEmptyInstance() => create();
  static $pb.PbList<AutoMlParams> createRepeated() =>
      $pb.PbList<AutoMlParams>();
  @$core.pragma('dart2js:noInline')
  static AutoMlParams getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AutoMlParams>(create);
...
enum InputConfig_Source { gcsSource, contents, notSet }
