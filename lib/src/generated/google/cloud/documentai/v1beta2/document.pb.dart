...
enum Document_Label_Source { automlModel, notSet }

class Document_Label extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Document_Label_Source>
      _Document_Label_SourceByTag = {
  ...
  factory Document_Label.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Document_Label.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Document_Label copyWith(void Function(Document_Label) updates) =>
      super.copyWith((message) => updates(message as Document_Label))
          as Document_Label; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Document_Label create() => Document_Label._();
  Document_Label createEmptyInstance() => create();
  static $pb.PbList<Document_Label> createRepeated() =>
      $pb.PbList<Document_Label>();
  @$core.pragma('dart2js:noInline')
  static Document_Label getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Document_Label>(create);
  static Document_Label? _defaultInstance;

  Document_Label_Source whichSource() =>
      _Document_Label_SourceByTag[$_whichOneof(0)]!;
...
class Document_Page_FormField extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  set correctedKeyText($core.String v) {
    $_setString(5, v);
  }
  ...
  @$pb.TagNumber(7)
  set correctedValueText($core.String v) {
    $_setString(6, v);
  }
...
class Document_Entity extends $pb.GeneratedMessage {
  ...
  factory Document_Entity({
    ...
    $core.String? id,
    $2.BoundingPoly? boundingPolyForDemoFrontend,
  }) {
    final _result = create();
    if (textAnchor != null) {
      _result.textAnchor = textAnchor;
    ...
    if (boundingPolyForDemoFrontend != null) {
      _result.boundingPolyForDemoFrontend = boundingPolyForDemoFrontend;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(8)
  $2.BoundingPoly get boundingPolyForDemoFrontend => $_getN(7);
  @$pb.TagNumber(8)
  set boundingPolyForDemoFrontend($2.BoundingPoly v) {
    setField(8, v);
  }

  @$pb.TagNumber(8)
  $core.bool hasBoundingPolyForDemoFrontend() => $_has(7);
  @$pb.TagNumber(8)
  void clearBoundingPolyForDemoFrontend() => clearField(8);
  @$pb.TagNumber(8)
  $2.BoundingPoly ensureBoundingPolyForDemoFrontend() => $_ensure(7);
}
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<Document_Label>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'labels',
        $pb.PbFieldType.PM,
        subBuilder: Document_Label.create)
    ..hasRequiredFields = false;
