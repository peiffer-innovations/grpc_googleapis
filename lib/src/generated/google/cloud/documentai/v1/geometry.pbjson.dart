...
const BoundingPoly$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.documentai.v1.Vertex',
      '10': 'vertices'
    },
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.documentai.v1.NormalizedVertex',
...
final $typed_data.Uint8List boundingPolyDescriptor = $convert.base64Decode(
    'CgxCb3VuZGluZ1BvbHkSPgoIdmVydGljZXMYASADKAsyIi5nb29nbGUuY2xvdWQuZG9jdW1lbnRhaS52MS5WZXJ0ZXhSCHZlcnRpY2VzEl0KE25vcm1hbGl6ZWRfdmVydGljZXMYAiADKAsyLC5nb29nbGUuY2xvdWQuZG9jdW1lbnRhaS52MS5Ob3JtYWxpemVkVmVydGV4UhJub3JtYWxpemVkVmVydGljZXM=');
