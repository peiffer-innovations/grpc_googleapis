...
const GcsDocuments$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.documentai.v1.GcsDocument',
      '10': 'documents'
    },
  ],
};
...
final $typed_data.Uint8List gcsDocumentsDescriptor = $convert.base64Decode(
    'CgxHY3NEb2N1bWVudHMSRQoJZG9jdW1lbnRzGAEgAygLMicuZ29vZ2xlLmNsb3VkLmRvY3VtZW50YWkudjEuR2NzRG9jdW1lbnRSCWRvY3VtZW50cw==');
...
const BatchDocumentsInputConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1.GcsPrefix',
      '9': 0,
      '10': 'gcsPrefix'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1.GcsDocuments',
      '9': 0,
      '10': 'gcsDocuments'
    },
  ],
...
final $typed_data.Uint8List batchDocumentsInputConfigDescriptor =
    $convert.base64Decode(
        'ChlCYXRjaERvY3VtZW50c0lucHV0Q29uZmlnEkYKCmdjc19wcmVmaXgYASABKAsyJS5nb29nbGUuY2xvdWQuZG9jdW1lbnRhaS52MS5HY3NQcmVmaXhIAFIJZ2NzUHJlZml4Ek8KDWdjc19kb2N1bWVudHMYAiABKAsyKC5nb29nbGUuY2xvdWQuZG9jdW1lbnRhaS52MS5HY3NEb2N1bWVudHNIAFIMZ2NzRG9jdW1lbnRzQggKBnNvdXJjZQ==');
...
const DocumentOutputConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.documentai.v1.DocumentOutputConfig.GcsOutputConfig',
      '9': 0,
      '10': 'gcsOutputConfig'
    },
  ],
...
final $typed_data.Uint8List documentOutputConfigDescriptor = $convert.base64Decode(
    '');
