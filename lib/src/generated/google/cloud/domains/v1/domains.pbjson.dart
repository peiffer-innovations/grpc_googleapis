...
const Registration$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.domains.v1.Registration.State',
      '8': const {},
      '10': 'state'
    },
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.google.cloud.domains.v1.Registration.Issue',
      '8': const {},
      '10': 'issues'
    },
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.domains.v1.Registration.LabelsEntry',
      '10': 'labels'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.domains.v1.ManagementSettings',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.domains.v1.DnsSettings',
      '10': 'dnsSettings'
    },
    const {
      '1': 'contact_settings',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.domains.v1.ContactSettings',
      '8': const {},
      '10': 'contactSettings'
    },
    const {
    ...
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.google.cloud.domains.v1.ContactPrivacy',
      '8': const {},
      '10': 'supportedPrivacy'
    },
  ],
...
const ManagementSettings$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.domains.v1.ManagementSettings.RenewalMethod',
      '8': const {},
      '10': 'renewalMethod'
    },
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.domains.v1.TransferLockState',
...
final $typed_data.Uint8List managementSettingsDescriptor = $convert.base64Decode(
    '');
...
const DnsSettings$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.domains.v1.DnsSettings.CustomDns',
      '9': 0,
      '10': 'customDns'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.domains.v1.DnsSettings.GoogleDomainsDns',
      '9': 0,
      '10': 'googleDomainsDns'
    },
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.domains.v1.DnsSettings.GlueRecord',
      '10': 'glueRecords'
    },
  ],
  '3': const [
...
const DnsSettings_CustomDns$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.domains.v1.DnsSettings.DsRecord',
      '10': 'dsRecords'
    },
  ],
};
...
const DnsSettings_GoogleDomainsDns$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.domains.v1.DnsSettings.DsState',
      '8': const {},
      '10': 'dsState'
    },
    const {
...
const DnsSettings_DsRecord$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.domains.v1.DnsSettings.DsRecord.Algorithm',
      '10': 'algorithm'
    },
    const {
      '1': 'digest_type',
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.domains.v1.DnsSettings.DsRecord.DigestType',
      '10': 'digestType'
    },
...
const ContactSettings$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.domains.v1.ContactSettings.Contact',
      '8': const {},
...
const SearchDomainsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.domains.v1.RegisterParameters',
...
final $typed_data.Uint8List searchDomainsResponseDescriptor = $convert.base64Decode(
    'ChVTZWFyY2hEb21haW5zUmVzcG9uc2USXAoTcmVnaXN0ZXJfcGFyYW1ldGVycxgBIAMoCzIrLmdvb2dsZS5jbG91ZC5kb21haW5zLnYxLlJlZ2lzdGVyUGFyYW1ldGVyc1IScmVnaXN0ZXJQYXJhbWV0ZXJz');
...
final $typed_data.Uint8List retrieveRegisterParametersResponseDescriptor =
    $convert.base64Decode(
        'CiJSZXRyaWV2ZVJlZ2lzdGVyUGFyYW1ldGVyc1Jlc3BvbnNlElwKE3JlZ2lzdGVyX3BhcmFtZXRlcnMYASABKAsyKy5nb29nbGUuY2xvdWQuZG9tYWlucy52MS5SZWdpc3RlclBhcmFtZXRlcnNSEnJlZ2lzdGVyUGFyYW1ldGVycw==');
...
const RegisterDomainRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.domains.v1.Registration',
      '8': const {},
      '10': 'registration'
    },
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.google.cloud.domains.v1.DomainNotice',
      '10': 'domainNotices'
    },
    const {
      '1': 'contact_notices',
      ...
      '4': 3,
      '5': 14,
      '6': '.google.cloud.domains.v1.ContactNotice',
      '10': 'contactNotices'
    },
    const {
      '1': 'yearly_price',
...
final $typed_data.Uint8List registerDomainRequestDescriptor = $convert.base64Decode(
    '');
...
const RetrieveTransferParametersResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.domains.v1.TransferParameters',
...
final $typed_data.Uint8List retrieveTransferParametersResponseDescriptor =
    $convert.base64Decode(
        'CiJSZXRyaWV2ZVRyYW5zZmVyUGFyYW1ldGVyc1Jlc3BvbnNlElwKE3RyYW5zZmVyX3BhcmFtZXRlcnMYASABKAsyKy5nb29nbGUuY2xvdWQuZG9tYWlucy52MS5UcmFuc2ZlclBhcmFtZXRlcnNSEnRyYW5zZmVyUGFyYW1ldGVycw==');
...
const TransferDomainRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.domains.v1.AuthorizationCode',
...
final $typed_data.Uint8List transferDomainRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listRegistrationsResponseDescriptor =
    $convert.base64Decode(
        'ChlMaXN0UmVnaXN0cmF0aW9uc1Jlc3BvbnNlEksKDXJlZ2lzdHJhdGlvbnMYASADKAsyJS5nb29nbGUuY2xvdWQuZG9tYWlucy52MS5SZWdpc3RyYXRpb25SDXJlZ2lzdHJhdGlvbnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List updateRegistrationRequestDescriptor =
    $convert.base64Decode(
        'ChlVcGRhdGVSZWdpc3RyYXRpb25SZXF1ZXN0EkkKDHJlZ2lzdHJhdGlvbhgBIAEoCzIlLmdvb2dsZS5jbG91ZC5kb21haW5zLnYxLlJlZ2lzdHJhdGlvblIMcmVnaXN0cmF0aW9uEkAKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza0ID4EECUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List configureDnsSettingsRequestDescriptor =
    $convert.base64Decode(
        '');
...
const RegisterParameters$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.domains.v1.RegisterParameters.Availability',
      '10': 'availability'
    },
    const {
      '1': 'supported_privacy',
...
final $typed_data.Uint8List registerParametersDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List transferParametersDescriptor = $convert.base64Decode(
    '');
