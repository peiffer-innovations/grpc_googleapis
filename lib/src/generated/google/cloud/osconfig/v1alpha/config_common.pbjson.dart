...
const OSPolicyResourceConfigStep$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.osconfig.v1alpha.OSPolicyResourceConfigStep.Type',
      '10': 'type'
    },
    const {
      '1': 'outcome',
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.osconfig.v1alpha.OSPolicyResourceConfigStep.Outcome',
      '10': 'outcome'
    },
...
final $typed_data.Uint8List oSPolicyResourceConfigStepDescriptor =
    $convert.base64Decode(
        '');
...
const OSPolicyResourceCompliance$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.osconfig.v1alpha.OSPolicyResourceConfigStep',
      '10': 'configSteps'
    },
    const {
      '1': 'state',
...
final $typed_data.Uint8List oSPolicyResourceComplianceDescriptor =
    $convert.base64Decode(
        '');
