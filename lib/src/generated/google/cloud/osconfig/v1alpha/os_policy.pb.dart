...
class OSPolicy_OSFilter extends $pb.GeneratedMessage {
  ...
  factory OSPolicy_OSFilter.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory OSPolicy_OSFilter.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  OSPolicy_OSFilter copyWith(void Function(OSPolicy_OSFilter) updates) =>
      super.copyWith((message) => updates(message as OSPolicy_OSFilter))
          as OSPolicy_OSFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static OSPolicy_OSFilter create() => OSPolicy_OSFilter._();
  OSPolicy_OSFilter createEmptyInstance() => create();
  static $pb.PbList<OSPolicy_OSFilter> createRepeated() =>
      $pb.PbList<OSPolicy_OSFilter>();
  @$core.pragma('dart2js:noInline')
  static OSPolicy_OSFilter getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OSPolicy_OSFilter>(create);
...
class OSPolicy_ResourceGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.cloud.osconfig.v1alpha'),
      createEmptyInstance: create)
    ..aOM<OSPolicy_OSFilter>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'osFilter',
        subBuilder: OSPolicy_OSFilter.create)
  ...
  @$pb.TagNumber(1)
  set osFilter(OSPolicy_OSFilter v) {
    setField(1, v);
  }
