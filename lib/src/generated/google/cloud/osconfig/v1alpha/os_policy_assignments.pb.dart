...
class OSPolicyAssignment_LabelSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $core.String>(
        ...
        packageName: const $pb.PackageName('google.cloud.osconfig.v1alpha'))
...
class OSPolicyAssignment extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  OSPolicyAssignment_RolloutState get rolloutState => $_getN(7);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  $core.bool hasRolloutState() => $_has(7);
  @$pb.TagNumber(9)
  void clearRolloutState() => clearField(9);

  @$pb.TagNumber(10)
  $core.bool get baseline => $_getBF(8);
  @$pb.TagNumber(10)
