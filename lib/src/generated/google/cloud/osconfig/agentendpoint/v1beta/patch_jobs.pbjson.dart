...
const PatchConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 14,
      '6':
          '.google.cloud.osconfig.agentendpoint.v1beta.PatchConfig.RebootConfig',
      '10': 'rebootConfig'
    },
    const {
      '1': 'retry_strategy',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.osconfig.agentendpoint.v1beta.RetryStrategy',
      '10': 'retryStrategy'
    },
    const {
      '1': 'apt',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.osconfig.agentendpoint.v1beta.AptSettings',
      '10': 'apt'
    },
    const {
      '1': 'yum',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.osconfig.agentendpoint.v1beta.YumSettings',
      '10': 'yum'
    },
    const {
      '1': 'goo',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.osconfig.agentendpoint.v1beta.GooSettings',
      '10': 'goo'
    },
    const {
      '1': 'zypper',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.osconfig.agentendpoint.v1beta.ZypperSettings',
      '10': 'zypper'
    },
    const {
      '1': 'windows_update',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.osconfig.agentendpoint.v1beta.WindowsUpdateSettings',
      '10': 'windowsUpdate'
    },
    const {
      '1': 'pre_step',
...
final $typed_data.Uint8List patchConfigDescriptor = $convert.base64Decode(
    '');
...
const AptSettings$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.osconfig.agentendpoint.v1beta.AptSettings.Type',
      '10': 'type'
    },
...
final $typed_data.Uint8List aptSettingsDescriptor = $convert.base64Decode(
    '');
...
const WindowsUpdateSettings$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 14,
      '6':
          '.google.cloud.osconfig.agentendpoint.v1beta.WindowsUpdateSettings.Classification',
      '10': 'classifications'
    },
    const {'1': 'excludes', '3': 2, '4': 3, '5': 9, '10': 'excludes'},
    const {
...
final $typed_data.Uint8List windowsUpdateSettingsDescriptor = $convert.base64Decode(
    '');
...
const ExecStep$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.osconfig.agentendpoint.v1beta.ExecStepConfig',
...
final $typed_data.Uint8List execStepDescriptor = $convert.base64Decode(
    '');
...
const ExecStepConfig$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.osconfig.agentendpoint.v1beta.GcsObject',
      '9': 0,
      '10': 'gcsObject'
    },
    const {
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.cloud.osconfig.agentendpoint.v1beta.ExecStepConfig.Interpreter',
      '10': 'interpreter'
    },
  ],
...
final $typed_data.Uint8List execStepConfigDescriptor = $convert.base64Decode(
    '');
