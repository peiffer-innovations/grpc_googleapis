...
class AgentEndpointServiceClient extends $grpc.Client {
  ...
  static final _$reportInventory = $grpc.ClientMethod<$0.ReportInventoryRequest,
          $0.ReportInventoryResponse>(
      '/google.cloud.osconfig.agentendpoint.v1.AgentEndpointService/ReportInventory',
      ($0.ReportInventoryRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.ReportInventoryResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.ReportInventoryResponse> reportInventory(
      $0.ReportInventoryRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class AgentEndpointServiceBase extends $grpc.Service {
  ...
  AgentEndpointServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ReportInventoryRequest,
            $0.ReportInventoryResponse>(
        'ReportInventory',
        reportInventory_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ReportInventoryRequest.fromBuffer(value),
        ($0.ReportInventoryResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.ReportInventoryResponse> reportInventory_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ReportInventoryRequest> request) async {
  ...
  $async.Future<$0.ReportInventoryResponse> reportInventory(
      $grpc.ServiceCall call, $0.ReportInventoryRequest request);
}
