  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<PatchRollout>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rollout',
        subBuilder: PatchRollout.create)
...
class PatchRollout extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<PatchRollout_Mode>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'mode',
        $pb.PbFieldType.OE,
        defaultOrMaker: PatchRollout_Mode.MODE_UNSPECIFIED,
        valueOf: PatchRollout_Mode.valueOf,
        enumValues: PatchRollout_Mode.values)
  ...
  factory PatchRollout.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PatchRollout.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PatchRollout copyWith(void Function(PatchRollout) updates) =>
      super.copyWith((message) => updates(message as PatchRollout))
          as PatchRollout; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PatchRollout create() => PatchRollout._();
  PatchRollout createEmptyInstance() => create();
  static $pb.PbList<PatchRollout> createRepeated() =>
      $pb.PbList<PatchRollout>();
  @$core.pragma('dart2js:noInline')
  static PatchRollout getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PatchRollout>(create);
  static PatchRollout? _defaultInstance;

  @$pb.TagNumber(1)
  PatchRollout_Mode get mode => $_getN(0);
  @$pb.TagNumber(1)
  set mode(PatchRollout_Mode v) {
    setField(1, v);
  }
