...
class Model extends $pb.GeneratedMessage {
  ...
  factory Model({
    ...
    if (onlinePredictionLogging != null) {
      _result.onlinePredictionLogging = onlinePredictionLogging;
    }
    return _result;
  }
...
class Version extends $pb.GeneratedMessage {
  ...
  factory Version({
    ...
    if (deploymentUri != null) {
      _result.deploymentUri = deploymentUri;
    }
    if (createTime != null) {
      _result.createTime = createTime;
    }
    if (lastUseTime != null) {
      _result.lastUseTime = lastUseTime;
    }
...
class SetDefaultVersionRequest extends $pb.GeneratedMessage {
  ...
  factory SetDefaultVersionRequest({
    $core.String? name,
  }) {
    final _result = create();
    if (name != null) {
  ...
  SetDefaultVersionRequest copyWith(
      ...
      super.copyWith((message) => updates(message as SetDefaultVersionRequest))
          as SetDefaultVersionRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
