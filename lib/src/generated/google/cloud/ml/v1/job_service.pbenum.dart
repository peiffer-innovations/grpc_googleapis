...
class TrainingInput_ScaleTier extends $pb.ProtobufEnum {
  static const TrainingInput_ScaleTier BASIC = TrainingInput_ScaleTier._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'BASIC');
  static const TrainingInput_ScaleTier STANDARD_1 = TrainingInput_ScaleTier._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'STANDARD_1');
  static const TrainingInput_ScaleTier PREMIUM_1 = TrainingInput_ScaleTier._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PREMIUM_1');
  static const TrainingInput_ScaleTier BASIC_GPU = TrainingInput_ScaleTier._(
      6,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'BASIC_GPU');
  static const TrainingInput_ScaleTier CUSTOM = TrainingInput_ScaleTier._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'CUSTOM');
...
class ParameterSpec_ScaleType extends $pb.ProtobufEnum {
  static const ParameterSpec_ScaleType NONE = ParameterSpec_ScaleType._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NONE');
  static const ParameterSpec_ScaleType UNIT_LINEAR_SCALE =
      ParameterSpec_ScaleType._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'UNIT_LINEAR_SCALE');
...
class PredictionInput_DataFormat extends $pb.ProtobufEnum {
  static const PredictionInput_DataFormat DATA_FORMAT_UNSPECIFIED =
      PredictionInput_DataFormat._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'DATA_FORMAT_UNSPECIFIED');
  static const PredictionInput_DataFormat TEXT = PredictionInput_DataFormat._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TEXT');
  ...
  static final $core.Map<$core.int, PredictionInput_DataFormat> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static PredictionInput_DataFormat? valueOf($core.int value) =>
      _byValue[value];
...
class Job_State extends $pb.ProtobufEnum {
  static const Job_State STATE_UNSPECIFIED = Job_State._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'STATE_UNSPECIFIED');
  static const Job_State QUEUED = Job_State._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'QUEUED');
  static const Job_State PREPARING = Job_State._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PREPARING');
  static const Job_State RUNNING = Job_State._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'RUNNING');
  static const Job_State SUCCEEDED = Job_State._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SUCCEEDED');
  static const Job_State FAILED = Job_State._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FAILED');
  static const Job_State CANCELLING = Job_State._(
      6,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'CANCELLING');
  static const Job_State CANCELLED = Job_State._(
      7,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'CANCELLED');
