...
const ListImageVersionsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.orchestration.airflow.service.v1beta1.ImageVersion',
      '10': 'imageVersions'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listImageVersionsResponseDescriptor =
    $convert.base64Decode(
        'ChlMaXN0SW1hZ2VWZXJzaW9uc1Jlc3BvbnNlEmcKDmltYWdlX3ZlcnNpb25zGAEgAygLMkAuZ29vZ2xlLmNsb3VkLm9yY2hlc3RyYXRpb24uYWlyZmxvdy5zZXJ2aWNlLnYxYmV0YTEuSW1hZ2VWZXJzaW9uUg1pbWFnZVZlcnNpb25zEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
