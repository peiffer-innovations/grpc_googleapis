...
class NluSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<NluSettings_ModelTrainingMode>(
        ...
        $pb.PbFieldType.OE,
        defaultOrMaker:
            NluSettings_ModelTrainingMode.MODEL_TRAINING_MODE_UNSPECIFIED,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'name')
    ..pc<$5.ValidationMessage>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validationMessages',
        $pb.PbFieldType.PM,
        subBuilder: $5.ValidationMessage.create)
    ..aOM<$6.Timestamp>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
...
enum ImportFlowRequest_Flow { flowUri, flowContent, notSet }

class ImportFlowRequest extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, ImportFlowRequest_Flow>
      _ImportFlowRequest_FlowByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'flowContent',
        $pb.PbFieldType.OY)
    ..e<ImportFlowRequest_ImportOption>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'importOption',
        $pb.PbFieldType.OE,
        defaultOrMaker:
            ImportFlowRequest_ImportOption.IMPORT_OPTION_UNSPECIFIED,
        valueOf: ImportFlowRequest_ImportOption.valueOf,
        enumValues: ImportFlowRequest_ImportOption.values)
    ..hasRequiredFields = false;
  ...
  factory ImportFlowRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ImportFlowRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ImportFlowRequest copyWith(void Function(ImportFlowRequest) updates) =>
      super.copyWith((message) => updates(message as ImportFlowRequest))
          as ImportFlowRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ImportFlowRequest create() => ImportFlowRequest._();
  ImportFlowRequest createEmptyInstance() => create();
  static $pb.PbList<ImportFlowRequest> createRepeated() =>
      $pb.PbList<ImportFlowRequest>();
  @$core.pragma('dart2js:noInline')
  static ImportFlowRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ImportFlowRequest>(create);
  static ImportFlowRequest? _defaultInstance;

  ImportFlowRequest_Flow whichFlow() =>
      _ImportFlowRequest_FlowByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(3)
  set flowContent($core.List<$core.int> v) {
    $_setBytes(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set importOption(ImportFlowRequest_ImportOption v) {
    setField(4, v);
  }
...
class ImportFlowResponse extends $pb.GeneratedMessage {
  ...
  factory ImportFlowResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ImportFlowResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ImportFlowResponse copyWith(void Function(ImportFlowResponse) updates) =>
      super.copyWith((message) => updates(message as ImportFlowResponse))
          as ImportFlowResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ImportFlowResponse create() => ImportFlowResponse._();
  ImportFlowResponse createEmptyInstance() => create();
  static $pb.PbList<ImportFlowResponse> createRepeated() =>
      $pb.PbList<ImportFlowResponse>();
  @$core.pragma('dart2js:noInline')
  static ImportFlowResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ImportFlowResponse>(create);
...
class ExportFlowRequest extends $pb.GeneratedMessage {
  ...
  factory ExportFlowRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ExportFlowRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ExportFlowRequest copyWith(void Function(ExportFlowRequest) updates) =>
      super.copyWith((message) => updates(message as ExportFlowRequest))
          as ExportFlowRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ExportFlowRequest create() => ExportFlowRequest._();
  ExportFlowRequest createEmptyInstance() => create();
  static $pb.PbList<ExportFlowRequest> createRepeated() =>
      $pb.PbList<ExportFlowRequest>();
  @$core.pragma('dart2js:noInline')
  static ExportFlowRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ExportFlowRequest>(create);
  ...
  @$pb.TagNumber(4)
  set includeReferencedFlows($core.bool v) {
    $_setBool(2, v);
  }
...
enum ExportFlowResponse_Flow { flowUri, flowContent, notSet }

class ExportFlowResponse extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, ExportFlowResponse_Flow>
      _ExportFlowResponse_FlowByTag = {
  ...
  factory ExportFlowResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ExportFlowResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ExportFlowResponse copyWith(void Function(ExportFlowResponse) updates) =>
      super.copyWith((message) => updates(message as ExportFlowResponse))
          as ExportFlowResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ExportFlowResponse create() => ExportFlowResponse._();
  ExportFlowResponse createEmptyInstance() => create();
  static $pb.PbList<ExportFlowResponse> createRepeated() =>
      $pb.PbList<ExportFlowResponse>();
  @$core.pragma('dart2js:noInline')
  static ExportFlowResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ExportFlowResponse>(create);
  static ExportFlowResponse? _defaultInstance;

  ExportFlowResponse_Flow whichFlow() =>
      _ExportFlowResponse_FlowByTag[$_whichOneof(0)]!;
  void clearFlow() => clearField($_whichOneof(0));
