...
class SecuritySettings_InsightsExportSettings extends $pb.GeneratedMessage {
  ...
  factory SecuritySettings_InsightsExportSettings.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SecuritySettings_InsightsExportSettings.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SecuritySettings_InsightsExportSettings clone() =>
      SecuritySettings_InsightsExportSettings()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SecuritySettings_InsightsExportSettings copyWith(
          void Function(SecuritySettings_InsightsExportSettings) updates) =>
      super.copyWith((message) =>
              updates(message as SecuritySettings_InsightsExportSettings))
          as SecuritySettings_InsightsExportSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SecuritySettings_InsightsExportSettings create() =>
      SecuritySettings_InsightsExportSettings._();
  SecuritySettings_InsightsExportSettings createEmptyInstance() => create();
  static $pb.PbList<SecuritySettings_InsightsExportSettings> createRepeated() =>
      $pb.PbList<SecuritySettings_InsightsExportSettings>();
  @$core.pragma('dart2js:noInline')
  static SecuritySettings_InsightsExportSettings getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          SecuritySettings_InsightsExportSettings>(create);
  static SecuritySettings_InsightsExportSettings? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get enableInsightsExport => $_getBF(0);
  @$pb.TagNumber(1)
  set enableInsightsExport($core.bool v) {
    $_setBool(0, v);
  }
...
class SecuritySettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'retentionWindowDays',
        $pb.PbFieldType.O3)
    ..pc<SecuritySettings_PurgeDataType>(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'purgeDataTypes',
        $pb.PbFieldType.PE,
        valueOf: SecuritySettings_PurgeDataType.valueOf,
        enumValues: SecuritySettings_PurgeDataType.values)
    ..aOS(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'inspectTemplate')
    ..aOM<SecuritySettings_InsightsExportSettings>(
        13,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'insightsExportSettings',
        subBuilder: SecuritySettings_InsightsExportSettings.create)
    ..aOS(
        17,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(13)
  SecuritySettings_InsightsExportSettings get insightsExportSettings =>
      $_getN(7);
  @$pb.TagNumber(13)
  set insightsExportSettings(SecuritySettings_InsightsExportSettings v) {
    setField(13, v);
  }

  @$pb.TagNumber(13)
  $core.bool hasInsightsExportSettings() => $_has(7);
  @$pb.TagNumber(13)
  void clearInsightsExportSettings() => clearField(13);
  @$pb.TagNumber(13)
  SecuritySettings_InsightsExportSettings ensureInsightsExportSettings() =>
      $_ensure(7);

  @$pb.TagNumber(17)
  $core.String get deidentifyTemplate => $_getSZ(8);
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(17)
  $core.bool hasDeidentifyTemplate() => $_has(8);
  @$pb.TagNumber(17)
