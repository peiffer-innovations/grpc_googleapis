...
class Webhook_ServiceDirectoryConfig extends $pb.GeneratedMessage {
  ...
  factory Webhook_ServiceDirectoryConfig.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Webhook_ServiceDirectoryConfig.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  Webhook_ServiceDirectoryConfig clone() =>
      Webhook_ServiceDirectoryConfig()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Webhook_ServiceDirectoryConfig copyWith(
          void Function(Webhook_ServiceDirectoryConfig) updates) =>
      super.copyWith(
              (message) => updates(message as Webhook_ServiceDirectoryConfig))
          as Webhook_ServiceDirectoryConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Webhook_ServiceDirectoryConfig create() =>
      Webhook_ServiceDirectoryConfig._();
  Webhook_ServiceDirectoryConfig createEmptyInstance() => create();
  static $pb.PbList<Webhook_ServiceDirectoryConfig> createRepeated() =>
      $pb.PbList<Webhook_ServiceDirectoryConfig>();
  @$core.pragma('dart2js:noInline')
  static Webhook_ServiceDirectoryConfig getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Webhook_ServiceDirectoryConfig>(create);
...
enum Webhook_Webhook { genericWebService, serviceDirectory, notSet }
...
class Webhook extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Webhook_ServiceDirectoryConfig>(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'serviceDirectory',
        subBuilder: Webhook_ServiceDirectoryConfig.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(7)
  set serviceDirectory(Webhook_ServiceDirectoryConfig v) {
    setField(7, v);
  }
...
class WebhookRequest extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, WebhookRequest_Query>
      _WebhookRequest_QueryByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$4.ResponseMessage>(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'messages',
        $pb.PbFieldType.PM,
        subBuilder: $4.ResponseMessage.create)
    ..aOM<$5.Struct>(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..aOM<WebhookRequest_SentimentAnalysisResult>(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'sentimentAnalysisResult',
        subBuilder: WebhookRequest_SentimentAnalysisResult.create)
    ..aOS(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  WebhookRequest_Query whichQuery() =>
      _WebhookRequest_QueryByTag[$_whichOneof(0)]!;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<WebhookResponse_FulfillmentResponse_MergeBehavior>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'mergeBehavior',
        $pb.PbFieldType.OE,
        defaultOrMaker: WebhookResponse_FulfillmentResponse_MergeBehavior
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<PageInfo_FormInfo_ParameterInfo_ParameterState>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'state',
        $pb.PbFieldType.OE,
        defaultOrMaker: PageInfo_FormInfo_ParameterInfo_ParameterState
