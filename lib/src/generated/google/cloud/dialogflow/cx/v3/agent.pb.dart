...
import 'advanced_settings.pb.dart' as $6;
...
class Agent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'avatarUri')
    ..aOM<SpeechToTextSettings>(
        13,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'speechToTextSettings',
        subBuilder: SpeechToTextSettings.create)
    ..aOS(
        16,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..aOM<$6.AdvancedSettings>(
        22,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'advancedSettings',
        subBuilder: $6.AdvancedSettings.create)
    ..hasRequiredFields = false;
  ...
  factory Agent({
    ...
    $6.AdvancedSettings? advancedSettings,
  }) {
    final _result = create();
    if (name != null) {
      _result.name = name;
  ...
  @$pb.TagNumber(22)
  $6.AdvancedSettings get advancedSettings => $_getN(12);
  @$pb.TagNumber(22)
  set advancedSettings($6.AdvancedSettings v) {
    setField(22, v);
  }
  ...
  @$pb.TagNumber(22)
  $6.AdvancedSettings ensureAdvancedSettings() => $_ensure(12);
}
...
class RestoreAgentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<RestoreAgentRequest_RestoreOption>(
        ...
        $pb.PbFieldType.OE,
        defaultOrMaker:
            RestoreAgentRequest_RestoreOption.RESTORE_OPTION_UNSPECIFIED,
