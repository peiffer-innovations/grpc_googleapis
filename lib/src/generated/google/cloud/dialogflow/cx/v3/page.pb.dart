...
class Page extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.Fulfillment>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'entryFulfillment',
        subBuilder: $2.Fulfillment.create)
    ..pc<TransitionRoute>(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(7)
  set entryFulfillment($2.Fulfillment v) {
    setField(7, v);
  }
...
class Form_Parameter_FillBehavior extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set initialPromptFulfillment($2.Fulfillment v) {
    setField(3, v);
  }
...
class EventHandler extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set triggerFulfillment($2.Fulfillment v) {
    setField(5, v);
  }
