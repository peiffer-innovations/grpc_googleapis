  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.double>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'count',
        $pb.PbFieldType.OD)
    ..e<Experiment_Result_CountType>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'countType',
        $pb.PbFieldType.OE,
        defaultOrMaker: Experiment_Result_CountType.COUNT_TYPE_UNSPECIFIED,
        valueOf: Experiment_Result_CountType.valueOf,
        enumValues: Experiment_Result_CountType.values)
    ..hasRequiredFields = false;
...
class Experiment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Experiment_Result>(
        6,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'result',
        subBuilder: Experiment_Result.create)
    ..aOM<$2.Timestamp>(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..pc<VariantsHistory>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'variantsHistory',
        $pb.PbFieldType.PM,
        subBuilder: VariantsHistory.create)
    ..aOM<RolloutConfig>(
        14,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rolloutConfig',
        subBuilder: RolloutConfig.create)
    ..aOM<RolloutState>(
        15,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rolloutState',
        subBuilder: RolloutState.create)
    ..aOS(
        16,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(11)
  set experimentLength($3.Duration v) {
    setField(11, v);
  }
  ...
  @$pb.TagNumber(14)
  set rolloutConfig(RolloutConfig v) {
    setField(14, v);
  }
  ...
  @$pb.TagNumber(15)
  set rolloutState(RolloutState v) {
    setField(15, v);
  }
  ...
  @$pb.TagNumber(16)
  set rolloutFailureReason($core.String v) {
    $_setString(14, v);
  }
...
class RolloutConfig_RolloutStep extends $pb.GeneratedMessage {
  ...
  factory RolloutConfig_RolloutStep.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RolloutConfig_RolloutStep.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  RolloutConfig_RolloutStep clone() =>
      RolloutConfig_RolloutStep()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RolloutConfig_RolloutStep copyWith(
          void Function(RolloutConfig_RolloutStep) updates) =>
      super.copyWith((message) => updates(message as RolloutConfig_RolloutStep))
          as RolloutConfig_RolloutStep; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RolloutConfig_RolloutStep create() => RolloutConfig_RolloutStep._();
  RolloutConfig_RolloutStep createEmptyInstance() => create();
  static $pb.PbList<RolloutConfig_RolloutStep> createRepeated() =>
      $pb.PbList<RolloutConfig_RolloutStep>();
  @$core.pragma('dart2js:noInline')
  static RolloutConfig_RolloutStep getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RolloutConfig_RolloutStep>(create);
...
class RolloutConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.cloud.dialogflow.cx.v3'),
      createEmptyInstance: create)
    ..pc<RolloutConfig_RolloutStep>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rolloutSteps',
        $pb.PbFieldType.PM,
        subBuilder: RolloutConfig_RolloutStep.create)
    ..aOS(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory RolloutConfig.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RolloutConfig.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RolloutConfig copyWith(void Function(RolloutConfig) updates) =>
      super.copyWith((message) => updates(message as RolloutConfig))
          as RolloutConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RolloutConfig create() => RolloutConfig._();
  RolloutConfig createEmptyInstance() => create();
  static $pb.PbList<RolloutConfig> createRepeated() =>
      $pb.PbList<RolloutConfig>();
  @$core.pragma('dart2js:noInline')
  static RolloutConfig getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RolloutConfig>(create);
  ...
  @$pb.TagNumber(2)
  set rolloutCondition($core.String v) {
    $_setString(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set failureCondition($core.String v) {
    $_setString(2, v);
  }
...
class RolloutState extends $pb.GeneratedMessage {
  ...
  factory RolloutState.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RolloutState.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RolloutState copyWith(void Function(RolloutState) updates) =>
      super.copyWith((message) => updates(message as RolloutState))
          as RolloutState; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RolloutState create() => RolloutState._();
  RolloutState createEmptyInstance() => create();
  static $pb.PbList<RolloutState> createRepeated() =>
      $pb.PbList<RolloutState>();
  @$core.pragma('dart2js:noInline')
  static RolloutState getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RolloutState>(create);
