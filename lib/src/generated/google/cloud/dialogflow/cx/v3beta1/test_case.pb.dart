...
class TestCase extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(10)
  set creationTime($10.Timestamp v) {
    setField(10, v);
  }
...
class ConversationTurn_UserInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$7.QueryInput>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'input',
        subBuilder: $7.QueryInput.create)
    ..aOB(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(2)
  set injectedParameters($11.Struct v) {
    setField(2, v);
  }
...
class ConversationTurn_VirtualAgentOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$12.ResponseMessage_Text>(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'textResponses',
        $pb.PbFieldType.PM,
        subBuilder: $12.ResponseMessage_Text.create)
    ..aOM<$13.Status>(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(4)
  set sessionParameters($11.Struct v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(7)
  set triggeredIntent($4.Intent v) {
    setField(7, v);
  }
...
class TransitionRouteGroupCoverage_Coverage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.cloud.dialogflow.cx.v3beta1'),
      createEmptyInstance: create)
    ..aOM<$8.TransitionRouteGroup>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'routeGroup',
        subBuilder: $8.TransitionRouteGroup.create)
  ...
  @$pb.TagNumber(1)
  set routeGroup($8.TransitionRouteGroup v) {
    setField(1, v);
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'agent')
    ..aOM<TransitionRouteGroupCoverage>(
        6,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'routeGroupCoverage',
        subBuilder: TransitionRouteGroupCoverage.create)
    ..hasRequiredFields = false;
...
class ListTestCasesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<ListTestCasesRequest_TestCaseView>(
        ...
        $pb.PbFieldType.OE,
        defaultOrMaker:
            ListTestCasesRequest_TestCaseView.TEST_CASE_VIEW_UNSPECIFIED,
...
class ExportTestCasesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<ExportTestCasesRequest_DataFormat>(
        ...
        $pb.PbFieldType.OE,
        defaultOrMaker:
            ExportTestCasesRequest_DataFormat.DATA_FORMAT_UNSPECIFIED,
...
class GetTestCaseResultRequest extends $pb.GeneratedMessage {
  ...
  factory GetTestCaseResultRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetTestCaseResultRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  GetTestCaseResultRequest clone() =>
      GetTestCaseResultRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetTestCaseResultRequest copyWith(
          void Function(GetTestCaseResultRequest) updates) =>
      super.copyWith((message) => updates(message as GetTestCaseResultRequest))
          as GetTestCaseResultRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetTestCaseResultRequest create() => GetTestCaseResultRequest._();
  GetTestCaseResultRequest createEmptyInstance() => create();
  static $pb.PbList<GetTestCaseResultRequest> createRepeated() =>
      $pb.PbList<GetTestCaseResultRequest>();
  @$core.pragma('dart2js:noInline')
  static GetTestCaseResultRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetTestCaseResultRequest>(create);
