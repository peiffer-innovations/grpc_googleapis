...
class ImportFlowRequest_ImportOption extends $pb.ProtobufEnum {
  static const ImportFlowRequest_ImportOption IMPORT_OPTION_UNSPECIFIED =
      ImportFlowRequest_ImportOption._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'IMPORT_OPTION_UNSPECIFIED');
  static const ImportFlowRequest_ImportOption KEEP =
      ImportFlowRequest_ImportOption._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'KEEP');
  static const ImportFlowRequest_ImportOption FALLBACK =
      ImportFlowRequest_ImportOption._(
          2,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
  ...
  static const $core.List<ImportFlowRequest_ImportOption> values =
  ...
  static final $core.Map<$core.int, ImportFlowRequest_ImportOption> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static ImportFlowRequest_ImportOption? valueOf($core.int value) =>
      _byValue[value];

  const ImportFlowRequest_ImportOption._($core.int v, $core.String n)
      : super(v, n);
}
