...
class Fulfillment_ConditionalCases_Case_CaseContent
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$0.ResponseMessage>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'message',
        subBuilder: $0.ResponseMessage.create)
  ...
  @$pb.TagNumber(1)
  set message($0.ResponseMessage v) {
    setField(1, v);
  }
...
class Fulfillment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'tag')
    ..pc<Fulfillment_SetParameterAction>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'setParameterActions',
        $pb.PbFieldType.PM,
        subBuilder: Fulfillment_SetParameterAction.create)
    ..pc<Fulfillment_ConditionalCases>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'conditionalCases',
  ...
  @$pb.TagNumber(8)
  set returnPartialResponses($core.bool v) {
    $_setBool(5, v);
  }
