...
const ListChangelogsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.dialogflow.cx.v3beta1.Changelog',
      '10': 'changelogs'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listChangelogsResponseDescriptor =
    $convert.base64Decode(
        'ChZMaXN0Q2hhbmdlbG9nc1Jlc3BvbnNlEk0KCmNoYW5nZWxvZ3MYASADKAsyLS5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy5jeC52M2JldGExLkNoYW5nZWxvZ1IKY2hhbmdlbG9ncxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
