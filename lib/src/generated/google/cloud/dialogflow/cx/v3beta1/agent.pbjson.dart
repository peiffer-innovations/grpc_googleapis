...
const Agent$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.dialogflow.cx.v3beta1.SpeechToTextSettings',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.dialogflow.cx.v3beta1.AdvancedSettings',
      '10': 'advancedSettings'
    },
  ],
  '7': const {},
...
final $typed_data.Uint8List agentDescriptor = $convert.base64Decode(
    '');
...
const ListAgentsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.dialogflow.cx.v3beta1.Agent',
      '10': 'agents'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listAgentsResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0QWdlbnRzUmVzcG9uc2USQQoGYWdlbnRzGAEgAygLMikuZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cuY3gudjNiZXRhMS5BZ2VudFIGYWdlbnRzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List createAgentRequestDescriptor = $convert.base64Decode(
    'ChJDcmVhdGVBZ2VudFJlcXVlc3QSPwoGcGFyZW50GAEgASgJQifgQQL6QSESH2RpYWxvZ2Zsb3cuZ29vZ2xlYXBpcy5jb20vQWdlbnRSBnBhcmVudBJECgVhZ2VudBgCIAEoCzIpLmdvb2dsZS5jbG91ZC5kaWFsb2dmbG93LmN4LnYzYmV0YTEuQWdlbnRCA+BBAlIFYWdlbnQ=');
...
final $typed_data.Uint8List updateAgentRequestDescriptor = $convert.base64Decode(
    'ChJVcGRhdGVBZ2VudFJlcXVlc3QSRAoFYWdlbnQYASABKAsyKS5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy5jeC52M2JldGExLkFnZW50QgPgQQJSBWFnZW50EjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
final $typed_data.Uint8List exportAgentRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List restoreAgentRequestDescriptor = $convert.base64Decode(
    '');
...
const AgentValidationResult$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.dialogflow.cx.v3beta1.FlowValidationResult',
...
final $typed_data.Uint8List agentValidationResultDescriptor = $convert.base64Decode(
    '');
