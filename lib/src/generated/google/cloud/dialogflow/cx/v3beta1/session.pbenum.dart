...
class DetectIntentResponse_ResponseType extends $pb.ProtobufEnum {
  static const DetectIntentResponse_ResponseType RESPONSE_TYPE_UNSPECIFIED =
      DetectIntentResponse_ResponseType._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'RESPONSE_TYPE_UNSPECIFIED');
  static const DetectIntentResponse_ResponseType PARTIAL =
      DetectIntentResponse_ResponseType._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'PARTIAL');
  static const DetectIntentResponse_ResponseType FINAL =
      DetectIntentResponse_ResponseType._(
          2,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
  ...
  static const $core.List<DetectIntentResponse_ResponseType> values =
  ...
  static final $core.Map<$core.int, DetectIntentResponse_ResponseType>
      _byValue = $pb.ProtobufEnum.initByValue(values);
  static DetectIntentResponse_ResponseType? valueOf($core.int value) =>
      _byValue[value];

  const DetectIntentResponse_ResponseType._($core.int v, $core.String n)
      : super(v, n);
}
