...
class Version extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.NluSettings>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'nluSettings',
        subBuilder: $4.NluSettings.create)
    ..aOM<$9.Timestamp>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(4)
  $4.NluSettings get nluSettings => $_getN(3);
  @$pb.TagNumber(4)
  set nluSettings($4.NluSettings v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $4.NluSettings ensureNluSettings() => $_ensure(3);
