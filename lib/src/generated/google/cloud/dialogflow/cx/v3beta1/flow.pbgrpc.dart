...
class FlowsClient extends $grpc.Client {
  ...
  static final _$getFlowValidationResult = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $3.FlowValidationResult.fromBuffer(value));
  static final _$importFlow =
      $grpc.ClientMethod<$3.ImportFlowRequest, $2.Operation>(
          '/google.cloud.dialogflow.cx.v3beta1.Flows/ImportFlow',
          ($3.ImportFlowRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $2.Operation.fromBuffer(value));
  static final _$exportFlow =
      $grpc.ClientMethod<$3.ExportFlowRequest, $2.Operation>(
          '/google.cloud.dialogflow.cx.v3beta1.Flows/ExportFlow',
          ($3.ExportFlowRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $2.Operation.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.Operation> importFlow($3.ImportFlowRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$importFlow, request, options: options);
  }

  $grpc.ResponseFuture<$2.Operation> exportFlow($3.ExportFlowRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class FlowsServiceBase extends $grpc.Service {
  ...
  FlowsServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$3.GetFlowValidationResultRequest,
        ...
        ($3.FlowValidationResult value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.ImportFlowRequest, $2.Operation>(
        'ImportFlow',
        importFlow_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $3.ImportFlowRequest.fromBuffer(value),
        ($2.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.ExportFlowRequest, $2.Operation>(
        'ExportFlow',
        exportFlow_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $3.ExportFlowRequest.fromBuffer(value),
        ($2.Operation value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$2.Operation> importFlow_Pre($grpc.ServiceCall call,
      $async.Future<$3.ImportFlowRequest> request) async {
    return importFlow(call, await request);
  }

  $async.Future<$2.Operation> exportFlow_Pre($grpc.ServiceCall call,
      $async.Future<$3.ExportFlowRequest> request) async {
  ...
  $async.Future<$2.Operation> importFlow(
      $grpc.ServiceCall call, $3.ImportFlowRequest request);
  $async.Future<$2.Operation> exportFlow(
      $grpc.ServiceCall call, $3.ExportFlowRequest request);
}
