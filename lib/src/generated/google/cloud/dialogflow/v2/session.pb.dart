...
class DetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$7.OutputAudioConfig>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'outputAudioConfig',
        subBuilder: $7.OutputAudioConfig.create)
  ...
  @$pb.TagNumber(7)
  set outputAudioConfigMask($8.FieldMask v) {
    setField(7, v);
  }
...
class QueryInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$7.InputAudioConfig>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'audioConfig',
        subBuilder: $7.InputAudioConfig.create)
    ..aOM<TextInput>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$7.SpeechWordInfo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'speechWordInfo',
        $pb.PbFieldType.PM,
        subBuilder: $7.SpeechWordInfo.create)
    ..aOM<$12.Duration>(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
