...
class AnswerFeedback extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  set displayTime($10.Timestamp v) {
    setField(6, v);
  }
...
class AgentAssistantRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$7.ArticleAnswer>(
        ...
        subBuilder: $7.ArticleAnswer.create)
    ..aOM<$7.FaqAnswer>(
        6,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'faqAnswer',
        subBuilder: $7.FaqAnswer.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(5)
  set articleSuggestionAnswer($7.ArticleAnswer v) {
    setField(5, v);
  }
