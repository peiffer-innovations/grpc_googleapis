...
class ConversationProfile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<NotificationConfig>(
        ...
        subBuilder: NotificationConfig.create)
    ..aOM<$9.SpeechToTextConfig>(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'sttConfig',
        subBuilder: $9.SpeechToTextConfig.create)
    ..aOS(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(9)
  set sttConfig($9.SpeechToTextConfig v) {
    setField(9, v);
  }
