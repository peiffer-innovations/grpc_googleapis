...
class AgentAssistantRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOM<$11.ArticleAnswer>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'articleSuggestionAnswer',
        subBuilder: $11.ArticleAnswer.create)
    ..aOM<$11.FaqAnswer>(
        6,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'faqAnswer',
        subBuilder: $11.FaqAnswer.create)
    ..hasRequiredFields = false;

  AgentAssistantRecord._() : super();
  factory AgentAssistantRecord({
    $11.ArticleAnswer? articleSuggestionAnswer,
    $11.FaqAnswer? faqAnswer,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(5)
  $11.ArticleAnswer get articleSuggestionAnswer => $_getN(0);
  @$pb.TagNumber(5)
  set articleSuggestionAnswer($11.ArticleAnswer v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $11.ArticleAnswer ensureArticleSuggestionAnswer() => $_ensure(0);

  @$pb.TagNumber(6)
  $11.FaqAnswer get faqAnswer => $_getN(1);
  @$pb.TagNumber(6)
  set faqAnswer($11.FaqAnswer v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $11.FaqAnswer ensureFaqAnswer() => $_ensure(1);
}
...
class AnswerFeedback extends $pb.GeneratedMessage {
  ...
  factory AnswerFeedback({
    ...
    $core.bool? clicked,
    $core.bool? displayed,
    $13.Timestamp? clickTime,
    $13.Timestamp? displayTime,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(5)
  $13.Timestamp get clickTime => $_getN(4);
  @$pb.TagNumber(5)
  set clickTime($13.Timestamp v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $13.Timestamp ensureClickTime() => $_ensure(4);

  @$pb.TagNumber(6)
  $13.Timestamp get displayTime => $_getN(5);
  @$pb.TagNumber(6)
  set displayTime($13.Timestamp v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $13.Timestamp ensureDisplayTime() => $_ensure(5);
}
...
class AgentAssistantFeedback_SummarizationFeedback
  ...
  factory AgentAssistantFeedback_SummarizationFeedback({
    $13.Timestamp? startTimestamp,
    $13.Timestamp? submitTimestamp,
  ...
  @$pb.TagNumber(1)
  $13.Timestamp get startTimestamp => $_getN(0);
  @$pb.TagNumber(1)
  set startTimestamp($13.Timestamp v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $13.Timestamp ensureStartTimestamp() => $_ensure(0);

  @$pb.TagNumber(2)
  $13.Timestamp get submitTimestamp => $_getN(1);
  @$pb.TagNumber(2)
  set submitTimestamp($13.Timestamp v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $13.Timestamp ensureSubmitTimestamp() => $_ensure(1);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<AgentAssistantFeedback_DocumentEfficiency>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'documentEfficiency',
        $pb.PbFieldType.OE,
        defaultOrMaker: AgentAssistantFeedback_DocumentEfficiency
    ...
    ..aOM<AgentAssistantFeedback_SummarizationFeedback>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'summarizationFeedback',
        subBuilder: AgentAssistantFeedback_SummarizationFeedback.create)
    ..hasRequiredFields = false;
