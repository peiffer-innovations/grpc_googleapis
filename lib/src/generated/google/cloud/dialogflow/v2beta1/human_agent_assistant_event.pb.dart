...
class HumanAgentAssistantEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'participant')
    ..pc<$11.SuggestionResult>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'suggestionResults',
        $pb.PbFieldType.PM,
        subBuilder: $11.SuggestionResult.create)
  ...
  factory HumanAgentAssistantEvent({
    ...
    $core.Iterable<$11.SuggestionResult>? suggestionResults,
  }) {
  ...
  @$pb.TagNumber(5)
  $core.List<$11.SuggestionResult> get suggestionResults => $_getList(2);
}
