...
class WebhookRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$10.QueryResult>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'queryResult',
        subBuilder: $10.QueryResult.create)
    ..aOM<OriginalDetectIntentRequest>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory WebhookRequest({
    ...
    $core.String? session,
    $core.Iterable<$10.QueryResult>? alternativeQueryResults,
  }) {
  ...
  @$pb.TagNumber(2)
  $10.QueryResult get queryResult => $_getN(1);
  @$pb.TagNumber(2)
  set queryResult($10.QueryResult v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $10.QueryResult ensureQueryResult() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $core.List<$10.QueryResult> get alternativeQueryResults => $_getList(4);
}
...
class WebhookResponse extends $pb.GeneratedMessage {
  ...
  factory WebhookResponse({
    ...
    $10.EventInput? followupEventInput,
  ...
  @$pb.TagNumber(6)
  $10.EventInput get followupEventInput => $_getN(5);
  @$pb.TagNumber(6)
  set followupEventInput($10.EventInput v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $10.EventInput ensureFollowupEventInput() => $_ensure(5);
  ...
  @$pb.TagNumber(10)
  $core.List<$9.SessionEntityType> get sessionEntityTypes => $_getList(8);
}
...
class OriginalDetectIntentRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $11.Struct ensurePayload() => $_ensure(2);
}
