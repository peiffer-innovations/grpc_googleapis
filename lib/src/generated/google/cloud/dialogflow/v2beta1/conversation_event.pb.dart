...
class ConversationEvent extends $pb.GeneratedMessage {
  ...
  factory ConversationEvent({
    ...
    $12.Status? errorStatus,
    $11.Message? newMessagePayload,
  }) {
  ...
  @$pb.TagNumber(3)
  $12.Status get errorStatus => $_getN(2);
  @$pb.TagNumber(3)
  set errorStatus($12.Status v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $12.Status ensureErrorStatus() => $_ensure(2);

  @$pb.TagNumber(4)
  $11.Message get newMessagePayload => $_getN(3);
  @$pb.TagNumber(4)
  set newMessagePayload($11.Message v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $11.Message ensureNewMessagePayload() => $_ensure(3);
}
