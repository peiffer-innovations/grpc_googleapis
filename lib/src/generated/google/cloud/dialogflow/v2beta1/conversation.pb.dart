...
class Conversation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'conversationProfile')
    ..aOM<ConversationPhoneNumber>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'phoneNumber',
        subBuilder: ConversationPhoneNumber.create)
    ..aOM<$13.Timestamp>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..e<Conversation_ConversationStage>(
        ...
        valueOf: Conversation_ConversationStage.valueOf,
        enumValues: Conversation_ConversationStage.values)
  ...
  @$pb.TagNumber(5)
  $13.Timestamp get startTime => $_getN(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $13.Timestamp ensureStartTime() => $_ensure(4);

  @$pb.TagNumber(6)
  $13.Timestamp get endTime => $_getN(5);
  @$pb.TagNumber(6)
  set endTime($13.Timestamp v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $13.Timestamp ensureEndTime() => $_ensure(5);
...
class CreateMessageRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $11.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($11.Message v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $11.Message ensureMessage() => $_ensure(1);
}
...
class BatchCreateMessagesResponse extends $pb.GeneratedMessage {
  ...
  factory BatchCreateMessagesResponse({
    $core.Iterable<$11.Message>? messages,
  }) {
    final _result = create();
    if (messages != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$11.Message> get messages => $_getList(0);
}
