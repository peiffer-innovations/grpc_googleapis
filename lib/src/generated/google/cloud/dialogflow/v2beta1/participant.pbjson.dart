...
const Participant$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 11,
      '6':
          '.google.cloud.dialogflow.v2beta1.Participant.DocumentsMetadataFiltersEntry',
      '8': const {},
...
final $typed_data.Uint8List participantDescriptor = $convert.base64Decode(
    '');
...
const AutomatedAgentReply$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'automated_agent_reply_type',
      '3': 7,
      '4': 1,
      '5': 14,
      '6':
          '.google.cloud.dialogflow.v2beta1.AutomatedAgentReply.AutomatedAgentReplyType',
      '10': 'automatedAgentReplyType'
    },
    const {
      '1': 'allow_cancellation',
      '3': 8,
      '4': 1,
      '5': 8,
      '10': 'allowCancellation'
    },
  ],
...
final $typed_data.Uint8List automatedAgentReplyDescriptor = $convert.base64Decode(
    '');
...
const AssistQueryParameters$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 11,
      '6':
          '.google.cloud.dialogflow.v2beta1.AssistQueryParameters.DocumentsMetadataFiltersEntry',
      '10': 'documentsMetadataFilters'
    },
  ],
...
final $typed_data.Uint8List assistQueryParametersDescriptor = $convert.base64Decode(
    '');
...
const AnalyzeContentRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.dialogflow.v2beta1.AssistQueryParameters',
...
final $typed_data.Uint8List analyzeContentRequestDescriptor = $convert.base64Decode(
    '');
...
const ResponseMessage$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 11,
      '6':
          '.google.cloud.dialogflow.v2beta1.ResponseMessage.TelephonyTransferCall',
      '9': 0,
...
final $typed_data.Uint8List responseMessageDescriptor = $convert.base64Decode(
    '');
