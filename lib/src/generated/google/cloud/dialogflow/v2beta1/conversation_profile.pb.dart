...
import '../../../protobuf/timestamp.pb.dart' as $15;
import 'participant.pb.dart' as $12;
...
class ConversationProfile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<NotificationConfig>(
        ...
        subBuilder: NotificationConfig.create)
    ..aOM<$14.SpeechToTextConfig>(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'sttConfig',
        subBuilder: $14.SpeechToTextConfig.create)
    ..aOS(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..aOM<$15.Timestamp>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'createTime',
        subBuilder: $15.Timestamp.create)
    ..aOM<$15.Timestamp>(
        12,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory ConversationProfile({
    ...
    $14.SpeechToTextConfig? sttConfig,
  ...
  @$pb.TagNumber(9)
  $14.SpeechToTextConfig get sttConfig => $_getN(8);
  @$pb.TagNumber(9)
  set sttConfig($14.SpeechToTextConfig v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  $14.SpeechToTextConfig ensureSttConfig() => $_ensure(8);
  ...
  @$pb.TagNumber(11)
  $15.Timestamp get createTime => $_getN(10);
  @$pb.TagNumber(11)
  set createTime($15.Timestamp v) {
    setField(11, v);
  }
  ...
  @$pb.TagNumber(11)
  $15.Timestamp ensureCreateTime() => $_ensure(10);

  @$pb.TagNumber(12)
  $15.Timestamp get updateTime => $_getN(11);
  @$pb.TagNumber(12)
  set updateTime($15.Timestamp v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(12)
  $15.Timestamp ensureUpdateTime() => $_ensure(11);
...
class HumanAgentAssistantConfig_SuggestionFeatureConfig
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$12.SuggestionFeature>(
        5,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'suggestionFeature',
        subBuilder: $12.SuggestionFeature.create)
  ...
  factory HumanAgentAssistantConfig_SuggestionFeatureConfig({
    ...
    $12.SuggestionFeature? suggestionFeature,
  ...
  @$pb.TagNumber(5)
  $12.SuggestionFeature get suggestionFeature => $_getN(1);
  @$pb.TagNumber(5)
  set suggestionFeature($12.SuggestionFeature v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $12.SuggestionFeature ensureSuggestionFeature() => $_ensure(1);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<HumanAgentAssistantConfig_SuggestionQueryConfig_DocumentQuerySource>(
        ...
        subBuilder:
            HumanAgentAssistantConfig_SuggestionQueryConfig_DocumentQuerySource
                .create)
    ..aOM<HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'dialogflowQuerySource',
    ...
    ..a<$core.double>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'confidenceThreshold',
        $pb.PbFieldType.OF)
    ..aOM<HumanAgentAssistantConfig_SuggestionQueryConfig_ContextFilterSettings>(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
