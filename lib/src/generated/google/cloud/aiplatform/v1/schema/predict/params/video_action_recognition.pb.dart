...
class VideoActionRecognitionPredictionParams extends $pb.GeneratedMessage {
  ...
  factory VideoActionRecognitionPredictionParams.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory VideoActionRecognitionPredictionParams.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  VideoActionRecognitionPredictionParams clone() =>
      VideoActionRecognitionPredictionParams()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  VideoActionRecognitionPredictionParams copyWith(
          void Function(VideoActionRecognitionPredictionParams) updates) =>
      super.copyWith((message) =>
              updates(message as VideoActionRecognitionPredictionParams))
          as VideoActionRecognitionPredictionParams; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static VideoActionRecognitionPredictionParams create() =>
      VideoActionRecognitionPredictionParams._();
  VideoActionRecognitionPredictionParams createEmptyInstance() => create();
  static $pb.PbList<VideoActionRecognitionPredictionParams> createRepeated() =>
      $pb.PbList<VideoActionRecognitionPredictionParams>();
  @$core.pragma('dart2js:noInline')
  static VideoActionRecognitionPredictionParams getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          VideoActionRecognitionPredictionParams>(create);
