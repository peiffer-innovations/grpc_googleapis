...
class ImageObjectDetectionPredictionParams extends $pb.GeneratedMessage {
  ...
  factory ImageObjectDetectionPredictionParams.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ImageObjectDetectionPredictionParams.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ImageObjectDetectionPredictionParams clone() =>
      ImageObjectDetectionPredictionParams()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ImageObjectDetectionPredictionParams copyWith(
          void Function(ImageObjectDetectionPredictionParams) updates) =>
      super.copyWith((message) =>
              updates(message as ImageObjectDetectionPredictionParams))
          as ImageObjectDetectionPredictionParams; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ImageObjectDetectionPredictionParams create() =>
      ImageObjectDetectionPredictionParams._();
  ImageObjectDetectionPredictionParams createEmptyInstance() => create();
  static $pb.PbList<ImageObjectDetectionPredictionParams> createRepeated() =>
      $pb.PbList<ImageObjectDetectionPredictionParams>();
  @$core.pragma('dart2js:noInline')
  static ImageObjectDetectionPredictionParams getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          ImageObjectDetectionPredictionParams>(create);
