...
const CreateStudyRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1.Study',
      '8': const {},
      '10': 'study'
    },
  ],
...
final $typed_data.Uint8List createStudyRequestDescriptor = $convert.base64Decode(
    'ChJDcmVhdGVTdHVkeVJlcXVlc3QSQQoGcGFyZW50GAEgASgJQingQQL6QSMKIWxvY2F0aW9ucy5nb29nbGVhcGlzLmNvbS9Mb2NhdGlvblIGcGFyZW50EjwKBXN0dWR5GAIgASgLMiEuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuU3R1ZHlCA+BBAlIFc3R1ZHk=');
...
final $typed_data.Uint8List listStudiesResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0U3R1ZGllc1Jlc3BvbnNlEjsKB3N0dWRpZXMYASADKAsyIS5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MS5TdHVkeVIHc3R1ZGllcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List suggestTrialsResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List suggestTrialsMetadataDescriptor = $convert.base64Decode(
    'ChVTdWdnZXN0VHJpYWxzTWV0YWRhdGESXwoQZ2VuZXJpY19tZXRhZGF0YRgBIAEoCzI0Lmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxLkdlbmVyaWNPcGVyYXRpb25NZXRhZGF0YVIPZ2VuZXJpY01ldGFkYXRhEhsKCWNsaWVudF9pZBgCIAEoCVIIY2xpZW50SWQ=');
...
final $typed_data.Uint8List createTrialRequestDescriptor = $convert.base64Decode(
    'ChJDcmVhdGVUcmlhbFJlcXVlc3QSPwoGcGFyZW50GAEgASgJQifgQQL6QSEKH2FpcGxhdGZvcm0uZ29vZ2xlYXBpcy5jb20vU3R1ZHlSBnBhcmVudBI8CgV0cmlhbBgCIAEoCzIhLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxLlRyaWFsQgPgQQJSBXRyaWFs');
...
final $typed_data.Uint8List listTrialsResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0VHJpYWxzUmVzcG9uc2USOQoGdHJpYWxzGAEgAygLMiEuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuVHJpYWxSBnRyaWFscxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List addTrialMeasurementRequestDescriptor =
    $convert.base64Decode(
        'ChpBZGRUcmlhbE1lYXN1cmVtZW50UmVxdWVzdBJGCgp0cmlhbF9uYW1lGAEgASgJQifgQQL6QSEKH2FpcGxhdGZvcm0uZ29vZ2xlYXBpcy5jb20vVHJpYWxSCXRyaWFsTmFtZRJOCgttZWFzdXJlbWVudBgDIAEoCzInLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxLk1lYXN1cmVtZW50QgPgQQJSC21lYXN1cmVtZW50');
...
final $typed_data.Uint8List completeTrialRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List checkTrialEarlyStoppingStateMetatdataDescriptor =
    $convert.base64Decode(
        'CiVDaGVja1RyaWFsRWFybHlTdG9wcGluZ1N0YXRlTWV0YXRkYXRhEl8KEGdlbmVyaWNfbWV0YWRhdGEYASABKAsyNC5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MS5HZW5lcmljT3BlcmF0aW9uTWV0YWRhdGFSD2dlbmVyaWNNZXRhZGF0YRIUCgVzdHVkeRgCIAEoCVIFc3R1ZHkSFAoFdHJpYWwYAyABKAlSBXRyaWFs');
...
final $typed_data.Uint8List listOptimalTrialsResponseDescriptor =
    $convert.base64Decode(
        'ChlMaXN0T3B0aW1hbFRyaWFsc1Jlc3BvbnNlEkgKDm9wdGltYWxfdHJpYWxzGAEgAygLMiEuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuVHJpYWxSDW9wdGltYWxUcmlhbHM=');
