...
const FeatureSelector$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1.IdMatcher',
      '8': const {},
      '10': 'idMatcher'
    },
  ],
...
final $typed_data.Uint8List featureSelectorDescriptor = $convert.base64Decode(
    'Cg9GZWF0dXJlU2VsZWN0b3ISSQoKaWRfbWF0Y2hlchgBIAEoCzIlLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxLklkTWF0Y2hlckID4EECUglpZE1hdGNoZXI=');
