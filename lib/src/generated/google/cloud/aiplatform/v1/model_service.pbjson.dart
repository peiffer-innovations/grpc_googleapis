...
final $typed_data.Uint8List uploadModelRequestDescriptor = $convert.base64Decode(
    'ChJVcGxvYWRNb2RlbFJlcXVlc3QSQQoGcGFyZW50GAEgASgJQingQQL6QSMKIWxvY2F0aW9ucy5nb29nbGVhcGlzLmNvbS9Mb2NhdGlvblIGcGFyZW50EjwKBW1vZGVsGAIgASgLMiEuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuTW9kZWxCA+BBAlIFbW9kZWw=');
...
final $typed_data.Uint8List uploadModelOperationMetadataDescriptor =
    $convert.base64Decode(
        'ChxVcGxvYWRNb2RlbE9wZXJhdGlvbk1ldGFkYXRhEl8KEGdlbmVyaWNfbWV0YWRhdGEYASABKAsyNC5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MS5HZW5lcmljT3BlcmF0aW9uTWV0YWRhdGFSD2dlbmVyaWNNZXRhZGF0YQ==');
...
final $typed_data.Uint8List listModelsRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listModelsResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0TW9kZWxzUmVzcG9uc2USOQoGbW9kZWxzGAEgAygLMiEuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuTW9kZWxSBm1vZGVscxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List updateModelRequestDescriptor = $convert.base64Decode(
    'ChJVcGRhdGVNb2RlbFJlcXVlc3QSPAoFbW9kZWwYASABKAsyIS5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MS5Nb2RlbEID4EECUgVtb2RlbBJACgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaw==');
...
const ExportModelRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1.ExportModelRequest.OutputConfig',
      '8': const {},
      '10': 'outputConfig'
    },
  ],
...
const ExportModelRequest_OutputConfig$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1.ContainerRegistryDestination',
      '10': 'imageDestination'
    },
  ],
};
...
final $typed_data.Uint8List exportModelOperationMetadataDescriptor =
    $convert.base64Decode(
        '');
...
const ListModelEvaluationsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1.ModelEvaluation',
      '10': 'modelEvaluations'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listModelEvaluationsResponseDescriptor =
    $convert.base64Decode(
        'ChxMaXN0TW9kZWxFdmFsdWF0aW9uc1Jlc3BvbnNlElgKEW1vZGVsX2V2YWx1YXRpb25zGAEgAygLMisuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuTW9kZWxFdmFsdWF0aW9uUhBtb2RlbEV2YWx1YXRpb25zEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const ListModelEvaluationSlicesResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1.ModelEvaluationSlice',
...
final $typed_data.Uint8List listModelEvaluationSlicesResponseDescriptor =
    $convert.base64Decode(
        'CiFMaXN0TW9kZWxFdmFsdWF0aW9uU2xpY2VzUmVzcG9uc2USaAoXbW9kZWxfZXZhbHVhdGlvbl9zbGljZXMYASADKAsyMC5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MS5Nb2RlbEV2YWx1YXRpb25TbGljZVIVbW9kZWxFdmFsdWF0aW9uU2xpY2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
