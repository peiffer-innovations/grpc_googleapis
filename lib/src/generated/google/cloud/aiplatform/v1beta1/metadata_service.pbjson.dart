...
const CreateMetadataStoreRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.MetadataStore',
      '8': const {},
      '10': 'metadataStore'
    },
    const {
...
final $typed_data.Uint8List createMetadataStoreRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List createMetadataStoreOperationMetadataDescriptor =
    $convert.base64Decode(
        'CiRDcmVhdGVNZXRhZGF0YVN0b3JlT3BlcmF0aW9uTWV0YWRhdGESZAoQZ2VuZXJpY19tZXRhZGF0YRgBIAEoCzI5Lmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuR2VuZXJpY09wZXJhdGlvbk1ldGFkYXRhUg9nZW5lcmljTWV0YWRhdGE=');
...
final $typed_data.Uint8List listMetadataStoresResponseDescriptor =
    $convert.base64Decode(
        'ChpMaXN0TWV0YWRhdGFTdG9yZXNSZXNwb25zZRJXCg9tZXRhZGF0YV9zdG9yZXMYASADKAsyLi5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLk1ldGFkYXRhU3RvcmVSDm1ldGFkYXRhU3RvcmVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List deleteMetadataStoreOperationMetadataDescriptor =
    $convert.base64Decode(
        'CiREZWxldGVNZXRhZGF0YVN0b3JlT3BlcmF0aW9uTWV0YWRhdGESZAoQZ2VuZXJpY19tZXRhZGF0YRgBIAEoCzI5Lmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuR2VuZXJpY09wZXJhdGlvbk1ldGFkYXRhUg9nZW5lcmljTWV0YWRhdGE=');
...
final $typed_data.Uint8List createArtifactRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listArtifactsResponseDescriptor = $convert.base64Decode(
    'ChVMaXN0QXJ0aWZhY3RzUmVzcG9uc2USRwoJYXJ0aWZhY3RzGAEgAygLMikuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjFiZXRhMS5BcnRpZmFjdFIJYXJ0aWZhY3RzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List updateArtifactRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List purgeArtifactsMetadataDescriptor =
    $convert.base64Decode(
        'ChZQdXJnZUFydGlmYWN0c01ldGFkYXRhEmQKEGdlbmVyaWNfbWV0YWRhdGEYASABKAsyOS5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLkdlbmVyaWNPcGVyYXRpb25NZXRhZGF0YVIPZ2VuZXJpY01ldGFkYXRh');
...
final $typed_data.Uint8List createContextRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listContextsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0Q29udGV4dHNSZXNwb25zZRJECghjb250ZXh0cxgBIAMoCzIoLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuQ29udGV4dFIIY29udGV4dHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List updateContextRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List purgeContextsMetadataDescriptor = $convert.base64Decode(
    'ChVQdXJnZUNvbnRleHRzTWV0YWRhdGESZAoQZ2VuZXJpY19tZXRhZGF0YRgBIAEoCzI5Lmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuR2VuZXJpY09wZXJhdGlvbk1ldGFkYXRhUg9nZW5lcmljTWV0YWRhdGE=');
@$core
...
final $typed_data.Uint8List createExecutionRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listExecutionsResponseDescriptor =
    $convert.base64Decode(
        'ChZMaXN0RXhlY3V0aW9uc1Jlc3BvbnNlEkoKCmV4ZWN1dGlvbnMYASADKAsyKi5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLkV4ZWN1dGlvblIKZXhlY3V0aW9ucxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List updateExecutionRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List purgeExecutionsMetadataDescriptor =
    $convert.base64Decode(
        'ChdQdXJnZUV4ZWN1dGlvbnNNZXRhZGF0YRJkChBnZW5lcmljX21ldGFkYXRhGAEgASgLMjkuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjFiZXRhMS5HZW5lcmljT3BlcmF0aW9uTWV0YWRhdGFSD2dlbmVyaWNNZXRhZGF0YQ==');
...
final $typed_data.Uint8List addExecutionEventsRequestDescriptor =
    $convert.base64Decode(
        'ChlBZGRFeGVjdXRpb25FdmVudHNSZXF1ZXN0EkkKCWV4ZWN1dGlvbhgBIAEoCUIr4EEC+kElCiNhaXBsYXRmb3JtLmdvb2dsZWFwaXMuY29tL0V4ZWN1dGlvblIJZXhlY3V0aW9uEj4KBmV2ZW50cxgCIAMoCzImLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuRXZlbnRSBmV2ZW50cw==');
...
const CreateMetadataSchemaRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.MetadataSchema',
      '8': const {},
      '10': 'metadataSchema'
    },
    const {
...
final $typed_data.Uint8List createMetadataSchemaRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listMetadataSchemasResponseDescriptor =
    $convert.base64Decode(
        'ChtMaXN0TWV0YWRhdGFTY2hlbWFzUmVzcG9uc2USWgoQbWV0YWRhdGFfc2NoZW1hcxgBIAMoCzIvLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuTWV0YWRhdGFTY2hlbWFSD21ldGFkYXRhU2NoZW1hcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
