...
class StudySpec_ConvexStopConfig extends $pb.GeneratedMessage {
  ...
  factory StudySpec_ConvexStopConfig.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory StudySpec_ConvexStopConfig.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  StudySpec_ConvexStopConfig clone() =>
      StudySpec_ConvexStopConfig()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  StudySpec_ConvexStopConfig copyWith(
          void Function(StudySpec_ConvexStopConfig) updates) =>
      super.copyWith(
              (message) => updates(message as StudySpec_ConvexStopConfig))
          as StudySpec_ConvexStopConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static $pb.PbList<StudySpec_ConvexStopConfig> createRepeated() =>
      $pb.PbList<StudySpec_ConvexStopConfig>();
  @$core.pragma('dart2js:noInline')
  static StudySpec_ConvexStopConfig getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<StudySpec_ConvexStopConfig>(create);
  static StudySpec_ConvexStopConfig? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get maxNumSteps => $_getI64(0);
  @$pb.TagNumber(1)
  set maxNumSteps($fixnum.Int64 v) {
    $_setInt64(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set minNumSteps($fixnum.Int64 v) {
    $_setInt64(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set autoregressiveOrder($fixnum.Int64 v) {
    $_setInt64(2, v);
  }
  ...
  @$pb.TagNumber(4)
  set learningRateParameterName($core.String v) {
    $_setString(3, v);
  }
...
class StudySpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<StudySpec_ConvexStopConfig>(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'convexStopConfig',
        subBuilder: StudySpec_ConvexStopConfig.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  set convexStopConfig(StudySpec_ConvexStopConfig v) {
    setField(8, v);
  }
