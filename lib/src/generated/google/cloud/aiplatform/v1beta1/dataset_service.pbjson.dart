...
const CreateDatasetRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.Dataset',
      '8': const {},
      '10': 'dataset'
    },
  ],
...
final $typed_data.Uint8List createDatasetRequestDescriptor = $convert.base64Decode(
    'ChRDcmVhdGVEYXRhc2V0UmVxdWVzdBJBCgZwYXJlbnQYASABKAlCKeBBAvpBIwohbG9jYXRpb25zLmdvb2dsZWFwaXMuY29tL0xvY2F0aW9uUgZwYXJlbnQSRwoHZGF0YXNldBgCIAEoCzIoLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuRGF0YXNldEID4EECUgdkYXRhc2V0');
...
final $typed_data.Uint8List createDatasetOperationMetadataDescriptor =
    $convert.base64Decode(
        'Ch5DcmVhdGVEYXRhc2V0T3BlcmF0aW9uTWV0YWRhdGESZAoQZ2VuZXJpY19tZXRhZGF0YRgBIAEoCzI5Lmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuR2VuZXJpY09wZXJhdGlvbk1ldGFkYXRhUg9nZW5lcmljTWV0YWRhdGE=');
...
final $typed_data.Uint8List updateDatasetRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVEYXRhc2V0UmVxdWVzdBJHCgdkYXRhc2V0GAEgASgLMiguZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjFiZXRhMS5EYXRhc2V0QgPgQQJSB2RhdGFzZXQSQAoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrQgPgQQJSCnVwZGF0ZU1hc2s=');
...
final $typed_data.Uint8List listDatasetsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0RGF0YXNldHNSZXNwb25zZRJECghkYXRhc2V0cxgBIAMoCzIoLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuRGF0YXNldFIIZGF0YXNldHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
const ImportDataRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.ImportDataConfig',
      '8': const {},
      '10': 'importConfigs'
    },
  ],
...
final $typed_data.Uint8List importDataRequestDescriptor = $convert.base64Decode(
    'ChFJbXBvcnREYXRhUmVxdWVzdBI9CgRuYW1lGAEgASgJQingQQL6QSMKIWFpcGxhdGZvcm0uZ29vZ2xlYXBpcy5jb20vRGF0YXNldFIEbmFtZRJdCg5pbXBvcnRfY29uZmlncxgCIAMoCzIxLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuSW1wb3J0RGF0YUNvbmZpZ0ID4EECUg1pbXBvcnRDb25maWdz');
...
final $typed_data.Uint8List importDataOperationMetadataDescriptor =
    $convert.base64Decode(
        'ChtJbXBvcnREYXRhT3BlcmF0aW9uTWV0YWRhdGESZAoQZ2VuZXJpY19tZXRhZGF0YRgBIAEoCzI5Lmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuR2VuZXJpY09wZXJhdGlvbk1ldGFkYXRhUg9nZW5lcmljTWV0YWRhdGE=');
...
const ExportDataRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.ExportDataConfig',
      '8': const {},
      '10': 'exportConfig'
    },
  ],
...
final $typed_data.Uint8List exportDataRequestDescriptor = $convert.base64Decode(
    'ChFFeHBvcnREYXRhUmVxdWVzdBI9CgRuYW1lGAEgASgJQingQQL6QSMKIWFpcGxhdGZvcm0uZ29vZ2xlYXBpcy5jb20vRGF0YXNldFIEbmFtZRJbCg1leHBvcnRfY29uZmlnGAIgASgLMjEuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjFiZXRhMS5FeHBvcnREYXRhQ29uZmlnQgPgQQJSDGV4cG9ydENvbmZpZw==');
...
final $typed_data.Uint8List exportDataOperationMetadataDescriptor =
    $convert.base64Decode(
        'ChtFeHBvcnREYXRhT3BlcmF0aW9uTWV0YWRhdGESZAoQZ2VuZXJpY19tZXRhZGF0YRgBIAEoCzI5Lmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuR2VuZXJpY09wZXJhdGlvbk1ldGFkYXRhUg9nZW5lcmljTWV0YWRhdGESMAoUZ2NzX291dHB1dF9kaXJlY3RvcnkYAiABKAlSEmdjc091dHB1dERpcmVjdG9yeQ==');
...
const ListDataItemsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.DataItem',
      '10': 'dataItems'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listDataItemsResponseDescriptor = $convert.base64Decode(
    'ChVMaXN0RGF0YUl0ZW1zUmVzcG9uc2USSAoKZGF0YV9pdGVtcxgBIAMoCzIpLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuRGF0YUl0ZW1SCWRhdGFJdGVtcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
const ListAnnotationsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.Annotation',
      '10': 'annotations'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listAnnotationsResponseDescriptor =
    $convert.base64Decode(
        'ChdMaXN0QW5ub3RhdGlvbnNSZXNwb25zZRJNCgthbm5vdGF0aW9ucxgBIAMoCzIrLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuQW5ub3RhdGlvblILYW5ub3RhdGlvbnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
