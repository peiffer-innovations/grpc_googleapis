...
class ExplanationParameters extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, ExplanationParameters_Method>
    ...
    7: ExplanationParameters_Method.similarity,
  ...
  @$pb.TagNumber(7)
  Similarity get similarity => $_getN(5);
  @$pb.TagNumber(7)
  set similarity(Similarity v) {
    setField(7, v);
  }

  @$pb.TagNumber(7)
  $core.bool hasSimilarity() => $_has(5);
  @$pb.TagNumber(7)
  void clearSimilarity() => clearField(7);
  @$pb.TagNumber(7)
  Similarity ensureSimilarity() => $_ensure(5);
}
...
class Similarity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
          : 'Similarity',
  ...
  factory Similarity.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Similarity.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  Similarity clone() => Similarity()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Similarity copyWith(void Function(Similarity) updates) =>
      super.copyWith((message) => updates(message as Similarity))
          as Similarity; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Similarity create() => Similarity._();
  Similarity createEmptyInstance() => create();
  static $pb.PbList<Similarity> createRepeated() => $pb.PbList<Similarity>();
  @$core.pragma('dart2js:noInline')
  static Similarity getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Similarity>(create);
  static Similarity? _defaultInstance;

  @$pb.TagNumber(1)
  $2.GcsSource get gcsSource => $_getN(0);
  @$pb.TagNumber(1)
  set gcsSource($2.GcsSource v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set nearestNeighborSearchConfig($0.Value v) {
    setField(2, v);
  }
