...
const ExplainRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.ExplanationSpecOverride',
...
const ExplainResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.Explanation',
      '10': 'explanations'
    },
    const {
      '1': 'deployed_model_id',
...
final $typed_data.Uint8List explainResponseDescriptor = $convert.base64Decode(
    '');
