...
class MetadataServiceClient extends $grpc.Client {
  static final _$createMetadataStore = $grpc.ClientMethod<
          $2.CreateMetadataStoreRequest, $0.Operation>(
  ...
  static final _$deleteMetadataStore = $grpc.ClientMethod<
          $2.DeleteMetadataStoreRequest, $0.Operation>(
  ...
  static final _$queryExecutionInputsAndOutputs = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) => $6.LineageSubgraph.fromBuffer(value));
  static final _$createMetadataSchema = $grpc.ClientMethod<
          $2.CreateMetadataSchemaRequest, $8.MetadataSchema>(
