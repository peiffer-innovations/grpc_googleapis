...
class TensorboardServiceClient extends $grpc.Client {
  static final _$createTensorboard = $grpc.ClientMethod<
          $2.CreateTensorboardRequest, $0.Operation>(
  ...
  static final _$updateTensorboard = $grpc.ClientMethod<
          $2.UpdateTensorboardRequest, $0.Operation>(
  ...
  static final _$deleteTensorboard = $grpc.ClientMethod<
          $2.DeleteTensorboardRequest, $0.Operation>(
  ...
  static final _$deleteTensorboardExperiment = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$createTensorboardRun = $grpc.ClientMethod<
          $2.CreateTensorboardRunRequest, $5.TensorboardRun>(
  ...
  static final _$getTensorboardRun = $grpc.ClientMethod<
          $2.GetTensorboardRunRequest, $5.TensorboardRun>(
      '/google.cloud.aiplatform.v1beta1.TensorboardService/GetTensorboardRun',
      ($2.GetTensorboardRunRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $5.TensorboardRun.fromBuffer(value));
  static final _$updateTensorboardRun = $grpc.ClientMethod<
          $2.UpdateTensorboardRunRequest, $5.TensorboardRun>(
  ...
  static final _$deleteTensorboardRun = $grpc.ClientMethod<
          $2.DeleteTensorboardRunRequest, $0.Operation>(
