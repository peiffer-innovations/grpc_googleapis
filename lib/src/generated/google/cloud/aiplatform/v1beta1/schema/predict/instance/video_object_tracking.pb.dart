...
class VideoObjectTrackingPredictionInstance extends $pb.GeneratedMessage {
  ...
  factory VideoObjectTrackingPredictionInstance.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory VideoObjectTrackingPredictionInstance.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  VideoObjectTrackingPredictionInstance clone() =>
      VideoObjectTrackingPredictionInstance()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  VideoObjectTrackingPredictionInstance copyWith(
          void Function(VideoObjectTrackingPredictionInstance) updates) =>
      super.copyWith((message) =>
              updates(message as VideoObjectTrackingPredictionInstance))
          as VideoObjectTrackingPredictionInstance; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static VideoObjectTrackingPredictionInstance create() =>
      VideoObjectTrackingPredictionInstance._();
  VideoObjectTrackingPredictionInstance createEmptyInstance() => create();
  static $pb.PbList<VideoObjectTrackingPredictionInstance> createRepeated() =>
      $pb.PbList<VideoObjectTrackingPredictionInstance>();
  @$core.pragma('dart2js:noInline')
  static VideoObjectTrackingPredictionInstance getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          VideoObjectTrackingPredictionInstance>(create);
