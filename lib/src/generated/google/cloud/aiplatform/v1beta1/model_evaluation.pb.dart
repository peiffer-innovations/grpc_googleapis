...
class ModelEvaluation_ModelEvaluationExplanationSpec
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'explanationType')
    ..aOM<$2.ExplanationSpec>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'explanationSpec',
        subBuilder: $2.ExplanationSpec.create)
  ...
  factory ModelEvaluation_ModelEvaluationExplanationSpec.fromBuffer(
  ...
  ModelEvaluation_ModelEvaluationExplanationSpec clone() =>
      ModelEvaluation_ModelEvaluationExplanationSpec()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ModelEvaluation_ModelEvaluationExplanationSpec copyWith(
          void Function(ModelEvaluation_ModelEvaluationExplanationSpec)
              updates) =>
      super.copyWith((message) => updates(
              message as ModelEvaluation_ModelEvaluationExplanationSpec))
          as ModelEvaluation_ModelEvaluationExplanationSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ModelEvaluation_ModelEvaluationExplanationSpec create() =>
      ModelEvaluation_ModelEvaluationExplanationSpec._();
  ModelEvaluation_ModelEvaluationExplanationSpec createEmptyInstance() =>
      create();
  static $pb.PbList<ModelEvaluation_ModelEvaluationExplanationSpec>
      createRepeated() =>
          $pb.PbList<ModelEvaluation_ModelEvaluationExplanationSpec>();
  @$core.pragma('dart2js:noInline')
  static ModelEvaluation_ModelEvaluationExplanationSpec getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          ModelEvaluation_ModelEvaluationExplanationSpec>(create);
  static ModelEvaluation_ModelEvaluationExplanationSpec? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get explanationType => $_getSZ(0);
  @$pb.TagNumber(1)
  set explanationType($core.String v) {
    $_setString(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set explanationSpec($2.ExplanationSpec v) {
    setField(2, v);
  }
...
class ModelEvaluation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<ModelEvaluation_ModelEvaluationExplanationSpec>(
        9,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'explanationSpecs',
        $pb.PbFieldType.PM,
        subBuilder: ModelEvaluation_ModelEvaluationExplanationSpec.create)
    ..hasRequiredFields = false;
  ...
  factory ModelEvaluation({
    ...
    $core.Iterable<ModelEvaluation_ModelEvaluationExplanationSpec>?
        explanationSpecs,
  }) {
    final _result = create();
    if (name != null) {
  ...
  @$pb.TagNumber(9)
  $core.List<ModelEvaluation_ModelEvaluationExplanationSpec>
      get explanationSpecs => $_getList(6);
}
