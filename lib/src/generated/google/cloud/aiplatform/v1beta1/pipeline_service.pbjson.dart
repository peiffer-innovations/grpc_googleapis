...
const CreateTrainingPipelineRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.TrainingPipeline',
      '8': const {},
      '10': 'trainingPipeline'
    },
  ],
...
final $typed_data.Uint8List createTrainingPipelineRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listTrainingPipelinesResponseDescriptor =
    $convert.base64Decode(
        'Ch1MaXN0VHJhaW5pbmdQaXBlbGluZXNSZXNwb25zZRJgChJ0cmFpbmluZ19waXBlbGluZXMYASADKAsyMS5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLlRyYWluaW5nUGlwZWxpbmVSEXRyYWluaW5nUGlwZWxpbmVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const CreatePipelineJobRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.PipelineJob',
      '8': const {},
      '10': 'pipelineJob'
    },
    const {
...
final $typed_data.Uint8List createPipelineJobRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listPipelineJobsResponseDescriptor =
    $convert.base64Decode(
        'ChhMaXN0UGlwZWxpbmVKb2JzUmVzcG9uc2USUQoNcGlwZWxpbmVfam9icxgBIAMoCzIsLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuUGlwZWxpbmVKb2JSDHBpcGVsaW5lSm9icxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
