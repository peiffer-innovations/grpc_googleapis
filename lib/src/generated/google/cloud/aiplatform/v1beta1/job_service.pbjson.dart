...
const CreateCustomJobRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.CustomJob',
      '8': const {},
      '10': 'customJob'
    },
  ],
...
final $typed_data.Uint8List createCustomJobRequestDescriptor =
    $convert.base64Decode(
        'ChZDcmVhdGVDdXN0b21Kb2JSZXF1ZXN0EkEKBnBhcmVudBgBIAEoCUIp4EEC+kEjCiFsb2NhdGlvbnMuZ29vZ2xlYXBpcy5jb20vTG9jYXRpb25SBnBhcmVudBJOCgpjdXN0b21fam9iGAIgASgLMiouZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjFiZXRhMS5DdXN0b21Kb2JCA+BBAlIJY3VzdG9tSm9i');
...
final $typed_data.Uint8List listCustomJobsResponseDescriptor =
    $convert.base64Decode(
        'ChZMaXN0Q3VzdG9tSm9ic1Jlc3BvbnNlEksKC2N1c3RvbV9qb2JzGAEgAygLMiouZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjFiZXRhMS5DdXN0b21Kb2JSCmN1c3RvbUpvYnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
const CreateDataLabelingJobRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.DataLabelingJob',
      '8': const {},
      '10': 'dataLabelingJob'
    },
  ],
...
final $typed_data.Uint8List createDataLabelingJobRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listDataLabelingJobsResponseDescriptor =
    $convert.base64Decode(
        'ChxMaXN0RGF0YUxhYmVsaW5nSm9ic1Jlc3BvbnNlEl4KEmRhdGFfbGFiZWxpbmdfam9icxgBIAMoCzIwLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuRGF0YUxhYmVsaW5nSm9iUhBkYXRhTGFiZWxpbmdKb2JzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const CreateHyperparameterTuningJobRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.HyperparameterTuningJob',
      '8': const {},
...
final $typed_data.Uint8List createHyperparameterTuningJobRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listHyperparameterTuningJobsResponseDescriptor =
    $convert.base64Decode(
        '');
...
const CreateBatchPredictionJobRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.BatchPredictionJob',
      '8': const {},
...
final $typed_data.Uint8List createBatchPredictionJobRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listBatchPredictionJobsResponseDescriptor =
    $convert.base64Decode(
        'Ch9MaXN0QmF0Y2hQcmVkaWN0aW9uSm9ic1Jlc3BvbnNlEmcKFWJhdGNoX3ByZWRpY3Rpb25fam9icxgBIAMoCzIzLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuQmF0Y2hQcmVkaWN0aW9uSm9iUhNiYXRjaFByZWRpY3Rpb25Kb2JzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const CreateModelDeploymentMonitoringJobRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.ModelDeploymentMonitoringJob',
      '8': const {},
...
final $typed_data.Uint8List
    createModelDeploymentMonitoringJobRequestDescriptor = $convert.base64Decode(
        '');
@$core.Deprecated(
...
final $typed_data.Uint8List
    ...
    $convert.base64Decode(
        '');
@$core.Deprecated(
...
const SearchModelDeploymentMonitoringStatsAnomaliesResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsAnomalies',
      '10': 'monitoringStats'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List
    ...
    $convert.base64Decode(
        '');
@$core
...
final $typed_data.Uint8List
    listModelDeploymentMonitoringJobsResponseDescriptor = $convert.base64Decode(
        '');
@$core.Deprecated(
...
final $typed_data.Uint8List
    updateModelDeploymentMonitoringJobRequestDescriptor = $convert.base64Decode(
        '');
@$core.Deprecated(
...
final $typed_data.Uint8List
    ...
    $convert.base64Decode(
        'CjNVcGRhdGVNb2RlbERlcGxveW1lbnRNb25pdG9yaW5nSm9iT3BlcmF0aW9uTWV0YWRhdGESZAoQZ2VuZXJpY19tZXRhZGF0YRgBIAEoCzI5Lmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuR2VuZXJpY09wZXJhdGlvbk1ldGFkYXRhUg9nZW5lcmljTWV0YWRhdGE=');
