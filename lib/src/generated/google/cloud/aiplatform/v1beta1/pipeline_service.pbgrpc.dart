...
class PipelineServiceClient extends $grpc.Client {
  static final _$createTrainingPipeline = $grpc.ClientMethod<
          $2.CreateTrainingPipelineRequest, $3.TrainingPipeline>(
      ...
      ($core.List<$core.int> value) => $3.TrainingPipeline.fromBuffer(value));
  static final _$getTrainingPipeline = $grpc.ClientMethod<
          $2.GetTrainingPipelineRequest, $3.TrainingPipeline>(
  ...
  static final _$deleteTrainingPipeline = $grpc.ClientMethod<
          $2.DeleteTrainingPipelineRequest, $0.Operation>(
  ...
  static final _$cancelTrainingPipeline = $grpc.ClientMethod<
          $2.CancelTrainingPipelineRequest, $1.Empty>(
