...
class KeyManagementServiceClient extends $grpc.Client {
  ...
  static final _$macSign =
      $grpc.ClientMethod<$0.MacSignRequest, $0.MacSignResponse>(
          '/google.cloud.kms.v1.KeyManagementService/MacSign',
          ($0.MacSignRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.MacSignResponse.fromBuffer(value));
  static final _$macVerify =
      $grpc.ClientMethod<$0.MacVerifyRequest, $0.MacVerifyResponse>(
          '/google.cloud.kms.v1.KeyManagementService/MacVerify',
          ($0.MacVerifyRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.MacVerifyResponse.fromBuffer(value));
  static final _$generateRandomBytes = $grpc.ClientMethod<
          $0.GenerateRandomBytesRequest, $0.GenerateRandomBytesResponse>(
      '/google.cloud.kms.v1.KeyManagementService/GenerateRandomBytes',
      ($0.GenerateRandomBytesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.GenerateRandomBytesResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.CryptoKeyVersion> createCryptoKeyVersion(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createCryptoKeyVersion, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$1.CryptoKeyVersion> importCryptoKeyVersion(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$importCryptoKeyVersion, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$1.CryptoKeyVersion> updateCryptoKeyVersion(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateCryptoKeyVersion, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$1.CryptoKey> updateCryptoKeyPrimaryVersion(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateCryptoKeyPrimaryVersion, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$1.CryptoKeyVersion> destroyCryptoKeyVersion(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$destroyCryptoKeyVersion, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$1.CryptoKeyVersion> restoreCryptoKeyVersion(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$restoreCryptoKeyVersion, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$0.MacSignResponse> macSign($0.MacSignRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$macSign, request, options: options);
  }

  $grpc.ResponseFuture<$0.MacVerifyResponse> macVerify(
      $0.MacVerifyRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$macVerify, request, options: options);
  }

  $grpc.ResponseFuture<$0.GenerateRandomBytesResponse> generateRandomBytes(
      $0.GenerateRandomBytesRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class KeyManagementServiceBase extends $grpc.Service {
  ...
  KeyManagementServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.MacSignRequest, $0.MacSignResponse>(
        'MacSign',
        macSign_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.MacSignRequest.fromBuffer(value),
        ($0.MacSignResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.MacVerifyRequest, $0.MacVerifyResponse>(
        'MacVerify',
        macVerify_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.MacVerifyRequest.fromBuffer(value),
        ($0.MacVerifyResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GenerateRandomBytesRequest,
            $0.GenerateRandomBytesResponse>(
        'GenerateRandomBytes',
        generateRandomBytes_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GenerateRandomBytesRequest.fromBuffer(value),
        ($0.GenerateRandomBytesResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.MacSignResponse> macSign_Pre(
      $grpc.ServiceCall call, $async.Future<$0.MacSignRequest> request) async {
    return macSign(call, await request);
  }

  $async.Future<$0.MacVerifyResponse> macVerify_Pre($grpc.ServiceCall call,
      $async.Future<$0.MacVerifyRequest> request) async {
    return macVerify(call, await request);
  }

  $async.Future<$0.GenerateRandomBytesResponse> generateRandomBytes_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GenerateRandomBytesRequest> request) async {
  ...
  $async.Future<$0.MacSignResponse> macSign(
      $grpc.ServiceCall call, $0.MacSignRequest request);
  $async.Future<$0.MacVerifyResponse> macVerify(
      $grpc.ServiceCall call, $0.MacVerifyRequest request);
  $async.Future<$0.GenerateRandomBytesResponse> generateRandomBytes(
      $grpc.ServiceCall call, $0.GenerateRandomBytesRequest request);
}
