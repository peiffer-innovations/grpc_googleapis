...
final $typed_data.Uint8List writeUserEventRequestDescriptor = $convert.base64Decode(
    'ChVXcml0ZVVzZXJFdmVudFJlcXVlc3QSGwoGcGFyZW50GAEgASgJQgPgQQJSBnBhcmVudBJJCgp1c2VyX2V2ZW50GAIgASgLMiUuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmJldGEuVXNlckV2ZW50QgPgQQJSCXVzZXJFdmVudA==');
...
const RejoinUserEventsRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.cloud.retail.v2beta.RejoinUserEventsRequest.UserEventRejoinScope',
...
final $typed_data.Uint8List rejoinUserEventsRequestDescriptor =
    $convert.base64Decode(
        '');
