...
const ListCatalogsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.retail.v2beta.Catalog',
      '10': 'catalogs'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listCatalogsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0Q2F0YWxvZ3NSZXNwb25zZRI/CghjYXRhbG9ncxgBIAMoCzIjLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZXRhLkNhdGFsb2dSCGNhdGFsb2dzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List updateCatalogRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVDYXRhbG9nUmVxdWVzdBJCCgdjYXRhbG9nGAEgASgLMiMuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmJldGEuQ2F0YWxvZ0ID4EECUgdjYXRhbG9nEjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
