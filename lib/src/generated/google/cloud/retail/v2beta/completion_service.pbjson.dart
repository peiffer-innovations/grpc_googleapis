...
const CompleteQueryResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.retail.v2beta.CompleteQueryResponse.CompletionResult',
    ...
    const {
      ...
      '5': 11,
      '6':
          '.google.cloud.retail.v2beta.CompleteQueryResponse.RecentSearchResult',
...
const CompleteQueryResponse_CompletionResult$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 11,
      '6':
          '.google.cloud.retail.v2beta.CompleteQueryResponse.CompletionResult.AttributesEntry',
      '10': 'attributes'
    },
  ],
...
final $typed_data.Uint8List completeQueryResponseDescriptor = $convert.base64Decode(
    '');
