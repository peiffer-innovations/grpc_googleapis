...
const ExportProductsResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2beta.ExportErrorsConfig',
      '10': 'errorsConfig'
    },
  ],
};
...
final $typed_data.Uint8List exportProductsResponseDescriptor =
    $convert.base64Decode(
        'ChZFeHBvcnRQcm9kdWN0c1Jlc3BvbnNlEjcKDWVycm9yX3NhbXBsZXMYASADKAsyEi5nb29nbGUucnBjLlN0YXR1c1IMZXJyb3JTYW1wbGVzElMKDWVycm9yc19jb25maWcYAiABKAsyLi5nb29nbGUuY2xvdWQucmV0YWlsLnYyYmV0YS5FeHBvcnRFcnJvcnNDb25maWdSDGVycm9yc0NvbmZpZw==');
...
final $typed_data.Uint8List exportUserEventsResponseDescriptor =
    $convert.base64Decode(
        'ChhFeHBvcnRVc2VyRXZlbnRzUmVzcG9uc2USNwoNZXJyb3Jfc2FtcGxlcxgBIAMoCzISLmdvb2dsZS5ycGMuU3RhdHVzUgxlcnJvclNhbXBsZXMSUwoNZXJyb3JzX2NvbmZpZxgCIAEoCzIuLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZXRhLkV4cG9ydEVycm9yc0NvbmZpZ1IMZXJyb3JzQ29uZmln');
