...
const Catalog$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2beta.ProductLevelConfig',
      '8': const {},
...
final $typed_data.Uint8List catalogDescriptor = $convert.base64Decode(
    '');
