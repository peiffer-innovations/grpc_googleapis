...
class SearchRequest_RelevanceThreshold extends $pb.ProtobufEnum {
  static const SearchRequest_RelevanceThreshold
      RELEVANCE_THRESHOLD_UNSPECIFIED = SearchRequest_RelevanceThreshold._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'RELEVANCE_THRESHOLD_UNSPECIFIED');
  static const SearchRequest_RelevanceThreshold HIGH =
      SearchRequest_RelevanceThreshold._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'HIGH');
  static const SearchRequest_RelevanceThreshold MEDIUM =
      SearchRequest_RelevanceThreshold._(
          2,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'MEDIUM');
  static const SearchRequest_RelevanceThreshold LOW =
      SearchRequest_RelevanceThreshold._(
          3,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'LOW');
  static const SearchRequest_RelevanceThreshold LOWEST =
      SearchRequest_RelevanceThreshold._(
          4,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
  ...
  static const $core.List<SearchRequest_RelevanceThreshold> values =
  ...
  static final $core.Map<$core.int, SearchRequest_RelevanceThreshold> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static SearchRequest_RelevanceThreshold? valueOf($core.int value) =>
      _byValue[value];

  const SearchRequest_RelevanceThreshold._($core.int v, $core.String n)
      : super(v, n);
}
