...
final $typed_data.Uint8List writeUserEventRequestDescriptor = $convert.base64Decode(
    'ChVXcml0ZVVzZXJFdmVudFJlcXVlc3QSGwoGcGFyZW50GAEgASgJQgPgQQJSBnBhcmVudBJKCgp1c2VyX2V2ZW50GAIgASgLMiYuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmFscGhhLlVzZXJFdmVudEID4EECUgl1c2VyRXZlbnQ=');
...
const RejoinUserEventsRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.cloud.retail.v2alpha.RejoinUserEventsRequest.UserEventRejoinScope',
...
final $typed_data.Uint8List rejoinUserEventsRequestDescriptor =
    $convert.base64Decode(
        '');
