...
final $typed_data.Uint8List productInlineSourceDescriptor = $convert.base64Decode(
    'ChNQcm9kdWN0SW5saW5lU291cmNlEkUKCHByb2R1Y3RzGAEgAygLMiQuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmFscGhhLlByb2R1Y3RCA+BBAlIIcHJvZHVjdHM=');
...
final $typed_data.Uint8List userEventInlineSourceDescriptor = $convert.base64Decode(
    'ChVVc2VyRXZlbnRJbmxpbmVTb3VyY2USTAoLdXNlcl9ldmVudHMYASADKAsyJi5nb29nbGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuVXNlckV2ZW50QgPgQQJSCnVzZXJFdmVudHM=');
...
const ImportProductsRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2alpha.ProductInputConfig',
      '8': const {},
      '10': 'inputConfig'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2alpha.ImportErrorsConfig',
      '10': 'errorsConfig'
    },
    const {
      '1': 'update_mask',
    ...
    const {
      ...
      '5': 14,
      '6':
          '.google.cloud.retail.v2alpha.ImportProductsRequest.ReconciliationMode',
...
final $typed_data.Uint8List importProductsRequestDescriptor = $convert.base64Decode(
    '');
...
const ImportUserEventsRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2alpha.UserEventInputConfig',
      '8': const {},
      '10': 'inputConfig'
    },
    const {
...
final $typed_data.Uint8List importUserEventsRequestDescriptor =
    $convert.base64Decode(
        '');
...
const ImportCompletionDataRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2alpha.CompletionDataInputConfig',
      '8': const {},
      '10': 'inputConfig'
    },
    const {
...
final $typed_data.Uint8List importCompletionDataRequestDescriptor =
    $convert.base64Decode(
        '');
...
const ProductInputConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2alpha.ProductInlineSource',
      '9': 0,
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2alpha.GcsSource',
      '9': 0,
      '10': 'gcsSource'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2alpha.BigQuerySource',
      '9': 0,
      '10': 'bigQuerySource'
    },
  ],
...
final $typed_data.Uint8List productInputConfigDescriptor = $convert.base64Decode(
    '');
...
const UserEventInputConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2alpha.UserEventInlineSource',
      '8': const {},
      '9': 0,
...
final $typed_data.Uint8List userEventInputConfigDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List completionDataInputConfigDescriptor =
    $convert.base64Decode(
        'ChlDb21wbGV0aW9uRGF0YUlucHV0Q29uZmlnElwKEGJpZ19xdWVyeV9zb3VyY2UYASABKAsyKy5nb29nbGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuQmlnUXVlcnlTb3VyY2VCA+BBAkgAUg5iaWdRdWVyeVNvdXJjZUIICgZzb3VyY2U=');
...
final $typed_data.Uint8List importProductsResponseDescriptor =
    $convert.base64Decode(
        'ChZJbXBvcnRQcm9kdWN0c1Jlc3BvbnNlEjcKDWVycm9yX3NhbXBsZXMYASADKAsyEi5nb29nbGUucnBjLlN0YXR1c1IMZXJyb3JTYW1wbGVzElQKDWVycm9yc19jb25maWcYAiABKAsyLy5nb29nbGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuSW1wb3J0RXJyb3JzQ29uZmlnUgxlcnJvcnNDb25maWc=');
...
const ImportUserEventsResponse$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2alpha.UserEventImportSummary',
      '10': 'importSummary'
    },
  ],
};
...
final $typed_data.Uint8List importUserEventsResponseDescriptor =
    $convert.base64Decode(
        '');
