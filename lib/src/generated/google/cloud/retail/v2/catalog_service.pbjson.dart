...
const ListCatalogsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.retail.v2.Catalog',
      '10': 'catalogs'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listCatalogsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0Q2F0YWxvZ3NSZXNwb25zZRI7CghjYXRhbG9ncxgBIAMoCzIfLmdvb2dsZS5jbG91ZC5yZXRhaWwudjIuQ2F0YWxvZ1IIY2F0YWxvZ3MSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List updateCatalogRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVDYXRhbG9nUmVxdWVzdBI+CgdjYXRhbG9nGAEgASgLMh8uZ29vZ2xlLmNsb3VkLnJldGFpbC52Mi5DYXRhbG9nQgPgQQJSB2NhdGFsb2cSOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
