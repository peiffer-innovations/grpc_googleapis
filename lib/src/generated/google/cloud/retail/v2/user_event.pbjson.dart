...
const UserEvent$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.retail.v2.ProductDetail',
      '10': 'productDetails'
    },
    const {
      '1': 'completion_detail',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2.CompletionDetail',
      '10': 'completionDetail'
    },
    const {
      '1': 'attributes',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.retail.v2.UserEvent.AttributesEntry',
      '10': 'attributes'
    },
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.retail.v2.PurchaseTransaction',
...
final $typed_data.Uint8List userEventDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List productDetailDescriptor = $convert.base64Decode(
    'Cg1Qcm9kdWN0RGV0YWlsEj4KB3Byb2R1Y3QYASABKAsyHy5nb29nbGUuY2xvdWQucmV0YWlsLnYyLlByb2R1Y3RCA+BBAlIHcHJvZHVjdBI3CghxdWFudGl0eRgCIAEoCzIbLmdvb2dsZS5wcm90b2J1Zi5JbnQzMlZhbHVlUghxdWFudGl0eQ==');
