...
class AttachedDisk_DiskMode extends $pb.ProtobufEnum {
  static const AttachedDisk_DiskMode DISK_MODE_UNSPECIFIED =
      AttachedDisk_DiskMode._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'DISK_MODE_UNSPECIFIED');
  static const AttachedDisk_DiskMode READ_WRITE = AttachedDisk_DiskMode._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'READ_WRITE');
  static const AttachedDisk_DiskMode READ_ONLY = AttachedDisk_DiskMode._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'READ_ONLY');

  static const $core.List<AttachedDisk_DiskMode> values =
  ...
  static final $core.Map<$core.int, AttachedDisk_DiskMode> _byValue =
