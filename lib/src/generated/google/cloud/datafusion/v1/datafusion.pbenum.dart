...
class Accelerator_State extends $pb.ProtobufEnum {
  static const Accelerator_State STATE_UNSPECIFIED = Accelerator_State._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'STATE_UNSPECIFIED');
  static const Accelerator_State ENABLED = Accelerator_State._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ENABLED');
  static const Accelerator_State DISABLED = Accelerator_State._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DISABLED');
  static const Accelerator_State UNKNOWN = Accelerator_State._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
