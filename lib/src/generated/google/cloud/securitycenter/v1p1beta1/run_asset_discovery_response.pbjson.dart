...
const RunAssetDiscoveryResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 14,
      '6':
          '.google.cloud.securitycenter.v1p1beta1.RunAssetDiscoveryResponse.State',
      '10': 'state'
    },
    const {
      '1': 'duration',
...
final $typed_data.Uint8List runAssetDiscoveryResponseDescriptor =
    $convert.base64Decode(
        '');
