...
final $typed_data.Uint8List createFindingRequestDescriptor = $convert.base64Decode(
    '');
...
const CreateNotificationConfigRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.securitycenter.v1p1beta1.NotificationConfig',
      '8': const {},
...
const CreateSourceRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.securitycenter.v1p1beta1.Source',
      '8': const {},
      '10': 'source'
    },
  ],
...
final $typed_data.Uint8List createSourceRequestDescriptor = $convert.base64Decode(
    'ChNDcmVhdGVTb3VyY2VSZXF1ZXN0ElAKBnBhcmVudBgBIAEoCUI44EEC+kEyCjBjbG91ZHJlc291cmNlbWFuYWdlci5nb29nbGVhcGlzLmNvbS9Pcmdhbml6YXRpb25SBnBhcmVudBJKCgZzb3VyY2UYAiABKAsyLS5nb29nbGUuY2xvdWQuc2VjdXJpdHljZW50ZXIudjFwMWJldGExLlNvdXJjZUID4EECUgZzb3VyY2U=');
...
const GroupAssetsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.securitycenter.v1p1beta1.GroupResult',
      '10': 'groupByResults'
    },
    const {
      '1': 'read_time',
...
final $typed_data.Uint8List groupAssetsResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List groupFindingsResponseDescriptor = $convert.base64Decode(
    '');
...
const GroupResult$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.securitycenter.v1p1beta1.GroupResult.PropertiesEntry',
      '10': 'properties'
    },
...
final $typed_data.Uint8List groupResultDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listNotificationConfigsResponseDescriptor =
    $convert.base64Decode(
        'Ch9MaXN0Tm90aWZpY2F0aW9uQ29uZmlnc1Jlc3BvbnNlEmwKFG5vdGlmaWNhdGlvbl9jb25maWdzGAEgAygLMjkuZ29vZ2xlLmNsb3VkLnNlY3VyaXR5Y2VudGVyLnYxcDFiZXRhMS5Ob3RpZmljYXRpb25Db25maWdSE25vdGlmaWNhdGlvbkNvbmZpZ3MSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List listSourcesResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0U291cmNlc1Jlc3BvbnNlEkcKB3NvdXJjZXMYASADKAsyLS5nb29nbGUuY2xvdWQuc2VjdXJpdHljZW50ZXIudjFwMWJldGExLlNvdXJjZVIHc291cmNlcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
const ListAssetsResponse_ListAssetsResult$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.securitycenter.v1p1beta1.Asset',
      '10': 'asset'
    },
    const {
      '1': 'state_change',
...
final $typed_data.Uint8List listAssetsResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listFindingsResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List setFindingStateRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List updateFindingRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVGaW5kaW5nUmVxdWVzdBJNCgdmaW5kaW5nGAEgASgLMi4uZ29vZ2xlLmNsb3VkLnNlY3VyaXR5Y2VudGVyLnYxcDFiZXRhMS5GaW5kaW5nQgPgQQJSB2ZpbmRpbmcSOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List updateNotificationConfigRequestDescriptor =
    $convert.base64Decode(
        '');
...
const UpdateOrganizationSettingsRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.securitycenter.v1p1beta1.OrganizationSettings',
      '8': const {},
...
final $typed_data.Uint8List updateOrganizationSettingsRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List updateSourceRequestDescriptor = $convert.base64Decode(
    'ChNVcGRhdGVTb3VyY2VSZXF1ZXN0EkoKBnNvdXJjZRgBIAEoCzItLmdvb2dsZS5jbG91ZC5zZWN1cml0eWNlbnRlci52MXAxYmV0YTEuU291cmNlQgPgQQJSBnNvdXJjZRI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCnVwZGF0ZU1hc2s=');
...
final $typed_data.Uint8List updateSecurityMarksRequestDescriptor =
    $convert.base64Decode(
        '');
