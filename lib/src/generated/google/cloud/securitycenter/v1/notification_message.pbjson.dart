...
const NotificationMessage$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.securitycenter.v1.Resource',
      '10': 'resource'
    },
  ],
  '8': const [
...
final $typed_data.Uint8List notificationMessageDescriptor = $convert.base64Decode(
    '');
