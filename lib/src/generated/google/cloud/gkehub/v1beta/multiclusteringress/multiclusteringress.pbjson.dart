...
const FeatureSpec$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.gkehub.multiclusteringress.v1beta.Billing',
      '10': 'billing'
    },
  ],
};
...
final $typed_data.Uint8List featureSpecDescriptor = $convert.base64Decode(
    'CgtGZWF0dXJlU3BlYxIrChFjb25maWdfbWVtYmVyc2hpcBgBIAEoCVIQY29uZmlnTWVtYmVyc2hpcBJRCgdiaWxsaW5nGAIgASgOMjcuZ29vZ2xlLmNsb3VkLmdrZWh1Yi5tdWx0aWNsdXN0ZXJpbmdyZXNzLnYxYmV0YS5CaWxsaW5nUgdiaWxsaW5n');
