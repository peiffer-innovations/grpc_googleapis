...
const FeatureSpec$json = const {
  ...
  '2': const [
    const {
      '1': 'allowlisted_service_accounts',
      '3': 1,
      '4': 3,
      '5': 9,
      '10': 'allowlistedServiceAccounts'
    },
  ],
};
...
final $typed_data.Uint8List featureSpecDescriptor = $convert.base64Decode(
    'CgtGZWF0dXJlU3BlYxJAChxhbGxvd2xpc3RlZF9zZXJ2aWNlX2FjY291bnRzGAEgAygJUhphbGxvd2xpc3RlZFNlcnZpY2VBY2NvdW50cw==');
