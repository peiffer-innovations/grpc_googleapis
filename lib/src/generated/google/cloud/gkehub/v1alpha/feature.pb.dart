...
class Feature extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $core.String>(
        ...
        packageName: const $pb.PackageName('google.cloud.gkehub.v1alpha'))
...
class CommonFeatureSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.FeatureSpec>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'cloudauditlogging',
        subBuilder: $2.FeatureSpec.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(108)
  set cloudauditlogging($2.FeatureSpec v) {
    setField(108, v);
  }
...
enum CommonFeatureState_FeatureState { servicemesh, notSet }

class CommonFeatureState extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, CommonFeatureState_FeatureState>
      _CommonFeatureState_FeatureStateByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$3.FeatureState>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'servicemesh',
        subBuilder: $3.FeatureState.create)
    ..hasRequiredFields = false;
  ...
  CommonFeatureState_FeatureState whichFeatureState() =>
      _CommonFeatureState_FeatureStateByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(100)
  set servicemesh($3.FeatureState v) {
    setField(100, v);
  }
...
class MembershipFeatureSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [106])
    ..aOM<$4.MembershipSpec>(
        106,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'configmanagement',
        subBuilder: $4.MembershipSpec.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(106)
  set configmanagement($4.MembershipSpec v) {
    setField(106, v);
  }
...
class MembershipFeatureState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$5.MembershipState>(
        104,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'metering',
        subBuilder: $5.MembershipState.create)
    ..aOM<$4.MembershipState>(
        106,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'configmanagement',
        subBuilder: $4.MembershipState.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(100)
  set servicemesh($3.MembershipState v) {
    setField(100, v);
  }
  ...
  @$pb.TagNumber(104)
  set metering($5.MembershipState v) {
    setField(104, v);
  }
  ...
  @$pb.TagNumber(106)
  set configmanagement($4.MembershipState v) {
    setField(106, v);
  }
