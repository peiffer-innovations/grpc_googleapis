...
class GkeHubMembershipServiceClient extends $grpc.Client {
  static final _$listMemberships = $grpc.ClientMethod<$2.ListMembershipsRequest,
  ...
  static final _$createMembership = $grpc.ClientMethod<
          $2.CreateMembershipRequest, $0.Operation>(
  ...
  static final _$deleteMembership = $grpc.ClientMethod<
          $2.DeleteMembershipRequest, $0.Operation>(
      '/google.cloud.gkehub.v1beta1.GkeHubMembershipService/DeleteMembership',
      ($2.DeleteMembershipRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$updateMembership = $grpc.ClientMethod<
          $2.UpdateMembershipRequest, $0.Operation>(
  ...
  static final _$validateExclusivity = $grpc.ClientMethod<
          $2.ValidateExclusivityRequest, $2.ValidateExclusivityResponse>(
      '/google.cloud.gkehub.v1beta1.GkeHubMembershipService/ValidateExclusivity',
      ($2.ValidateExclusivityRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $2.ValidateExclusivityResponse.fromBuffer(value));
  static final _$generateExclusivityManifest = $grpc.ClientMethod<
          $2.GenerateExclusivityManifestRequest,
          $2.GenerateExclusivityManifestResponse>(
      '/google.cloud.gkehub.v1beta1.GkeHubMembershipService/GenerateExclusivityManifest',
      ($2.GenerateExclusivityManifestRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $2.GenerateExclusivityManifestResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.ValidateExclusivityResponse> validateExclusivity(
      $2.ValidateExclusivityRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$validateExclusivity, request, options: options);
  }

  $grpc.ResponseFuture<$2.GenerateExclusivityManifestResponse>
      generateExclusivityManifest($2.GenerateExclusivityManifestRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$generateExclusivityManifest, request,
        options: options);
  }
}
...
abstract class GkeHubMembershipServiceBase extends $grpc.Service {
  ...
  GkeHubMembershipServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.ValidateExclusivityRequest,
            $2.ValidateExclusivityResponse>(
        'ValidateExclusivity',
        validateExclusivity_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.ValidateExclusivityRequest.fromBuffer(value),
        ($2.ValidateExclusivityResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.GenerateExclusivityManifestRequest,
            $2.GenerateExclusivityManifestResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $2.GenerateExclusivityManifestRequest.fromBuffer(value),
        ($2.GenerateExclusivityManifestResponse value) =>
            value.writeToBuffer()));
  }
  ...
  $async.Future<$2.ValidateExclusivityResponse> validateExclusivity_Pre(
      $grpc.ServiceCall call,
      $async.Future<$2.ValidateExclusivityRequest> request) async {
    return validateExclusivity(call, await request);
  }

  $async.Future<$2.GenerateExclusivityManifestResponse>
      generateExclusivityManifest_Pre($grpc.ServiceCall call,
          $async.Future<$2.GenerateExclusivityManifestRequest> request) async {
  ...
  $async.Future<$2.ValidateExclusivityResponse> validateExclusivity(
      $grpc.ServiceCall call, $2.ValidateExclusivityRequest request);
  $async.Future<$2.GenerateExclusivityManifestResponse>
      generateExclusivityManifest($grpc.ServiceCall call,
          $2.GenerateExclusivityManifestRequest request);
}
