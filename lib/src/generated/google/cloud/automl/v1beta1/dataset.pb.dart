...
class Dataset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'exampleCount',
        $pb.PbFieldType.O3)
    ..aOM<$1.TranslationDatasetMetadata>(
        23,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'translationDatasetMetadata',
        subBuilder: $1.TranslationDatasetMetadata.create)
    ..aOM<$2.ImageClassificationDatasetMetadata>(
        24,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'imageClassificationDatasetMetadata',
        subBuilder: $2.ImageClassificationDatasetMetadata.create)
    ..aOM<$3.TextClassificationDatasetMetadata>(
        25,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'textClassificationDatasetMetadata',
    ...
    ..aOM<$3.TextExtractionDatasetMetadata>(
        28,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'textExtractionDatasetMetadata',
        subBuilder: $3.TextExtractionDatasetMetadata.create)
    ..aOM<$4.VideoObjectTrackingDatasetMetadata>(
        29,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'videoObjectTrackingDatasetMetadata',
        subBuilder: $4.VideoObjectTrackingDatasetMetadata.create)
    ..aOM<$3.TextSentimentDatasetMetadata>(
        30,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'textSentimentDatasetMetadata',
        subBuilder: $3.TextSentimentDatasetMetadata.create)
    ..aOM<$4.VideoClassificationDatasetMetadata>(
        31,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'videoClassificationDatasetMetadata',
        subBuilder: $4.VideoClassificationDatasetMetadata.create)
    ..aOM<$5.TablesDatasetMetadata>(
        33,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'tablesDatasetMetadata',
        subBuilder: $5.TablesDatasetMetadata.create)
  ...
  factory Dataset({
    ...
    if (imageClassificationDatasetMetadata != null) {
      _result.imageClassificationDatasetMetadata =
          imageClassificationDatasetMetadata;
    }
    if (textClassificationDatasetMetadata != null) {
      _result.textClassificationDatasetMetadata =
          textClassificationDatasetMetadata;
    }
    if (imageObjectDetectionDatasetMetadata != null) {
      _result.imageObjectDetectionDatasetMetadata =
          imageObjectDetectionDatasetMetadata;
    }
    ...
    if (videoObjectTrackingDatasetMetadata != null) {
      _result.videoObjectTrackingDatasetMetadata =
          videoObjectTrackingDatasetMetadata;
    }
    ...
    if (videoClassificationDatasetMetadata != null) {
      _result.videoClassificationDatasetMetadata =
          videoClassificationDatasetMetadata;
    }
