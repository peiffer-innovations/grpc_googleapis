...
const ListInsightsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.recommender.v1beta1.Insight',
      '10': 'insights'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listInsightsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0SW5zaWdodHNSZXNwb25zZRJFCghpbnNpZ2h0cxgBIAMoCzIpLmdvb2dsZS5jbG91ZC5yZWNvbW1lbmRlci52MWJldGExLkluc2lnaHRSCGluc2lnaHRzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const MarkInsightAcceptedRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 11,
      '6':
          '.google.cloud.recommender.v1beta1.MarkInsightAcceptedRequest.StateMetadataEntry',
      '8': const {},
      '10': 'stateMetadata'
    },
...
final $typed_data.Uint8List markInsightAcceptedRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listRecommendationsResponseDescriptor =
    $convert.base64Decode(
        'ChtMaXN0UmVjb21tZW5kYXRpb25zUmVzcG9uc2USWgoPcmVjb21tZW5kYXRpb25zGAEgAygLMjAuZ29vZ2xlLmNsb3VkLnJlY29tbWVuZGVyLnYxYmV0YTEuUmVjb21tZW5kYXRpb25SD3JlY29tbWVuZGF0aW9ucxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List markRecommendationClaimedRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List markRecommendationSucceededRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List markRecommendationFailedRequestDescriptor =
    $convert.base64Decode(
        '');
