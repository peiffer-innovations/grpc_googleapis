...
const Feature$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.vision.v1p2beta1.Feature.Type',
      '10': 'type'
    },
...
final $typed_data.Uint8List featureDescriptor = $convert.base64Decode(
    '');
...
const Image$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.ImageSource',
      '10': 'source'
    },
  ],
};
...
final $typed_data.Uint8List imageDescriptor = $convert.base64Decode(
    'CgVJbWFnZRIYCgdjb250ZW50GAEgASgMUgdjb250ZW50EkIKBnNvdXJjZRgCIAEoCzIqLmdvb2dsZS5jbG91ZC52aXNpb24udjFwMmJldGExLkltYWdlU291cmNlUgZzb3VyY2U=');
...
const FaceAnnotation$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.FaceAnnotation.Landmark',
      '10': 'landmarks'
    },
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.vision.v1p2beta1.Likelihood',
      '10': 'joyLikelihood'
    },
    const {
      '1': 'sorrow_likelihood',
...
const FaceAnnotation_Landmark$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.vision.v1p2beta1.FaceAnnotation.Landmark.Type',
      '10': 'type'
    },
    const {
      '1': 'position',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.Position',
      '10': 'position'
    },
  ],
...
final $typed_data.Uint8List faceAnnotationDescriptor = $convert.base64Decode(
    '');
...
const EntityAnnotation$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.LocationInfo',
      '10': 'locations'
    },
    const {
      '1': 'properties',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.Property',
      '10': 'properties'
    },
  ],
};
...
final $typed_data.Uint8List entityAnnotationDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List safeSearchAnnotationDescriptor = $convert.base64Decode(
    '');
...
const DominantColorsAnnotation$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.ColorInfo',
      '10': 'colors'
    },
  ],
};
...
final $typed_data.Uint8List dominantColorsAnnotationDescriptor =
    $convert.base64Decode(
        'ChhEb21pbmFudENvbG9yc0Fubm90YXRpb24SQAoGY29sb3JzGAEgAygLMiguZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAyYmV0YTEuQ29sb3JJbmZvUgZjb2xvcnM=');
...
const ImageProperties$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.DominantColorsAnnotation',
      '10': 'dominantColors'
    },
  ],
};
...
final $typed_data.Uint8List imagePropertiesDescriptor = $convert.base64Decode(
    'Cg9JbWFnZVByb3BlcnRpZXMSYAoPZG9taW5hbnRfY29sb3JzGAEgASgLMjcuZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAyYmV0YTEuRG9taW5hbnRDb2xvcnNBbm5vdGF0aW9uUg5kb21pbmFudENvbG9ycw==');
...
final $typed_data.Uint8List cropHintDescriptor = $convert.base64Decode(
    'CghDcm9wSGludBJQCg1ib3VuZGluZ19wb2x5GAEgASgLMisuZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAyYmV0YTEuQm91bmRpbmdQb2x5Ugxib3VuZGluZ1BvbHkSHgoKY29uZmlkZW5jZRgCIAEoAlIKY29uZmlkZW5jZRIvChNpbXBvcnRhbmNlX2ZyYWN0aW9uGAMgASgCUhJpbXBvcnRhbmNlRnJhY3Rpb24=');
...
const CropHintsAnnotation$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.CropHint',
      '10': 'cropHints'
    },
  ],
};
...
final $typed_data.Uint8List cropHintsAnnotationDescriptor = $convert.base64Decode(
    'ChNDcm9wSGludHNBbm5vdGF0aW9uEkYKCmNyb3BfaGludHMYASADKAsyJy5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDJiZXRhMS5Dcm9wSGludFIJY3JvcEhpbnRz');
...
const ImageContext$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.LatLongRect',
      '10': 'latLongRect'
    },
    const {
      '1': 'language_hints',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.CropHintsParams',
      '10': 'cropHintsParams'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.WebDetectionParams',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.TextDetectionParams',
...
final $typed_data.Uint8List imageContextDescriptor = $convert.base64Decode(
    '');
...
const AnnotateImageRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.Image',
      '10': 'image'
    },
    const {
      '1': 'features',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.Feature',
      '10': 'features'
    },
    const {
      '1': 'image_context',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.ImageContext',
      '10': 'imageContext'
    },
  ],
};
...
final $typed_data.Uint8List annotateImageRequestDescriptor = $convert.base64Decode(
    '');
...
const AnnotateImageResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.FaceAnnotation',
      '10': 'faceAnnotations'
    },
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.EntityAnnotation',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.TextAnnotation',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.SafeSearchAnnotation',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.ImageProperties',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.CropHintsAnnotation',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.WebDetection',
      '10': 'webDetection'
    },
    const {
      '1': 'error',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.ImageAnnotationContext',
      '10': 'context'
    },
  ],
};
...
final $typed_data.Uint8List annotateImageResponseDescriptor = $convert.base64Decode(
    '');
...
const AnnotateFileResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.InputConfig',
      '10': 'inputConfig'
    },
    const {
      '1': 'responses',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.AnnotateImageResponse',
      '10': 'responses'
    },
  ],
};
...
final $typed_data.Uint8List annotateFileResponseDescriptor = $convert.base64Decode(
    'ChRBbm5vdGF0ZUZpbGVSZXNwb25zZRJNCgxpbnB1dF9jb25maWcYASABKAsyKi5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDJiZXRhMS5JbnB1dENvbmZpZ1ILaW5wdXRDb25maWcSUgoJcmVzcG9uc2VzGAIgAygLMjQuZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAyYmV0YTEuQW5ub3RhdGVJbWFnZVJlc3BvbnNlUglyZXNwb25zZXM=');
...
const BatchAnnotateImagesRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.AnnotateImageRequest',
      '8': const {},
      '10': 'requests'
    },
  ],
...
final $typed_data.Uint8List batchAnnotateImagesRequestDescriptor =
    $convert.base64Decode(
        'ChpCYXRjaEFubm90YXRlSW1hZ2VzUmVxdWVzdBJUCghyZXF1ZXN0cxgBIAMoCzIzLmdvb2dsZS5jbG91ZC52aXNpb24udjFwMmJldGExLkFubm90YXRlSW1hZ2VSZXF1ZXN0QgPgQQJSCHJlcXVlc3Rz');
...
final $typed_data.Uint8List batchAnnotateImagesResponseDescriptor =
    $convert.base64Decode(
        'ChtCYXRjaEFubm90YXRlSW1hZ2VzUmVzcG9uc2USUgoJcmVzcG9uc2VzGAEgAygLMjQuZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAyYmV0YTEuQW5ub3RhdGVJbWFnZVJlc3BvbnNlUglyZXNwb25zZXM=');
...
const AsyncAnnotateFileRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.OutputConfig',
      '10': 'outputConfig'
    },
  ],
};
...
final $typed_data.Uint8List asyncAnnotateFileRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List asyncAnnotateFileResponseDescriptor =
    $convert.base64Decode(
        'ChlBc3luY0Fubm90YXRlRmlsZVJlc3BvbnNlElAKDW91dHB1dF9jb25maWcYASABKAsyKy5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDJiZXRhMS5PdXRwdXRDb25maWdSDG91dHB1dENvbmZpZw==');
...
const AsyncBatchAnnotateFilesRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.AsyncAnnotateFileRequest',
      '8': const {},
      '10': 'requests'
    },
  ],
...
final $typed_data.Uint8List asyncBatchAnnotateFilesRequestDescriptor =
    $convert.base64Decode(
        'Ch5Bc3luY0JhdGNoQW5ub3RhdGVGaWxlc1JlcXVlc3QSWAoIcmVxdWVzdHMYASADKAsyNy5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDJiZXRhMS5Bc3luY0Fubm90YXRlRmlsZVJlcXVlc3RCA+BBAlIIcmVxdWVzdHM=');
...
const AsyncBatchAnnotateFilesResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.AsyncAnnotateFileResponse',
      '10': 'responses'
    },
  ],
};
...
final $typed_data.Uint8List asyncBatchAnnotateFilesResponseDescriptor =
    $convert.base64Decode(
        'Ch9Bc3luY0JhdGNoQW5ub3RhdGVGaWxlc1Jlc3BvbnNlElYKCXJlc3BvbnNlcxgBIAMoCzI4Lmdvb2dsZS5jbG91ZC52aXNpb24udjFwMmJldGExLkFzeW5jQW5ub3RhdGVGaWxlUmVzcG9uc2VSCXJlc3BvbnNlcw==');
...
const InputConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.GcsSource',
      '10': 'gcsSource'
    },
...
final $typed_data.Uint8List inputConfigDescriptor = $convert.base64Decode(
    'CgtJbnB1dENvbmZpZxJHCgpnY3Nfc291cmNlGAEgASgLMiguZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAyYmV0YTEuR2NzU291cmNlUglnY3NTb3VyY2USGwoJbWltZV90eXBlGAIgASgJUghtaW1lVHlwZQ==');
...
const OutputConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p2beta1.GcsDestination',
      '10': 'gcsDestination'
    },
...
final $typed_data.Uint8List outputConfigDescriptor = $convert.base64Decode(
    'CgxPdXRwdXRDb25maWcSVgoPZ2NzX2Rlc3RpbmF0aW9uGAEgASgLMi0uZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAyYmV0YTEuR2NzRGVzdGluYXRpb25SDmdjc0Rlc3RpbmF0aW9uEh0KCmJhdGNoX3NpemUYAiABKAVSCWJhdGNoU2l6ZQ==');
...
const OperationMetadata$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.vision.v1p2beta1.OperationMetadata.State',
      '10': 'state'
    },
    const {
      '1': 'create_time',
...
final $typed_data.Uint8List operationMetadataDescriptor = $convert.base64Decode(
    '');
