...
const BoundingPoly$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p3beta1.Vertex',
      '10': 'vertices'
    },
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1p3beta1.NormalizedVertex',
...
final $typed_data.Uint8List boundingPolyDescriptor = $convert.base64Decode(
    'CgxCb3VuZGluZ1BvbHkSQQoIdmVydGljZXMYASADKAsyJS5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDNiZXRhMS5WZXJ0ZXhSCHZlcnRpY2VzEmAKE25vcm1hbGl6ZWRfdmVydGljZXMYAiADKAsyLy5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDNiZXRhMS5Ob3JtYWxpemVkVmVydGV4UhJub3JtYWxpemVkVmVydGljZXM=');
...
final $typed_data.Uint8List normalizedBoundingPolyDescriptor =
    $convert.base64Decode(
        'ChZOb3JtYWxpemVkQm91bmRpbmdQb2x5EksKCHZlcnRpY2VzGAEgAygLMi8uZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAzYmV0YTEuTm9ybWFsaXplZFZlcnRleFIIdmVydGljZXM=');
