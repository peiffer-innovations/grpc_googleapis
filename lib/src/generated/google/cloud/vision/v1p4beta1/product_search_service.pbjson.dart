...
final $typed_data.Uint8List productDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List createProductRequestDescriptor = $convert.base64Decode(
    'ChRDcmVhdGVQcm9kdWN0UmVxdWVzdBJBCgZwYXJlbnQYASABKAlCKeBBAvpBIwohbG9jYXRpb25zLmdvb2dsZWFwaXMuY29tL0xvY2F0aW9uUgZwYXJlbnQSRQoHcHJvZHVjdBgCIAEoCzImLmdvb2dsZS5jbG91ZC52aXNpb24udjFwNGJldGExLlByb2R1Y3RCA+BBAlIHcHJvZHVjdBIdCgpwcm9kdWN0X2lkGAMgASgJUglwcm9kdWN0SWQ=');
...
final $typed_data.Uint8List listProductsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0UHJvZHVjdHNSZXNwb25zZRJCCghwcm9kdWN0cxgBIAMoCzImLmdvb2dsZS5jbG91ZC52aXNpb24udjFwNGJldGExLlByb2R1Y3RSCHByb2R1Y3RzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List updateProductRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVQcm9kdWN0UmVxdWVzdBJFCgdwcm9kdWN0GAEgASgLMiYuZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXA0YmV0YTEuUHJvZHVjdEID4EECUgdwcm9kdWN0EjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
final $typed_data.Uint8List createProductSetRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listProductSetsResponseDescriptor =
    $convert.base64Decode(
        'ChdMaXN0UHJvZHVjdFNldHNSZXNwb25zZRJMCgxwcm9kdWN0X3NldHMYASADKAsyKS5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDRiZXRhMS5Qcm9kdWN0U2V0Ugtwcm9kdWN0U2V0cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List updateProductSetRequestDescriptor =
    $convert.base64Decode(
        'ChdVcGRhdGVQcm9kdWN0U2V0UmVxdWVzdBJPCgtwcm9kdWN0X3NldBgBIAEoCzIpLmdvb2dsZS5jbG91ZC52aXNpb24udjFwNGJldGExLlByb2R1Y3RTZXRCA+BBAlIKcHJvZHVjdFNldBI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCnVwZGF0ZU1hc2s=');
...
final $typed_data.Uint8List createReferenceImageRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listReferenceImagesResponseDescriptor =
    $convert.base64Decode(
        'ChtMaXN0UmVmZXJlbmNlSW1hZ2VzUmVzcG9uc2USWAoQcmVmZXJlbmNlX2ltYWdlcxgBIAMoCzItLmdvb2dsZS5jbG91ZC52aXNpb24udjFwNGJldGExLlJlZmVyZW5jZUltYWdlUg9yZWZlcmVuY2VJbWFnZXMSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRImCg9uZXh0X3BhZ2VfdG9rZW4YAyABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List listProductsInProductSetResponseDescriptor =
    $convert.base64Decode(
        'CiBMaXN0UHJvZHVjdHNJblByb2R1Y3RTZXRSZXNwb25zZRJCCghwcm9kdWN0cxgBIAMoCzImLmdvb2dsZS5jbG91ZC52aXNpb24udjFwNGJldGExLlByb2R1Y3RSCHByb2R1Y3RzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List importProductSetsInputConfigDescriptor =
    $convert.base64Decode(
        'ChxJbXBvcnRQcm9kdWN0U2V0c0lucHV0Q29uZmlnEloKCmdjc19zb3VyY2UYASABKAsyOS5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDRiZXRhMS5JbXBvcnRQcm9kdWN0U2V0c0djc1NvdXJjZUgAUglnY3NTb3VyY2VCCAoGc291cmNl');
...
final $typed_data.Uint8List importProductSetsRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List importProductSetsResponseDescriptor =
    $convert.base64Decode(
        'ChlJbXBvcnRQcm9kdWN0U2V0c1Jlc3BvbnNlElgKEHJlZmVyZW5jZV9pbWFnZXMYASADKAsyLS5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDRiZXRhMS5SZWZlcmVuY2VJbWFnZVIPcmVmZXJlbmNlSW1hZ2VzEi4KCHN0YXR1c2VzGAIgAygLMhIuZ29vZ2xlLnJwYy5TdGF0dXNSCHN0YXR1c2Vz');
...
final $typed_data.Uint8List batchOperationMetadataDescriptor =
    $convert.base64Decode(
        '');
...
const PurgeProductsRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.vision.v1p4beta1.ProductSetPurgeConfig',
      '9': 0,
...
final $typed_data.Uint8List purgeProductsRequestDescriptor = $convert.base64Decode(
    '');
