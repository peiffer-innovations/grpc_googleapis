...
const BoundingPoly$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1.Vertex',
      '10': 'vertices'
    },
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.vision.v1.NormalizedVertex',
...
final $typed_data.Uint8List boundingPolyDescriptor = $convert.base64Decode(
    'CgxCb3VuZGluZ1BvbHkSOgoIdmVydGljZXMYASADKAsyHi5nb29nbGUuY2xvdWQudmlzaW9uLnYxLlZlcnRleFIIdmVydGljZXMSWQoTbm9ybWFsaXplZF92ZXJ0aWNlcxgCIAMoCzIoLmdvb2dsZS5jbG91ZC52aXNpb24udjEuTm9ybWFsaXplZFZlcnRleFISbm9ybWFsaXplZFZlcnRpY2Vz');
