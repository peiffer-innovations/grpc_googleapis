...
class Feature_Type extends $pb.ProtobufEnum {
  ...
  static const Feature_Type WEB_DETECTION = Feature_Type._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WEB_DETECTION');
  static const Feature_Type PRODUCT_SEARCH = Feature_Type._(
      12,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PRODUCT_SEARCH');
  static const Feature_Type OBJECT_LOCALIZATION = Feature_Type._(
      19,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'OBJECT_LOCALIZATION');
  ...
  static const FaceAnnotation_Landmark_Type CHIN_RIGHT_GONION =
      FaceAnnotation_Landmark_Type._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'CHIN_RIGHT_GONION');
  static const FaceAnnotation_Landmark_Type LEFT_CHEEK_CENTER =
      FaceAnnotation_Landmark_Type._(
          35,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'LEFT_CHEEK_CENTER');
  static const FaceAnnotation_Landmark_Type RIGHT_CHEEK_CENTER =
      FaceAnnotation_Landmark_Type._(
          36,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
