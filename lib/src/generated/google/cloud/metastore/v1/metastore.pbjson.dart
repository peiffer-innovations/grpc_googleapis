...
const Service$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.metastore.v1.HiveMetastoreConfig',
      '9': 0,
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.metastore.v1.Service.LabelsEntry',
      '10': 'labels'
    },
    const {
      '1': 'network',
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.metastore.v1.Service.State',
      '8': const {},
      '10': 'state'
    },
    const {
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.metastore.v1.Service.Tier',
      '10': 'tier'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.metastore.v1.MaintenanceWindow',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.metastore.v1.MetadataManagementActivity',
      '8': const {},
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.metastore.v1.Service.ReleaseChannel',
      '8': const {},
      '10': 'releaseChannel'
    },
  ],
...
const HiveMetastoreConfig$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '5': 11,
      '6':
          '.google.cloud.metastore.v1.HiveMetastoreConfig.ConfigOverridesEntry',
      '10': 'configOverrides'
    },
    const {
      '1': 'kerberos_config',
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.metastore.v1.KerberosConfig',
      '10': 'kerberosConfig'
    },
  ],
...
final $typed_data.Uint8List hiveMetastoreConfigDescriptor = $convert.base64Decode(
    '');
...
const KerberosConfig$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.metastore.v1.Secret',
      '10': 'keytab'
    },
...
final $typed_data.Uint8List kerberosConfigDescriptor = $convert.base64Decode(
    'Cg5LZXJiZXJvc0NvbmZpZxI5CgZrZXl0YWIYASABKAsyIS5nb29nbGUuY2xvdWQubWV0YXN0b3JlLnYxLlNlY3JldFIGa2V5dGFiEhwKCXByaW5jaXBhbBgCIAEoCVIJcHJpbmNpcGFsEi0KE2tyYjVfY29uZmlnX2djc191cmkYAyABKAlSEGtyYjVDb25maWdHY3NVcmk=');
...
const MetadataManagementActivity$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.metastore.v1.MetadataExport',
      '8': const {},
      '10': 'metadataExports'
    },
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.metastore.v1.Restore',
      '8': const {},
      '10': 'restores'
    },
  ],
...
final $typed_data.Uint8List metadataManagementActivityDescriptor =
    $convert.base64Decode(
        'ChpNZXRhZGF0YU1hbmFnZW1lbnRBY3Rpdml0eRJZChBtZXRhZGF0YV9leHBvcnRzGAEgAygLMikuZ29vZ2xlLmNsb3VkLm1ldGFzdG9yZS52MS5NZXRhZGF0YUV4cG9ydEID4EEDUg9tZXRhZGF0YUV4cG9ydHMSQwoIcmVzdG9yZXMYAiADKAsyIi5nb29nbGUuY2xvdWQubWV0YXN0b3JlLnYxLlJlc3RvcmVCA+BBA1IIcmVzdG9yZXM=');
...
const MetadataImport$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.metastore.v1.MetadataImport.DatabaseDump',
      '8': const {},
      '9': 0,
      '10': 'databaseDump'
    },
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.metastore.v1.MetadataImport.State',
      '8': const {},
      '10': 'state'
    },
  ],
...
const MetadataImport_DatabaseDump$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.metastore.v1.DatabaseDumpSpec.Type',
      '8': const {},
      '10': 'type'
    },
  ],
...
const MetadataExport$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.metastore.v1.MetadataExport.State',
      '8': const {},
      '10': 'state'
    },
    const {
...
const Backup$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.metastore.v1.Backup.State',
      '8': const {},
      '10': 'state'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.metastore.v1.Service',
      '8': const {},
      '10': 'serviceRevision'
    },
...
const Restore$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.metastore.v1.Restore.State',
      '8': const {},
      '10': 'state'
    },
    const {
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.metastore.v1.Restore.RestoreType',
      '8': const {},
      '10': 'type'
    },
    const {
...
final $typed_data.Uint8List listServicesResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0U2VydmljZXNSZXNwb25zZRI+CghzZXJ2aWNlcxgBIAMoCzIiLmdvb2dsZS5jbG91ZC5tZXRhc3RvcmUudjEuU2VydmljZVIIc2VydmljZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
...
final $typed_data.Uint8List createServiceRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List updateServiceRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVTZXJ2aWNlUmVxdWVzdBJACgt1cGRhdGVfbWFzaxgBIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaxJBCgdzZXJ2aWNlGAIgASgLMiIuZ29vZ2xlLmNsb3VkLm1ldGFzdG9yZS52MS5TZXJ2aWNlQgPgQQJSB3NlcnZpY2USIgoKcmVxdWVzdF9pZBgDIAEoCUID4EEBUglyZXF1ZXN0SWQ=');
...
const ListMetadataImportsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.metastore.v1.MetadataImport',
      '10': 'metadataImports'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listMetadataImportsResponseDescriptor =
    $convert.base64Decode(
        'ChtMaXN0TWV0YWRhdGFJbXBvcnRzUmVzcG9uc2USVAoQbWV0YWRhdGFfaW1wb3J0cxgBIAMoCzIpLmdvb2dsZS5jbG91ZC5tZXRhc3RvcmUudjEuTWV0YWRhdGFJbXBvcnRSD21ldGFkYXRhSW1wb3J0cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4SIAoLdW5yZWFjaGFibGUYAyADKAlSC3VucmVhY2hhYmxl');
...
final $typed_data.Uint8List createMetadataImportRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List updateMetadataImportRequestDescriptor =
    $convert.base64Decode(
        '');
...
const ListBackupsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.metastore.v1.Backup',
      '10': 'backups'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listBackupsResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0QmFja3Vwc1Jlc3BvbnNlEjsKB2JhY2t1cHMYASADKAsyIS5nb29nbGUuY2xvdWQubWV0YXN0b3JlLnYxLkJhY2t1cFIHYmFja3VwcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4SIAoLdW5yZWFjaGFibGUYAyADKAlSC3VucmVhY2hhYmxl');
...
final $typed_data.Uint8List createBackupRequestDescriptor = $convert.base64Decode(
    '');
...
const LocationMetadata$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.metastore.v1.LocationMetadata.HiveMetastoreVersion',
...
final $typed_data.Uint8List locationMetadataDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List databaseDumpSpecDescriptor = $convert.base64Decode(
    'ChBEYXRhYmFzZUR1bXBTcGVjIjEKBFR5cGUSFAoQVFlQRV9VTlNQRUNJRklFRBAAEgkKBU1ZU1FMEAESCAoEQVZSTxAC');
