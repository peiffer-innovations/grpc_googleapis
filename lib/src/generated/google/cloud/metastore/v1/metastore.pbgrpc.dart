...
class DataprocMetastoreClient extends $grpc.Client {
  ...
  static final _$createMetadataImport =
      $grpc.ClientMethod<$2.CreateMetadataImportRequest, $0.Operation>(
          '/google.cloud.metastore.v1.DataprocMetastore/CreateMetadataImport',
          ($2.CreateMetadataImportRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$updateMetadataImport =
      $grpc.ClientMethod<$2.UpdateMetadataImportRequest, $0.Operation>(
...
abstract class DataprocMetastoreServiceBase extends $grpc.Service {
  $core.String get $name => 'google.cloud.metastore.v1.DataprocMetastore';
