...
const GcsFilesetSpec$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.datacatalog.v1.GcsFileSpec',
      '8': const {},
...
final $typed_data.Uint8List gcsFilesetSpecDescriptor = $convert.base64Decode(
    'Cg5HY3NGaWxlc2V0U3BlYxIoCg1maWxlX3BhdHRlcm5zGAEgAygJQgPgQQJSDGZpbGVQYXR0ZXJucxJgChVzYW1wbGVfZ2NzX2ZpbGVfc3BlY3MYAiADKAsyKC5nb29nbGUuY2xvdWQuZGF0YWNhdGFsb2cudjEuR2NzRmlsZVNwZWNCA+BBA1ISc2FtcGxlR2NzRmlsZVNwZWNz');
...
final $typed_data.Uint8List gcsFileSpecDescriptor = $convert.base64Decode(
    'CgtHY3NGaWxlU3BlYxIgCglmaWxlX3BhdGgYASABKAlCA+BBAlIIZmlsZVBhdGgSWQoOZ2NzX3RpbWVzdGFtcHMYAiABKAsyLS5nb29nbGUuY2xvdWQuZGF0YWNhdGFsb2cudjEuU3lzdGVtVGltZXN0YW1wc0ID4EEDUg1nY3NUaW1lc3RhbXBzEiIKCnNpemVfYnl0ZXMYBCABKANCA+BBA1IJc2l6ZUJ5dGVz');
