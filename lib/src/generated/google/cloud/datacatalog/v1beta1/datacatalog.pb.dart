...
class Entry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'userSpecifiedType')
    ..e<$11.IntegratedSystem>(
        17,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'integratedSystem',
        $pb.PbFieldType.OE,
        defaultOrMaker: $11.IntegratedSystem.INTEGRATED_SYSTEM_UNSPECIFIED,
        valueOf: $11.IntegratedSystem.valueOf,
        enumValues: $11.IntegratedSystem.values)
    ..aOS(
        18,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(17)
  set integratedSystem($11.IntegratedSystem v) {
    setField(17, v);
  }
