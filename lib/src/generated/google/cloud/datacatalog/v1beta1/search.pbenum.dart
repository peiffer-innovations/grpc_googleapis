...
class SearchResultType extends $pb.ProtobufEnum {
  ...
  static const SearchResultType ENTRY = SearchResultType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ENTRY');
  static const SearchResultType TAG_TEMPLATE = SearchResultType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TAG_TEMPLATE');
  static const SearchResultType ENTRY_GROUP = SearchResultType._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ENTRY_GROUP');
