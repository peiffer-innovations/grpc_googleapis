...
const Taxonomy$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 14,
      '6': '.google.cloud.datacatalog.v1beta1.Taxonomy.PolicyType',
      '8': const {},
...
final $typed_data.Uint8List taxonomyDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List createTaxonomyRequestDescriptor = $convert.base64Decode(
    'ChVDcmVhdGVUYXhvbm9teVJlcXVlc3QSQwoGcGFyZW50GAEgASgJQivgQQL6QSUSI2RhdGFjYXRhbG9nLmdvb2dsZWFwaXMuY29tL1RheG9ub215UgZwYXJlbnQSRgoIdGF4b25vbXkYAiABKAsyKi5nb29nbGUuY2xvdWQuZGF0YWNhdGFsb2cudjFiZXRhMS5UYXhvbm9teVIIdGF4b25vbXk=');
...
final $typed_data.Uint8List updateTaxonomyRequestDescriptor = $convert.base64Decode(
    'ChVVcGRhdGVUYXhvbm9teVJlcXVlc3QSRgoIdGF4b25vbXkYASABKAsyKi5nb29nbGUuY2xvdWQuZGF0YWNhdGFsb2cudjFiZXRhMS5UYXhvbm9teVIIdGF4b25vbXkSOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List listTaxonomiesResponseDescriptor =
    $convert.base64Decode(
        'ChZMaXN0VGF4b25vbWllc1Jlc3BvbnNlEkoKCnRheG9ub21pZXMYASADKAsyKi5nb29nbGUuY2xvdWQuZGF0YWNhdGFsb2cudjFiZXRhMS5UYXhvbm9teVIKdGF4b25vbWllcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
const CreatePolicyTagRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.datacatalog.v1beta1.PolicyTag',
      '10': 'policyTag'
    },
  ],
};
...
final $typed_data.Uint8List createPolicyTagRequestDescriptor =
    $convert.base64Decode(
        'ChZDcmVhdGVQb2xpY3lUYWdSZXF1ZXN0EkQKBnBhcmVudBgBIAEoCUIs4EEC+kEmEiRkYXRhY2F0YWxvZy5nb29nbGVhcGlzLmNvbS9Qb2xpY3lUYWdSBnBhcmVudBJKCgpwb2xpY3lfdGFnGAIgASgLMisuZ29vZ2xlLmNsb3VkLmRhdGFjYXRhbG9nLnYxYmV0YTEuUG9saWN5VGFnUglwb2xpY3lUYWc=');
...
final $typed_data.Uint8List updatePolicyTagRequestDescriptor =
    $convert.base64Decode(
        'ChZVcGRhdGVQb2xpY3lUYWdSZXF1ZXN0EkoKCnBvbGljeV90YWcYASABKAsyKy5nb29nbGUuY2xvdWQuZGF0YWNhdGFsb2cudjFiZXRhMS5Qb2xpY3lUYWdSCXBvbGljeVRhZxI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCnVwZGF0ZU1hc2s=');
...
final $typed_data.Uint8List listPolicyTagsResponseDescriptor =
    $convert.base64Decode(
        'ChZMaXN0UG9saWN5VGFnc1Jlc3BvbnNlEkwKC3BvbGljeV90YWdzGAEgAygLMisuZ29vZ2xlLmNsb3VkLmRhdGFjYXRhbG9nLnYxYmV0YTEuUG9saWN5VGFnUgpwb2xpY3lUYWdzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
