...
class SecretManagerServiceClient extends $grpc.Client {
  ...
  static final _$addSecretVersion =
      $grpc.ClientMethod<$2.AddSecretVersionRequest, $3.SecretVersion>(
  ...
  static final _$getSecretVersion =
      $grpc.ClientMethod<$2.GetSecretVersionRequest, $3.SecretVersion>(
