...
class Policy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, AdmissionRule>(
        ...
        packageName:
            const $pb.PackageName('google.cloud.binaryauthorization.v1'))
    ..aOM<AdmissionRule>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
...
enum Attestor_AttestorType { userOwnedGrafeasNote, notSet }
...
class Attestor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'name')
    ..aOM<UserOwnedGrafeasNote>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'userOwnedGrafeasNote',
        subBuilder: UserOwnedGrafeasNote.create)
    ..aOM<$0.Timestamp>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(3)
  set userOwnedGrafeasNote(UserOwnedGrafeasNote v) {
    setField(3, v);
  }
...
class UserOwnedGrafeasNote extends $pb.GeneratedMessage {
  ...
  factory UserOwnedGrafeasNote.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UserOwnedGrafeasNote.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  UserOwnedGrafeasNote clone() =>
      UserOwnedGrafeasNote()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  UserOwnedGrafeasNote copyWith(void Function(UserOwnedGrafeasNote) updates) =>
      super.copyWith((message) => updates(message as UserOwnedGrafeasNote))
          as UserOwnedGrafeasNote; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UserOwnedGrafeasNote create() => UserOwnedGrafeasNote._();
  UserOwnedGrafeasNote createEmptyInstance() => create();
  static $pb.PbList<UserOwnedGrafeasNote> createRepeated() =>
      $pb.PbList<UserOwnedGrafeasNote>();
  @$core.pragma('dart2js:noInline')
  static UserOwnedGrafeasNote getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UserOwnedGrafeasNote>(create);
