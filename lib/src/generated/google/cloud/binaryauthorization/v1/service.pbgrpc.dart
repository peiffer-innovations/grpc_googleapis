...
class SystemPolicyV1Client extends $grpc.Client {
  static final _$getSystemPolicy =
      $grpc.ClientMethod<$0.GetSystemPolicyRequest, $1.Policy>(
...
class ValidationHelperV1Client extends $grpc.Client {
  static final _$validateAttestationOccurrence = $grpc.ClientMethod<
          $0.ValidateAttestationOccurrenceRequest,
          $0.ValidateAttestationOccurrenceResponse>(
      '/google.cloud.binaryauthorization.v1.ValidationHelperV1/ValidateAttestationOccurrence',
      ($0.ValidateAttestationOccurrenceRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.ValidateAttestationOccurrenceResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.ValidateAttestationOccurrenceResponse>
      validateAttestationOccurrence(
          $0.ValidateAttestationOccurrenceRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$validateAttestationOccurrence, request,
        options: options);
  }
}
...
abstract class ValidationHelperV1ServiceBase extends $grpc.Service {
  ...
  ValidationHelperV1ServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.ValidateAttestationOccurrenceRequest,
            $0.ValidateAttestationOccurrenceResponse>(
        'ValidateAttestationOccurrence',
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.ValidateAttestationOccurrenceRequest.fromBuffer(value),
        ($0.ValidateAttestationOccurrenceResponse value) =>
            value.writeToBuffer()));
  }

  $async.Future<$0.ValidateAttestationOccurrenceResponse>
      validateAttestationOccurrence_Pre(
          $grpc.ServiceCall call,
          $async.Future<$0.ValidateAttestationOccurrenceRequest>
              request) async {
    return validateAttestationOccurrence(call, await request);
  }

  $async.Future<$0.ValidateAttestationOccurrenceResponse>
      validateAttestationOccurrence($grpc.ServiceCall call,
          $0.ValidateAttestationOccurrenceRequest request);
}
