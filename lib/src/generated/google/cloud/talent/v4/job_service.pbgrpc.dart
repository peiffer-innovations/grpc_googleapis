...
class JobServiceClient extends $grpc.Client {
  ...
  static final _$batchDeleteJobs =
      $grpc.ClientMethod<$2.BatchDeleteJobsRequest, $0.Operation>(
  ...
  $grpc.ResponseFuture<$0.Operation> batchDeleteJobs(
...
abstract class JobServiceBase extends $grpc.Service {
  ...
  JobServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.BatchDeleteJobsRequest, $0.Operation>(
        'BatchDeleteJobs',
        batchDeleteJobs_Pre,
        false,
        false,
  ...
  $async.Future<$0.Operation> batchDeleteJobs_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$0.Operation> batchDeleteJobs(
