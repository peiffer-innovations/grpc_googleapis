...
const CompleteQueryRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.talent.v4.CompleteQueryRequest.CompletionScope',
      '10': 'scope'
    },
    const {
      '1': 'type',
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.talent.v4.CompleteQueryRequest.CompletionType',
      '10': 'type'
    },
  ],
  '4': const [
...
const CompleteQueryResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.talent.v4.CompleteQueryResponse.CompletionResult',
...
final $typed_data.Uint8List completeQueryResponseDescriptor = $convert.base64Decode(
    '');
