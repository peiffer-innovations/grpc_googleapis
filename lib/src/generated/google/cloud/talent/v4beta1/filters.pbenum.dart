...
class EmployerFilter_EmployerFilterMode extends $pb.ProtobufEnum {
  static const EmployerFilter_EmployerFilterMode
      EMPLOYER_FILTER_MODE_UNSPECIFIED = EmployerFilter_EmployerFilterMode._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'EMPLOYER_FILTER_MODE_UNSPECIFIED');
  static const EmployerFilter_EmployerFilterMode ALL_EMPLOYMENT_RECORDS =
      EmployerFilter_EmployerFilterMode._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'ALL_EMPLOYMENT_RECORDS');
  static const EmployerFilter_EmployerFilterMode
      CURRENT_EMPLOYMENT_RECORDS_ONLY = EmployerFilter_EmployerFilterMode._(
          2,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'CURRENT_EMPLOYMENT_RECORDS_ONLY');
  static const EmployerFilter_EmployerFilterMode PAST_EMPLOYMENT_RECORDS_ONLY =
      EmployerFilter_EmployerFilterMode._(
          3,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
  ...
  static const $core.List<EmployerFilter_EmployerFilterMode> values =
      <EmployerFilter_EmployerFilterMode>[
    EMPLOYER_FILTER_MODE_UNSPECIFIED,
    ALL_EMPLOYMENT_RECORDS,
    CURRENT_EMPLOYMENT_RECORDS_ONLY,
    PAST_EMPLOYMENT_RECORDS_ONLY,
  ...
  static final $core.Map<$core.int, EmployerFilter_EmployerFilterMode>
      _byValue = $pb.ProtobufEnum.initByValue(values);
  static EmployerFilter_EmployerFilterMode? valueOf($core.int value) =>
      _byValue[value];

  const EmployerFilter_EmployerFilterMode._($core.int v, $core.String n)
      : super(v, n);
}

class TimeFilter_TimeField extends $pb.ProtobufEnum {
  static const TimeFilter_TimeField TIME_FIELD_UNSPECIFIED =
      TimeFilter_TimeField._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'TIME_FIELD_UNSPECIFIED');
  static const TimeFilter_TimeField CREATE_TIME = TimeFilter_TimeField._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'CREATE_TIME');
  static const TimeFilter_TimeField UPDATE_TIME = TimeFilter_TimeField._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UPDATE_TIME');
  ...
  static final $core.Map<$core.int, TimeFilter_TimeField> _byValue =
      $pb.ProtobufEnum.initByValue(values);
