...
class Tenant_DataUsageType extends $pb.ProtobufEnum {
  static const Tenant_DataUsageType DATA_USAGE_TYPE_UNSPECIFIED =
      Tenant_DataUsageType._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'DATA_USAGE_TYPE_UNSPECIFIED');
  static const Tenant_DataUsageType AGGREGATED = Tenant_DataUsageType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'AGGREGATED');
  static const Tenant_DataUsageType ISOLATED = Tenant_DataUsageType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ISOLATED');
