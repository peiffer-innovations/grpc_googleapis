...
class JobEvent_JobEventType extends $pb.ProtobufEnum {
  static const JobEvent_JobEventType JOB_EVENT_TYPE_UNSPECIFIED =
      JobEvent_JobEventType._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'JOB_EVENT_TYPE_UNSPECIFIED');
  static const JobEvent_JobEventType IMPRESSION = JobEvent_JobEventType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'IMPRESSION');
  static const JobEvent_JobEventType VIEW = JobEvent_JobEventType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'VIEW');
  static const JobEvent_JobEventType VIEW_REDIRECT = JobEvent_JobEventType._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'VIEW_REDIRECT');
  ...
  static const JobEvent_JobEventType BOOKMARK = JobEvent_JobEventType._(
      11,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'BOOKMARK');
  static const JobEvent_JobEventType NOTIFICATION = JobEvent_JobEventType._(
      12,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NOTIFICATION');
  static const JobEvent_JobEventType HIRED = JobEvent_JobEventType._(
      13,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'HIRED');
  static const JobEvent_JobEventType SENT_CV = JobEvent_JobEventType._(
      14,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SENT_CV');
...
class ProfileEvent_ProfileEventType extends $pb.ProtobufEnum {
  static const ProfileEvent_ProfileEventType PROFILE_EVENT_TYPE_UNSPECIFIED =
      ProfileEvent_ProfileEventType._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
