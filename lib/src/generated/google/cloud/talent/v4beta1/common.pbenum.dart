...
class ContactInfoUsage extends $pb.ProtobufEnum {
  ...
  static const ContactInfoUsage PERSONAL = ContactInfoUsage._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PERSONAL');
  static const ContactInfoUsage WORK = ContactInfoUsage._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WORK');
  static const ContactInfoUsage SCHOOL = ContactInfoUsage._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SCHOOL');
...
class SkillProficiencyLevel extends $pb.ProtobufEnum {
  static const SkillProficiencyLevel SKILL_PROFICIENCY_LEVEL_UNSPECIFIED =
      SkillProficiencyLevel._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'SKILL_PROFICIENCY_LEVEL_UNSPECIFIED');
  static const SkillProficiencyLevel UNSKILLED = SkillProficiencyLevel._(
      6,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNSKILLED');
  ...
  static const SkillProficiencyLevel NOVICE = SkillProficiencyLevel._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NOVICE');
  static const SkillProficiencyLevel INTERMEDIATE = SkillProficiencyLevel._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'INTERMEDIATE');
  static const SkillProficiencyLevel ADVANCED = SkillProficiencyLevel._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ADVANCED');
  static const SkillProficiencyLevel EXPERT = SkillProficiencyLevel._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'EXPERT');
...
class Outcome extends $pb.ProtobufEnum {
  static const Outcome OUTCOME_UNSPECIFIED = Outcome._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'OUTCOME_UNSPECIFIED');
  static const Outcome POSITIVE = Outcome._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'POSITIVE');
  static const Outcome NEUTRAL = Outcome._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NEUTRAL');
  static const Outcome NEGATIVE = Outcome._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NEGATIVE');
  static const Outcome OUTCOME_NOT_AVAILABLE = Outcome._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
...
class AvailabilitySignalType extends $pb.ProtobufEnum {
  static const AvailabilitySignalType AVAILABILITY_SIGNAL_TYPE_UNSPECIFIED =
      AvailabilitySignalType._(
          0,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'AVAILABILITY_SIGNAL_TYPE_UNSPECIFIED');
  static const AvailabilitySignalType JOB_APPLICATION =
      AvailabilitySignalType._(
          1,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'JOB_APPLICATION');
  static const AvailabilitySignalType RESUME_UPDATE = AvailabilitySignalType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'RESUME_UPDATE');
  static const AvailabilitySignalType CANDIDATE_UPDATE =
      AvailabilitySignalType._(
          3,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'CANDIDATE_UPDATE');
  static const AvailabilitySignalType CLIENT_SUBMISSION =
      AvailabilitySignalType._(
          4,
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
  ...
  static const $core.List<AvailabilitySignalType> values =
  ...
  static final $core.Map<$core.int, AvailabilitySignalType> _byValue =
      $pb.ProtobufEnum.initByValue(values);
