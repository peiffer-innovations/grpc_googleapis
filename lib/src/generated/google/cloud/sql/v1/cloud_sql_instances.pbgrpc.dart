...
import 'cloud_sql_instances.pb.dart' as $0;
...
class SqlInstancesServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.DatabaseInstance> get(
  ...
  $grpc.ResponseFuture<$0.InstancesListResponse> list(
      $0.SqlInstancesListRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$list, request, options: options);
  }

  $grpc.ResponseFuture<$0.InstancesListServerCasResponse> listServerCas(
  ...
  $grpc.ResponseFuture<$0.SqlInstancesVerifyExternalSyncSettingsResponse>
...
abstract class SqlInstancesServiceBase extends $grpc.Service {
  ...
  SqlInstancesServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.SqlInstancesFailoverRequest, $1.Operation>(
            ...
            ($1.Operation value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.SqlInstancesGetRequest, $0.DatabaseInstance>(
            'Get',
            get_Pre,
            false,
            false,
            ...
            ($0.DatabaseInstance value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.SqlInstancesListRequest,
        ...
        ($0.InstancesListResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SqlInstancesListServerCasRequest,
        ...
        ($0.InstancesListServerCasResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<
        ...
        ($0.SqlInstancesVerifyExternalSyncSettingsResponse value) =>
            value.writeToBuffer()));
  ...
  $async.Future<$0.DatabaseInstance> get_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$0.InstancesListResponse> list_Pre($grpc.ServiceCall call,
      $async.Future<$0.SqlInstancesListRequest> request) async {
    return list(call, await request);
  }

  $async.Future<$0.InstancesListServerCasResponse> listServerCas_Pre(
  ...
  $async.Future<$0.SqlInstancesVerifyExternalSyncSettingsResponse>
      verifyExternalSyncSettings_Pre(
          $grpc.ServiceCall call,
  ...
  $async.Future<$0.DatabaseInstance> get(
  ...
  $async.Future<$0.InstancesListResponse> list(
      $grpc.ServiceCall call, $0.SqlInstancesListRequest request);
  $async.Future<$0.InstancesListServerCasResponse> listServerCas(
