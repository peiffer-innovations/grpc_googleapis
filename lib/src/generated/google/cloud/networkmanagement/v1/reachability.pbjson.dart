...
const ListConnectivityTestsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.networkmanagement.v1.ConnectivityTest',
      '10': 'resources'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listConnectivityTestsResponseDescriptor =
    $convert.base64Decode(
        'Ch1MaXN0Q29ubmVjdGl2aXR5VGVzdHNSZXNwb25zZRJRCglyZXNvdXJjZXMYASADKAsyMy5nb29nbGUuY2xvdWQubmV0d29ya21hbmFnZW1lbnQudjEuQ29ubmVjdGl2aXR5VGVzdFIJcmVzb3VyY2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbhIgCgt1bnJlYWNoYWJsZRgDIAMoCVILdW5yZWFjaGFibGU=');
...
final $typed_data.Uint8List createConnectivityTestRequestDescriptor =
    $convert.base64Decode(
        'Ch1DcmVhdGVDb25uZWN0aXZpdHlUZXN0UmVxdWVzdBIbCgZwYXJlbnQYASABKAlCA+BBAlIGcGFyZW50EhwKB3Rlc3RfaWQYAiABKAlCA+BBAlIGdGVzdElkElQKCHJlc291cmNlGAMgASgLMjMuZ29vZ2xlLmNsb3VkLm5ldHdvcmttYW5hZ2VtZW50LnYxLkNvbm5lY3Rpdml0eVRlc3RCA+BBAlIIcmVzb3VyY2U=');
...
final $typed_data.Uint8List updateConnectivityTestRequestDescriptor =
    $convert.base64Decode(
        'Ch1VcGRhdGVDb25uZWN0aXZpdHlUZXN0UmVxdWVzdBJACgt1cGRhdGVfbWFzaxgBIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaxJUCghyZXNvdXJjZRgCIAEoCzIzLmdvb2dsZS5jbG91ZC5uZXR3b3JrbWFuYWdlbWVudC52MS5Db25uZWN0aXZpdHlUZXN0QgPgQQJSCHJlc291cmNl');
