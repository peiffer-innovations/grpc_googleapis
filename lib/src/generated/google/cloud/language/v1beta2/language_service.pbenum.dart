...
class DependencyEdge_Label extends $pb.ProtobufEnum {
  ...
  static const DependencyEdge_Label DISLOCATED = DependencyEdge_Label._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DISLOCATED');
  static const DependencyEdge_Label ASP = DependencyEdge_Label._(
      77,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ASP');
  static const DependencyEdge_Label GMOD = DependencyEdge_Label._(
      78,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'GMOD');
  static const DependencyEdge_Label GOBJ = DependencyEdge_Label._(
      79,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'GOBJ');
  static const DependencyEdge_Label INFMOD = DependencyEdge_Label._(
      80,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'INFMOD');
  static const DependencyEdge_Label MES = DependencyEdge_Label._(
      81,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'MES');
  static const DependencyEdge_Label NCOMP = DependencyEdge_Label._(
      82,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NCOMP');
