...
final $typed_data.Uint8List documentDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List sentenceDescriptor = $convert.base64Decode(
    'CghTZW50ZW5jZRI7CgR0ZXh0GAEgASgLMicuZ29vZ2xlLmNsb3VkLmxhbmd1YWdlLnYxYmV0YTEuVGV4dFNwYW5SBHRleHQSRgoJc2VudGltZW50GAIgASgLMiguZ29vZ2xlLmNsb3VkLmxhbmd1YWdlLnYxYmV0YTEuU2VudGltZW50UglzZW50aW1lbnQ=');
...
const Entity$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.language.v1beta1.EntityMention',
      '10': 'mentions'
    },
  ],
...
final $typed_data.Uint8List entityDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List tokenDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List sentimentDescriptor = $convert.base64Decode(
    'CglTZW50aW1lbnQSGgoIcG9sYXJpdHkYASABKAJSCHBvbGFyaXR5EhwKCW1hZ25pdHVkZRgCIAEoAlIJbWFnbml0dWRlEhQKBXNjb3JlGAMgASgCUgVzY29yZQ==');
...
const PartOfSpeech$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.language.v1beta1.PartOfSpeech.Voice',
      '10': 'voice'
    },
  ],
  '4': const [
...
final $typed_data.Uint8List partOfSpeechDescriptor = $convert.base64Decode(
    '');
...
const DependencyEdge$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.language.v1beta1.DependencyEdge.Label',
      '10': 'label'
    },
  ],
...
final $typed_data.Uint8List dependencyEdgeDescriptor = $convert.base64Decode(
    '');
...
const EntityMention$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.language.v1beta1.EntityMention.Type',
      '10': 'type'
    },
  ],
...
final $typed_data.Uint8List entityMentionDescriptor = $convert.base64Decode(
    '');
...
const AnalyzeSentimentRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.language.v1beta1.EncodingType',
      '10': 'encodingType'
    },
  ],
};
...
final $typed_data.Uint8List analyzeSentimentRequestDescriptor =
    $convert.base64Decode(
        'ChdBbmFseXplU2VudGltZW50UmVxdWVzdBJDCghkb2N1bWVudBgBIAEoCzInLmdvb2dsZS5jbG91ZC5sYW5ndWFnZS52MWJldGExLkRvY3VtZW50Ughkb2N1bWVudBJQCg1lbmNvZGluZ190eXBlGAIgASgOMisuZ29vZ2xlLmNsb3VkLmxhbmd1YWdlLnYxYmV0YTEuRW5jb2RpbmdUeXBlUgxlbmNvZGluZ1R5cGU=');
...
final $typed_data.Uint8List analyzeSentimentResponseDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List analyzeEntitiesRequestDescriptor =
    $convert.base64Decode(
        'ChZBbmFseXplRW50aXRpZXNSZXF1ZXN0EkMKCGRvY3VtZW50GAEgASgLMicuZ29vZ2xlLmNsb3VkLmxhbmd1YWdlLnYxYmV0YTEuRG9jdW1lbnRSCGRvY3VtZW50ElAKDWVuY29kaW5nX3R5cGUYAiABKA4yKy5nb29nbGUuY2xvdWQubGFuZ3VhZ2UudjFiZXRhMS5FbmNvZGluZ1R5cGVSDGVuY29kaW5nVHlwZQ==');
...
final $typed_data.Uint8List analyzeEntitiesResponseDescriptor =
    $convert.base64Decode(
        'ChdBbmFseXplRW50aXRpZXNSZXNwb25zZRJBCghlbnRpdGllcxgBIAMoCzIlLmdvb2dsZS5jbG91ZC5sYW5ndWFnZS52MWJldGExLkVudGl0eVIIZW50aXRpZXMSGgoIbGFuZ3VhZ2UYAiABKAlSCGxhbmd1YWdl');
...
final $typed_data.Uint8List analyzeSyntaxRequestDescriptor = $convert.base64Decode(
    'ChRBbmFseXplU3ludGF4UmVxdWVzdBJDCghkb2N1bWVudBgBIAEoCzInLmdvb2dsZS5jbG91ZC5sYW5ndWFnZS52MWJldGExLkRvY3VtZW50Ughkb2N1bWVudBJQCg1lbmNvZGluZ190eXBlGAIgASgOMisuZ29vZ2xlLmNsb3VkLmxhbmd1YWdlLnYxYmV0YTEuRW5jb2RpbmdUeXBlUgxlbmNvZGluZ1R5cGU=');
...
final $typed_data.Uint8List analyzeSyntaxResponseDescriptor = $convert.base64Decode(
    'ChVBbmFseXplU3ludGF4UmVzcG9uc2USRQoJc2VudGVuY2VzGAEgAygLMicuZ29vZ2xlLmNsb3VkLmxhbmd1YWdlLnYxYmV0YTEuU2VudGVuY2VSCXNlbnRlbmNlcxI8CgZ0b2tlbnMYAiADKAsyJC5nb29nbGUuY2xvdWQubGFuZ3VhZ2UudjFiZXRhMS5Ub2tlblIGdG9rZW5zEhoKCGxhbmd1YWdlGAMgASgJUghsYW5ndWFnZQ==');
...
final $typed_data.Uint8List annotateTextRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List annotateTextResponseDescriptor = $convert.base64Decode(
    '');
