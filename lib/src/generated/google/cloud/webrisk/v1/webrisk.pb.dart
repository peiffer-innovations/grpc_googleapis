...
class Submission extends $pb.GeneratedMessage {
  ...
  factory Submission.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Submission.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Submission copyWith(void Function(Submission) updates) =>
      super.copyWith((message) => updates(message as Submission))
          as Submission; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Submission getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<Submission>(create);
...
class CreateSubmissionRequest extends $pb.GeneratedMessage {
  ...
  factory CreateSubmissionRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CreateSubmissionRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  CreateSubmissionRequest clone() =>
      CreateSubmissionRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CreateSubmissionRequest copyWith(
          void Function(CreateSubmissionRequest) updates) =>
      super.copyWith((message) => updates(message as CreateSubmissionRequest))
          as CreateSubmissionRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CreateSubmissionRequest create() => CreateSubmissionRequest._();
  CreateSubmissionRequest createEmptyInstance() => create();
  static $pb.PbList<CreateSubmissionRequest> createRepeated() =>
      $pb.PbList<CreateSubmissionRequest>();
  @$core.pragma('dart2js:noInline')
  static CreateSubmissionRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CreateSubmissionRequest>(create);
