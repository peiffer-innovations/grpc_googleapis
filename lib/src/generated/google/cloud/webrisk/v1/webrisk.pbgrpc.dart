...
class WebRiskServiceClient extends $grpc.Client {
  ...
  static final _$createSubmission =
      $grpc.ClientMethod<$0.CreateSubmissionRequest, $0.Submission>(
          '/google.cloud.webrisk.v1.WebRiskService/CreateSubmission',
          ($0.CreateSubmissionRequest value) => value.writeToBuffer(),
  ...
  $grpc.ResponseFuture<$0.Submission> createSubmission(
      $0.CreateSubmissionRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class WebRiskServiceBase extends $grpc.Service {
  ...
  WebRiskServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.CreateSubmissionRequest, $0.Submission>(
        'CreateSubmission',
        createSubmission_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.CreateSubmissionRequest.fromBuffer(value),
  ...
  $async.Future<$0.Submission> createSubmission_Pre($grpc.ServiceCall call,
      $async.Future<$0.CreateSubmissionRequest> request) async {
  ...
  $async.Future<$0.Submission> createSubmission(
      $grpc.ServiceCall call, $0.CreateSubmissionRequest request);
}
