...
class WebSecurityScannerClient extends $grpc.Client {
  ...
  static final _$updateScanConfig = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) => $1.ScanConfig.fromBuffer(value));
  static final _$startScanRun =
      $grpc.ClientMethod<$0.StartScanRunRequest, $3.ScanRun>(
  ...
  static final _$getScanRun =
      $grpc.ClientMethod<$0.GetScanRunRequest, $3.ScanRun>(
          '/google.cloud.websecurityscanner.v1.WebSecurityScanner/GetScanRun',
          ($0.GetScanRunRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $3.ScanRun.fromBuffer(value));
  static final _$listScanRuns =
      $grpc.ClientMethod<$0.ListScanRunsRequest, $0.ListScanRunsResponse>(
  ...
  static final _$stopScanRun =
      $grpc.ClientMethod<$0.StopScanRunRequest, $3.ScanRun>(
  ...
  static final _$getFinding =
      $grpc.ClientMethod<$0.GetFindingRequest, $4.Finding>(
  ...
  static final _$listFindings =
      $grpc.ClientMethod<$0.ListFindingsRequest, $0.ListFindingsResponse>(
