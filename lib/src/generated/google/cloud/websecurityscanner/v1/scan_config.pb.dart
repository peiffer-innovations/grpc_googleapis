...
class ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo
  ...
  ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo._()
      : super();
  ...
  factory ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo.fromJson(
          $core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo clone() =>
      ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo()
        ..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo copyWith(
          void Function(
                  ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo)
              updates) =>
      super.copyWith((message) => updates(message
              as ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo))
          as ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo
      create() =>
          ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo._();
  ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo
      createEmptyInstance() => create();
  ...
  @$pb.TagNumber(1)
  set targetAudienceClientId($core.String v) {
    $_setString(0, v);
  }
...
class ScanConfig_Authentication_IapCredential extends $pb.GeneratedMessage {
  static const $core.Map<$core.int,
          ScanConfig_Authentication_IapCredential_IapCredentials>
      _ScanConfig_Authentication_IapCredential_IapCredentialsByTag = {
    1: ScanConfig_Authentication_IapCredential_IapCredentials
        .iapTestServiceAccountInfo,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'iapTestServiceAccountInfo',
  ...
  factory ScanConfig_Authentication_IapCredential.fromBuffer(
          $core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ScanConfig_Authentication_IapCredential.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ScanConfig_Authentication_IapCredential clone() =>
      ScanConfig_Authentication_IapCredential()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ScanConfig_Authentication_IapCredential copyWith(
          void Function(ScanConfig_Authentication_IapCredential) updates) =>
      super.copyWith((message) =>
              updates(message as ScanConfig_Authentication_IapCredential))
          as ScanConfig_Authentication_IapCredential; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ScanConfig_Authentication_IapCredential create() =>
      ScanConfig_Authentication_IapCredential._();
  ScanConfig_Authentication_IapCredential createEmptyInstance() => create();
  static $pb.PbList<ScanConfig_Authentication_IapCredential> createRepeated() =>
      $pb.PbList<ScanConfig_Authentication_IapCredential>();
  @$core.pragma('dart2js:noInline')
  static ScanConfig_Authentication_IapCredential getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          ScanConfig_Authentication_IapCredential>(create);
  ...
  @$pb.TagNumber(1)
  ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo
      get iapTestServiceAccountInfo => $_getN(0);
  @$pb.TagNumber(1)
  set iapTestServiceAccountInfo(
      ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  ScanConfig_Authentication_IapCredential_IapTestServiceAccountInfo
      ensureIapTestServiceAccountInfo() => $_ensure(0);
}
...
class ScanConfig_Authentication extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ScanConfig_Authentication_IapCredential>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'iapCredential',
        subBuilder: ScanConfig_Authentication_IapCredential.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  set iapCredential(ScanConfig_Authentication_IapCredential v) {
    setField(4, v);
  }
