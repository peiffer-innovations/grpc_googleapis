...
const VulnerableHeaders$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.websecurityscanner.v1beta.VulnerableHeaders.Header',
      '10': 'headers'
    },
    const {
      '1': 'missing_headers',
...
final $typed_data.Uint8List vulnerableHeadersDescriptor = $convert.base64Decode(
    '');
