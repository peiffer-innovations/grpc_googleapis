...
class VariableState extends $pb.ProtobufEnum {
  static const VariableState VARIABLE_STATE_UNSPECIFIED = VariableState._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'VARIABLE_STATE_UNSPECIFIED');
  static const VariableState UPDATED = VariableState._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UPDATED');
  static const VariableState DELETED = VariableState._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DELETED');
