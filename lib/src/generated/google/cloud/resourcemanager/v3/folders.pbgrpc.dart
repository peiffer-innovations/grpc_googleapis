...
class FoldersClient extends $grpc.Client {
  ...
  static final _$updateFolder =
      $grpc.ClientMethod<$4.UpdateFolderRequest, $2.Operation>(
  ...
  static final _$deleteFolder =
      $grpc.ClientMethod<$4.DeleteFolderRequest, $2.Operation>(
  ...
  static final _$undeleteFolder =
      $grpc.ClientMethod<$4.UndeleteFolderRequest, $2.Operation>(
  ...
  $grpc.ResponseFuture<$2.Operation> updateFolder(
      $4.UpdateFolderRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$2.Operation> deleteFolder(
      $4.DeleteFolderRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteFolder, request, options: options);
  }

  $grpc.ResponseFuture<$2.Operation> undeleteFolder(
...
abstract class FoldersServiceBase extends $grpc.Service {
  ...
  FoldersServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$4.UpdateFolderRequest, $2.Operation>(
        'UpdateFolder',
        updateFolder_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$4.MoveFolderRequest, $2.Operation>(
        ...
        ($2.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$4.DeleteFolderRequest, $2.Operation>(
        'DeleteFolder',
        deleteFolder_Pre,
        false,
        false,
        ...
        ($2.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$4.UndeleteFolderRequest, $2.Operation>(
        'UndeleteFolder',
        undeleteFolder_Pre,
        false,
        false,
  ...
  $async.Future<$2.Operation> updateFolder_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$2.Operation> deleteFolder_Pre($grpc.ServiceCall call,
      $async.Future<$4.DeleteFolderRequest> request) async {
    return deleteFolder(call, await request);
  }

  $async.Future<$2.Operation> undeleteFolder_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$2.Operation> updateFolder(
  ...
  $async.Future<$2.Operation> deleteFolder(
      $grpc.ServiceCall call, $4.DeleteFolderRequest request);
  $async.Future<$2.Operation> undeleteFolder(
