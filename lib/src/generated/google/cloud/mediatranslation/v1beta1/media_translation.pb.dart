...
enum StreamingTranslateSpeechResult_Result { textTranslationResult, notSet }

class StreamingTranslateSpeechResult extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, StreamingTranslateSpeechResult_Result>
      _StreamingTranslateSpeechResult_ResultByTag = {
  ...
  StreamingTranslateSpeechResult_Result whichResult() =>
      _StreamingTranslateSpeechResult_ResultByTag[$_whichOneof(0)]!;
