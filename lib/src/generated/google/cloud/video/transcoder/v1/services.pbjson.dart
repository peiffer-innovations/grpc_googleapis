...
const CreateJobRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.video.transcoder.v1.Job',
      '8': const {},
      '10': 'job'
    },
  ],
...
final $typed_data.Uint8List createJobRequestDescriptor = $convert.base64Decode(
    'ChBDcmVhdGVKb2JSZXF1ZXN0EkEKBnBhcmVudBgBIAEoCUIp4EEC+kEjCiFsb2NhdGlvbnMuZ29vZ2xlYXBpcy5jb20vTG9jYXRpb25SBnBhcmVudBI8CgNqb2IYAiABKAsyJS5nb29nbGUuY2xvdWQudmlkZW8udHJhbnNjb2Rlci52MS5Kb2JCA+BBAlIDam9i');
...
final $typed_data.Uint8List listJobsRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List deleteJobRequestDescriptor = $convert.base64Decode(
    'ChBEZWxldGVKb2JSZXF1ZXN0EjkKBG5hbWUYASABKAlCJeBBAvpBHwoddHJhbnNjb2Rlci5nb29nbGVhcGlzLmNvbS9Kb2JSBG5hbWUSIwoNYWxsb3dfbWlzc2luZxgCIAEoCFIMYWxsb3dNaXNzaW5n');
...
final $typed_data.Uint8List listJobsResponseDescriptor = $convert.base64Decode(
    'ChBMaXN0Sm9ic1Jlc3BvbnNlEjkKBGpvYnMYASADKAsyJS5nb29nbGUuY2xvdWQudmlkZW8udHJhbnNjb2Rlci52MS5Kb2JSBGpvYnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
...
const CreateJobTemplateRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.video.transcoder.v1.JobTemplate',
      '8': const {},
      '10': 'jobTemplate'
    },
    const {
...
final $typed_data.Uint8List createJobTemplateRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listJobTemplatesRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List deleteJobTemplateRequestDescriptor =
    $convert.base64Decode(
        'ChhEZWxldGVKb2JUZW1wbGF0ZVJlcXVlc3QSQQoEbmFtZRgBIAEoCUIt4EEC+kEnCiV0cmFuc2NvZGVyLmdvb2dsZWFwaXMuY29tL0pvYlRlbXBsYXRlUgRuYW1lEiMKDWFsbG93X21pc3NpbmcYAiABKAhSDGFsbG93TWlzc2luZw==');
...
final $typed_data.Uint8List listJobTemplatesResponseDescriptor =
    $convert.base64Decode(
        'ChhMaXN0Sm9iVGVtcGxhdGVzUmVzcG9uc2USUgoNam9iX3RlbXBsYXRlcxgBIAMoCzItLmdvb2dsZS5jbG91ZC52aWRlby50cmFuc2NvZGVyLnYxLkpvYlRlbXBsYXRlUgxqb2JUZW1wbGF0ZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
