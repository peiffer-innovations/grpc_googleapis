...
const CreateNamespaceRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.servicedirectory.v1.Namespace',
      '8': const {},
      '10': 'namespace'
    },
  ],
...
final $typed_data.Uint8List createNamespaceRequestDescriptor =
    $convert.base64Decode(
        '');
...
final $typed_data.Uint8List listNamespacesResponseDescriptor =
    $convert.base64Decode(
        'ChZMaXN0TmFtZXNwYWNlc1Jlc3BvbnNlEksKCm5hbWVzcGFjZXMYASADKAsyKy5nb29nbGUuY2xvdWQuc2VydmljZWRpcmVjdG9yeS52MS5OYW1lc3BhY2VSCm5hbWVzcGFjZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List updateNamespaceRequestDescriptor =
    $convert.base64Decode(
        'ChZVcGRhdGVOYW1lc3BhY2VSZXF1ZXN0Ek4KCW5hbWVzcGFjZRgBIAEoCzIrLmdvb2dsZS5jbG91ZC5zZXJ2aWNlZGlyZWN0b3J5LnYxLk5hbWVzcGFjZUID4EECUgluYW1lc3BhY2USQAoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrQgPgQQJSCnVwZGF0ZU1hc2s=');
...
const CreateServiceRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.google.cloud.servicedirectory.v1.Service',
      '8': const {},
      '10': 'service'
    },
  ],
...
final $typed_data.Uint8List createServiceRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listServicesResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0U2VydmljZXNSZXNwb25zZRJFCghzZXJ2aWNlcxgBIAMoCzIpLmdvb2dsZS5jbG91ZC5zZXJ2aWNlZGlyZWN0b3J5LnYxLlNlcnZpY2VSCHNlcnZpY2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List updateServiceRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVTZXJ2aWNlUmVxdWVzdBJICgdzZXJ2aWNlGAEgASgLMikuZ29vZ2xlLmNsb3VkLnNlcnZpY2VkaXJlY3RvcnkudjEuU2VydmljZUID4EECUgdzZXJ2aWNlEkAKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza0ID4EECUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List createEndpointRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listEndpointsResponseDescriptor = $convert.base64Decode(
    'ChVMaXN0RW5kcG9pbnRzUmVzcG9uc2USSAoJZW5kcG9pbnRzGAEgAygLMiouZ29vZ2xlLmNsb3VkLnNlcnZpY2VkaXJlY3RvcnkudjEuRW5kcG9pbnRSCWVuZHBvaW50cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List updateEndpointRequestDescriptor = $convert.base64Decode(
    'ChVVcGRhdGVFbmRwb2ludFJlcXVlc3QSSwoIZW5kcG9pbnQYASABKAsyKi5nb29nbGUuY2xvdWQuc2VydmljZWRpcmVjdG9yeS52MS5FbmRwb2ludEID4EECUghlbmRwb2ludBJACgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaw==');
