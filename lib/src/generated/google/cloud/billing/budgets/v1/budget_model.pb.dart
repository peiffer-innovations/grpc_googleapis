...
class Budget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<NotificationsRule>(
        6,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'notificationsRule',
        subBuilder: NotificationsRule.create)
    ..aOS(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(6)
  set notificationsRule(NotificationsRule v) {
    setField(6, v);
  }
...
class NotificationsRule extends $pb.GeneratedMessage {
  ...
  factory NotificationsRule.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NotificationsRule.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  NotificationsRule copyWith(void Function(NotificationsRule) updates) =>
      super.copyWith((message) => updates(message as NotificationsRule))
          as NotificationsRule; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NotificationsRule create() => NotificationsRule._();
  NotificationsRule createEmptyInstance() => create();
  static $pb.PbList<NotificationsRule> createRepeated() =>
      $pb.PbList<NotificationsRule>();
  @$core.pragma('dart2js:noInline')
  static NotificationsRule getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<NotificationsRule>(create);
...
class Filter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $1.ListValue>(
        ...
        packageName: const $pb.PackageName('google.cloud.billing.budgets.v1'))
    ..pPS(
        7,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
