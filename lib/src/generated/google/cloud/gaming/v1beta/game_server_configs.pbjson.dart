...
const ListGameServerConfigsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.gaming.v1beta.GameServerConfig',
...
final $typed_data.Uint8List listGameServerConfigsResponseDescriptor =
    $convert.base64Decode(
        '');
...
const ScalingConfig$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.gaming.v1beta.LabelSelector',
      '10': 'selectors'
    },
    const {
      '1': 'schedules',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.gaming.v1beta.Schedule',
      '10': 'schedules'
    },
  ],
};
...
final $typed_data.Uint8List scalingConfigDescriptor = $convert.base64Decode(
    '');
...
const GameServerConfig$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.gaming.v1beta.GameServerConfig.LabelsEntry',
      '10': 'labels'
    },
    const {
      '1': 'fleet_configs',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.gaming.v1beta.FleetConfig',
      '10': 'fleetConfigs'
    },
    const {
      '1': 'scaling_configs',
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.gaming.v1beta.ScalingConfig',
      '10': 'scalingConfigs'
    },
...
final $typed_data.Uint8List gameServerConfigDescriptor = $convert.base64Decode(
    '');
