...
class Reservation extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  set creationTime($2.Timestamp v) {
    setField(8, v);
  }
...
class CapacityCommitment extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set commitmentStartTime($2.Timestamp v) {
    setField(9, v);
  }
...
class CreateCapacityCommitmentRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set capacityCommitmentId($core.String v) {
    $_setString(3, v);
  }
...
class CreateAssignmentRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set assignmentId($core.String v) {
    $_setString(2, v);
  }
...
class SearchAllAssignmentsRequest extends $pb.GeneratedMessage {
  ...
  factory SearchAllAssignmentsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SearchAllAssignmentsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SearchAllAssignmentsRequest clone() =>
      SearchAllAssignmentsRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SearchAllAssignmentsRequest copyWith(
          void Function(SearchAllAssignmentsRequest) updates) =>
      super.copyWith(
              (message) => updates(message as SearchAllAssignmentsRequest))
          as SearchAllAssignmentsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SearchAllAssignmentsRequest create() =>
      SearchAllAssignmentsRequest._();
  SearchAllAssignmentsRequest createEmptyInstance() => create();
  static $pb.PbList<SearchAllAssignmentsRequest> createRepeated() =>
      $pb.PbList<SearchAllAssignmentsRequest>();
  @$core.pragma('dart2js:noInline')
  static SearchAllAssignmentsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SearchAllAssignmentsRequest>(create);
...
class SearchAllAssignmentsResponse extends $pb.GeneratedMessage {
  ...
  factory SearchAllAssignmentsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SearchAllAssignmentsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SearchAllAssignmentsResponse clone() =>
      SearchAllAssignmentsResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SearchAllAssignmentsResponse copyWith(
          void Function(SearchAllAssignmentsResponse) updates) =>
      super.copyWith(
              (message) => updates(message as SearchAllAssignmentsResponse))
          as SearchAllAssignmentsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SearchAllAssignmentsResponse create() =>
      SearchAllAssignmentsResponse._();
  SearchAllAssignmentsResponse createEmptyInstance() => create();
  static $pb.PbList<SearchAllAssignmentsResponse> createRepeated() =>
      $pb.PbList<SearchAllAssignmentsResponse>();
  @$core.pragma('dart2js:noInline')
  static SearchAllAssignmentsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SearchAllAssignmentsResponse>(create);
...
class UpdateBiReservationRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set biReservation(BiReservation v) {
    setField(1, v);
  }
