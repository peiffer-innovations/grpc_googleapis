...
class ArrowSerializationOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'google.cloud.bigquery.storage.v1beta2'),
      createEmptyInstance: create)
    ..e<ArrowSerializationOptions_Format>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'format',
        $pb.PbFieldType.OE,
        defaultOrMaker: ArrowSerializationOptions_Format.FORMAT_UNSPECIFIED,
        valueOf: ArrowSerializationOptions_Format.valueOf,
        enumValues: ArrowSerializationOptions_Format.values)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set format(ArrowSerializationOptions_Format v) {
    setField(1, v);
  }
