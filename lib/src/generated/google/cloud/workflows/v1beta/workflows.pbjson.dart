...
const Workflow$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.google.cloud.workflows.v1beta.Workflow.State',
      '8': const {},
      '10': 'state'
    },
    const {
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.workflows.v1beta.Workflow.LabelsEntry',
      '10': 'labels'
    },
    const {
      '1': 'service_account',
...
final $typed_data.Uint8List workflowDescriptor = $convert.base64Decode(
    '');
...
const ListWorkflowsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.cloud.workflows.v1beta.Workflow',
      '10': 'workflows'
    },
    const {
      '1': 'next_page_token',
...
final $typed_data.Uint8List listWorkflowsResponseDescriptor = $convert.base64Decode(
    'ChVMaXN0V29ya2Zsb3dzUmVzcG9uc2USRQoJd29ya2Zsb3dzGAEgAygLMicuZ29vZ2xlLmNsb3VkLndvcmtmbG93cy52MWJldGEuV29ya2Zsb3dSCXdvcmtmbG93cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4SIAoLdW5yZWFjaGFibGUYAyADKAlSC3VucmVhY2hhYmxl');
...
final $typed_data.Uint8List createWorkflowRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List updateWorkflowRequestDescriptor = $convert.base64Decode(
    'ChVVcGRhdGVXb3JrZmxvd1JlcXVlc3QSSAoId29ya2Zsb3cYASABKAsyJy5nb29nbGUuY2xvdWQud29ya2Zsb3dzLnYxYmV0YS5Xb3JrZmxvd0ID4EECUgh3b3JrZmxvdxI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCnVwZGF0ZU1hc2s=');
