...
class Instance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $core.String>(
        ...
        packageName: const $pb.PackageName('google.cloud.memcache.v1beta2'))
    ..aOS(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
...
class ApplySoftwareUpdateRequest extends $pb.GeneratedMessage {
  ...
  factory ApplySoftwareUpdateRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ApplySoftwareUpdateRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ApplySoftwareUpdateRequest clone() =>
      ApplySoftwareUpdateRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ApplySoftwareUpdateRequest copyWith(
          void Function(ApplySoftwareUpdateRequest) updates) =>
      super.copyWith(
              (message) => updates(message as ApplySoftwareUpdateRequest))
          as ApplySoftwareUpdateRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static $pb.PbList<ApplySoftwareUpdateRequest> createRepeated() =>
      $pb.PbList<ApplySoftwareUpdateRequest>();
  @$core.pragma('dart2js:noInline')
  static ApplySoftwareUpdateRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ApplySoftwareUpdateRequest>(create);
