...
class CloudMemcacheClient extends $grpc.Client {
  ...
  static final _$applyParameters =
      $grpc.ClientMethod<$2.ApplyParametersRequest, $0.Operation>(
          ...
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$applySoftwareUpdate =
      $grpc.ClientMethod<$2.ApplySoftwareUpdateRequest, $0.Operation>(
          '/google.cloud.memcache.v1beta2.CloudMemcache/ApplySoftwareUpdate',
          ($2.ApplySoftwareUpdateRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.Operation> applySoftwareUpdate(
      $2.ApplySoftwareUpdateRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class CloudMemcacheServiceBase extends $grpc.Service {
  ...
  CloudMemcacheServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.ApplyParametersRequest, $0.Operation>(
        ...
        ($0.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.ApplySoftwareUpdateRequest, $0.Operation>(
        'ApplySoftwareUpdate',
        applySoftwareUpdate_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.ApplySoftwareUpdateRequest.fromBuffer(value),
        ($0.Operation value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.Operation> applySoftwareUpdate_Pre($grpc.ServiceCall call,
      $async.Future<$2.ApplySoftwareUpdateRequest> request) async {
  ...
  $async.Future<$0.Operation> applySoftwareUpdate(
      $grpc.ServiceCall call, $2.ApplySoftwareUpdateRequest request);
}
