...
class WorkflowTemplateServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$4.WorkflowTemplate> createWorkflowTemplate(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createWorkflowTemplate, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$0.Operation> instantiateWorkflowTemplate(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$instantiateWorkflowTemplate, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$0.Operation> instantiateInlineWorkflowTemplate(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$instantiateInlineWorkflowTemplate, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$4.WorkflowTemplate> updateWorkflowTemplate(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateWorkflowTemplate, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$1.Empty> deleteWorkflowTemplate(
      ...
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteWorkflowTemplate, request,
        options: options);
  }
}
