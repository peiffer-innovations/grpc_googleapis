...
class MetricDescriptor_MetricDescriptorMetadata extends $pb.GeneratedMessage {
  factory MetricDescriptor_MetricDescriptorMetadata({
    @$core.Deprecated('This field is deprecated.') $2.LaunchStage? launchStage,
  ...
  factory MetricDescriptor_MetricDescriptorMetadata.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<$2.LaunchStage>(1, _omitFieldNames ? '' : 'launchStage',
        enumValues: $2.LaunchStage.values)
    ..aOM<$1.Duration>(2, _omitFieldNames ? '' : 'samplePeriod',
        subBuilder: $1.Duration.create)
    ..aOM<$1.Duration>(3, _omitFieldNames ? '' : 'ingestDelay',
        subBuilder: $1.Duration.create)
  ...
  MetricDescriptor_MetricDescriptorMetadata clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set launchStage($2.LaunchStage value) => $_setField(1, value);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set samplePeriod($1.Duration value) => $_setField(2, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set ingestDelay($1.Duration value) => $_setField(3, value);
  @$pb.TagNumber(3)
...
class MetricDescriptor extends $pb.GeneratedMessage {
  ...
  factory MetricDescriptor.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory MetricDescriptor.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<MetricDescriptor_MetricKind>(3, _omitFieldNames ? '' : 'metricKind',
        enumValues: MetricDescriptor_MetricKind.values)
    ..aE<MetricDescriptor_ValueType>(4, _omitFieldNames ? '' : 'valueType',
    ...
    ..aE<$2.LaunchStage>(12, _omitFieldNames ? '' : 'launchStage',
        enumValues: $2.LaunchStage.values)
    ..pPS(13, _omitFieldNames ? '' : 'monitoredResourceTypes')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MetricDescriptor clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(10)
  set metadata(MetricDescriptor_MetricDescriptorMetadata value) =>
      $_setField(10, value);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set launchStage($2.LaunchStage value) => $_setField(12, value);
  @$pb.TagNumber(12)
