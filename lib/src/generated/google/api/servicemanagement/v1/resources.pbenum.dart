  ...
  static const OperationMetadata_Status IN_PROGRESS =
      OperationMetadata_Status._(
          ...
          const $core.bool.fromEnvironment('protobuf.omit_enum_names')
              ? ''
              : 'IN_PROGRESS');
  static const OperationMetadata_Status FAILED = OperationMetadata_Status._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FAILED');
...
class Diagnostic_Kind extends $pb.ProtobufEnum {
  static const Diagnostic_Kind WARNING = Diagnostic_Kind._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WARNING');
...
class Rollout_RolloutStatus extends $pb.ProtobufEnum {
  ...
  static const Rollout_RolloutStatus IN_PROGRESS = Rollout_RolloutStatus._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'IN_PROGRESS');
  static const Rollout_RolloutStatus SUCCESS = Rollout_RolloutStatus._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SUCCESS');
  static const Rollout_RolloutStatus CANCELLED = Rollout_RolloutStatus._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'CANCELLED');
  static const Rollout_RolloutStatus FAILED = Rollout_RolloutStatus._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'FAILED');
  static const Rollout_RolloutStatus PENDING = Rollout_RolloutStatus._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PENDING');
