...
class Backend extends $pb.GeneratedMessage {
  ...
  factory Backend.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory Backend.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<BackendRule>(1, _omitFieldNames ? '' : 'rules',
        subBuilder: BackendRule.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  Backend clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class BackendRule extends $pb.GeneratedMessage {
  factory BackendRule({
    ...
    $core.Iterable<$core.MapEntry<$core.String, BackendRule>>?
    ...
    if (overridesByRequestProtocol != null)
      result.overridesByRequestProtocol.addEntries(overridesByRequestProtocol);
    return result;
  }

  BackendRule._();

  factory BackendRule.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory BackendRule.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aD(3, _omitFieldNames ? '' : 'deadline')
    ..aD(4, _omitFieldNames ? '' : 'minDeadline')
    ..aD(5, _omitFieldNames ? '' : 'operationDeadline')
    ..aE<BackendRule_PathTranslation>(
        6, _omitFieldNames ? '' : 'pathTranslation',
  ...
  @$pb.TagNumber(6)
  set pathTranslation(BackendRule_PathTranslation value) =>
      $_setField(6, value);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(10)
  $pb.PbMap<$core.String, BackendRule> get overridesByRequestProtocol =>
      $_getMap(9);
}
