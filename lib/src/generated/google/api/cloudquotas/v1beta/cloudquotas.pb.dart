...
class ListQuotaInfosResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<$1.QuotaInfo> get quotaInfos => $_getList(0);
...
class ListQuotaPreferencesResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<$1.QuotaPreference> get quotaPreferences => $_getList(0);
...
class CreateQuotaPreferenceRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set quotaPreference($1.QuotaPreference v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(4)
  $core.List<$1.QuotaSafetyCheck> get ignoreSafetyChecks => $_getList(3);
}
...
class UpdateQuotaPreferenceRequest extends $pb.GeneratedMessage {
  ...
  /// The list of quota safety checks to be ignored.
  @$pb.TagNumber(5)
  $core.List<$1.QuotaSafetyCheck> get ignoreSafetyChecks => $_getList(4);
}
