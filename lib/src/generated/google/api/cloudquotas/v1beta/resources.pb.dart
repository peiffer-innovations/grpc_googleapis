...
class QuotaInfo extends $pb.GeneratedMessage {
  ...
  factory QuotaInfo.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QuotaInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<QuotaInfo_ContainerType>(7, _omitFieldNames ? '' : 'containerType',
    ...
    ..pPM<DimensionsInfo>(14, _omitFieldNames ? '' : 'dimensionsInfos',
  ...
  @$pb.TagNumber(12)
  set quotaIncreaseEligibility(QuotaIncreaseEligibility value) =>
      $_setField(12, value);
  @$pb.TagNumber(12)
...
class QuotaIncreaseEligibility extends $pb.GeneratedMessage {
  ...
  factory QuotaIncreaseEligibility.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QuotaIncreaseEligibility.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<QuotaIncreaseEligibility_IneligibilityReason>(
        2, _omitFieldNames ? '' : 'ineligibilityReason',
        enumValues: QuotaIncreaseEligibility_IneligibilityReason.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  QuotaIncreaseEligibility clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  QuotaIncreaseEligibility_IneligibilityReason get ineligibilityReason =>
      $_getN(1);
  @$pb.TagNumber(2)
  set ineligibilityReason(QuotaIncreaseEligibility_IneligibilityReason value) =>
      $_setField(2, value);
  @$pb.TagNumber(2)
...
class QuotaPreference extends $pb.GeneratedMessage {
  ...
  factory QuotaPreference.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QuotaPreference.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'dimensions',
        ...
        packageName: const $pb.PackageName('google.api.cloudquotas.v1beta'))
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  QuotaPreference clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class QuotaConfig extends $pb.GeneratedMessage {
  ...
  factory QuotaConfig.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QuotaConfig.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.Int64Value>(3, _omitFieldNames ? '' : 'grantedValue',
    ...
    ..m<$core.String, $core.String>(5, _omitFieldNames ? '' : 'annotations',
        ...
        valueFieldType: $pb.PbFieldType.OS,
        packageName: const $pb.PackageName('google.api.cloudquotas.v1beta'))
    ..aE<QuotaConfig_Origin>(6, _omitFieldNames ? '' : 'requestOrigin',
        enumValues: QuotaConfig_Origin.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  QuotaConfig clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(3)
  $1.Int64Value get grantedValue => $_getN(2);
  @$pb.TagNumber(3)
  set grantedValue($1.Int64Value value) => $_setField(3, value);
  @$pb.TagNumber(3)
  $core.bool hasGrantedValue() => $_has(2);
  @$pb.TagNumber(3)
  void clearGrantedValue() => $_clearField(3);
  @$pb.TagNumber(3)
  $1.Int64Value ensureGrantedValue() => $_ensure(2);
...
class DimensionsInfo extends $pb.GeneratedMessage {
  ...
  factory DimensionsInfo.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory DimensionsInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
...
class QuotaDetails extends $pb.GeneratedMessage {
  ...
  factory QuotaDetails.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory QuotaDetails.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
...
class RolloutInfo extends $pb.GeneratedMessage {
  ...
  factory RolloutInfo.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RolloutInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
