...
final $typed_data.Uint8List clientLibraryDestinationDescriptor =
    $convert.base64Decode(
        'ChhDbGllbnRMaWJyYXJ5RGVzdGluYXRpb24SKgomQ0xJRU5UX0xJQlJBUllfREVTVElOQVRJT05fVU5TUEVDSUZJRUQQABIKCgZHSVRIVUIQChITCg9QQUNLQUdFX01BTkFHRVIQFA==');
...
final $typed_data.Uint8List commonLanguageSettingsDescriptor =
    $convert.base64Decode(
        'ChZDb21tb25MYW5ndWFnZVNldHRpbmdzEjAKEnJlZmVyZW5jZV9kb2NzX3VyaRgBIAEoCUICGAFSEHJlZmVyZW5jZURvY3NVcmkSSAoMZGVzdGluYXRpb25zGAIgAygOMiQuZ29vZ2xlLmFwaS5DbGllbnRMaWJyYXJ5RGVzdGluYXRpb25SDGRlc3RpbmF0aW9ucw==');
...
final $typed_data.Uint8List clientLibrarySettingsDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List javaSettingsDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List cppSettingsDescriptor = $convert.base64Decode(
    'CgtDcHBTZXR0aW5ncxI6CgZjb21tb24YASABKAsyIi5nb29nbGUuYXBpLkNvbW1vbkxhbmd1YWdlU2V0dGluZ3NSBmNvbW1vbg==');
...
final $typed_data.Uint8List phpSettingsDescriptor = $convert.base64Decode(
    'CgtQaHBTZXR0aW5ncxI6CgZjb21tb24YASABKAsyIi5nb29nbGUuYXBpLkNvbW1vbkxhbmd1YWdlU2V0dGluZ3NSBmNvbW1vbg==');
...
final $typed_data.Uint8List pythonSettingsDescriptor = $convert.base64Decode(
    'Cg5QeXRob25TZXR0aW5ncxI6CgZjb21tb24YASABKAsyIi5nb29nbGUuYXBpLkNvbW1vbkxhbmd1YWdlU2V0dGluZ3NSBmNvbW1vbg==');
...
final $typed_data.Uint8List nodeSettingsDescriptor = $convert.base64Decode(
    'CgxOb2RlU2V0dGluZ3MSOgoGY29tbW9uGAEgASgLMiIuZ29vZ2xlLmFwaS5Db21tb25MYW5ndWFnZVNldHRpbmdzUgZjb21tb24=');
...
final $typed_data.Uint8List rubySettingsDescriptor = $convert.base64Decode(
    'CgxSdWJ5U2V0dGluZ3MSOgoGY29tbW9uGAEgASgLMiIuZ29vZ2xlLmFwaS5Db21tb25MYW5ndWFnZVNldHRpbmdzUgZjb21tb24=');
...
final $typed_data.Uint8List goSettingsDescriptor = $convert.base64Decode(
    'CgpHb1NldHRpbmdzEjoKBmNvbW1vbhgBIAEoCzIiLmdvb2dsZS5hcGkuQ29tbW9uTGFuZ3VhZ2VTZXR0aW5nc1IGY29tbW9u');
...
final $typed_data.Uint8List methodSettingsDescriptor = $convert.base64Decode(
    '');
