...
class ClientLibraryOrganization extends $pb.ProtobufEnum {
  ...
  static const ClientLibraryOrganization CLOUD = ClientLibraryOrganization._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'CLOUD');
  static const ClientLibraryOrganization ADS = ClientLibraryOrganization._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ADS');
  static const ClientLibraryOrganization PHOTOS = ClientLibraryOrganization._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PHOTOS');
...
class ClientLibraryDestination extends $pb.ProtobufEnum {
  ...
  static const ClientLibraryDestination GITHUB = ClientLibraryDestination._(
      10,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'GITHUB');
