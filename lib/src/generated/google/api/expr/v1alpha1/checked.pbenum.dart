...
class Type_PrimitiveType extends $pb.ProtobufEnum {
  ...
  static const Type_PrimitiveType INT64 = Type_PrimitiveType._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'INT64');
  static const Type_PrimitiveType UINT64 = Type_PrimitiveType._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UINT64');
  static const Type_PrimitiveType DOUBLE = Type_PrimitiveType._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DOUBLE');
  static const Type_PrimitiveType STRING = Type_PrimitiveType._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'STRING');
...
class Type_WellKnownType extends $pb.ProtobufEnum {
  ...
  static const Type_WellKnownType TIMESTAMP = Type_WellKnownType._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TIMESTAMP');
  static const Type_WellKnownType DURATION = Type_WellKnownType._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DURATION');
