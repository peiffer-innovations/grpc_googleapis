...
//
// Generated from google/api/expr/v1beta1/eval.proto.
...
class EvalState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.api.expr.v1beta1'),
      createEmptyInstance: create)
    ..pPM<ExprValue>(1, _omitFieldNames ? '' : 'values',
        subBuilder: ExprValue.create)
    ..pPM<EvalState_Result>(3, _omitFieldNames ? '' : 'results',
...
class ErrorSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.api.expr.v1beta1'),
      createEmptyInstance: create)
    ..pPM<$1.Status>(1, _omitFieldNames ? '' : 'errors',
  ...
  @$pb.TagNumber(1)
  $pb.PbList<$1.Status> get errors => $_getList(0);
}
...
class UnknownSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.api.expr.v1beta1'),
      createEmptyInstance: create)
    ..pPM<IdRef>(1, _omitFieldNames ? '' : 'exprs', subBuilder: IdRef.create)
    ..hasRequiredFields = false;
...
class IdRef extends $pb.GeneratedMessage {
  ...
  factory IdRef.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory IdRef.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
