...
class Role_RoleLaunchStage extends $pb.ProtobufEnum {
  ...
  static const Role_RoleLaunchStage BETA = Role_RoleLaunchStage._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'BETA');
  static const Role_RoleLaunchStage GA = Role_RoleLaunchStage._(2,
  ...
  static const Role_RoleLaunchStage DEPRECATED = Role_RoleLaunchStage._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DEPRECATED');
  static const Role_RoleLaunchStage DISABLED = Role_RoleLaunchStage._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DISABLED');
...
class LintResult_Severity extends $pb.ProtobufEnum {
  ...
  static const LintResult_Severity ERROR = LintResult_Severity._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'ERROR');
  static const LintResult_Severity WARNING = LintResult_Severity._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WARNING');
  static const LintResult_Severity NOTICE = LintResult_Severity._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NOTICE');
