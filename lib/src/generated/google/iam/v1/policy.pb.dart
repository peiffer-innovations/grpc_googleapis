...
class Policy extends $pb.GeneratedMessage {
  factory Policy({
    ...
    if (auditConfigs != null) result.auditConfigs.addAll(auditConfigs);
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<Binding>(4, _omitFieldNames ? '' : 'bindings',
        subBuilder: Binding.create)
    ..pPM<AuditConfig>(6, _omitFieldNames ? '' : 'auditConfigs',
  ...
  @$pb.TagNumber(6)
  $pb.PbList<AuditConfig> get auditConfigs => $_getList(3);
}
...
class Binding extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.Expr>(3, _omitFieldNames ? '' : 'condition',
  ...
  @$pb.TagNumber(3)
  set condition($0.Expr value) => $_setField(3, value);
  @$pb.TagNumber(3)
...
class AuditConfig extends $pb.GeneratedMessage {
  factory AuditConfig({
    ...
    if (auditLogConfigs != null) result.auditLogConfigs.addAll(auditLogConfigs);
    return result;
  }

  AuditConfig._();

  factory AuditConfig.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AuditConfig.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<AuditLogConfig>(3, _omitFieldNames ? '' : 'auditLogConfigs',
        subBuilder: AuditLogConfig.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AuditConfig clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class AuditLogConfig extends $pb.GeneratedMessage {
  factory AuditLogConfig({
    ...
    if (exemptedMembers != null) result.exemptedMembers.addAll(exemptedMembers);
    return result;
  }

  AuditLogConfig._();

  factory AuditLogConfig.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AuditLogConfig.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v1'),
      createEmptyInstance: create)
    ..aE<AuditLogConfig_LogType>(1, _omitFieldNames ? '' : 'logType',
        enumValues: AuditLogConfig_LogType.values)
    ..pPS(2, _omitFieldNames ? '' : 'exemptedMembers')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AuditLogConfig clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set logType(AuditLogConfig_LogType value) => $_setField(1, value);
  @$pb.TagNumber(1)
...
class PolicyDelta extends $pb.GeneratedMessage {
  factory PolicyDelta({
    ...
    final result = create();
    if (bindingDeltas != null) result.bindingDeltas.addAll(bindingDeltas);
  ...
  factory PolicyDelta.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory PolicyDelta.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v1'),
      createEmptyInstance: create)
    ..pPM<BindingDelta>(1, _omitFieldNames ? '' : 'bindingDeltas',
        subBuilder: BindingDelta.create)
    ..pPM<AuditConfigDelta>(2, _omitFieldNames ? '' : 'auditConfigDeltas',
        subBuilder: AuditConfigDelta.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PolicyDelta clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<BindingDelta> get bindingDeltas => $_getList(0);

  /// The delta for AuditConfigs between two policies.
  @$pb.TagNumber(2)
  $pb.PbList<AuditConfigDelta> get auditConfigDeltas => $_getList(1);
}
...
class BindingDelta extends $pb.GeneratedMessage {
  ...
  factory BindingDelta.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory BindingDelta.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v1'),
      createEmptyInstance: create)
    ..aE<BindingDelta_Action>(1, _omitFieldNames ? '' : 'action',
  ...
  @$pb.TagNumber(1)
  set action(BindingDelta_Action value) => $_setField(1, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set member($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set condition($0.Expr value) => $_setField(4, value);
  @$pb.TagNumber(4)
...
class AuditConfigDelta extends $pb.GeneratedMessage {
  factory AuditConfigDelta({
    ...
    if (action != null) result.action = action;
    if (service != null) result.service = service;
    if (exemptedMember != null) result.exemptedMember = exemptedMember;
    if (logType != null) result.logType = logType;
    return result;
  }
  ...
  factory AuditConfigDelta.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AuditConfigDelta.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v1'),
      createEmptyInstance: create)
    ..aE<AuditConfigDelta_Action>(1, _omitFieldNames ? '' : 'action',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AuditConfigDelta clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  set action(AuditConfigDelta_Action value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasAction() => $_has(0);
  @$pb.TagNumber(1)
  void clearAction() => $_clearField(1);
  ...
  @$pb.TagNumber(3)
  set exemptedMember($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasExemptedMember() => $_has(2);
  @$pb.TagNumber(3)
  void clearExemptedMember() => $_clearField(3);
  ...
  @$pb.TagNumber(4)
  set logType($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasLogType() => $_has(3);
  @$pb.TagNumber(4)
  void clearLogType() => $_clearField(4);
}
