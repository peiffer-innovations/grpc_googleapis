...
class Policy extends $pb.GeneratedMessage {
  factory Policy({
    ...
    if (managingAuthority != null) {
      $result.managingAuthority = managingAuthority;
    }
    return $result;
  }
  Policy._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$3.Timestamp>(8, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $3.Timestamp.create)
    ..aOM<$3.Timestamp>(9, _omitFieldNames ? '' : 'deleteTime',
        subBuilder: $3.Timestamp.create)
...
class PolicyRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.DenyRule>(2, _omitFieldNames ? '' : 'denyRule',
