...
//
// Generated from google/iam/v2/deny.proto.
...
class DenyRule extends $pb.GeneratedMessage {
  ...
  factory DenyRule.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory DenyRule.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.Expr>(5, _omitFieldNames ? '' : 'denialCondition',
        subBuilder: $0.Expr.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DenyRule clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(1)
  $pb.PbList<$core.String> get deniedPrincipals => $_getList(0);
  ...
  /// the internet.
  @$pb.TagNumber(2)
  $pb.PbList<$core.String> get exceptionPrincipals => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $pb.PbList<$core.String> get deniedPermissions => $_getList(2);
  ...
  @$pb.TagNumber(5)
  set denialCondition($0.Expr value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasDenialCondition() => $_has(4);
  @$pb.TagNumber(5)
  void clearDenialCondition() => $_clearField(5);
  @$pb.TagNumber(5)
